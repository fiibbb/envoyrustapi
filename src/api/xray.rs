...
//! Generated file from `envoy/extensions/tracers/xray/v4alpha/xray.proto`
...
impl XRayConfig {
    ...
    // .envoy.config.core.v4alpha.SocketAddress daemon_endpoint = 1;
    ...
    // .envoy.config.core.v4alpha.DataSource sampling_rule_manifest = 3;
    ...
    // .envoy.extensions.tracers.xray.v4alpha.XRayConfig.SegmentFields segment_fields = 4;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n0envoy/extensions/tracers/xray/v4alpha/xray.proto\x12%envoy.extensions\
    .tracers.xray.v4alpha\x1a'envoy/config/core/v4alpha/address.proto\x1a$en\
    voy/config/core/v4alpha/base.proto\x1a\x1cgoogle/protobuf/struct.proto\
    \x1a\x1dudpa/annotations/status.proto\x1a!udpa/annotations/versioning.pr\
    oto\x1a\x17validate/validate.proto\"\x85\x04\n\nXRayConfig\x12Q\n\x0fdae\
    mon_endpoint\x18\x01\x20\x01(\x0b2(.envoy.config.core.v4alpha.SocketAddr\
    essR\x0edaemonEndpoint\x12*\n\x0csegment_name\x18\x02\x20\x01(\tR\x0bseg\
    mentNameB\x07\xfaB\x04r\x02\x10\x01\x12[\n\x16sampling_rule_manifest\x18\
    \x03\x20\x01(\x0b2%.envoy.config.core.v4alpha.DataSourceR\x14samplingRul\
    eManifest\x12f\n\x0esegment_fields\x18\x04\x20\x01(\x0b2?.envoy.extensio\
    ns.tracers.xray.v4alpha.XRayConfig.SegmentFieldsR\rsegmentFields\x1a\x89\
    \x01\n\rSegmentFields\x12\x16\n\x06origin\x18\x01\x20\x01(\tR\x06origin\
    \x12)\n\x03aws\x18\x02\x20\x01(\x0b2\x17.google.protobuf.StructR\x03aws:\
    5\x9a\xc5\x88\x1e0\n.envoy.config.trace.v3.XRayConfig.SegmentFields:'\
    \x9a\xc5\x88\x1e\"\n\x20envoy.config.trace.v3.XRayConfigBJ\n3io.envoypro\
    xy.envoy.extensions.tracers.xray.v4alphaB\tXrayProtoP\x01\xba\x80\xc8\
