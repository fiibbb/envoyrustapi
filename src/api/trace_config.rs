...
//! Generated file from `opencensus/proto/trace/v1/trace_config.proto`
...
impl TraceConfig {
    ...
    pub fn get_max_number_of_annotations(&self) -> i64 {
        self.max_number_of_annotations
    }
    pub fn clear_max_number_of_annotations(&mut self) {
        self.max_number_of_annotations = 0;
    }

    // Param is passed by value, moved
    pub fn set_max_number_of_annotations(&mut self, v: i64) {
        self.max_number_of_annotations = v;
    }

    // int64 max_number_of_message_events = 6;


    pub fn get_max_number_of_message_events(&self) -> i64 {
        self.max_number_of_message_events
    }
    pub fn clear_max_number_of_message_events(&mut self) {
        self.max_number_of_message_events = 0;
    }

    // Param is passed by value, moved
    pub fn set_max_number_of_message_events(&mut self, v: i64) {
        self.max_number_of_message_events = v;
    }
...
impl ::protobuf::Message for TraceConfig {
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                5 => {
                    ...
                    let tmp = is.read_int64()?;
                    self.max_number_of_annotations = tmp;
                },
                6 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    ...
                    let tmp = is.read_int64()?;
                    self.max_number_of_message_events = tmp;
                },
                7 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.max_number_of_annotations != 0 {
            my_size += ::protobuf::rt::value_size(5, self.max_number_of_annotations, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.max_number_of_message_events != 0 {
            my_size += ::protobuf::rt::value_size(6, self.max_number_of_message_events, ::protobuf::wire_format::WireTypeVarint);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.max_number_of_annotations != 0 {
            os.write_int64(5, self.max_number_of_annotations)?;
        }
        if self.max_number_of_message_events != 0 {
            os.write_int64(6, self.max_number_of_message_events)?;
        }
        if self.max_number_of_links != 0 {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeInt64>(
                ...
                |m: &TraceConfig| { &m.max_number_of_annotations },
                |m: &mut TraceConfig| { &mut m.max_number_of_annotations },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeInt64>(
                "max_number_of_message_events",
                |m: &TraceConfig| { &m.max_number_of_message_events },
                |m: &mut TraceConfig| { &mut m.max_number_of_message_events },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeInt64>(
                "max_number_of_links",
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n,opencensus/proto/trace/v1/trace_config.proto\x12\x19opencensus.proto.\
    trace.v1\"\x9c\x04\n\x0bTraceConfig\x12`\n\x13probability_sampler\x18\
    \x01\x20\x01(\x0b2-.opencensus.proto.trace.v1.ProbabilitySamplerH\0R\x12\
    probabilitySampler\x12W\n\x10constant_sampler\x18\x02\x20\x01(\x0b2*.ope\
    ncensus.proto.trace.v1.ConstantSamplerH\0R\x0fconstantSampler\x12d\n\x15\
    rate_limiting_sampler\x18\x03\x20\x01(\x0b2..opencensus.proto.trace.v1.R\
    ateLimitingSamplerH\0R\x13rateLimitingSampler\x127\n\x18max_number_of_at\
    tributes\x18\x04\x20\x01(\x03R\x15maxNumberOfAttributes\x129\n\x19max_nu\
    mber_of_annotations\x18\x05\x20\x01(\x03R\x16maxNumberOfAnnotations\x12>\
    \n\x1cmax_number_of_message_events\x18\x06\x20\x01(\x03R\x18maxNumberOfM\
    essageEvents\x12-\n\x13max_number_of_links\x18\x07\x20\x01(\x03R\x10maxN\
    umberOfLinksB\t\n\x07sampler\"F\n\x12ProbabilitySampler\x120\n\x13sampli\
    ngProbability\x18\x01\x20\x01(\x01R\x13samplingProbability\"\xb0\x01\n\
    \x0fConstantSampler\x12W\n\x08decision\x18\x01\x20\x01(\x0e2;.opencensus\
    .proto.trace.v1.ConstantSampler.ConstantDecisionR\x08decision\"D\n\x10Co\
    nstantDecision\x12\x0e\n\nALWAYS_OFF\x10\0\x12\r\n\tALWAYS_ON\x10\x01\
    \x12\x11\n\rALWAYS_PARENT\x10\x02\"'\n\x13RateLimitingSampler\x12\x10\n\
    \x03qps\x18\x01\x20\x01(\x03R\x03qpsB\x92\x01\n\x1cio.opencensus.proto.t\
    race.v1B\x10TraceConfigProtoP\x01ZBgithub.com/census-instrumentation/ope\
    ncensus-proto/gen-go/trace/v1\xea\x02\x19OpenCensus.Proto.Trace.V1b\x06p\
    roto3\
";
