...
//! Generated file from `envoy/service/auth/v4alpha/attribute_context.proto`
...
impl AttributeContext {
    ...
    // repeated .envoy.service.auth.v4alpha.AttributeContext.ContextExtensionsEntry context_extensions = 10;
...
impl AttributeContext_Peer {
    ...
    // repeated .envoy.service.auth.v4alpha.AttributeContext.Peer.LabelsEntry labels = 3;
...
impl AttributeContext_Request {
    ...
    // .envoy.service.auth.v4alpha.AttributeContext.HttpRequest http = 2;
...
impl AttributeContext_HttpRequest {
    ...
    // repeated .envoy.service.auth.v4alpha.AttributeContext.HttpRequest.HeadersEntry headers = 3;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n2envoy/service/auth/v4alpha/attribute_context.proto\x12\x1aenvoy.servi\
    ce.auth.v4alpha\x1a'envoy/config/core/v4alpha/address.proto\x1a$envoy/co\
    nfig/core/v4alpha/base.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\
    \x1dudpa/annotations/status.proto\x1a!udpa/annotations/versioning.proto\
    \"\xc4\x0c\n\x10AttributeContext\x12I\n\x06source\x18\x01\x20\x01(\x0b21\
    .envoy.service.auth.v4alpha.AttributeContext.PeerR\x06source\x12S\n\x0bd\
    estination\x18\x02\x20\x01(\x0b21.envoy.service.auth.v4alpha.AttributeCo\
    ntext.PeerR\x0bdestination\x12N\n\x07request\x18\x04\x20\x01(\x0b24.envo\
    y.service.auth.v4alpha.AttributeContext.RequestR\x07request\x12r\n\x12co\
    ntext_extensions\x18\n\x20\x03(\x0b2C.envoy.service.auth.v4alpha.Attribu\
    teContext.ContextExtensionsEntryR\x11contextExtensions\x12N\n\x10metadat\
    a_context\x18\x0b\x20\x01(\x0b2#.envoy.config.core.v4alpha.MetadataR\x0f\
    metadataContext\x1a\xe4\x02\n\x04Peer\x12<\n\x07address\x18\x01\x20\x01(\
    \x0b2\".envoy.config.core.v4alpha.AddressR\x07address\x12\x18\n\x07servi\
    ce\x18\x02\x20\x01(\tR\x07service\x12U\n\x06labels\x18\x03\x20\x03(\x0b2\
    =.envoy.service.auth.v4alpha.AttributeContext.Peer.LabelsEntryR\x06label\
    s\x12\x1c\n\tprincipal\x18\x04\x20\x01(\tR\tprincipal\x12\x20\n\x0bcerti\
    ficate\x18\x05\x20\x01(\tR\x0bcertificate\x1a9\n\x0bLabelsEntry\x12\x10\
    \n\x03key\x18\x01\x20\x01(\tR\x03key\x12\x14\n\x05value\x18\x02\x20\x01(\
    \tR\x05value:\x028\x01:2\x9a\xc5\x88\x1e-\n+envoy.service.auth.v3.Attrib\
    uteContext.Peer\x1a\xbe\x01\n\x07Request\x12.\n\x04time\x18\x01\x20\x01(\
    \x0b2\x1a.google.protobuf.TimestampR\x04time\x12L\n\x04http\x18\x02\x20\
    \x01(\x0b28.envoy.service.auth.v4alpha.AttributeContext.HttpRequestR\x04\
    http:5\x9a\xc5\x88\x1e0\n.envoy.service.auth.v3.AttributeContext.Request\
    \x1a\xde\x03\n\x0bHttpRequest\x12\x0e\n\x02id\x18\x01\x20\x01(\tR\x02id\
    \x12\x16\n\x06method\x18\x02\x20\x01(\tR\x06method\x12_\n\x07headers\x18\
    \x03\x20\x03(\x0b2E.envoy.service.auth.v4alpha.AttributeContext.HttpRequ\
    est.HeadersEntryR\x07headers\x12\x12\n\x04path\x18\x04\x20\x01(\tR\x04pa\
    th\x12\x12\n\x04host\x18\x05\x20\x01(\tR\x04host\x12\x16\n\x06scheme\x18\
    \x06\x20\x01(\tR\x06scheme\x12\x14\n\x05query\x18\x07\x20\x01(\tR\x05que\
    ry\x12\x1a\n\x08fragment\x18\x08\x20\x01(\tR\x08fragment\x12\x12\n\x04si\
    ze\x18\t\x20\x01(\x03R\x04size\x12\x1a\n\x08protocol\x18\n\x20\x01(\tR\
    \x08protocol\x12\x12\n\x04body\x18\x0b\x20\x01(\tR\x04body\x12\x19\n\x08\
    raw_body\x18\x0c\x20\x01(\x0cR\x07rawBody\x1a:\n\x0cHeadersEntry\x12\x10\
    \n\x03key\x18\x01\x20\x01(\tR\x03key\x12\x14\n\x05value\x18\x02\x20\x01(\
    \tR\x05value:\x028\x01:9\x9a\xc5\x88\x1e4\n2envoy.service.auth.v3.Attrib\
    uteContext.HttpRequest\x1aD\n\x16ContextExtensionsEntry\x12\x10\n\x03key\
    \x18\x01\x20\x01(\tR\x03key\x12\x14\n\x05value\x18\x02\x20\x01(\tR\x05va\
    lue:\x028\x01:-\x9a\xc5\x88\x1e(\n&envoy.service.auth.v3.AttributeContex\
    tBK\n(io.envoyproxy.envoy.service.auth.v4alphaB\x15AttributeContextProto\
    P\x01\xba\x80\xc8\xd1\x06\x02\x10\x03b\x06proto3\
";
