...
//! Generated file from `envoy/service/auth/v4alpha/external_auth.proto`
...
impl CheckRequest {
    ...
    // .envoy.service.auth.v4alpha.AttributeContext attributes = 1;
...
impl DeniedHttpResponse {
    ...
    // repeated .envoy.config.core.v4alpha.HeaderValueOption headers = 2;
...
impl CheckResponse {
    ...
    // .envoy.service.auth.v4alpha.DeniedHttpResponse denied_response = 2;
    ...
    // .envoy.service.auth.v4alpha.OkHttpResponse ok_response = 3;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n.envoy/service/auth/v4alpha/external_auth.proto\x12\x1aenvoy.service.a\
    uth.v4alpha\x1a$envoy/config/core/v4alpha/base.proto\x1a2envoy/service/a\
    uth/v4alpha/attribute_context.proto\x1a\x1fenvoy/type/v3/http_status.pro\
    to\x1a\x1cgoogle/protobuf/struct.proto\x1a\x17google/rpc/status.proto\
    \x1a\x1dudpa/annotations/status.proto\x1a!udpa/annotations/versioning.pr\
    oto\x1a\x17validate/validate.proto\"\x87\x01\n\x0cCheckRequest\x12L\n\na\
    ttributes\x18\x01\x20\x01(\x0b2,.envoy.service.auth.v4alpha.AttributeCon\
    textR\nattributes:)\x9a\xc5\x88\x1e$\n\"envoy.service.auth.v3.CheckReque\
    st\"\xde\x01\n\x12DeniedHttpResponse\x12;\n\x06status\x18\x01\x20\x01(\
    \x0b2\x19.envoy.type.v3.HttpStatusR\x06statusB\x08\xfaB\x05\x8a\x01\x02\
    \x10\x01\x12F\n\x07headers\x18\x02\x20\x03(\x0b2,.envoy.config.core.v4al\
    pha.HeaderValueOptionR\x07headers\x12\x12\n\x04body\x18\x03\x20\x01(\tR\
    \x04body:/\x9a\xc5\x88\x1e*\n(envoy.service.auth.v3.DeniedHttpResponse\"\
    \xc9\x01\n\x0eOkHttpResponse\x12F\n\x07headers\x18\x02\x20\x03(\x0b2,.en\
    voy.config.core.v4alpha.HeaderValueOptionR\x07headers\x12*\n\x11headers_\
    to_remove\x18\x05\x20\x03(\tR\x0fheadersToRemove:+\x9a\xc5\x88\x1e&\n$en\
    voy.service.auth.v3.OkHttpResponseJ\x04\x08\x03\x10\x04R\x10dynamic_meta\
    data\"\xe6\x02\n\rCheckResponse\x12*\n\x06status\x18\x01\x20\x01(\x0b2\
    \x12.google.rpc.StatusR\x06status\x12Y\n\x0fdenied_response\x18\x02\x20\
    \x01(\x0b2..envoy.service.auth.v4alpha.DeniedHttpResponseH\0R\x0edeniedR\
    esponse\x12M\n\x0bok_response\x18\x03\x20\x01(\x0b2*.envoy.service.auth.\
    v4alpha.OkHttpResponseH\0R\nokResponse\x12B\n\x10dynamic_metadata\x18\
    ...
    2o\n\rAuthorization\x12^\n\x05Check\x12(.envoy.service.auth.v4alpha.Chec\
    kRequest\x1a).envoy.service.auth.v4alpha.CheckResponse\"\0BJ\n(io.envoyp\
    roxy.envoy.service.auth.v4alphaB\x11ExternalAuthProtoP\x01\x88\x01\x01\
