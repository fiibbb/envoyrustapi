...
//! Generated file from `envoy/extensions/tracers/opencensus/v4alpha/opencensus.proto`
...
impl OpenCensusConfig {
    ...
    // .envoy.config.core.v4alpha.GrpcService stackdriver_grpc_service = 13;
    ...
    // .envoy.config.core.v4alpha.GrpcService ocagent_grpc_service = 14;
    ...
    // repeated .envoy.extensions.tracers.opencensus.v4alpha.OpenCensusConfig.TraceContext incoming_trace_context = 8;
    ...
    // repeated .envoy.extensions.tracers.opencensus.v4alpha.OpenCensusConfig.TraceContext outgoing_trace_context = 9;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n<envoy/extensions/tracers/opencensus/v4alpha/opencensus.proto\x12+envo\
    y.extensions.tracers.opencensus.v4alpha\x1a,envoy/config/core/v4alpha/gr\
    pc_service.proto\x1a,opencensus/proto/trace/v1/trace_config.proto\x1a\
    \x1dudpa/annotations/status.proto\x1a!udpa/annotations/versioning.proto\
    \x1a\x17validate/validate.proto\"\xd1\x08\n\x10OpenCensusConfig\x12I\n\
    \x0ctrace_config\x18\x01\x20\x01(\x0b2&.opencensus.proto.trace.v1.TraceC\
    onfigR\x0btraceConfig\x126\n\x17stdout_exporter_enabled\x18\x02\x20\x01(\
    \x08R\x15stdoutExporterEnabled\x12@\n\x1cstackdriver_exporter_enabled\
    \x18\x03\x20\x01(\x08R\x1astackdriverExporterEnabled\x124\n\x16stackdriv\
    er_project_id\x18\x04\x20\x01(\tR\x14stackdriverProjectId\x12/\n\x13stac\
    kdriver_address\x18\n\x20\x01(\tR\x12stackdriverAddress\x12`\n\x18stackd\
    river_grpc_service\x18\r\x20\x01(\x0b2&.envoy.config.core.v4alpha.GrpcSe\
    rviceR\x16stackdriverGrpcService\x126\n\x17zipkin_exporter_enabled\x18\
    \x05\x20\x01(\x08R\x15zipkinExporterEnabled\x12\x1d\n\nzipkin_url\x18\
    \x06\x20\x01(\tR\tzipkinUrl\x128\n\x18ocagent_exporter_enabled\x18\x0b\
    \x20\x01(\x08R\x16ocagentExporterEnabled\x12'\n\x0focagent_address\x18\
    \x0c\x20\x01(\tR\x0eocagentAddress\x12X\n\x14ocagent_grpc_service\x18\
    \x0e\x20\x01(\x0b2&.envoy.config.core.v4alpha.GrpcServiceR\x12ocagentGrp\
    cService\x12\x80\x01\n\x16incoming_trace_context\x18\x08\x20\x03(\x0e2J.\
    envoy.extensions.tracers.opencensus.v4alpha.OpenCensusConfig.TraceContex\
    tR\x14incomingTraceContext\x12\x80\x01\n\x16outgoing_trace_context\x18\t\
    \x20\x03(\x0e2J.envoy.extensions.tracers.opencensus.v4alpha.OpenCensusCo\
    nfig.TraceContextR\x14outgoingTraceContext\"`\n\x0cTraceContext\x12\x08\
    \n\x04NONE\x10\0\x12\x11\n\rTRACE_CONTEXT\x10\x01\x12\x12\n\x0eGRPC_TRAC\
    E_BIN\x10\x02\x12\x17\n\x13CLOUD_TRACE_CONTEXT\x10\x03\x12\x06\n\x02B3\
    \x10\x04:-\x9a\xc5\x88\x1e(\n&envoy.config.trace.v3.OpenCensusConfigJ\
    \x04\x08\x07\x10\x08BV\n9io.envoyproxy.envoy.extensions.tracers.opencens\
    us.v4alphaB\x0fOpencensusProtoP\x01\xba\x80\xc8\xd1\x06\x02\x10\x03b\x06\
    proto3\
";
