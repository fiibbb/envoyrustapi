...
//! Generated file from `envoy/service/auth/v2/attribute_context.proto`
...
impl AttributeContext {
    ...
    // repeated .envoy.service.auth.v2.AttributeContext.ContextExtensionsEntry context_extensions = 10;
...
impl AttributeContext_Peer {
    ...
    // repeated .envoy.service.auth.v2.AttributeContext.Peer.LabelsEntry labels = 3;
...
impl AttributeContext_HttpRequest {
    ...
    // repeated .envoy.service.auth.v2.AttributeContext.HttpRequest.HeadersEntry headers = 3;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n-envoy/service/auth/v2/attribute_context.proto\x12\x15envoy.service.au\
    th.v2\x1a\x1fenvoy/api/v2/core/address.proto\x1a\x1cenvoy/api/v2/core/ba\
    se.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1dudpa/annotations/\
    status.proto\"\xa1\n\n\x10AttributeContext\x12D\n\x06source\x18\x01\x20\
    \x01(\x0b2,.envoy.service.auth.v2.AttributeContext.PeerR\x06source\x12N\
    \n\x0bdestination\x18\x02\x20\x01(\x0b2,.envoy.service.auth.v2.Attribute\
    Context.PeerR\x0bdestination\x12I\n\x07request\x18\x04\x20\x01(\x0b2/.en\
    voy.service.auth.v2.AttributeContext.RequestR\x07request\x12m\n\x12conte\
    xt_extensions\x18\n\x20\x03(\x0b2>.envoy.service.auth.v2.AttributeContex\
    t.ContextExtensionsEntryR\x11contextExtensions\x12F\n\x10metadata_contex\
    t\x18\x0b\x20\x01(\x0b2\x1b.envoy.api.v2.core.MetadataR\x0fmetadataConte\
    xt\x1a\xa3\x02\n\x04Peer\x124\n\x07address\x18\x01\x20\x01(\x0b2\x1a.env\
    oy.api.v2.core.AddressR\x07address\x12\x18\n\x07service\x18\x02\x20\x01(\
    \tR\x07service\x12P\n\x06labels\x18\x03\x20\x03(\x0b28.envoy.service.aut\
    h.v2.AttributeContext.Peer.LabelsEntryR\x06labels\x12\x1c\n\tprincipal\
    \x18\x04\x20\x01(\tR\tprincipal\x12\x20\n\x0bcertificate\x18\x05\x20\x01\
    (\tR\x0bcertificate\x1a9\n\x0bLabelsEntry\x12\x10\n\x03key\x18\x01\x20\
    \x01(\tR\x03key\x12\x14\n\x05value\x18\x02\x20\x01(\tR\x05value:\x028\
    \x01\x1a\x82\x01\n\x07Request\x12.\n\x04time\x18\x01\x20\x01(\x0b2\x1a.g\
    oogle.protobuf.TimestampR\x04time\x12G\n\x04http\x18\x02\x20\x01(\x0b23.\
    envoy.service.auth.v2.AttributeContext.HttpRequestR\x04http\x1a\x83\x03\
    \n\x0bHttpRequest\x12\x0e\n\x02id\x18\x01\x20\x01(\tR\x02id\x12\x16\n\
    \x06method\x18\x02\x20\x01(\tR\x06method\x12Z\n\x07headers\x18\x03\x20\
    \x03(\x0b2@.envoy.service.auth.v2.AttributeContext.HttpRequest.HeadersEn\
    tryR\x07headers\x12\x12\n\x04path\x18\x04\x20\x01(\tR\x04path\x12\x12\n\
    \x04host\x18\x05\x20\x01(\tR\x04host\x12\x16\n\x06scheme\x18\x06\x20\x01\
    (\tR\x06scheme\x12\x14\n\x05query\x18\x07\x20\x01(\tR\x05query\x12\x1a\n\
    \x08fragment\x18\x08\x20\x01(\tR\x08fragment\x12\x12\n\x04size\x18\t\x20\
    \x01(\x03R\x04size\x12\x1a\n\x08protocol\x18\n\x20\x01(\tR\x08protocol\
    \x12\x12\n\x04body\x18\x0b\x20\x01(\tR\x04body\x1a:\n\x0cHeadersEntry\
    \x12\x10\n\x03key\x18\x01\x20\x01(\tR\x03key\x12\x14\n\x05value\x18\x02\
    \x20\x01(\tR\x05value:\x028\x01\x1aD\n\x16ContextExtensionsEntry\x12\x10\
    \n\x03key\x18\x01\x20\x01(\tR\x03key\x12\x14\n\x05value\x18\x02\x20\x01(\
    \tR\x05value:\x028\x01BF\n#io.envoyproxy.envoy.service.auth.v2B\x15Attri\
    buteContextProtoP\x01\xba\x80\xc8\xd1\x06\x02\x10\x01b\x06proto3\
";
