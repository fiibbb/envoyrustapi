...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    protobuf/struct.proto\x1a\x17google/rpc/status.proto\x1a\x1dudpa/annotat\
    ions/status.proto\x1a!udpa/annotations/versioning.proto\x1a\x17validate/\
    validate.proto\"\x82\x01\n\x0cCheckRequest\x12G\n\nattributes\x18\x01\
    \x20\x01(\x0b2'.envoy.service.auth.v3.AttributeContextR\nattributes:)\
    \x9a\xc5\x88\x1e$\n\"envoy.service.auth.v2.CheckRequest\"\xd9\x01\n\x12D\
    eniedHttpResponse\x12;\n\x06status\x18\x01\x20\x01(\x0b2\x19.envoy.type.\
    v3.HttpStatusR\x06statusB\x08\xfaB\x05\x8a\x01\x02\x10\x01\x12A\n\x07hea\
    ders\x18\x02\x20\x03(\x0b2'.envoy.config.core.v3.HeaderValueOptionR\x07h\
    eaders\x12\x12\n\x04body\x18\x03\x20\x01(\tR\x04body:/\x9a\xc5\x88\x1e*\
    \n(envoy.service.auth.v2.DeniedHttpResponse\"\xf4\x01\n\x0eOkHttpRespons\
    e\x12A\n\x07headers\x18\x02\x20\x03(\x0b2'.envoy.config.core.v3.HeaderVa\
    lueOptionR\x07headers\x12*\n\x11headers_to_remove\x18\x05\x20\x03(\tR\
    \x0fheadersToRemove\x12F\n\x10dynamic_metadata\x18\x03\x20\x01(\x0b2\x17\
    .google.protobuf.StructR\x0fdynamicMetadataB\x02\x18\x01:+\x9a\xc5\x88\
    \x1e&\n$envoy.service.auth.v2.OkHttpResponse\"\xdc\x02\n\rCheckResponse\
    \x12*\n\x06status\x18\x01\x20\x01(\x0b2\x12.google.rpc.StatusR\x06status\
    \x12T\n\x0fdenied_response\x18\x02\x20\x01(\x0b2).envoy.service.auth.v3.\
    DeniedHttpResponseH\0R\x0edeniedResponse\x12H\n\x0bok_response\x18\x03\
    \x20\x01(\x0b2%.envoy.service.auth.v3.OkHttpResponseH\0R\nokResponse\x12\
    B\n\x10dynamic_metadata\x18\x04\x20\x01(\x0b2\x17.google.protobuf.Struct\
    R\x0fdynamicMetadataB\x0f\n\rhttp_response:*\x9a\xc5\x88\x1e%\n#envoy.se\
    rvice.auth.v2.CheckResponse2e\n\rAuthorization\x12T\n\x05Check\x12#.envo\
    y.service.auth.v3.CheckRequest\x1a$.envoy.service.auth.v3.CheckResponse\
    \"\0BE\n#io.envoyproxy.envoy.service.auth.v3B\x11ExternalAuthProtoP\x01\
    \x88\x01\x01\xba\x80\xc8\xd1\x06\x02\x10\x02b\x06proto3\
";
