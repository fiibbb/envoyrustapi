...
//! Generated file from `envoy/service/metrics/v4alpha/metrics_service.proto`
...
impl StreamMetricsMessage {
    ...
    // .envoy.service.metrics.v4alpha.StreamMetricsMessage.Identifier identifier = 1;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n3envoy/service/metrics/v4alpha/metrics_service.proto\x12\x1denvoy.serv\
    ice.metrics.v4alpha\x1a$envoy/config/core/v4alpha/base.proto\x1a\rmetric\
    s.proto\x1a\x1dudpa/annotations/status.proto\x1a!udpa/annotations/versio\
    ning.proto\x1a\x17validate/validate.proto\"N\n\x15StreamMetricsResponse:\
    5\x9a\xc5\x88\x1e0\n.envoy.service.metrics.v3.StreamMetricsResponse\"\
    \x84\x03\n\x14StreamMetricsMessage\x12^\n\nidentifier\x18\x01\x20\x01(\
    \x0b2>.envoy.service.metrics.v4alpha.StreamMetricsMessage.IdentifierR\ni\
    dentifier\x12G\n\renvoy_metrics\x18\x02\x20\x03(\x0b2\".io.prometheus.cl\
    ient.MetricFamilyR\x0cenvoyMetrics\x1a\x8c\x01\n\nIdentifier\x12=\n\x04n\
    ode\x18\x01\x20\x01(\x0b2\x1f.envoy.config.core.v4alpha.NodeR\x04nodeB\
    \x08\xfaB\x05\x8a\x01\x02\x10\x01:?\x9a\xc5\x88\x1e:\n8envoy.service.met\
    rics.v3.StreamMetricsMessage.Identifier:4\x9a\xc5\x88\x1e/\n-envoy.servi\
    ce.metrics.v3.StreamMetricsMessage2\x90\x01\n\x0eMetricsService\x12~\n\r\
    StreamMetrics\x123.envoy.service.metrics.v4alpha.StreamMetricsMessage\
    \x1a4.envoy.service.metrics.v4alpha.StreamMetricsResponse\"\0(\x01BO\n+i\
    o.envoyproxy.envoy.service.metrics.v4alphaB\x13MetricsServiceProtoP\x01\
