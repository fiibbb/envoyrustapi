...
//! Generated file from `envoy/service/tap/v2alpha/common.proto`
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n&envoy/service/tap/v2alpha/common.proto\x12\x19envoy.service.tap.v2alp\
    ha\x1a\x1cenvoy/api/v2/core/base.proto\x1a$envoy/api/v2/core/grpc_servic\
    e.proto\x1a)envoy/api/v2/route/route_components.proto\x1a\x1egoogle/prot\
    obuf/wrappers.proto\x1a\x1eudpa/annotations/migrate.proto\x1a\x1dudpa/an\
    notations/status.proto\x1a\x17validate/validate.proto\"\x89\x02\n\tTapCo\
    nfig\x12V\n\x0cmatch_config\x18\x01\x20\x01(\x0b2).envoy.service.tap.v2a\
    lpha.MatchPredicateR\x0bmatchConfigB\x08\xfaB\x05\x8a\x01\x02\x10\x01\
    \x12V\n\routput_config\x18\x02\x20\x01(\x0b2'.envoy.service.tap.v2alpha.\
    OutputConfigR\x0coutputConfigB\x08\xfaB\x05\x8a\x01\x02\x10\x01\x12L\n\
    \x0btap_enabled\x18\x03\x20\x01(\x0b2+.envoy.api.v2.core.RuntimeFraction\
    alPercentR\ntapEnabled\"\xc2\x06\n\x0eMatchPredicate\x12O\n\x08or_match\
    \x18\x01\x20\x01(\x0b22.envoy.service.tap.v2alpha.MatchPredicate.MatchSe\
    tH\0R\x07orMatch\x12Q\n\tand_match\x18\x02\x20\x01(\x0b22.envoy.service.\
    tap.v2alpha.MatchPredicate.MatchSetH\0R\x08andMatch\x12H\n\tnot_match\
    \x18\x03\x20\x01(\x0b2).envoy.service.tap.v2alpha.MatchPredicateH\0R\x08\
    notMatch\x12&\n\tany_match\x18\x04\x20\x01(\x08H\0R\x08anyMatchB\x07\xfa\
    B\x04j\x02\x08\x01\x12j\n\x1ahttp_request_headers_match\x18\x05\x20\x01(\
    \x0b2+.envoy.service.tap.v2alpha.HttpHeadersMatchH\0R\x17httpRequestHead\
    ersMatch\x12l\n\x1bhttp_request_trailers_match\x18\x06\x20\x01(\x0b2+.en\
    voy.service.tap.v2alpha.HttpHeadersMatchH\0R\x18httpRequestTrailersMatch\
    \x12l\n\x1bhttp_response_headers_match\x18\x07\x20\x01(\x0b2+.envoy.serv\
    ice.tap.v2alpha.HttpHeadersMatchH\0R\x18httpResponseHeadersMatch\x12n\n\
    \x1chttp_response_trailers_match\x18\x08\x20\x01(\x0b2+.envoy.service.ta\
    p.v2alpha.HttpHeadersMatchH\0R\x19httpResponseTrailersMatch\x1aU\n\x08Ma\
    tchSet\x12I\n\x05rules\x18\x01\x20\x03(\x0b2).envoy.service.tap.v2alpha.\
    MatchPredicateR\x05rulesB\x08\xfaB\x05\x92\x01\x02\x08\x02B\x0b\n\x04rul\
    e\x12\x03\xf8B\x01\"O\n\x10HttpHeadersMatch\x12;\n\x07headers\x18\x01\
    \x20\x03(\x0b2!.envoy.api.v2.route.HeaderMatcherR\x07headers\"\x97\x02\n\
    \x0cOutputConfig\x12G\n\x05sinks\x18\x01\x20\x03(\x0b2%.envoy.service.ta\
    p.v2alpha.OutputSinkR\x05sinksB\n\xfaB\x07\x92\x01\x04\x08\x01\x10\x01\
    \x12O\n\x15max_buffered_rx_bytes\x18\x02\x20\x01(\x0b2\x1c.google.protob\
    uf.UInt32ValueR\x12maxBufferedRxBytes\x12O\n\x15max_buffered_tx_bytes\
    \x18\x03\x20\x01(\x0b2\x1c.google.protobuf.UInt32ValueR\x12maxBufferedTx\
    Bytes\x12\x1c\n\tstreaming\x18\x04\x20\x01(\x08R\tstreaming\"\xf5\x03\n\
    \nOutputSink\x12N\n\x06format\x18\x01\x20\x01(\x0e2,.envoy.service.tap.v\
    2alpha.OutputSink.FormatR\x06formatB\x08\xfaB\x05\x82\x01\x02\x10\x01\
    \x12X\n\x0fstreaming_admin\x18\x02\x20\x01(\x0b2-.envoy.service.tap.v2al\
    pha.StreamingAdminSinkH\0R\x0estreamingAdmin\x12M\n\x0cfile_per_tap\x18\
    \x03\x20\x01(\x0b2).envoy.service.tap.v2alpha.FilePerTapSinkH\0R\nfilePe\
    rTap\x12U\n\x0estreaming_grpc\x18\x04\x20\x01(\x0b2,.envoy.service.tap.v\
    2alpha.StreamingGrpcSinkH\0R\rstreamingGrpc\"~\n\x06Format\x12\x16\n\x12\
    JSON_BODY_AS_BYTES\x10\0\x12\x17\n\x13JSON_BODY_AS_STRING\x10\x01\x12\
    \x10\n\x0cPROTO_BINARY\x10\x02\x12!\n\x1dPROTO_BINARY_LENGTH_DELIMITED\
    \x10\x03\x12\x0e\n\nPROTO_TEXT\x10\x04B\x17\n\x10output_sink_type\x12\
    \x03\xf8B\x01\"\x14\n\x12StreamingAdminSink\":\n\x0eFilePerTapSink\x12(\
    \n\x0bpath_prefix\x18\x01\x20\x01(\tR\npathPrefixB\x07\xfaB\x04r\x02\x20\
