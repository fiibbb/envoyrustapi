...
//! Generated file from `envoy/service/health/v4alpha/hds.proto`
...
impl Capability {
    ...
    // repeated .envoy.service.health.v4alpha.Capability.Protocol health_check_protocols = 1;
...
impl HealthCheckRequest {
    ...
    // .envoy.service.health.v4alpha.Capability capability = 2;
...
impl EndpointHealth {
    ...
    // .envoy.config.core.v4alpha.HealthStatus health_status = 2;
...
impl<'a> ::std::default::Default for &'a LocalityEndpointsHealth {
    fn default() -> &'a LocalityEndpointsHealth {
        <LocalityEndpointsHealth as ::protobuf::Message>::default_instance()
    }
}

impl LocalityEndpointsHealth {
    pub fn new() -> LocalityEndpointsHealth {
        ::std::default::Default::default()
    }
...
impl ::protobuf::Message for LocalityEndpointsHealth {
    fn is_initialized(&self) -> bool {
    ...
    fn new() -> LocalityEndpointsHealth {
        LocalityEndpointsHealth::new()
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<super::base::Locality>>(
                "locality",
                |m: &LocalityEndpointsHealth| { &m.locality },
                |m: &mut LocalityEndpointsHealth| { &mut m.locality },
            ));
            fields.push(::protobuf::reflect::accessor::make_repeated_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<EndpointHealth>>(
                "endpoints_health",
                |m: &LocalityEndpointsHealth| { &m.endpoints_health },
                |m: &mut LocalityEndpointsHealth| { &mut m.endpoints_health },
            ));
            ::protobuf::reflect::MessageDescriptor::new_pb_name::<LocalityEndpointsHealth>(
    ...
    fn default_instance() -> &'static LocalityEndpointsHealth {
        static instance: ::protobuf::rt::LazyV2<LocalityEndpointsHealth> = ::protobuf::rt::LazyV2::INIT;
        instance.get(LocalityEndpointsHealth::new)
    }
}

impl ::protobuf::Clear for LocalityEndpointsHealth {
    fn clear(&mut self) {
        self.locality.clear();
        self.endpoints_health.clear();
        self.unknown_fields.clear();
...
impl ::std::fmt::Debug for LocalityEndpointsHealth {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for LocalityEndpointsHealth {
    fn as_ref(&self) -> ::protobuf::reflect::ReflectValueRef {
        ::protobuf::reflect::ReflectValueRef::Message(self)
    }
}
...
pub struct ClusterEndpointsHealth {
    ...
    pub locality_endpoints_health: ::protobuf::RepeatedField<LocalityEndpointsHealth>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}

impl<'a> ::std::default::Default for &'a ClusterEndpointsHealth {
    fn default() -> &'a ClusterEndpointsHealth {
        <ClusterEndpointsHealth as ::protobuf::Message>::default_instance()
    }
}

impl ClusterEndpointsHealth {
    pub fn new() -> ClusterEndpointsHealth {
        ::std::default::Default::default()
    }
    ...
    // repeated .envoy.service.health.v4alpha.LocalityEndpointsHealth locality_endpoints_health = 2;


    pub fn get_locality_endpoints_health(&self) -> &[LocalityEndpointsHealth] {
        &self.locality_endpoints_health
    }
    pub fn clear_locality_endpoints_health(&mut self) {
        self.locality_endpoints_health.clear();
    }

    // Param is passed by value, moved
    pub fn set_locality_endpoints_health(&mut self, v: ::protobuf::RepeatedField<LocalityEndpointsHealth>) {
        self.locality_endpoints_health = v;
    }

    // Mutable pointer to the field.
    pub fn mut_locality_endpoints_health(&mut self) -> &mut ::protobuf::RepeatedField<LocalityEndpointsHealth> {
        &mut self.locality_endpoints_health
    }

    // Take field
    pub fn take_locality_endpoints_health(&mut self) -> ::protobuf::RepeatedField<LocalityEndpointsHealth> {
        ::std::mem::replace(&mut self.locality_endpoints_health, ::protobuf::RepeatedField::new())
    }
}

impl ::protobuf::Message for ClusterEndpointsHealth {
    fn is_initialized(&self) -> bool {
        for v in &self.locality_endpoints_health {
            if !v.is_initialized() {
                return false;
            }
        };
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                2 => {
                    ::protobuf::rt::read_repeated_message_into(wire_type, is, &mut self.locality_endpoints_health)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        for value in &self.locality_endpoints_health {
            let len = value.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        };
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
    ...
    fn new() -> ClusterEndpointsHealth {
        ClusterEndpointsHealth::new()
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "cluster_name",
                |m: &ClusterEndpointsHealth| { &m.cluster_name },
                |m: &mut ClusterEndpointsHealth| { &mut m.cluster_name },
            ));
            fields.push(::protobuf::reflect::accessor::make_repeated_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<LocalityEndpointsHealth>>(
                "locality_endpoints_health",
                |m: &ClusterEndpointsHealth| { &m.locality_endpoints_health },
                |m: &mut ClusterEndpointsHealth| { &mut m.locality_endpoints_health },
            ));
            ::protobuf::reflect::MessageDescriptor::new_pb_name::<ClusterEndpointsHealth>(
    ...
    fn default_instance() -> &'static ClusterEndpointsHealth {
        static instance: ::protobuf::rt::LazyV2<ClusterEndpointsHealth> = ::protobuf::rt::LazyV2::INIT;
        instance.get(ClusterEndpointsHealth::new)
    }
}

impl ::protobuf::Clear for ClusterEndpointsHealth {
    fn clear(&mut self) {
        self.cluster_name.clear();
        self.locality_endpoints_health.clear();
        self.unknown_fields.clear();
...
impl ::std::fmt::Debug for ClusterEndpointsHealth {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for ClusterEndpointsHealth {
    fn as_ref(&self) -> ::protobuf::reflect::ReflectValueRef {
        ::protobuf::reflect::ReflectValueRef::Message(self)
    }
}
...
pub struct EndpointHealthResponse {
    // message fields
    pub cluster_endpoints_health: ::protobuf::RepeatedField<ClusterEndpointsHealth>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl EndpointHealthResponse {
    ...
    // repeated .envoy.service.health.v4alpha.ClusterEndpointsHealth cluster_endpoints_health = 2;


    pub fn get_cluster_endpoints_health(&self) -> &[ClusterEndpointsHealth] {
        &self.cluster_endpoints_health
    }
    pub fn clear_cluster_endpoints_health(&mut self) {
        self.cluster_endpoints_health.clear();
    }

    // Param is passed by value, moved
    pub fn set_cluster_endpoints_health(&mut self, v: ::protobuf::RepeatedField<ClusterEndpointsHealth>) {
        self.cluster_endpoints_health = v;
    }

    // Mutable pointer to the field.
    pub fn mut_cluster_endpoints_health(&mut self) -> &mut ::protobuf::RepeatedField<ClusterEndpointsHealth> {
        &mut self.cluster_endpoints_health
    }

    // Take field
    pub fn take_cluster_endpoints_health(&mut self) -> ::protobuf::RepeatedField<ClusterEndpointsHealth> {
        ::std::mem::replace(&mut self.cluster_endpoints_health, ::protobuf::RepeatedField::new())
    }
}

impl ::protobuf::Message for EndpointHealthResponse {
    fn is_initialized(&self) -> bool {
        for v in &self.cluster_endpoints_health {
            if !v.is_initialized() {
                return false;
            }
        };
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                2 => {
                    ::protobuf::rt::read_repeated_message_into(wire_type, is, &mut self.cluster_endpoints_health)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        let mut my_size = 0;
        for value in &self.cluster_endpoints_health {
            let len = value.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        };
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            let mut fields = ::std::vec::Vec::new();
            fields.push(::protobuf::reflect::accessor::make_repeated_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<ClusterEndpointsHealth>>(
                "cluster_endpoints_health",
                |m: &EndpointHealthResponse| { &m.cluster_endpoints_health },
                |m: &mut EndpointHealthResponse| { &mut m.cluster_endpoints_health },
            ));
...
impl HealthCheckRequestOrEndpointHealthResponse {
    ...
    // .envoy.service.health.v4alpha.HealthCheckRequest health_check_request = 1;
    ...
    // .envoy.service.health.v4alpha.EndpointHealthResponse endpoint_health_response = 2;
...
pub struct ClusterHealthCheck {
    ...
    pub transport_socket_matches: ::protobuf::RepeatedField<super::cluster::Cluster_TransportSocketMatch>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl ClusterHealthCheck {
    ...
    // repeated .envoy.config.cluster.v4alpha.Cluster.TransportSocketMatch transport_socket_matches = 4;


    pub fn get_transport_socket_matches(&self) -> &[super::cluster::Cluster_TransportSocketMatch] {
    ...
    // Param is passed by value, moved
    pub fn set_transport_socket_matches(&mut self, v: ::protobuf::RepeatedField<super::cluster::Cluster_TransportSocketMatch>) {
        self.transport_socket_matches = v;
    }

    // Mutable pointer to the field.
    pub fn mut_transport_socket_matches(&mut self) -> &mut ::protobuf::RepeatedField<super::cluster::Cluster_TransportSocketMatch> {
        &mut self.transport_socket_matches
    }

    // Take field
    pub fn take_transport_socket_matches(&mut self) -> ::protobuf::RepeatedField<super::cluster::Cluster_TransportSocketMatch> {
...
impl ::protobuf::Message for ClusterHealthCheck {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_repeated_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<super::cluster::Cluster_TransportSocketMatch>>(
                "transport_socket_matches",
                |m: &ClusterHealthCheck| { &m.transport_socket_matches },
                |m: &mut ClusterHealthCheck| { &mut m.transport_socket_matches },
            ));
...
impl HealthCheckSpecifier {
    ...
    // repeated .envoy.service.health.v4alpha.ClusterHealthCheck cluster_health_checks = 1;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n&envoy/service/health/v4alpha/hds.proto\x12\x1cenvoy.service.health.v4\
    alpha\x1a*envoy/config/cluster/v4alpha/cluster.proto\x1a$envoy/config/co\
    re/v4alpha/base.proto\x1a,envoy/config/core/v4alpha/health_check.proto\
    \x1a2envoy/config/endpoint/v3/endpoint_components.proto\x1a\x1cgoogle/ap\
    i/annotations.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1dudpa/an\
    notations/status.proto\x1a!udpa/annotations/versioning.proto\"\xca\x01\n\
    \nCapability\x12g\n\x16health_check_protocols\x18\x01\x20\x03(\x0e21.env\
    oy.service.health.v4alpha.Capability.ProtocolR\x14healthCheckProtocols\"\
    (\n\x08Protocol\x12\x08\n\x04HTTP\x10\0\x12\x07\n\x03TCP\x10\x01\x12\t\n\
    \x05REDIS\x10\x02:)\x9a\xc5\x88\x1e$\n\"envoy.service.health.v3.Capabili\
    ty\"\xc6\x01\n\x12HealthCheckRequest\x123\n\x04node\x18\x01\x20\x01(\x0b\
    2\x1f.envoy.config.core.v4alpha.NodeR\x04node\x12H\n\ncapability\x18\x02\
    \x20\x01(\x0b2(.envoy.service.health.v4alpha.CapabilityR\ncapability:1\
    \x9a\xc5\x88\x1e,\n*envoy.service.health.v3.HealthCheckRequest\"\xcd\x01\
    \n\x0eEndpointHealth\x12>\n\x08endpoint\x18\x01\x20\x01(\x0b2\".envoy.co\
    nfig.endpoint.v3.EndpointR\x08endpoint\x12L\n\rhealth_status\x18\x02\x20\
    \x01(\x0e2'.envoy.config.core.v4alpha.HealthStatusR\x0chealthStatus:-\
    \x9a\xc5\x88\x1e(\n&envoy.service.health.v3.EndpointHealth\"\xeb\x01\n\
    \x17LocalityEndpointsHealth\x12?\n\x08locality\x18\x01\x20\x01(\x0b2#.en\
    voy.config.core.v4alpha.LocalityR\x08locality\x12W\n\x10endpoints_health\
    \x18\x02\x20\x03(\x0b2,.envoy.service.health.v4alpha.EndpointHealthR\x0f\
    endpointsHealth:6\x9a\xc5\x88\x1e1\n/envoy.service.health.v3.LocalityEnd\
    pointsHealth\"\xe5\x01\n\x16ClusterEndpointsHealth\x12!\n\x0ccluster_nam\
    e\x18\x01\x20\x01(\tR\x0bclusterName\x12q\n\x19locality_endpoints_health\
    \x18\x02\x20\x03(\x0b25.envoy.service.health.v4alpha.LocalityEndpointsHe\
    althR\x17localityEndpointsHealth:5\x9a\xc5\x88\x1e0\n.envoy.service.heal\
    th.v3.ClusterEndpointsHealth\"\xd7\x01\n\x16EndpointHealthResponse\x12n\
    \n\x18cluster_endpoints_health\x18\x02\x20\x03(\x0b24.envoy.service.heal\
    th.v4alpha.ClusterEndpointsHealthR\x16clusterEndpointsHealth:5\x9a\xc5\
    \x88\x1e0\n.envoy.service.health.v3.EndpointHealthResponseJ\x04\x08\x01\
    \x10\x02R\x10endpoints_health\"\xdf\x02\n*HealthCheckRequestOrEndpointHe\
    althResponse\x12d\n\x14health_check_request\x18\x01\x20\x01(\x0b20.envoy\
    .service.health.v4alpha.HealthCheckRequestH\0R\x12healthCheckRequest\x12\
    p\n\x18endpoint_health_response\x18\x02\x20\x01(\x0b24.envoy.service.hea\
    lth.v4alpha.EndpointHealthResponseH\0R\x16endpointHealthResponseB\x0e\n\
    \x0crequest_type:I\x9a\xc5\x88\x1eD\nBenvoy.service.health.v3.HealthChec\
    kRequestOrEndpointHealthResponse\"\xc8\x01\n\x11LocalityEndpoints\x12?\n\
    \x08locality\x18\x01\x20\x01(\x0b2#.envoy.config.core.v4alpha.LocalityR\
    \x08locality\x12@\n\tendpoints\x18\x02\x20\x03(\x0b2\".envoy.config.endp\
    oint.v3.EndpointR\tendpoints:0\x9a\xc5\x88\x1e+\n)envoy.service.health.v\
    3.LocalityEndpoints\"\x8d\x03\n\x12ClusterHealthCheck\x12!\n\x0ccluster_\
    name\x18\x01\x20\x01(\tR\x0bclusterName\x12K\n\rhealth_checks\x18\x02\
    \x20\x03(\x0b2&.envoy.config.core.v4alpha.HealthCheckR\x0chealthChecks\
    \x12^\n\x12locality_endpoints\x18\x03\x20\x03(\x0b2/.envoy.service.healt\
    h.v4alpha.LocalityEndpointsR\x11localityEndpoints\x12t\n\x18transport_so\
    cket_matches\x18\x04\x20\x03(\x0b2:.envoy.config.cluster.v4alpha.Cluster\
    .TransportSocketMatchR\x16transportSocketMatches:1\x9a\xc5\x88\x1e,\n*en\
    voy.service.health.v3.ClusterHealthCheck\"\xe8\x01\n\x14HealthCheckSpeci\
    fier\x12d\n\x15cluster_health_checks\x18\x01\x20\x03(\x0b20.envoy.servic\
    e.health.v4alpha.ClusterHealthCheckR\x13clusterHealthChecks\x125\n\x08in\
    terval\x18\x02\x20\x01(\x0b2\x19.google.protobuf.DurationR\x08interval:3\
    \x9a\xc5\x88\x1e.\n,envoy.service.health.v3.HealthCheckSpecifier2\xf2\
    \x02\n\x16HealthDiscoveryService\x12\x97\x01\n\x11StreamHealthCheck\x12H\
    .envoy.service.health.v4alpha.HealthCheckRequestOrEndpointHealthResponse\
    \x1a2.envoy.service.health.v4alpha.HealthCheckSpecifier\"\0(\x010\x01\
    \x12\xbd\x01\n\x10FetchHealthCheck\x12H.envoy.service.health.v4alpha.Hea\
    lthCheckRequestOrEndpointHealthResponse\x1a2.envoy.service.health.v4alph\
    a.HealthCheckSpecifier\"+\x82\xd3\xe4\x93\x02\x1c\"\x1a/v3/discovery:hea\
    lth_check\x82\xd3\xe4\x93\x02\x03:\x01*BC\n*io.envoyproxy.envoy.service.\
    health.v4alphaB\x08HdsProtoP\x01\x88\x01\x01\xba\x80\xc8\xd1\x06\x02\x10\
    \x03b\x06proto3\
";
