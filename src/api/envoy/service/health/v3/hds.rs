...
//! Generated file from `envoy/service/health/v3/hds.proto`
...
impl EndpointHealthResponse {
    ...
    // repeated .envoy.service.health.v3.EndpointHealth endpoints_health = 1;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n!envoy/service/health/v3/hds.proto\x12\x17envoy.service.health.v3\x1a%\
    envoy/config/cluster/v3/cluster.proto\x1a\x1fenvoy/config/core/v3/base.p\
    roto\x1a'envoy/config/core/v3/health_check.proto\x1a2envoy/config/endpoi\
    nt/v3/endpoint_components.proto\x1a\x1cgoogle/api/annotations.proto\x1a\
    \x1egoogle/protobuf/duration.proto\x1a\x1eudpa/annotations/migrate.proto\
    \x1a\x1dudpa/annotations/status.proto\x1a!udpa/annotations/versioning.pr\
    oto\"\xc8\x01\n\nCapability\x12b\n\x16health_check_protocols\x18\x01\x20\
    \x03(\x0e2,.envoy.service.health.v3.Capability.ProtocolR\x14healthCheckP\
    rotocols\"(\n\x08Protocol\x12\x08\n\x04HTTP\x10\0\x12\x07\n\x03TCP\x10\
    \x01\x12\t\n\x05REDIS\x10\x02:,\x9a\xc5\x88\x1e'\n%envoy.service.discove\
    ry.v2.Capability\"\xbf\x01\n\x12HealthCheckRequest\x12.\n\x04node\x18\
    \x01\x20\x01(\x0b2\x1a.envoy.config.core.v3.NodeR\x04node\x12C\n\ncapabi\
    lity\x18\x02\x20\x01(\x0b2#.envoy.service.health.v3.CapabilityR\ncapabil\
    ity:4\x9a\xc5\x88\x1e/\n-envoy.service.discovery.v2.HealthCheckRequest\"\
    \xcb\x01\n\x0eEndpointHealth\x12>\n\x08endpoint\x18\x01\x20\x01(\x0b2\".\
    envoy.config.endpoint.v3.EndpointR\x08endpoint\x12G\n\rhealth_status\x18\
    \x02\x20\x01(\x0e2\".envoy.config.core.v3.HealthStatusR\x0chealthStatus:\
    0\x9a\xc5\x88\x1e+\n)envoy.service.discovery.v2.EndpointHealth\"\xa9\x01\
    \n\x17LocalityEndpointsHealth\x12:\n\x08locality\x18\x01\x20\x01(\x0b2\
    \x1e.envoy.config.core.v3.LocalityR\x08locality\x12R\n\x10endpoints_heal\
    th\x18\x02\x20\x03(\x0b2'.envoy.service.health.v3.EndpointHealthR\x0fend\
    pointsHealth\"\xa9\x01\n\x16ClusterEndpointsHealth\x12!\n\x0ccluster_nam\
    e\x18\x01\x20\x01(\tR\x0bclusterName\x12l\n\x19locality_endpoints_health\
    \x18\x02\x20\x03(\x0b20.envoy.service.health.v3.LocalityEndpointsHealthR\
    \x17localityEndpointsHealth\"\x95\x02\n\x16EndpointHealthResponse\x12V\n\
    \x10endpoints_health\x18\x01\x20\x03(\x0b2'.envoy.service.health.v3.Endp\
    ointHealthR\x0fendpointsHealthB\x02\x18\x01\x12i\n\x18cluster_endpoints_\
    health\x18\x02\x20\x03(\x0b2/.envoy.service.health.v3.ClusterEndpointsHe\
    althR\x16clusterEndpointsHealth:8\x9a\xc5\x88\x1e3\n1envoy.service.disco\
    very.v2.EndpointHealthResponse\"\xd8\x02\n*HealthCheckRequestOrEndpointH\
    ealthResponse\x12_\n\x14health_check_request\x18\x01\x20\x01(\x0b2+.envo\
    y.service.health.v3.HealthCheckRequestH\0R\x12healthCheckRequest\x12k\n\
    \x18endpoint_health_response\x18\x02\x20\x01(\x0b2/.envoy.service.health\
    .v3.EndpointHealthResponseH\0R\x16endpointHealthResponseB\x0e\n\x0creque\
    st_type:L\x9a\xc5\x88\x1eG\nEenvoy.service.discovery.v2.HealthCheckReque\
    stOrEndpointHealthResponse\"\xc6\x01\n\x11LocalityEndpoints\x12:\n\x08lo\
    cality\x18\x01\x20\x01(\x0b2\x1e.envoy.config.core.v3.LocalityR\x08local\
    ity\x12@\n\tendpoints\x18\x02\x20\x03(\x0b2\".envoy.config.endpoint.v3.E\
    ndpointR\tendpoints:3\x9a\xc5\x88\x1e.\n,envoy.service.discovery.v2.Loca\
    lityEndpoints\"\x81\x03\n\x12ClusterHealthCheck\x12!\n\x0ccluster_name\
    \x18\x01\x20\x01(\tR\x0bclusterName\x12F\n\rhealth_checks\x18\x02\x20\
    \x03(\x0b2!.envoy.config.core.v3.HealthCheckR\x0chealthChecks\x12Y\n\x12\
    locality_endpoints\x18\x03\x20\x03(\x0b2*.envoy.service.health.v3.Locali\
    tyEndpointsR\x11localityEndpoints\x12o\n\x18transport_socket_matches\x18\
    \x04\x20\x03(\x0b25.envoy.config.cluster.v3.Cluster.TransportSocketMatch\
    R\x16transportSocketMatches:4\x9a\xc5\x88\x1e/\n-envoy.service.discovery\
    .v2.ClusterHealthCheck\"\xe6\x01\n\x14HealthCheckSpecifier\x12_\n\x15clu\
    ster_health_checks\x18\x01\x20\x03(\x0b2+.envoy.service.health.v3.Cluste\
    rHealthCheckR\x13clusterHealthChecks\x125\n\x08interval\x18\x02\x20\x01(\
    \x0b2\x19.google.protobuf.DurationR\x08interval:6\x9a\xc5\x88\x1e1\n/env\
    oy.service.discovery.v2.HealthCheckSpecifier2\xde\x02\n\x16HealthDiscove\
    ryService\x12\x8d\x01\n\x11StreamHealthCheck\x12C.envoy.service.health.v\
    3.HealthCheckRequestOrEndpointHealthResponse\x1a-.envoy.service.health.v\
    3.HealthCheckSpecifier\"\0(\x010\x01\x12\xb3\x01\n\x10FetchHealthCheck\
    \x12C.envoy.service.health.v3.HealthCheckRequestOrEndpointHealthResponse\
    \x1a-.envoy.service.health.v3.HealthCheckSpecifier\"+\x82\xd3\xe4\x93\
    \x02\x1c\"\x1a/v3/discovery:health_check\x82\xd3\xe4\x93\x02\x03:\x01*B>\
    \n%io.envoyproxy.envoy.service.health.v3B\x08HdsProtoP\x01\x88\x01\x01\
