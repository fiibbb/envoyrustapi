...
//! Generated file from `envoy/api/v2/endpoint.proto`
...
impl ClusterLoadAssignment_Policy {
    ...
    pub fn get_disable_overprovisioning(&self) -> bool {
        self.disable_overprovisioning
    }
    pub fn clear_disable_overprovisioning(&mut self) {
        self.disable_overprovisioning = false;
    }

    // Param is passed by value, moved
    pub fn set_disable_overprovisioning(&mut self, v: bool) {
        self.disable_overprovisioning = v;
    }
}
...
impl ::protobuf::Message for ClusterLoadAssignment_Policy {
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                5 => {
                    ...
                    self.disable_overprovisioning = tmp;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.disable_overprovisioning != false {
            my_size += 2;
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.disable_overprovisioning != false {
            os.write_bool(5, self.disable_overprovisioning)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBool>(
                ...
                |m: &ClusterLoadAssignment_Policy| { &m.disable_overprovisioning },
                |m: &mut ClusterLoadAssignment_Policy| { &mut m.disable_overprovisioning },
            ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1benvoy/api/v2/endpoint.proto\x12\x0cenvoy.api.v2\x1a/envoy/api/v2/e\
    ndpoint/endpoint_components.proto\x1a\x18envoy/type/percent.proto\x1a\
    ...
    \"\xfb\x06\n\x15ClusterLoadAssignment\x12*\n\x0ccluster_name\x18\x01\x20\
    \x01(\tR\x0bclusterNameB\x07\xfaB\x04r\x02\x20\x01\x12H\n\tendpoints\x18\
    \x02\x20\x03(\x0b2*.envoy.api.v2.endpoint.LocalityLbEndpointsR\tendpoint\
    s\x12`\n\x0fnamed_endpoints\x18\x05\x20\x03(\x0b27.envoy.api.v2.ClusterL\
    oadAssignment.NamedEndpointsEntryR\x0enamedEndpoints\x12B\n\x06policy\
    \x18\x04\x20\x01(\x0b2*.envoy.api.v2.ClusterLoadAssignment.PolicyR\x06po\
    licy\x1a\xe1\x03\n\x06Policy\x12^\n\x0edrop_overloads\x18\x02\x20\x03(\
    \x0b27.envoy.api.v2.ClusterLoadAssignment.Policy.DropOverloadR\rdropOver\
    loads\x12^\n\x17overprovisioning_factor\x18\x03\x20\x01(\x0b2\x1c.google\
    .protobuf.UInt32ValueR\x16overprovisioningFactorB\x07\xfaB\x04*\x02\x20\
    \0\x12U\n\x14endpoint_stale_after\x18\x04\x20\x01(\x0b2\x19.google.proto\
    buf.DurationR\x12endpointStaleAfterB\x08\xfaB\x05\xaa\x01\x02*\0\x12=\n\
    \x18disable_overprovisioning\x18\x05\x20\x01(\x08R\x17disableOverprovisi\
    oningB\x02\x18\x01\x1a{\n\x0cDropOverload\x12#\n\x08category\x18\x01\x20\
    \x01(\tR\x08categoryB\x07\xfaB\x04r\x02\x20\x01\x12F\n\x0fdrop_percentag\
    e\x18\x02\x20\x01(\x0b2\x1d.envoy.type.FractionalPercentR\x0edropPercent\
