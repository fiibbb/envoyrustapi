...
//! Generated file from `envoy/api/v2/discovery.proto`
...
impl DeltaDiscoveryRequest {
    ...
    // repeated .envoy.api.v2.DeltaDiscoveryRequest.InitialResourceVersionsEntry initial_resource_versions = 5;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    atus.proto\x1a\x1eudpa/annotations/migrate.proto\x1a\x1dudpa/annotations\
    /status.proto\"\x82\x02\n\x10DiscoveryRequest\x12!\n\x0cversion_info\x18\
    \x01\x20\x01(\tR\x0bversionInfo\x12+\n\x04node\x18\x02\x20\x01(\x0b2\x17\
    .envoy.api.v2.core.NodeR\x04node\x12%\n\x0eresource_names\x18\x03\x20\
    \x03(\tR\rresourceNames\x12\x19\n\x08type_url\x18\x04\x20\x01(\tR\x07typ\
    eUrl\x12%\n\x0eresponse_nonce\x18\x05\x20\x01(\tR\rresponseNonce\x125\n\
    \x0cerror_detail\x18\x06\x20\x01(\x0b2\x12.google.rpc.StatusR\x0berrorDe\
    tail\"\xf9\x01\n\x11DiscoveryResponse\x12!\n\x0cversion_info\x18\x01\x20\
    \x01(\tR\x0bversionInfo\x122\n\tresources\x18\x02\x20\x03(\x0b2\x14.goog\
    le.protobuf.AnyR\tresources\x12\x16\n\x06canary\x18\x03\x20\x01(\x08R\
    \x06canary\x12\x19\n\x08type_url\x18\x04\x20\x01(\tR\x07typeUrl\x12\x14\
    \n\x05nonce\x18\x05\x20\x01(\tR\x05nonce\x12D\n\rcontrol_plane\x18\x06\
    \x20\x01(\x0b2\x1f.envoy.api.v2.core.ControlPlaneR\x0ccontrolPlane\"\xff\
    \x03\n\x15DeltaDiscoveryRequest\x12+\n\x04node\x18\x01\x20\x01(\x0b2\x17\
    .envoy.api.v2.core.NodeR\x04node\x12\x19\n\x08type_url\x18\x02\x20\x01(\
    \tR\x07typeUrl\x128\n\x18resource_names_subscribe\x18\x03\x20\x03(\tR\
    \x16resourceNamesSubscribe\x12<\n\x1aresource_names_unsubscribe\x18\x04\
    \x20\x03(\tR\x18resourceNamesUnsubscribe\x12|\n\x19initial_resource_vers\
    ions\x18\x05\x20\x03(\x0b2@.envoy.api.v2.DeltaDiscoveryRequest.InitialRe\
    sourceVersionsEntryR\x17initialResourceVersions\x12%\n\x0eresponse_nonce\
    \x18\x06\x20\x01(\tR\rresponseNonce\x125\n\x0cerror_detail\x18\x07\x20\
    \x01(\x0b2\x12.google.rpc.StatusR\x0berrorDetail\x1aJ\n\x1cInitialResour\
    ceVersionsEntry\x12\x10\n\x03key\x18\x01\x20\x01(\tR\x03key\x12\x14\n\
    \x05value\x18\x02\x20\x01(\tR\x05value:\x028\x01\"\xdc\x01\n\x16DeltaDis\
    coveryResponse\x12.\n\x13system_version_info\x18\x01\x20\x01(\tR\x11syst\
    emVersionInfo\x124\n\tresources\x18\x02\x20\x03(\x0b2\x16.envoy.api.v2.R\
    esourceR\tresources\x12\x19\n\x08type_url\x18\x04\x20\x01(\tR\x07typeUrl\
    \x12+\n\x11removed_resources\x18\x06\x20\x03(\tR\x10removedResources\x12\
    \x14\n\x05nonce\x18\x05\x20\x01(\tR\x05nonce\"\x84\x01\n\x08Resource\x12\
    \x12\n\x04name\x18\x03\x20\x01(\tR\x04name\x12\x18\n\x07aliases\x18\x04\
    \x20\x03(\tR\x07aliases\x12\x18\n\x07version\x18\x01\x20\x01(\tR\x07vers\
    ion\x120\n\x08resource\x18\x02\x20\x01(\x0b2\x14.google.protobuf.AnyR\
    \x08resourceBX\n\x1aio.envoyproxy.envoy.api.v2B\x0eDiscoveryProtoP\x01\
    \xba\x80\xc8\xd1\x06\x02\x10\x01\xf2\x98\xfe\x8f\x05\x1c\x12\x1aenvoy.se\
    rvice.discovery.v3b\x06proto3\
";
