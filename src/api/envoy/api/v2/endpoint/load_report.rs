...
//! Generated file from `envoy/api/v2/endpoint/load_report.proto`
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    us.proto\x1a\x17validate/validate.proto\"\x8d\x04\n\x15UpstreamLocalityS\
    tats\x127\n\x08locality\x18\x01\x20\x01(\x0b2\x1b.envoy.api.v2.core.Loca\
    lityR\x08locality\x12:\n\x19total_successful_requests\x18\x02\x20\x01(\
    \x04R\x17totalSuccessfulRequests\x12;\n\x1atotal_requests_in_progress\
    \x18\x03\x20\x01(\x04R\x17totalRequestsInProgress\x120\n\x14total_error_\
    requests\x18\x04\x20\x01(\x04R\x12totalErrorRequests\x122\n\x15total_iss\
    ued_requests\x18\x08\x20\x01(\x04R\x13totalIssuedRequests\x12Z\n\x11load\
    _metric_stats\x18\x05\x20\x03(\x0b2..envoy.api.v2.endpoint.EndpointLoadM\
    etricStatsR\x0floadMetricStats\x12d\n\x17upstream_endpoint_stats\x18\x07\
    \x20\x03(\x0b2,.envoy.api.v2.endpoint.UpstreamEndpointStatsR\x15upstream\
    EndpointStats\x12\x1a\n\x08priority\x18\x06\x20\x01(\rR\x08priority\"\
    \xbd\x03\n\x15UpstreamEndpointStats\x124\n\x07address\x18\x01\x20\x01(\
    \x0b2\x1a.envoy.api.v2.core.AddressR\x07address\x123\n\x08metadata\x18\
    \x06\x20\x01(\x0b2\x17.google.protobuf.StructR\x08metadata\x12:\n\x19tot\
    al_successful_requests\x18\x02\x20\x01(\x04R\x17totalSuccessfulRequests\
    \x12;\n\x1atotal_requests_in_progress\x18\x03\x20\x01(\x04R\x17totalRequ\
    estsInProgress\x120\n\x14total_error_requests\x18\x04\x20\x01(\x04R\x12t\
    otalErrorRequests\x122\n\x15total_issued_requests\x18\x07\x20\x01(\x04R\
    \x13totalIssuedRequests\x12Z\n\x11load_metric_stats\x18\x05\x20\x03(\x0b\
    2..envoy.api.v2.endpoint.EndpointLoadMetricStatsR\x0floadMetricStats\"\
    ...
    ic_value\x18\x03\x20\x01(\x01R\x10totalMetricValue\"\x9c\x04\n\x0cCluste\
    rStats\x12*\n\x0ccluster_name\x18\x01\x20\x01(\tR\x0bclusterNameB\x07\
    \xfaB\x04r\x02\x20\x01\x120\n\x14cluster_service_name\x18\x06\x20\x01(\t\
    R\x12clusterServiceName\x12n\n\x17upstream_locality_stats\x18\x02\x20\
    \x03(\x0b2,.envoy.api.v2.endpoint.UpstreamLocalityStatsR\x15upstreamLoca\
    lityStatsB\x08\xfaB\x05\x92\x01\x02\x08\x01\x124\n\x16total_dropped_requ\
    ests\x18\x03\x20\x01(\x04R\x14totalDroppedRequests\x12^\n\x10dropped_req\
    uests\x18\x05\x20\x03(\x0b23.envoy.api.v2.endpoint.ClusterStats.DroppedR\
    equestsR\x0fdroppedRequests\x12K\n\x14load_report_interval\x18\x04\x20\
    \x01(\x0b2\x19.google.protobuf.DurationR\x12loadReportInterval\x1a[\n\
