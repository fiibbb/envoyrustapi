...
//! Generated file from `envoy/config/ratelimit/v4alpha/rls.proto`
...
impl RateLimitServiceConfig {
    ...
    // .envoy.config.core.v4alpha.ApiVersion transport_api_version = 4;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n(envoy/config/ratelimit/v4alpha/rls.proto\x12\x1eenvoy.config.ratelimi\
    t.v4alpha\x1a-envoy/config/core/v4alpha/config_source.proto\x1a,envoy/co\
    nfig/core/v4alpha/grpc_service.proto\x1a\x1dudpa/annotations/status.prot\
    o\x1a!udpa/annotations/versioning.proto\x1a\x17validate/validate.proto\"\
    \x97\x02\n\x16RateLimitServiceConfig\x12S\n\x0cgrpc_service\x18\x02\x20\
    \x01(\x0b2&.envoy.config.core.v4alpha.GrpcServiceR\x0bgrpcServiceB\x08\
    \xfaB\x05\x8a\x01\x02\x10\x01\x12c\n\x15transport_api_version\x18\x04\
    \x20\x01(\x0e2%.envoy.config.core.v4alpha.ApiVersionR\x13transportApiVer\
    sionB\x08\xfaB\x05\x82\x01\x02\x10\x01:7\x9a\xc5\x88\x1e2\n0envoy.config\
    .ratelimit.v3.RateLimitServiceConfigJ\x04\x08\x01\x10\x02J\x04\x08\x03\
    \x10\x04BB\n,io.envoyproxy.envoy.config.ratelimit.v4alphaB\x08RlsProtoP\
