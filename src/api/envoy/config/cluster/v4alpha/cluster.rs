...
//! Generated file from `envoy/config/cluster/v4alpha/cluster.proto`
...
impl Cluster {
    ...
    // repeated .envoy.config.cluster.v4alpha.Cluster.TransportSocketMatch transport_socket_matches = 43;
    ...
    // .envoy.config.cluster.v4alpha.Cluster.DiscoveryType type = 2;
    ...
    // .envoy.config.cluster.v4alpha.Cluster.CustomClusterType cluster_type = 38;
    ...
    // .envoy.config.cluster.v4alpha.Cluster.EdsClusterConfig eds_cluster_config = 3;
    ...
    // .envoy.config.cluster.v4alpha.Cluster.LbPolicy lb_policy = 6;
    ...
    // repeated .envoy.config.core.v4alpha.HealthCheck health_checks = 8;
    ...
    // .envoy.config.cluster.v4alpha.CircuitBreakers circuit_breakers = 10;
    ...
    // repeated .envoy.config.cluster.v4alpha.Cluster.TypedExtensionProtocolOptionsEntry typed_extension_protocol_options = 36;
    ...
    // .envoy.config.cluster.v4alpha.Cluster.RefreshRate dns_failure_refresh_rate = 44;
    ...
    // .envoy.config.cluster.v4alpha.Cluster.DnsLookupFamily dns_lookup_family = 17;
    ...
    // repeated .envoy.config.core.v4alpha.Address dns_resolvers = 18;
    ...
    // .envoy.config.cluster.v4alpha.OutlierDetection outlier_detection = 19;
    ...
    // .envoy.config.core.v4alpha.BindConfig upstream_bind_config = 21;
    ...
    // .envoy.config.cluster.v4alpha.Cluster.LbSubsetConfig lb_subset_config = 22;
    ...
    // .envoy.config.cluster.v4alpha.Cluster.RingHashLbConfig ring_hash_lb_config = 23;
    ...
    // .envoy.config.cluster.v4alpha.Cluster.MaglevLbConfig maglev_lb_config = 52;
    ...
    // .envoy.config.cluster.v4alpha.Cluster.OriginalDstLbConfig original_dst_lb_config = 34;
    ...
    // .envoy.config.cluster.v4alpha.Cluster.LeastRequestLbConfig least_request_lb_config = 37;
    ...
    // .envoy.config.cluster.v4alpha.Cluster.CommonLbConfig common_lb_config = 27;
    ...
    // .envoy.config.core.v4alpha.TransportSocket transport_socket = 24;
    ...
    // .envoy.config.core.v4alpha.Metadata metadata = 25;
    ...
    // .envoy.config.cluster.v4alpha.UpstreamConnectionOptions upstream_connection_options = 30;
    ...
    // repeated .envoy.config.cluster.v4alpha.Filter filters = 40;
    ...
    // .envoy.config.cluster.v4alpha.LoadBalancingPolicy load_balancing_policy = 41;
    ...
    // .envoy.config.core.v4alpha.ConfigSource lrs_server = 42;
    ...
    // .envoy.config.core.v4alpha.TypedExtensionConfig upstream_config = 48;
    ...
    // .envoy.config.cluster.v4alpha.TrackClusterStats track_cluster_stats = 49;
    ...
    // .envoy.config.cluster.v4alpha.Cluster.PrefetchPolicy prefetch_policy = 50;
...
impl Cluster_TransportSocketMatch {
    ...
    // .envoy.config.core.v4alpha.TransportSocket transport_socket = 3;
...
impl Cluster_EdsClusterConfig {
    ...
    // .envoy.config.core.v4alpha.ConfigSource eds_config = 1;
...
impl Cluster_LbSubsetConfig {
    ...
    // .envoy.config.cluster.v4alpha.Cluster.LbSubsetConfig.LbSubsetFallbackPolicy fallback_policy = 1;
    ...
    // repeated .envoy.config.cluster.v4alpha.Cluster.LbSubsetConfig.LbSubsetSelector subset_selectors = 3;
...
impl Cluster_LbSubsetConfig_LbSubsetSelector {
    ...
    // .envoy.config.cluster.v4alpha.Cluster.LbSubsetConfig.LbSubsetSelector.LbSubsetSelectorFallbackPolicy fallback_policy = 2;
...
impl Cluster_LeastRequestLbConfig {
    ...
    // .envoy.config.core.v4alpha.RuntimeDouble active_request_bias = 2;
...
impl Cluster_RingHashLbConfig {
    ...
    // .envoy.config.cluster.v4alpha.Cluster.RingHashLbConfig.HashFunction hash_function = 3;
...
impl Cluster_CommonLbConfig {
    ...
    // .envoy.config.cluster.v4alpha.Cluster.CommonLbConfig.ZoneAwareLbConfig zone_aware_lb_config = 2;
    ...
    // .envoy.config.cluster.v4alpha.Cluster.CommonLbConfig.LocalityWeightedLbConfig locality_weighted_lb_config = 3;
    ...
    // .envoy.config.cluster.v4alpha.Cluster.CommonLbConfig.ConsistentHashingLbConfig consistent_hashing_lb_config = 7;
...
impl LoadBalancingPolicy {
    ...
    // repeated .envoy.config.cluster.v4alpha.LoadBalancingPolicy.Policy policies = 1;
...
impl UpstreamBindConfig {
    ...
    // .envoy.config.core.v4alpha.Address source_address = 1;
...
impl UpstreamConnectionOptions {
    ...
    // .envoy.config.core.v4alpha.TcpKeepalive tcp_keepalive = 1;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n*envoy/config/cluster/v4alpha/cluster.proto\x12\x1cenvoy.config.cluste\
    r.v4alpha\x1a2envoy/config/cluster/v4alpha/circuit_breaker.proto\x1a)env\
    oy/config/cluster/v4alpha/filter.proto\x1a4envoy/config/cluster/v4alpha/\
    outlier_detection.proto\x1a'envoy/config/core/v4alpha/address.proto\x1a$\
    envoy/config/core/v4alpha/base.proto\x1a-envoy/config/core/v4alpha/confi\
    g_source.proto\x1a)envoy/config/core/v4alpha/extension.proto\x1a,envoy/c\
    onfig/core/v4alpha/health_check.proto\x1a'envoy/config/endpoint/v3/endpo\
    int.proto\x1a\x1benvoy/type/v3/percent.proto\x1a\x19google/protobuf/any.\
    proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1cgoogle/protobuf/struc\
    t.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\"xds/core/v3/collectio\
    n_entry.proto\x1a#envoy/annotations/deprecation.proto\x1a\x1fudpa/annota\
    tions/security.proto\x1a\x1dudpa/annotations/status.proto\x1a!udpa/annot\
    ations/versioning.proto\x1a\x17validate/validate.proto\"}\n\x11ClusterCo\
    llection\x126\n\x07entries\x18\x01\x20\x01(\x0b2\x1c.xds.core.v3.Collect\
    ionEntryR\x07entries:0\x9a\xc5\x88\x1e+\n)envoy.config.cluster.v3.Cluste\
    rCollection\"\xb6G\n\x07Cluster\x12t\n\x18transport_socket_matches\x18+\
    \x20\x03(\x0b2:.envoy.config.cluster.v4alpha.Cluster.TransportSocketMatc\
    hR\x16transportSocketMatches\x12\x1b\n\x04name\x18\x01\x20\x01(\tR\x04na\
    meB\x07\xfaB\x04r\x02\x10\x01\x12\"\n\ralt_stat_name\x18\x1c\x20\x01(\tR\
    \x0baltStatName\x12S\n\x04type\x18\x02\x20\x01(\x0e23.envoy.config.clust\
    er.v4alpha.Cluster.DiscoveryTypeH\0R\x04typeB\x08\xfaB\x05\x82\x01\x02\
    \x10\x01\x12\\\n\x0ccluster_type\x18&\x20\x01(\x0b27.envoy.config.cluste\
    r.v4alpha.Cluster.CustomClusterTypeH\0R\x0bclusterType\x12d\n\x12eds_clu\
    ster_config\x18\x03\x20\x01(\x0b26.envoy.config.cluster.v4alpha.Cluster.\
    EdsClusterConfigR\x10edsClusterConfig\x12L\n\x0fconnect_timeout\x18\x04\
    \x20\x01(\x0b2\x19.google.protobuf.DurationR\x0econnectTimeoutB\x08\xfaB\
    \x05\xaa\x01\x02*\0\x12o\n!per_connection_buffer_limit_bytes\x18\x05\x20\
    \x01(\x0b2\x1c.google.protobuf.UInt32ValueR\x1dperConnectionBufferLimitB\
    ytesB\x07\x8a\x93\xb7*\x02\x10\x01\x12W\n\tlb_policy\x18\x06\x20\x01(\
    \x0e2..envoy.config.cluster.v4alpha.Cluster.LbPolicyR\x08lbPolicyB\n\xfa\
    B\x07\x82\x01\x04\x10\x01\x20\x07\x12X\n\x0fload_assignment\x18!\x20\x01\
    (\x0b2/.envoy.config.endpoint.v3.ClusterLoadAssignmentR\x0eloadAssignmen\
    t\x12K\n\rhealth_checks\x18\x08\x20\x03(\x0b2&.envoy.config.core.v4alpha\
    .HealthCheckR\x0chealthChecks\x12[\n\x1bmax_requests_per_connection\x18\
    \t\x20\x01(\x0b2\x1c.google.protobuf.UInt32ValueR\x18maxRequestsPerConne\
    ction\x12X\n\x10circuit_breakers\x18\n\x20\x01(\x0b2-.envoy.config.clust\
    er.v4alpha.CircuitBreakersR\x0fcircuitBreakers\x12\x91\x01\n\x20typed_ex\
    tension_protocol_options\x18$\x20\x03(\x0b2H.envoy.config.cluster.v4alph\
    a.Cluster.TypedExtensionProtocolOptionsEntryR\x1dtypedExtensionProtocolO\
    ptions\x12Q\n\x10dns_refresh_rate\x18\x10\x20\x01(\x0b2\x19.google.proto\
    buf.DurationR\x0ednsRefreshRateB\x0c\xfaB\t\xaa\x01\x06*\x04\x10\xc0\x84\
    =\x12j\n\x18dns_failure_refresh_rate\x18,\x20\x01(\x0b21.envoy.config.cl\
    uster.v4alpha.Cluster.RefreshRateR\x15dnsFailureRefreshRate\x12&\n\x0fre\
    spect_dns_ttl\x18'\x20\x01(\x08R\rrespectDnsTtl\x12k\n\x11dns_lookup_fam\
    ily\x18\x11\x20\x01(\x0e25.envoy.config.cluster.v4alpha.Cluster.DnsLooku\
    pFamilyR\x0fdnsLookupFamilyB\x08\xfaB\x05\x82\x01\x02\x10\x01\x12G\n\rdn\
    s_resolvers\x18\x12\x20\x03(\x0b2\".envoy.config.core.v4alpha.AddressR\
    \x0cdnsResolvers\x124\n\x17use_tcp_for_dns_lookups\x18-\x20\x01(\x08R\
    \x13useTcpForDnsLookups\x12[\n\x11outlier_detection\x18\x13\x20\x01(\x0b\
    2..envoy.config.cluster.v4alpha.OutlierDetectionR\x10outlierDetection\
    \x12N\n\x10cleanup_interval\x18\x14\x20\x01(\x0b2\x19.google.protobuf.Du\
    rationR\x0fcleanupIntervalB\x08\xfaB\x05\xaa\x01\x02*\0\x12W\n\x14upstre\
    am_bind_config\x18\x15\x20\x01(\x0b2%.envoy.config.core.v4alpha.BindConf\
    igR\x12upstreamBindConfig\x12^\n\x10lb_subset_config\x18\x16\x20\x01(\
    \x0b24.envoy.config.cluster.v4alpha.Cluster.LbSubsetConfigR\x0elbSubsetC\
    onfig\x12g\n\x13ring_hash_lb_config\x18\x17\x20\x01(\x0b26.envoy.config.\
    cluster.v4alpha.Cluster.RingHashLbConfigH\x01R\x10ringHashLbConfig\x12`\
    \n\x10maglev_lb_config\x184\x20\x01(\x0b24.envoy.config.cluster.v4alpha.\
    Cluster.MaglevLbConfigH\x01R\x0emaglevLbConfig\x12p\n\x16original_dst_lb\
    _config\x18\"\x20\x01(\x0b29.envoy.config.cluster.v4alpha.Cluster.Origin\
    alDstLbConfigH\x01R\x13originalDstLbConfig\x12s\n\x17least_request_lb_co\
    nfig\x18%\x20\x01(\x0b2:.envoy.config.cluster.v4alpha.Cluster.LeastReque\
    stLbConfigH\x01R\x14leastRequestLbConfig\x12^\n\x10common_lb_config\x18\
    \x1b\x20\x01(\x0b24.envoy.config.cluster.v4alpha.Cluster.CommonLbConfigR\
    \x0ecommonLbConfig\x12U\n\x10transport_socket\x18\x18\x20\x01(\x0b2*.env\
    oy.config.core.v4alpha.TransportSocketR\x0ftransportSocket\x12?\n\x08met\
    adata\x18\x19\x20\x01(\x0b2#.envoy.config.core.v4alpha.MetadataR\x08meta\
    data\x12w\n\x1bupstream_connection_options\x18\x1e\x20\x01(\x0b27.envoy.\
    config.cluster.v4alpha.UpstreamConnectionOptionsR\x19upstreamConnectionO\
    ptions\x12U\n(close_connections_on_host_health_failure\x18\x1f\x20\x01(\
    \x08R#closeConnectionsOnHostHealthFailure\x12@\n\x1dignore_health_on_hos\
    t_removal\x18\x20\x20\x01(\x08R\x19ignoreHealthOnHostRemoval\x12>\n\x07f\
    ilters\x18(\x20\x03(\x0b2$.envoy.config.cluster.v4alpha.FilterR\x07filte\
    rs\x12e\n\x15load_balancing_policy\x18)\x20\x01(\x0b21.envoy.config.clus\
    ter.v4alpha.LoadBalancingPolicyR\x13loadBalancingPolicy\x12F\n\nlrs_serv\
    er\x18*\x20\x01(\x0b2'.envoy.config.core.v4alpha.ConfigSourceR\tlrsServe\
    r\x12X\n\x0fupstream_config\x180\x20\x01(\x0b2/.envoy.config.core.v4alph\
    a.TypedExtensionConfigR\x0eupstreamConfig\x12_\n\x13track_cluster_stats\
    \x181\x20\x01(\x0b2/.envoy.config.cluster.v4alpha.TrackClusterStatsR\x11\
    trackClusterStats\x12]\n\x0fprefetch_policy\x182\x20\x01(\x0b24.envoy.co\
    nfig.cluster.v4alpha.Cluster.PrefetchPolicyR\x0eprefetchPolicy\x12X\n)co\
    nnection_pool_per_downstream_connection\x183\x20\x01(\x08R%connectionPoo\
    lPerDownstreamConnection\x1a\xf6\x01\n\x14TransportSocketMatch\x12\x1b\n\
    \x04name\x18\x01\x20\x01(\tR\x04nameB\x07\xfaB\x04r\x02\x10\x01\x12-\n\
    \x05match\x18\x02\x20\x01(\x0b2\x17.google.protobuf.StructR\x05match\x12\
    U\n\x10transport_socket\x18\x03\x20\x01(\x0b2*.envoy.config.core.v4alpha\
    .TransportSocketR\x0ftransportSocket:;\x9a\xc5\x88\x1e6\n4envoy.config.c\
    luster.v3.Cluster.TransportSocketMatch\x1a\xa3\x01\n\x11CustomClusterTyp\
    e\x12\x1b\n\x04name\x18\x01\x20\x01(\tR\x04nameB\x07\xfaB\x04r\x02\x10\
    \x01\x127\n\x0ctyped_config\x18\x02\x20\x01(\x0b2\x14.google.protobuf.An\
    yR\x0btypedConfig:8\x9a\xc5\x88\x1e3\n1envoy.config.cluster.v3.Cluster.C\
    ustomClusterType\x1a\xb6\x01\n\x10EdsClusterConfig\x12F\n\neds_config\
    \x18\x01\x20\x01(\x0b2'.envoy.config.core.v4alpha.ConfigSourceR\tedsConf\
    ig\x12!\n\x0cservice_name\x18\x02\x20\x01(\tR\x0bserviceName:7\x9a\xc5\
    \x88\x1e2\n0envoy.config.cluster.v3.Cluster.EdsClusterConfig\x1a\xe5\x08\
    \n\x0eLbSubsetConfig\x12~\n\x0ffallback_policy\x18\x01\x20\x01(\x0e2K.en\
    voy.config.cluster.v4alpha.Cluster.LbSubsetConfig.LbSubsetFallbackPolicy\
    R\x0efallbackPolicyB\x08\xfaB\x05\x82\x01\x02\x10\x01\x12>\n\x0edefault_\
    subset\x18\x02\x20\x01(\x0b2\x17.google.protobuf.StructR\rdefaultSubset\
    \x12p\n\x10subset_selectors\x18\x03\x20\x03(\x0b2E.envoy.config.cluster.\
    v4alpha.Cluster.LbSubsetConfig.LbSubsetSelectorR\x0fsubsetSelectors\x122\
    \n\x15locality_weight_aware\x18\x04\x20\x01(\x08R\x13localityWeightAware\
    \x122\n\x15scale_locality_weight\x18\x05\x20\x01(\x08R\x13scaleLocalityW\
    eight\x12$\n\x0epanic_mode_any\x18\x06\x20\x01(\x08R\x0cpanicModeAny\x12\
    \x1e\n\x0blist_as_any\x18\x07\x20\x01(\x08R\tlistAsAny\x1a\xea\x03\n\x10\
    LbSubsetSelector\x12\x12\n\x04keys\x18\x01\x20\x03(\tR\x04keys\x123\n\
    \x16single_host_per_subset\x18\x04\x20\x01(\x08R\x13singleHostPerSubset\
    \x12\x97\x01\n\x0ffallback_policy\x18\x02\x20\x01(\x0e2d.envoy.config.cl\
    uster.v4alpha.Cluster.LbSubsetConfig.LbSubsetSelector.LbSubsetSelectorFa\
    llbackPolicyR\x0efallbackPolicyB\x08\xfaB\x05\x82\x01\x02\x10\x01\x120\n\
    \x14fallback_keys_subset\x18\x03\x20\x03(\tR\x12fallbackKeysSubset\"y\n\
    \x1eLbSubsetSelectorFallbackPolicy\x12\x0f\n\x0bNOT_DEFINED\x10\0\x12\
    \x0f\n\x0bNO_FALLBACK\x10\x01\x12\x10\n\x0cANY_ENDPOINT\x10\x02\x12\x12\
    \n\x0eDEFAULT_SUBSET\x10\x03\x12\x0f\n\x0bKEYS_SUBSET\x10\x04:F\x9a\xc5\
    \x88\x1eA\n?envoy.config.cluster.v3.Cluster.LbSubsetConfig.LbSubsetSelec\
    tor\"O\n\x16LbSubsetFallbackPolicy\x12\x0f\n\x0bNO_FALLBACK\x10\0\x12\
    \x10\n\x0cANY_ENDPOINT\x10\x01\x12\x12\n\x0eDEFAULT_SUBSET\x10\x02:5\x9a\
    \xc5\x88\x1e0\n.envoy.config.cluster.v3.Cluster.LbSubsetConfig\x1a\xf7\
    \x01\n\x14LeastRequestLbConfig\x12H\n\x0cchoice_count\x18\x01\x20\x01(\
    \x0b2\x1c.google.protobuf.UInt32ValueR\x0bchoiceCountB\x07\xfaB\x04*\x02\
    (\x02\x12X\n\x13active_request_bias\x18\x02\x20\x01(\x0b2(.envoy.config.\
    core.v4alpha.RuntimeDoubleR\x11activeRequestBias:;\x9a\xc5\x88\x1e6\n4en\
    voy.config.cluster.v3.Cluster.LeastRequestLbConfig\x1a\xa1\x03\n\x10Ring\
    HashLbConfig\x12T\n\x11minimum_ring_size\x18\x01\x20\x01(\x0b2\x1c.googl\
    e.protobuf.UInt64ValueR\x0fminimumRingSizeB\n\xfaB\x072\x05\x18\x80\x80\
    \x80\x04\x12r\n\rhash_function\x18\x03\x20\x01(\x0e2C.envoy.config.clust\
    er.v4alpha.Cluster.RingHashLbConfig.HashFunctionR\x0chashFunctionB\x08\
    \xfaB\x05\x82\x01\x02\x10\x01\x12T\n\x11maximum_ring_size\x18\x04\x20\
    \x01(\x0b2\x1c.google.protobuf.UInt64ValueR\x0fmaximumRingSizeB\n\xfaB\
    \x072\x05\x18\x80\x80\x80\x04\".\n\x0cHashFunction\x12\x0b\n\x07XX_HASH\
    \x10\0\x12\x11\n\rMURMUR_HASH_2\x10\x01:7\x9a\xc5\x88\x1e2\n0envoy.confi\
    g.cluster.v3.Cluster.RingHashLbConfigJ\x04\x08\x02\x10\x03\x1a\x84\x01\n\
    \x0eMaglevLbConfig\x12;\n\ntable_size\x18\x01\x20\x01(\x0b2\x1c.google.p\
    rotobuf.UInt64ValueR\ttableSize:5\x9a\xc5\x88\x1e0\n.envoy.config.cluste\
    r.v3.Cluster.MaglevLbConfig\x1ay\n\x13OriginalDstLbConfig\x12&\n\x0fuse_\
    http_header\x18\x01\x20\x01(\x08R\ruseHttpHeader::\x9a\xc5\x88\x1e5\n3en\
    voy.config.cluster.v3.Cluster.OriginalDstLbConfig\x1a\xb7\x0b\n\x0eCommo\
    nLbConfig\x12N\n\x17healthy_panic_threshold\x18\x01\x20\x01(\x0b2\x16.en\
    voy.type.v3.PercentR\x15healthyPanicThreshold\x12y\n\x14zone_aware_lb_co\
    nfig\x18\x02\x20\x01(\x0b2F.envoy.config.cluster.v4alpha.Cluster.CommonL\
    bConfig.ZoneAwareLbConfigH\0R\x11zoneAwareLbConfig\x12\x8e\x01\n\x1bloca\
    lity_weighted_lb_config\x18\x03\x20\x01(\x0b2M.envoy.config.cluster.v4al\
    pha.Cluster.CommonLbConfig.LocalityWeightedLbConfigH\0R\x18localityWeigh\
    tedLbConfig\x12I\n\x13update_merge_window\x18\x04\x20\x01(\x0b2\x19.goog\
    le.protobuf.DurationR\x11updateMergeWindow\x12C\n\x1fignore_new_hosts_un\
    til_first_hc\x18\x05\x20\x01(\x08R\x1aignoreNewHostsUntilFirstHc\x12M\n$\
    close_connections_on_host_set_change\x18\x06\x20\x01(\x08R\x1fcloseConne\
    ctionsOnHostSetChange\x12\x8f\x01\n\x1cconsistent_hashing_lb_config\x18\
    \x07\x20\x01(\x0b2N.envoy.config.cluster.v4alpha.Cluster.CommonLbConfig.\
    ConsistentHashingLbConfigR\x19consistentHashingLbConfig\x1a\x98\x02\n\
    \x11ZoneAwareLbConfig\x12?\n\x0frouting_enabled\x18\x01\x20\x01(\x0b2\
    \x16.envoy.type.v3.PercentR\x0eroutingEnabled\x12F\n\x10min_cluster_size\
    \x18\x02\x20\x01(\x0b2\x1c.google.protobuf.UInt64ValueR\x0eminClusterSiz\
    e\x121\n\x15fail_traffic_on_panic\x18\x03\x20\x01(\x08R\x12failTrafficOn\
    Panic:G\x9a\xc5\x88\x1eB\n@envoy.config.cluster.v3.Cluster.CommonLbConfi\
    g.ZoneAwareLbConfig\x1aj\n\x18LocalityWeightedLbConfig:N\x9a\xc5\x88\x1e\
    I\nGenvoy.config.cluster.v3.Cluster.CommonLbConfig.LocalityWeightedLbCon\
    fig\x1a\xfc\x01\n\x19ConsistentHashingLbConfig\x127\n\x18use_hostname_fo\
    r_hashing\x18\x01\x20\x01(\x08R\x15useHostnameForHashing\x12U\n\x13hash_\
    balance_factor\x18\x02\x20\x01(\x0b2\x1c.google.protobuf.UInt32ValueR\
    \x11hashBalanceFactorB\x07\xfaB\x04*\x02(d:O\x9a\xc5\x88\x1eJ\nHenvoy.co\
    nfig.cluster.v3.Cluster.CommonLbConfig.ConsistentHashingLbConfigB\x1b\n\
    \x19locality_config_specifier:5\x9a\xc5\x88\x1e0\n.envoy.config.cluster.\
    v3.Cluster.CommonLbConfig\x1a\xdd\x01\n\x0bRefreshRate\x12N\n\rbase_inte\
    rval\x18\x01\x20\x01(\x0b2\x19.google.protobuf.DurationR\x0cbaseInterval\
    B\x0e\xfaB\x0b\xaa\x01\x08\x08\x01*\x04\x10\xc0\x84=\x12J\n\x0cmax_inter\
    val\x18\x02\x20\x01(\x0b2\x19.google.protobuf.DurationR\x0bmaxIntervalB\
    \x0c\xfaB\t\xaa\x01\x06*\x04\x10\xc0\x84=:2\x9a\xc5\x88\x1e-\n+envoy.con\
    fig.cluster.v3.Cluster.RefreshRate\x1a\xb0\x02\n\x0ePrefetchPolicy\x12t\
    \n\x1bper_upstream_prefetch_ratio\x18\x01\x20\x01(\x0b2\x1c.google.proto\
    buf.DoubleValueR\x18perUpstreamPrefetchRatioB\x17\xfaB\x14\x12\x12\x19\0\
    \0\0\0\0\0\x08@)\0\0\0\0\0\0\xf0?\x12q\n\x19predictive_prefetch_ratio\
    \x18\x02\x20\x01(\x0b2\x1c.google.protobuf.DoubleValueR\x17predictivePre\
    fetchRatioB\x17\xfaB\x14\x12\x12\x19\0\0\0\0\0\0\x08@)\0\0\0\0\0\0\xf0?:\
    5\x9a\xc5\x88\x1e0\n.envoy.config.cluster.v3.Cluster.PrefetchPolicy\x1af\
    \n\"TypedExtensionProtocolOptionsEntry\x12\x10\n\x03key\x18\x01\x20\x01(\
    \tR\x03key\x12*\n\x05value\x18\x02\x20\x01(\x0b2\x14.google.protobuf.Any\
    ...
    \x18\n\x16cluster_discovery_typeB\x0b\n\tlb_config:&\x9a\xc5\x88\x1e!\n\
    \x1fenvoy.config.cluster.v3.ClusterJ\x04\x08\x0c\x10\rJ\x04\x08\x0f\x10\
    \x10J\x04\x08\x07\x10\x08J\x04\x08\x0b\x10\x0cJ\x04\x08#\x10$J\x04\x08.\
    \x10/J\x04\x08\x1d\x10\x1eJ\x04\x08\r\x10\x0eJ\x04\x08\x0e\x10\x0fJ\x04\
    \x08\x1a\x10\x1bJ\x04\x08/\x100R\x05hostsR\x0btls_contextR\x1aextension_\
    protocol_optionsR\x1eupstream_http_protocol_optionsR\x1ccommon_http_prot\
    ocol_optionsR\x15http_protocol_optionsR\x16http2_protocol_optionsR\x12pr\
    otocol_selectionR\x15track_timeout_budgets\"\xc0\x02\n\x13LoadBalancingP\
    olicy\x12T\n\x08policies\x18\x01\x20\x03(\x0b28.envoy.config.cluster.v4a\
    lpha.LoadBalancingPolicy.PolicyR\x08policies\x1a\x9e\x01\n\x06Policy\x12\
    \x12\n\x04name\x18\x01\x20\x01(\tR\x04name\x127\n\x0ctyped_config\x18\
    \x03\x20\x01(\x0b2\x14.google.protobuf.AnyR\x0btypedConfig:9\x9a\xc5\x88\
    \x1e4\n2envoy.config.cluster.v3.LoadBalancingPolicy.PolicyJ\x04\x08\x02\
    \x10\x03R\x06config:2\x9a\xc5\x88\x1e-\n+envoy.config.cluster.v3.LoadBal\
    ancingPolicy\"\x92\x01\n\x12UpstreamBindConfig\x12I\n\x0esource_address\
    \x18\x01\x20\x01(\x0b2\".envoy.config.core.v4alpha.AddressR\rsourceAddre\
    ss:1\x9a\xc5\x88\x1e,\n*envoy.config.cluster.v3.UpstreamBindConfig\"\xa3\
    \x01\n\x19UpstreamConnectionOptions\x12L\n\rtcp_keepalive\x18\x01\x20\
    \x01(\x0b2'.envoy.config.core.v4alpha.TcpKeepaliveR\x0ctcpKeepalive:8\
    \x9a\xc5\x88\x1e3\n1envoy.config.cluster.v3.UpstreamConnectionOptions\"\
    \xa4\x01\n\x11TrackClusterStats\x12'\n\x0ftimeout_budgets\x18\x01\x20\
    \x01(\x08R\x0etimeoutBudgets\x124\n\x16request_response_sizes\x18\x02\
    \x20\x01(\x08R\x14requestResponseSizes:0\x9a\xc5\x88\x1e+\n)envoy.config\
    .cluster.v3.TrackClusterStatsBD\n*io.envoyproxy.envoy.config.cluster.v4a\
    lphaB\x0cClusterProtoP\x01\xba\x80\xc8\xd1\x06\x02\x10\x03b\x06proto3\
";
