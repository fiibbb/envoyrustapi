...
//! Generated file from `envoy/config/tap/v3/common.proto`
...
pub struct TapConfig {
    // message fields
    pub match_config: ::protobuf::SingularPtrField<MatchPredicate>,
...
impl TapConfig {
    ...
    // .envoy.config.tap.v3.MatchPredicate match_config = 1;


    pub fn get_match_config(&self) -> &MatchPredicate {
        self.match_config.as_ref().unwrap_or_else(|| <MatchPredicate as ::protobuf::Message>::default_instance())
    }
    pub fn clear_match_config(&mut self) {
        self.match_config.clear();
    }

    pub fn has_match_config(&self) -> bool {
        self.match_config.is_some()
    }

    // Param is passed by value, moved
    pub fn set_match_config(&mut self, v: MatchPredicate) {
        self.match_config = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_match_config(&mut self) -> &mut MatchPredicate {
        if self.match_config.is_none() {
            self.match_config.set_default();
        }
        self.match_config.as_mut().unwrap()
    }

    // Take field
    pub fn take_match_config(&mut self) -> MatchPredicate {
        self.match_config.take().unwrap_or_else(|| MatchPredicate::new())
    }
...
impl ::protobuf::Message for TapConfig {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.match_config)?;
                },
                4 => {
    ...
    fn compute_size(&self) -> u32 {
        let mut my_size = 0;
        if let Some(ref v) = self.match_config.as_ref() {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<MatchPredicate>>(
                "match_config",
                |m: &TapConfig| { &m.match_config },
                |m: &mut TapConfig| { &mut m.match_config },
            ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x20envoy/config/tap/v3/common.proto\x12\x13envoy.config.tap.v3\x1a,en\
    voy/config/common/matcher/v3/matcher.proto\x1a\x1fenvoy/config/core/v3/b\
    ase.proto\x1a'envoy/config/core/v3/grpc_service.proto\x1a,envoy/config/r\
    oute/v3/route_components.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\
    \x1dudpa/annotations/status.proto\x1a!udpa/annotations/versioning.proto\
    \x1a\x17validate/validate.proto\"\xec\x02\n\tTapConfig\x12J\n\x0cmatch_c\
    onfig\x18\x01\x20\x01(\x0b2#.envoy.config.tap.v3.MatchPredicateR\x0bmatc\
    hConfigB\x02\x18\x01\x12D\n\x05match\x18\x04\x20\x01(\x0b2..envoy.config\
    .common.matcher.v3.MatchPredicateR\x05match\x12P\n\routput_config\x18\
    \x02\x20\x01(\x0b2!.envoy.config.tap.v3.OutputConfigR\x0coutputConfigB\
    \x08\xfaB\x05\x8a\x01\x02\x10\x01\x12O\n\x0btap_enabled\x18\x03\x20\x01(\
    \x0b2..envoy.config.core.v3.RuntimeFractionalPercentR\ntapEnabled:*\x9a\
    \xc5\x88\x1e%\n#envoy.service.tap.v2alpha.TapConfig\"\xe6\x08\n\x0eMatch\
    Predicate\x12I\n\x08or_match\x18\x01\x20\x01(\x0b2,.envoy.config.tap.v3.\
    MatchPredicate.MatchSetH\0R\x07orMatch\x12K\n\tand_match\x18\x02\x20\x01\
    (\x0b2,.envoy.config.tap.v3.MatchPredicate.MatchSetH\0R\x08andMatch\x12B\
    \n\tnot_match\x18\x03\x20\x01(\x0b2#.envoy.config.tap.v3.MatchPredicateH\
    \0R\x08notMatch\x12&\n\tany_match\x18\x04\x20\x01(\x08H\0R\x08anyMatchB\
    \x07\xfaB\x04j\x02\x08\x01\x12d\n\x1ahttp_request_headers_match\x18\x05\
    \x20\x01(\x0b2%.envoy.config.tap.v3.HttpHeadersMatchH\0R\x17httpRequestH\
    eadersMatch\x12f\n\x1bhttp_request_trailers_match\x18\x06\x20\x01(\x0b2%\
    .envoy.config.tap.v3.HttpHeadersMatchH\0R\x18httpRequestTrailersMatch\
    \x12f\n\x1bhttp_response_headers_match\x18\x07\x20\x01(\x0b2%.envoy.conf\
    ig.tap.v3.HttpHeadersMatchH\0R\x18httpResponseHeadersMatch\x12h\n\x1chtt\
    p_response_trailers_match\x18\x08\x20\x01(\x0b2%.envoy.config.tap.v3.Htt\
    pHeadersMatchH\0R\x19httpResponseTrailersMatch\x12q\n\x1fhttp_request_ge\
    neric_body_match\x18\t\x20\x01(\x0b2).envoy.config.tap.v3.HttpGenericBod\
    yMatchH\0R\x1bhttpRequestGenericBodyMatch\x12s\n\x20http_response_generi\
    c_body_match\x18\n\x20\x01(\x0b2).envoy.config.tap.v3.HttpGenericBodyMat\
    chH\0R\x1chttpResponseGenericBodyMatch\x1a\x89\x01\n\x08MatchSet\x12C\n\
    \x05rules\x18\x01\x20\x03(\x0b2#.envoy.config.tap.v3.MatchPredicateR\x05\
    rulesB\x08\xfaB\x05\x92\x01\x02\x08\x02:8\x9a\xc5\x88\x1e3\n1envoy.servi\
    ce.tap.v2alpha.MatchPredicate.MatchSetB\x0b\n\x04rule\x12\x03\xf8B\x01:/\
    \x9a\xc5\x88\x1e*\n(envoy.service.tap.v2alpha.MatchPredicate\"\x85\x01\n\
    \x10HttpHeadersMatch\x12>\n\x07headers\x18\x01\x20\x03(\x0b2$.envoy.conf\
    ig.route.v3.HeaderMatcherR\x07headers:1\x9a\xc5\x88\x1e,\n*envoy.service\
    .tap.v2alpha.HttpHeadersMatch\"\x96\x02\n\x14HttpGenericBodyMatch\x12\
    \x1f\n\x0bbytes_limit\x18\x01\x20\x01(\rR\nbytesLimit\x12`\n\x08patterns\
    \x18\x02\x20\x03(\x0b2:.envoy.config.tap.v3.HttpGenericBodyMatch.Generic\
    TextMatchR\x08patternsB\x08\xfaB\x05\x92\x01\x02\x08\x01\x1a{\n\x10Gener\
    icTextMatch\x12,\n\x0cstring_match\x18\x01\x20\x01(\tH\0R\x0bstringMatch\
    B\x07\xfaB\x04r\x02\x10\x01\x12,\n\x0cbinary_match\x18\x02\x20\x01(\x0cH\
    \0R\x0bbinaryMatchB\x07\xfaB\x04z\x02\x10\x01B\x0b\n\x04rule\x12\x03\xf8\
    B\x01\"\xc0\x02\n\x0cOutputConfig\x12A\n\x05sinks\x18\x01\x20\x03(\x0b2\
    \x1f.envoy.config.tap.v3.OutputSinkR\x05sinksB\n\xfaB\x07\x92\x01\x04\
    \x08\x01\x10\x01\x12O\n\x15max_buffered_rx_bytes\x18\x02\x20\x01(\x0b2\
    \x1c.google.protobuf.UInt32ValueR\x12maxBufferedRxBytes\x12O\n\x15max_bu\
    ffered_tx_bytes\x18\x03\x20\x01(\x0b2\x1c.google.protobuf.UInt32ValueR\
    \x12maxBufferedTxBytes\x12\x1c\n\tstreaming\x18\x04\x20\x01(\x08R\tstrea\
    ming:-\x9a\xc5\x88\x1e(\n&envoy.service.tap.v2alpha.OutputConfig\"\x8a\
    \x04\n\nOutputSink\x12H\n\x06format\x18\x01\x20\x01(\x0e2&.envoy.config.\
    tap.v3.OutputSink.FormatR\x06formatB\x08\xfaB\x05\x82\x01\x02\x10\x01\
    \x12R\n\x0fstreaming_admin\x18\x02\x20\x01(\x0b2'.envoy.config.tap.v3.St\
    reamingAdminSinkH\0R\x0estreamingAdmin\x12G\n\x0cfile_per_tap\x18\x03\
    \x20\x01(\x0b2#.envoy.config.tap.v3.FilePerTapSinkH\0R\nfilePerTap\x12O\
    \n\x0estreaming_grpc\x18\x04\x20\x01(\x0b2&.envoy.config.tap.v3.Streamin\
    gGrpcSinkH\0R\rstreamingGrpc\"~\n\x06Format\x12\x16\n\x12JSON_BODY_AS_BY\
    TES\x10\0\x12\x17\n\x13JSON_BODY_AS_STRING\x10\x01\x12\x10\n\x0cPROTO_BI\
    NARY\x10\x02\x12!\n\x1dPROTO_BINARY_LENGTH_DELIMITED\x10\x03\x12\x0e\n\n\
    PROTO_TEXT\x10\x04B\x17\n\x10output_sink_type\x12\x03\xf8B\x01:+\x9a\xc5\
    \x88\x1e&\n$envoy.service.tap.v2alpha.OutputSink\"I\n\x12StreamingAdminS\
    ink:3\x9a\xc5\x88\x1e.\n,envoy.service.tap.v2alpha.StreamingAdminSink\"k\
    \n\x0eFilePerTapSink\x12(\n\x0bpath_prefix\x18\x01\x20\x01(\tR\npathPref\
    ixB\x07\xfaB\x04r\x02\x10\x01:/\x9a\xc5\x88\x1e*\n(envoy.service.tap.v2a\
    lpha.FilePerTapSink\"\xae\x01\n\x11StreamingGrpcSink\x12\x15\n\x06tap_id\
    \x18\x01\x20\x01(\tR\x05tapId\x12N\n\x0cgrpc_service\x18\x02\x20\x01(\
    \x0b2!.envoy.config.core.v3.GrpcServiceR\x0bgrpcServiceB\x08\xfaB\x05\
    \x8a\x01\x02\x10\x01:2\x9a\xc5\x88\x1e-\n+envoy.service.tap.v2alpha.Stre\
    amingGrpcSinkB:\n!io.envoyproxy.envoy.config.tap.v3B\x0bCommonProtoP\x01\
