...
//! Generated file from `envoy/config/accesslog/v3/accesslog.proto`
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n)envoy/config/accesslog/v3/accesslog.proto\x12\x19envoy.config.accessl\
    og.v3\x1a\x1fenvoy/config/core/v3/base.proto\x1a,envoy/config/route/v3/r\
    oute_components.proto\x1a$envoy/type/matcher/v3/metadata.proto\x1a\x1ben\
    voy/type/v3/percent.proto\x1a\x19google/protobuf/any.proto\x1a\x1cgoogle\
    /protobuf/struct.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1dudpa\
    /annotations/status.proto\x1a!udpa/annotations/versioning.proto\x1a\x17v\
    alidate/validate.proto\"\xee\x01\n\tAccessLog\x12\x12\n\x04name\x18\x01\
    \x20\x01(\tR\x04name\x12B\n\x06filter\x18\x02\x20\x01(\x0b2*.envoy.confi\
    g.accesslog.v3.AccessLogFilterR\x06filter\x129\n\x0ctyped_config\x18\x04\
    \x20\x01(\x0b2\x14.google.protobuf.AnyH\0R\x0btypedConfigB\r\n\x0bconfig\
    _type:1\x9a\xc5\x88\x1e,\n*envoy.config.filter.accesslog.v2.AccessLogJ\
    \x04\x08\x03\x10\x04R\x06config\"\xf6\x08\n\x0fAccessLogFilter\x12[\n\
    \x12status_code_filter\x18\x01\x20\x01(\x0b2+.envoy.config.accesslog.v3.\
    StatusCodeFilterH\0R\x10statusCodeFilter\x12T\n\x0fduration_filter\x18\
    \x02\x20\x01(\x0b2).envoy.config.accesslog.v3.DurationFilterH\0R\x0edura\
    tionFilter\x12h\n\x17not_health_check_filter\x18\x03\x20\x01(\x0b2/.envo\
    y.config.accesslog.v3.NotHealthCheckFilterH\0R\x14notHealthCheckFilter\
    \x12W\n\x10traceable_filter\x18\x04\x20\x01(\x0b2*.envoy.config.accesslo\
    g.v3.TraceableFilterH\0R\x0ftraceableFilter\x12Q\n\x0eruntime_filter\x18\
    \x05\x20\x01(\x0b2(.envoy.config.accesslog.v3.RuntimeFilterH\0R\rruntime\
    Filter\x12E\n\nand_filter\x18\x06\x20\x01(\x0b2$.envoy.config.accesslog.\
    v3.AndFilterH\0R\tandFilter\x12B\n\tor_filter\x18\x07\x20\x01(\x0b2#.env\
    oy.config.accesslog.v3.OrFilterH\0R\x08orFilter\x12N\n\rheader_filter\
    \x18\x08\x20\x01(\x0b2'.envoy.config.accesslog.v3.HeaderFilterH\0R\x0che\
    aderFilter\x12a\n\x14response_flag_filter\x18\t\x20\x01(\x0b2-.envoy.con\
    fig.accesslog.v3.ResponseFlagFilterH\0R\x12responseFlagFilter\x12[\n\x12\
    grpc_status_filter\x18\n\x20\x01(\x0b2+.envoy.config.accesslog.v3.GrpcSt\
    atusFilterH\0R\x10grpcStatusFilter\x12W\n\x10extension_filter\x18\x0b\
    \x20\x01(\x0b2*.envoy.config.accesslog.v3.ExtensionFilterH\0R\x0fextensi\
    onFilter\x12T\n\x0fmetadata_filter\x18\x0c\x20\x01(\x0b2).envoy.config.a\
    ccesslog.v3.MetadataFilterH\0R\x0emetadataFilterB\x17\n\x10filter_specif\
    ier\x12\x03\xf8B\x01:7\x9a\xc5\x88\x1e2\n0envoy.config.filter.accesslog.\
    v2.AccessLogFilter\"\xef\x01\n\x10ComparisonFilter\x12H\n\x02op\x18\x01\
    \x20\x01(\x0e2..envoy.config.accesslog.v3.ComparisonFilter.OpR\x02opB\
    \x08\xfaB\x05\x82\x01\x02\x10\x01\x129\n\x05value\x18\x02\x20\x01(\x0b2#\
    .envoy.config.core.v3.RuntimeUInt32R\x05value\"\x1c\n\x02Op\x12\x06\n\
    \x02EQ\x10\0\x12\x06\n\x02GE\x10\x01\x12\x06\n\x02LE\x10\x02:8\x9a\xc5\
    \x88\x1e3\n1envoy.config.filter.accesslog.v2.ComparisonFilter\"\xa3\x01\
    \n\x10StatusCodeFilter\x12U\n\ncomparison\x18\x01\x20\x01(\x0b2+.envoy.c\
    onfig.accesslog.v3.ComparisonFilterR\ncomparisonB\x08\xfaB\x05\x8a\x01\
    \x02\x10\x01:8\x9a\xc5\x88\x1e3\n1envoy.config.filter.accesslog.v2.Statu\
    sCodeFilter\"\x9f\x01\n\x0eDurationFilter\x12U\n\ncomparison\x18\x01\x20\
    \x01(\x0b2+.envoy.config.accesslog.v3.ComparisonFilterR\ncomparisonB\x08\
    \xfaB\x05\x8a\x01\x02\x10\x01:6\x9a\xc5\x88\x1e1\n/envoy.config.filter.a\
    ccesslog.v2.DurationFilter\"T\n\x14NotHealthCheckFilter:<\x9a\xc5\x88\
    \x1e7\n5envoy.config.filter.accesslog.v2.NotHealthCheckFilter\"J\n\x0fTr\
    aceableFilter:7\x9a\xc5\x88\x1e2\n0envoy.config.filter.accesslog.v2.Trac\
    eableFilter\"\xf9\x01\n\rRuntimeFilter\x12(\n\x0bruntime_key\x18\x01\x20\
    \x01(\tR\nruntimeKeyB\x07\xfaB\x04r\x02\x10\x01\x12I\n\x0fpercent_sample\
    d\x18\x02\x20\x01(\x0b2\x20.envoy.type.v3.FractionalPercentR\x0epercentS\
    ampled\x12<\n\x1ause_independent_randomness\x18\x03\x20\x01(\x08R\x18use\
    IndependentRandomness:5\x9a\xc5\x88\x1e0\n.envoy.config.filter.accesslog\
    .v2.RuntimeFilter\"\x8e\x01\n\tAndFilter\x12N\n\x07filters\x18\x01\x20\
    \x03(\x0b2*.envoy.config.accesslog.v3.AccessLogFilterR\x07filtersB\x08\
    \xfaB\x05\x92\x01\x02\x08\x02:1\x9a\xc5\x88\x1e,\n*envoy.config.filter.a\
    ccesslog.v2.AndFilter\"\x8c\x01\n\x08OrFilter\x12N\n\x07filters\x18\x02\
    \x20\x03(\x0b2*.envoy.config.accesslog.v3.AccessLogFilterR\x07filtersB\
    \x08\xfaB\x05\x92\x01\x02\x08\x02:0\x9a\xc5\x88\x1e+\n)envoy.config.filt\
    er.accesslog.v2.OrFilter\"\x8c\x01\n\x0cHeaderFilter\x12F\n\x06header\
    \x18\x01\x20\x01(\x0b2$.envoy.config.route.v3.HeaderMatcherR\x06headerB\
    \x08\xfaB\x05\x8a\x01\x02\x10\x01:4\x9a\xc5\x88\x1e/\n-envoy.config.filt\
    er.accesslog.v2.HeaderFilter\"\xdc\x01\n\x12ResponseFlagFilter\x12\x89\
    \x01\n\x05flags\x18\x01\x20\x03(\tR\x05flagsBs\xfaBp\x92\x01m\"kriR\x02L\
    HR\x02UHR\x02UTR\x02LRR\x02URR\x02UFR\x02UCR\x02UOR\x02NRR\x02DIR\x02FIR\
    \x02RLR\x04UAEXR\x04RLSER\x02DCR\x03URXR\x02SIR\x02IHR\x03DPER\x05UMSDRR\
    \x04RFCFR\x04NFCFR\x02DT::\x9a\xc5\x88\x1e5\n3envoy.config.filter.access\
    log.v2.ResponseFlagFilter\"\x80\x04\n\x10GrpcStatusFilter\x12]\n\x08stat\
    uses\x18\x01\x20\x03(\x0e22.envoy.config.accesslog.v3.GrpcStatusFilter.S\
    tatusR\x08statusesB\r\xfaB\n\x92\x01\x07\"\x05\x82\x01\x02\x10\x01\x12\
    \x18\n\x07exclude\x18\x02\x20\x01(\x08R\x07exclude\"\xb8\x02\n\x06Status\
    \x12\x06\n\x02OK\x10\0\x12\x0c\n\x08CANCELED\x10\x01\x12\x0b\n\x07UNKNOW\
    N\x10\x02\x12\x14\n\x10INVALID_ARGUMENT\x10\x03\x12\x15\n\x11DEADLINE_EX\
    CEEDED\x10\x04\x12\r\n\tNOT_FOUND\x10\x05\x12\x12\n\x0eALREADY_EXISTS\
    \x10\x06\x12\x15\n\x11PERMISSION_DENIED\x10\x07\x12\x16\n\x12RESOURCE_EX\
    HAUSTED\x10\x08\x12\x17\n\x13FAILED_PRECONDITION\x10\t\x12\x0b\n\x07ABOR\
    TED\x10\n\x12\x10\n\x0cOUT_OF_RANGE\x10\x0b\x12\x11\n\rUNIMPLEMENTED\x10\
    \x0c\x12\x0c\n\x08INTERNAL\x10\r\x12\x0f\n\x0bUNAVAILABLE\x10\x0e\x12\r\
    \n\tDATA_LOSS\x10\x0f\x12\x13\n\x0fUNAUTHENTICATED\x10\x10:8\x9a\xc5\x88\
    \x1e3\n1envoy.config.filter.accesslog.v2.GrpcStatusFilter\"\xda\x01\n\
    \x0eMetadataFilter\x12@\n\x07matcher\x18\x01\x20\x01(\x0b2&.envoy.type.m\
    atcher.v3.MetadataMatcherR\x07matcher\x12N\n\x16match_if_key_not_found\
    \x18\x02\x20\x01(\x0b2\x1a.google.protobuf.BoolValueR\x12matchIfKeyNotFo\
    und:6\x9a\xc5\x88\x1e1\n/envoy.config.filter.accesslog.v2.MetadataFilter\
    \"\xb6\x01\n\x0fExtensionFilter\x12\x12\n\x04name\x18\x01\x20\x01(\tR\
    \x04name\x129\n\x0ctyped_config\x18\x03\x20\x01(\x0b2\x14.google.protobu\
    f.AnyH\0R\x0btypedConfigB\r\n\x0bconfig_type:7\x9a\xc5\x88\x1e2\n0envoy.\
    config.filter.accesslog.v2.ExtensionFilterJ\x04\x08\x02\x10\x03R\x06conf\
    igBC\n'io.envoyproxy.envoy.config.accesslog.v3B\x0eAccesslogProtoP\x01\
