...
//! Generated file from `envoy/config/listener/v4alpha/listener_components.proto`
...
impl FilterChainMatch {
    ...
    // repeated .envoy.config.core.v4alpha.CidrRange prefix_ranges = 3;
    ...
    // .envoy.config.listener.v4alpha.FilterChainMatch.ConnectionSourceType source_type = 12;
    ...
    // repeated .envoy.config.core.v4alpha.CidrRange source_prefix_ranges = 6;
...
impl ::protobuf::ProtobufEnum for FilterChainMatch_ConnectionSourceType {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<FilterChainMatch_ConnectionSourceType> {
        match value {
            ...
            1 => ::std::option::Option::Some(FilterChainMatch_ConnectionSourceType::SAME_IP_OR_LOOPBACK),
    ...
    fn values() -> &'static [Self] {
        static values: &'static [FilterChainMatch_ConnectionSourceType] = &[
            ...
            FilterChainMatch_ConnectionSourceType::SAME_IP_OR_LOOPBACK,
...
pub struct FilterChain {
    ...
    pub transport_socket_connect_timeout: ::protobuf::SingularPtrField<::protobuf::well_known_types::Duration>,
    pub name: ::std::string::String,
    pub on_demand_configuration: ::protobuf::SingularPtrField<FilterChain_OnDemandConfiguration>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl FilterChain {
    ...
    // .envoy.config.listener.v4alpha.FilterChainMatch filter_chain_match = 1;
    ...
    // repeated .envoy.config.listener.v4alpha.Filter filters = 3;
    ...
    // .envoy.config.core.v4alpha.Metadata metadata = 5;
    ...
    // .envoy.config.core.v4alpha.TransportSocket transport_socket = 6;
    ...
    pub fn get_transport_socket_connect_timeout(&self) -> &::protobuf::well_known_types::Duration {
        self.transport_socket_connect_timeout.as_ref().unwrap_or_else(|| <::protobuf::well_known_types::Duration as ::protobuf::Message>::default_instance())
    }
    pub fn clear_transport_socket_connect_timeout(&mut self) {
        self.transport_socket_connect_timeout.clear();
    }

    pub fn has_transport_socket_connect_timeout(&self) -> bool {
        self.transport_socket_connect_timeout.is_some()
    }

    // Param is passed by value, moved
    pub fn set_transport_socket_connect_timeout(&mut self, v: ::protobuf::well_known_types::Duration) {
        self.transport_socket_connect_timeout = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_transport_socket_connect_timeout(&mut self) -> &mut ::protobuf::well_known_types::Duration {
        if self.transport_socket_connect_timeout.is_none() {
            self.transport_socket_connect_timeout.set_default();
        }
        self.transport_socket_connect_timeout.as_mut().unwrap()
    }

    // Take field
    pub fn take_transport_socket_connect_timeout(&mut self) -> ::protobuf::well_known_types::Duration {
        self.transport_socket_connect_timeout.take().unwrap_or_else(|| ::protobuf::well_known_types::Duration::new())
    }
    ...
    // .envoy.config.listener.v4alpha.FilterChain.OnDemandConfiguration on_demand_configuration = 8;


    pub fn get_on_demand_configuration(&self) -> &FilterChain_OnDemandConfiguration {
        self.on_demand_configuration.as_ref().unwrap_or_else(|| <FilterChain_OnDemandConfiguration as ::protobuf::Message>::default_instance())
    }
    pub fn clear_on_demand_configuration(&mut self) {
        self.on_demand_configuration.clear();
    }

    pub fn has_on_demand_configuration(&self) -> bool {
        self.on_demand_configuration.is_some()
    }

    // Param is passed by value, moved
    pub fn set_on_demand_configuration(&mut self, v: FilterChain_OnDemandConfiguration) {
        self.on_demand_configuration = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_on_demand_configuration(&mut self) -> &mut FilterChain_OnDemandConfiguration {
        if self.on_demand_configuration.is_none() {
            self.on_demand_configuration.set_default();
        }
        self.on_demand_configuration.as_mut().unwrap()
    }

    // Take field
    pub fn take_on_demand_configuration(&mut self) -> FilterChain_OnDemandConfiguration {
        self.on_demand_configuration.take().unwrap_or_else(|| FilterChain_OnDemandConfiguration::new())
    }
}
...
impl ::protobuf::Message for FilterChain {
    fn is_initialized(&self) -> bool {
        ...
        for v in &self.transport_socket_connect_timeout {
            if !v.is_initialized() {
                return false;
            }
        };
        for v in &self.on_demand_configuration {
            if !v.is_initialized() {
                return false;
            }
        };
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                9 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.transport_socket_connect_timeout)?;
                },
                7 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.name)?;
                },
                8 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.on_demand_configuration)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let Some(ref v) = self.transport_socket_connect_timeout.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        }
        if !self.name.is_empty() {
        ...
        if let Some(ref v) = self.on_demand_configuration.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<::protobuf::well_known_types::Duration>>(
                ...
                |m: &FilterChain| { &m.transport_socket_connect_timeout },
                |m: &mut FilterChain| { &mut m.transport_socket_connect_timeout },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "name",
            ...
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<FilterChain_OnDemandConfiguration>>(
                "on_demand_configuration",
                |m: &FilterChain| { &m.on_demand_configuration },
                |m: &mut FilterChain| { &mut m.on_demand_configuration },
            ));
...
#[derive(PartialEq,Clone,Default)]
pub struct FilterChain_OnDemandConfiguration {
    // message fields
    pub rebuild_timeout: ::protobuf::SingularPtrField<::protobuf::well_known_types::Duration>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}

impl<'a> ::std::default::Default for &'a FilterChain_OnDemandConfiguration {
    fn default() -> &'a FilterChain_OnDemandConfiguration {
        <FilterChain_OnDemandConfiguration as ::protobuf::Message>::default_instance()
    }
}

impl FilterChain_OnDemandConfiguration {
    pub fn new() -> FilterChain_OnDemandConfiguration {
        ::std::default::Default::default()
    }
    ...
    pub fn get_rebuild_timeout(&self) -> &::protobuf::well_known_types::Duration {
        self.rebuild_timeout.as_ref().unwrap_or_else(|| <::protobuf::well_known_types::Duration as ::protobuf::Message>::default_instance())
    }
    pub fn clear_rebuild_timeout(&mut self) {
        self.rebuild_timeout.clear();
    }

    pub fn has_rebuild_timeout(&self) -> bool {
        self.rebuild_timeout.is_some()
    }

    // Param is passed by value, moved
    pub fn set_rebuild_timeout(&mut self, v: ::protobuf::well_known_types::Duration) {
        self.rebuild_timeout = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_rebuild_timeout(&mut self) -> &mut ::protobuf::well_known_types::Duration {
        if self.rebuild_timeout.is_none() {
            self.rebuild_timeout.set_default();
        }
        self.rebuild_timeout.as_mut().unwrap()
    }

    // Take field
    pub fn take_rebuild_timeout(&mut self) -> ::protobuf::well_known_types::Duration {
        self.rebuild_timeout.take().unwrap_or_else(|| ::protobuf::well_known_types::Duration::new())
    }
}

impl ::protobuf::Message for FilterChain_OnDemandConfiguration {
    fn is_initialized(&self) -> bool {
        for v in &self.rebuild_timeout {
            if !v.is_initialized() {
                return false;
            }
        };
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.rebuild_timeout)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        let mut my_size = 0;
        if let Some(ref v) = self.rebuild_timeout.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
    ...
    fn new() -> FilterChain_OnDemandConfiguration {
        FilterChain_OnDemandConfiguration::new()
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<::protobuf::well_known_types::Duration>>(
                "rebuild_timeout",
                |m: &FilterChain_OnDemandConfiguration| { &m.rebuild_timeout },
                |m: &mut FilterChain_OnDemandConfiguration| { &mut m.rebuild_timeout },
            ));
            ::protobuf::reflect::MessageDescriptor::new_pb_name::<FilterChain_OnDemandConfiguration>(
    ...
    fn default_instance() -> &'static FilterChain_OnDemandConfiguration {
        static instance: ::protobuf::rt::LazyV2<FilterChain_OnDemandConfiguration> = ::protobuf::rt::LazyV2::INIT;
        instance.get(FilterChain_OnDemandConfiguration::new)
    }
}

impl ::protobuf::Clear for FilterChain_OnDemandConfiguration {
    fn clear(&mut self) {
        self.rebuild_timeout.clear();
        self.unknown_fields.clear();
    }
...
impl ::std::fmt::Debug for FilterChain_OnDemandConfiguration {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for FilterChain_OnDemandConfiguration {
    fn as_ref(&self) -> ::protobuf::reflect::ReflectValueRef {
        ::protobuf::reflect::ReflectValueRef::Message(self)
    }
}
...
impl ListenerFilterChainMatchPredicate {
    ...
    // .envoy.config.listener.v4alpha.ListenerFilterChainMatchPredicate.MatchSet or_match = 1;
    ...
    // .envoy.config.listener.v4alpha.ListenerFilterChainMatchPredicate.MatchSet and_match = 2;
    ...
    // .envoy.config.listener.v4alpha.ListenerFilterChainMatchPredicate not_match = 3;
...
impl ListenerFilterChainMatchPredicate_MatchSet {
    ...
    // repeated .envoy.config.listener.v4alpha.ListenerFilterChainMatchPredicate rules = 1;
...
impl ListenerFilter {
    ...
    // .envoy.config.listener.v4alpha.ListenerFilterChainMatchPredicate filter_disabled = 4;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n7envoy/config/listener/v4alpha/listener_components.proto\x12\x1denvoy.\
    config.listener.v4alpha\x1a'envoy/config/core/v4alpha/address.proto\x1a$\
    envoy/config/core/v4alpha/base.proto\x1a\x19envoy/type/v3/range.proto\
    \x1a\x19google/protobuf/any.proto\x1a\x1egoogle/protobuf/duration.proto\
    ...
    proto\x1a\x17validate/validate.proto\"\xab\x01\n\x06Filter\x12\x1b\n\x04\
    name\x18\x01\x20\x01(\tR\x04nameB\x07\xfaB\x04r\x02\x10\x01\x129\n\x0cty\
    ped_config\x18\x04\x20\x01(\x0b2\x14.google.protobuf.AnyH\0R\x0btypedCon\
    figB\r\n\x0bconfig_type:&\x9a\xc5\x88\x1e!\n\x1fenvoy.config.listener.v3\
    .FilterJ\x04\x08\x03\x10\x04J\x04\x08\x02\x10\x03R\x06config\"\x9c\x06\n\
    \x10FilterChainMatch\x12T\n\x10destination_port\x18\x08\x20\x01(\x0b2\
    \x1c.google.protobuf.UInt32ValueR\x0fdestinationPortB\x0b\xfaB\x08*\x06\
    \x18\xff\xff\x03(\x01\x12I\n\rprefix_ranges\x18\x03\x20\x03(\x0b2$.envoy\
    .config.core.v4alpha.CidrRangeR\x0cprefixRanges\x12%\n\x0eaddress_suffix\
    \x18\x04\x20\x01(\tR\raddressSuffix\x12;\n\nsuffix_len\x18\x05\x20\x01(\
    \x0b2\x1c.google.protobuf.UInt32ValueR\tsuffixLen\x12o\n\x0bsource_type\
    \x18\x0c\x20\x01(\x0e2D.envoy.config.listener.v4alpha.FilterChainMatch.C\
    onnectionSourceTypeR\nsourceTypeB\x08\xfaB\x05\x82\x01\x02\x10\x01\x12V\
    \n\x14source_prefix_ranges\x18\x06\x20\x03(\x0b2$.envoy.config.core.v4al\
    pha.CidrRangeR\x12sourcePrefixRanges\x123\n\x0csource_ports\x18\x07\x20\
    \x03(\rR\x0bsourcePortsB\x10\xfaB\r\x92\x01\n\"\x08*\x06\x18\xff\xff\x03\
    (\x01\x12!\n\x0cserver_names\x18\x0b\x20\x03(\tR\x0bserverNames\x12-\n\
    \x12transport_protocol\x18\t\x20\x01(\tR\x11transportProtocol\x123\n\x15\
    application_protocols\x18\n\x20\x03(\tR\x14applicationProtocols\"F\n\x14\
    ConnectionSourceType\x12\x07\n\x03ANY\x10\0\x12\x17\n\x13SAME_IP_OR_LOOP\
    BACK\x10\x01\x12\x0c\n\x08EXTERNAL\x10\x02:0\x9a\xc5\x88\x1e+\n)envoy.co\
    nfig.listener.v3.FilterChainMatchJ\x04\x08\x01\x10\x02\"\xdc\x06\n\x0bFi\
    lterChain\x12]\n\x12filter_chain_match\x18\x01\x20\x01(\x0b2/.envoy.conf\
    ig.listener.v4alpha.FilterChainMatchR\x10filterChainMatch\x12?\n\x07filt\
    ers\x18\x03\x20\x03(\x0b2%.envoy.config.listener.v4alpha.FilterR\x07filt\
    ers\x12B\n\x0fuse_proxy_proto\x18\x04\x20\x01(\x0b2\x1a.google.protobuf.\
    BoolValueR\ruseProxyProto\x12?\n\x08metadata\x18\x05\x20\x01(\x0b2#.envo\
    y.config.core.v4alpha.MetadataR\x08metadata\x12U\n\x10transport_socket\
    \x18\x06\x20\x01(\x0b2*.envoy.config.core.v4alpha.TransportSocketR\x0ftr\
    ansportSocket\x12b\n\x20transport_socket_connect_timeout\x18\t\x20\x01(\
    \x0b2\x19.google.protobuf.DurationR\x1dtransportSocketConnectTimeout\x12\
    \x12\n\x04name\x18\x07\x20\x01(\tR\x04name\x12x\n\x17on_demand_configura\
    tion\x18\x08\x20\x01(\x0b2@.envoy.config.listener.v4alpha.FilterChain.On\
    DemandConfigurationR\x15onDemandConfiguration\x1a\x9e\x01\n\x15OnDemandC\
    onfiguration\x12B\n\x0frebuild_timeout\x18\x01\x20\x01(\x0b2\x19.google.\
    protobuf.DurationR\x0erebuildTimeout:A\x9a\xc5\x88\x1e<\n:envoy.config.l\
    istener.v3.FilterChain.OnDemandConfiguration:+\x9a\xc5\x88\x1e&\n$envoy.\
    config.listener.v3.FilterChainJ\x04\x08\x02\x10\x03R\x0btls_context\"\
    \xdc\x05\n!ListenerFilterChainMatchPredicate\x12f\n\x08or_match\x18\x01\
    \x20\x01(\x0b2I.envoy.config.listener.v4alpha.ListenerFilterChainMatchPr\
    edicate.MatchSetH\0R\x07orMatch\x12h\n\tand_match\x18\x02\x20\x01(\x0b2I\
    .envoy.config.listener.v4alpha.ListenerFilterChainMatchPredicate.MatchSe\
    tH\0R\x08andMatch\x12_\n\tnot_match\x18\x03\x20\x01(\x0b2@.envoy.config.\
    listener.v4alpha.ListenerFilterChainMatchPredicateH\0R\x08notMatch\x12&\
    \n\tany_match\x18\x04\x20\x01(\x08H\0R\x08anyMatchB\x07\xfaB\x04j\x02\
    \x08\x01\x12Q\n\x16destination_port_range\x18\x05\x20\x01(\x0b2\x19.envo\
    y.type.v3.Int32RangeH\0R\x14destinationPortRange\x1a\xb8\x01\n\x08MatchS\
    et\x12`\n\x05rules\x18\x01\x20\x03(\x0b2@.envoy.config.listener.v4alpha.\
    ListenerFilterChainMatchPredicateR\x05rulesB\x08\xfaB\x05\x92\x01\x02\
    \x08\x02:J\x9a\xc5\x88\x1eE\nCenvoy.config.listener.v3.ListenerFilterCha\
    inMatchPredicate.MatchSetB\x0b\n\x04rule\x12\x03\xf8B\x01:A\x9a\xc5\x88\
    \x1e<\n:envoy.config.listener.v3.ListenerFilterChainMatchPredicate\"\xa0\
    \x02\n\x0eListenerFilter\x12\x1b\n\x04name\x18\x01\x20\x01(\tR\x04nameB\
    \x07\xfaB\x04r\x02\x10\x01\x129\n\x0ctyped_config\x18\x03\x20\x01(\x0b2\
    \x14.google.protobuf.AnyH\0R\x0btypedConfig\x12i\n\x0ffilter_disabled\
    \x18\x04\x20\x01(\x0b2@.envoy.config.listener.v4alpha.ListenerFilterChai\
    nMatchPredicateR\x0efilterDisabledB\r\n\x0bconfig_type:.\x9a\xc5\x88\x1e\
    )\n'envoy.config.listener.v3.ListenerFilterJ\x04\x08\x02\x10\x03R\x06con\
    figBP\n+io.envoyproxy.envoy.config.listener.v4alphaB\x17ListenerComponen\
    tsProtoP\x01\xba\x80\xc8\xd1\x06\x02\x10\x03b\x06proto3\
";
