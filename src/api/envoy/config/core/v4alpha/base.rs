...
//! Generated file from `envoy/config/core/v4alpha/base.proto`
...
impl Extension {
    ...
    // .envoy.config.core.v4alpha.BuildVersion version = 4;
...
impl Node {
    ...
    // .envoy.config.core.v4alpha.Locality locality = 4;
    ...
    // .envoy.config.core.v4alpha.BuildVersion user_agent_build_version = 8;
    ...
    // repeated .envoy.config.core.v4alpha.Extension extensions = 9;
...
impl Metadata {
    ...
    // repeated .envoy.config.core.v4alpha.Metadata.FilterMetadataEntry filter_metadata = 1;
...
impl HeaderValueOption {
    ...
    // .envoy.config.core.v4alpha.HeaderValue header = 1;
...
impl RetryPolicy {
    ...
    // .envoy.config.core.v4alpha.BackoffStrategy retry_back_off = 1;
...
impl RemoteDataSource {
    ...
    // .envoy.config.core.v4alpha.RetryPolicy retry_policy = 3;
...
impl AsyncDataSource {
    ...
    // .envoy.config.core.v4alpha.DataSource local = 1;
    ...
    // .envoy.config.core.v4alpha.RemoteDataSource remote = 2;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n$envoy/config/core/v4alpha/base.proto\x12\x19envoy.config.core.v4alpha\
    \x1a'envoy/config/core/v4alpha/backoff.proto\x1a(envoy/config/core/v4alp\
    ha/http_uri.proto\x1a\x1benvoy/type/v3/percent.proto\x1a$envoy/type/v3/s\
    emantic_version.proto\x1a\x19google/protobuf/any.proto\x1a\x1egoogle/pro\
    tobuf/duration.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1egoogle/p\
    rotobuf/wrappers.proto\x1a\x1dudpa/annotations/status.proto\x1a!udpa/ann\
    otations/versioning.proto\x1a\x17validate/validate.proto\"w\n\x08Localit\
    y\x12\x16\n\x06region\x18\x01\x20\x01(\tR\x06region\x12\x12\n\x04zone\
    \x18\x02\x20\x01(\tR\x04zone\x12\x19\n\x08sub_zone\x18\x03\x20\x01(\tR\
    \x07subZone:$\x9a\xc5\x88\x1e\x1f\n\x1denvoy.config.core.v3.Locality\"\
    \xa7\x01\n\x0cBuildVersion\x128\n\x07version\x18\x01\x20\x01(\x0b2\x1e.e\
    nvoy.type.v3.SemanticVersionR\x07version\x123\n\x08metadata\x18\x02\x20\
    \x01(\x0b2\x17.google.protobuf.StructR\x08metadata:(\x9a\xc5\x88\x1e#\n!\
    envoy.config.core.v3.BuildVersion\"\xea\x01\n\tExtension\x12\x12\n\x04na\
    me\x18\x01\x20\x01(\tR\x04name\x12\x1a\n\x08category\x18\x02\x20\x01(\tR\
    \x08category\x12'\n\x0ftype_descriptor\x18\x03\x20\x01(\tR\x0etypeDescri\
    ptor\x12A\n\x07version\x18\x04\x20\x01(\x0b2'.envoy.config.core.v4alpha.\
    BuildVersionR\x07version\x12\x1a\n\x08disabled\x18\x05\x20\x01(\x08R\x08\
    disabled:%\x9a\xc5\x88\x1e\x20\n\x1eenvoy.config.core.v3.Extension\"\xbe\
    \x04\n\x04Node\x12\x0e\n\x02id\x18\x01\x20\x01(\tR\x02id\x12\x18\n\x07cl\
    uster\x18\x02\x20\x01(\tR\x07cluster\x123\n\x08metadata\x18\x03\x20\x01(\
    \x0b2\x17.google.protobuf.StructR\x08metadata\x12?\n\x08locality\x18\x04\
    \x20\x01(\x0b2#.envoy.config.core.v4alpha.LocalityR\x08locality\x12&\n\
    \x0fuser_agent_name\x18\x06\x20\x01(\tR\ruserAgentName\x12.\n\x12user_ag\
    ent_version\x18\x07\x20\x01(\tH\0R\x10userAgentVersion\x12b\n\x18user_ag\
    ent_build_version\x18\x08\x20\x01(\x0b2'.envoy.config.core.v4alpha.Build\
    VersionH\0R\x15userAgentBuildVersion\x12D\n\nextensions\x18\t\x20\x03(\
    \x0b2$.envoy.config.core.v4alpha.ExtensionR\nextensions\x12'\n\x0fclient\
    _features\x18\n\x20\x03(\tR\x0eclientFeaturesB\x19\n\x17user_agent_versi\
    on_type:\x20\x9a\xc5\x88\x1e\x1b\n\x19envoy.config.core.v3.NodeJ\x04\x08\
    \x05\x10\x06J\x04\x08\x0b\x10\x0cR\rbuild_versionR\x13listening_addresse\
    s\"\xee\x01\n\x08Metadata\x12`\n\x0ffilter_metadata\x18\x01\x20\x03(\x0b\
    27.envoy.config.core.v4alpha.Metadata.FilterMetadataEntryR\x0efilterMeta\
    data\x1aZ\n\x13FilterMetadataEntry\x12\x10\n\x03key\x18\x01\x20\x01(\tR\
    \x03key\x12-\n\x05value\x18\x02\x20\x01(\x0b2\x17.google.protobuf.Struct\
    R\x05value:\x028\x01:$\x9a\xc5\x88\x1e\x1f\n\x1denvoy.config.core.v3.Met\
    adata\"\x89\x01\n\rRuntimeUInt32\x12#\n\rdefault_value\x18\x02\x20\x01(\
    \rR\x0cdefaultValue\x12(\n\x0bruntime_key\x18\x03\x20\x01(\tR\nruntimeKe\
    yB\x07\xfaB\x04r\x02\x10\x01:)\x9a\xc5\x88\x1e$\n\"envoy.config.core.v3.\
    RuntimeUInt32\"\xa3\x01\n\x0eRuntimePercent\x12;\n\rdefault_value\x18\
    \x01\x20\x01(\x0b2\x16.envoy.type.v3.PercentR\x0cdefaultValue\x12(\n\x0b\
    runtime_key\x18\x02\x20\x01(\tR\nruntimeKeyB\x07\xfaB\x04r\x02\x10\x01:*\
    \x9a\xc5\x88\x1e%\n#envoy.config.core.v3.RuntimePercent\"\x89\x01\n\rRun\
    timeDouble\x12#\n\rdefault_value\x18\x01\x20\x01(\x01R\x0cdefaultValue\
    \x12(\n\x0bruntime_key\x18\x02\x20\x01(\tR\nruntimeKeyB\x07\xfaB\x04r\
    \x02\x10\x01:)\x9a\xc5\x88\x1e$\n\"envoy.config.core.v3.RuntimeDouble\"\
    \xb9\x01\n\x12RuntimeFeatureFlag\x12I\n\rdefault_value\x18\x01\x20\x01(\
    \x0b2\x1a.google.protobuf.BoolValueR\x0cdefaultValueB\x08\xfaB\x05\x8a\
    \x01\x02\x10\x01\x12(\n\x0bruntime_key\x18\x02\x20\x01(\tR\nruntimeKeyB\
    \x07\xfaB\x04r\x02\x10\x01:.\x9a\xc5\x88\x1e)\n'envoy.config.core.v3.Run\
    timeFeatureFlag\"\x82\x01\n\x0bHeaderValue\x12#\n\x03key\x18\x01\x20\x01\
    (\tR\x03keyB\x11\xfaB\x0er\x0c\x10\x01(\x80\x80\x01\xc0\x01\x01\xc8\x01\
    \0\x12%\n\x05value\x18\x02\x20\x01(\tR\x05valueB\x0f\xfaB\x0cr\n(\x80\
    \x80\x01\xc0\x01\x02\xc8\x01\0:'\x9a\xc5\x88\x1e\"\n\x20envoy.config.cor\
    e.v3.HeaderValue\"\xc0\x01\n\x11HeaderValueOption\x12H\n\x06header\x18\
    \x01\x20\x01(\x0b2&.envoy.config.core.v4alpha.HeaderValueR\x06headerB\
    \x08\xfaB\x05\x8a\x01\x02\x10\x01\x122\n\x06append\x18\x02\x20\x01(\x0b2\
    \x1a.google.protobuf.BoolValueR\x06append:-\x9a\xc5\x88\x1e(\n&envoy.con\
    fig.core.v3.HeaderValueOption\"t\n\tHeaderMap\x12@\n\x07headers\x18\x01\
    \x20\x03(\x0b2&.envoy.config.core.v4alpha.HeaderValueR\x07headers:%\x9a\
    \xc5\x88\x1e\x20\n\x1eenvoy.config.core.v3.HeaderMap\"]\n\x10WatchedDire\
    ctory\x12\x1b\n\x04path\x18\x01\x20\x01(\tR\x04pathB\x07\xfaB\x04r\x02\
    \x10\x01:,\x9a\xc5\x88\x1e'\n%envoy.config.core.v3.WatchedDirectory\"\
    \xcb\x01\n\nDataSource\x12%\n\x08filename\x18\x01\x20\x01(\tH\0R\x08file\
    nameB\x07\xfaB\x04r\x02\x10\x01\x12,\n\x0cinline_bytes\x18\x02\x20\x01(\
    \x0cH\0R\x0binlineBytesB\x07\xfaB\x04z\x02\x10\x01\x12.\n\rinline_string\
    \x18\x03\x20\x01(\tH\0R\x0cinlineStringB\x07\xfaB\x04r\x02\x10\x01B\x10\
    \n\tspecifier\x12\x03\xf8B\x01:&\x9a\xc5\x88\x1e!\n\x1fenvoy.config.core\
    .v3.DataSource\"\xc7\x01\n\x0bRetryPolicy\x12P\n\x0eretry_back_off\x18\
    \x01\x20\x01(\x0b2*.envoy.config.core.v4alpha.BackoffStrategyR\x0cretryB\
    ackOff\x12=\n\x0bmax_retries\x18\x02\x20\x01(\x0b2\x1c.google.protobuf.U\
    Int32ValueR\nmaxRetries:'\x9a\xc5\x88\x1e\"\n\x20envoy.config.core.v3.Re\
    tryPolicy\"\xf5\x01\n\x10RemoteDataSource\x12G\n\x08http_uri\x18\x01\x20\
    \x01(\x0b2\".envoy.config.core.v4alpha.HttpUriR\x07httpUriB\x08\xfaB\x05\
    \x8a\x01\x02\x10\x01\x12\x1f\n\x06sha256\x18\x02\x20\x01(\tR\x06sha256B\
    \x07\xfaB\x04r\x02\x10\x01\x12I\n\x0cretry_policy\x18\x03\x20\x01(\x0b2&\
    .envoy.config.core.v4alpha.RetryPolicyR\x0bretryPolicy:,\x9a\xc5\x88\x1e\
    '\n%envoy.config.core.v3.RemoteDataSource\"\xd6\x01\n\x0fAsyncDataSource\
    \x12=\n\x05local\x18\x01\x20\x01(\x0b2%.envoy.config.core.v4alpha.DataSo\
    urceH\0R\x05local\x12E\n\x06remote\x18\x02\x20\x01(\x0b2+.envoy.config.c\
    ore.v4alpha.RemoteDataSourceH\0R\x06remoteB\x10\n\tspecifier\x12\x03\xf8\
    B\x01:+\x9a\xc5\x88\x1e&\n$envoy.config.core.v3.AsyncDataSource\"\xb3\
    ...
    \xc5\x88\x1e&\n$envoy.config.core.v3.TransportSocketJ\x04\x08\x02\x10\
    \x03R\x06config\"\xc2\x01\n\x18RuntimeFractionalPercent\x12O\n\rdefault_\
    value\x18\x01\x20\x01(\x0b2\x20.envoy.type.v3.FractionalPercentR\x0cdefa\
    ultValueB\x08\xfaB\x05\x8a\x01\x02\x10\x01\x12\x1f\n\x0bruntime_key\x18\
    \x02\x20\x01(\tR\nruntimeKey:4\x9a\xc5\x88\x1e/\n-envoy.config.core.v3.R\
    untimeFractionalPercent\"X\n\x0cControlPlane\x12\x1e\n\nidentifier\x18\
    \x01\x20\x01(\tR\nidentifier:(\x9a\xc5\x88\x1e#\n!envoy.config.core.v3.C\
    ...
    PECIFIED\x10\0\x12\x0b\n\x07INBOUND\x10\x01\x12\x0c\n\x08OUTBOUND\x10\
    \x02B>\n'io.envoyproxy.envoy.config.core.v4alphaB\tBaseProtoP\x01\xba\
