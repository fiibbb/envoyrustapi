...
//! Generated file from `envoy/config/core/v4alpha/config_source.proto`
...
impl ApiConfigSource {
    ...
    // .envoy.config.core.v4alpha.ApiConfigSource.ApiType api_type = 1;
    ...
    // .envoy.config.core.v4alpha.ApiVersion transport_api_version = 8;
    ...
    pub fn clear_transport_api_version(&mut self) {
        self.transport_api_version = ApiVersion::DEPRECATED_AND_UNAVAILABLE_DO_NOT_USE;
    }
    ...
    // repeated .envoy.config.core.v4alpha.GrpcService grpc_services = 4;
    ...
    // .envoy.config.core.v4alpha.RateLimitSettings rate_limit_settings = 6;
...
impl ::protobuf::Message for ApiConfigSource {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.transport_api_version != ApiVersion::DEPRECATED_AND_UNAVAILABLE_DO_NOT_USE {
...
impl SelfConfigSource {
    ...
    // .envoy.config.core.v4alpha.ApiVersion transport_api_version = 1;
...
impl ConfigSource {
    ...
    // .envoy.config.core.v4alpha.ApiConfigSource api_config_source = 2;
    ...
    // .envoy.config.core.v4alpha.AggregatedConfigSource ads = 3;
    ...
    // .envoy.config.core.v4alpha.SelfConfigSource self = 5;
    ...
    // .envoy.config.core.v4alpha.ApiVersion resource_api_version = 6;
    ...
    pub fn clear_resource_api_version(&mut self) {
        self.resource_api_version = ApiVersion::DEPRECATED_AND_UNAVAILABLE_DO_NOT_USE;
    }
...
impl ::protobuf::Message for ConfigSource {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.resource_api_version != ApiVersion::DEPRECATED_AND_UNAVAILABLE_DO_NOT_USE {
...
impl ::protobuf::ProtobufEnum for ApiVersion {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<ApiVersion> {
        match value {
            0 => ::std::option::Option::Some(ApiVersion::DEPRECATED_AND_UNAVAILABLE_DO_NOT_USE),
    ...
    fn values() -> &'static [Self] {
        static values: &'static [ApiVersion] = &[
            ApiVersion::DEPRECATED_AND_UNAVAILABLE_DO_NOT_USE,
            ApiVersion::V3,
        ];
        values
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n-envoy/config/core/v4alpha/config_source.proto\x12\x19envoy.config.cor\
    e.v4alpha\x1a,envoy/config/core/v4alpha/grpc_service.proto\x1a\x1egoogle\
    /protobuf/duration.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1bxd\
    s/core/v3/authority.proto\x1a#envoy/annotations/deprecation.proto\x1a\
    \x1dudpa/annotations/status.proto\x1a!udpa/annotations/versioning.proto\
    \x1a\x17validate/validate.proto\"\xb2\x06\n\x0fApiConfigSource\x12W\n\
    \x08api_type\x18\x01\x20\x01(\x0e22.envoy.config.core.v4alpha.ApiConfigS\
    ource.ApiTypeR\x07apiTypeB\x08\xfaB\x05\x82\x01\x02\x10\x01\x12c\n\x15tr\
    ansport_api_version\x18\x08\x20\x01(\x0e2%.envoy.config.core.v4alpha.Api\
    VersionR\x13transportApiVersionB\x08\xfaB\x05\x82\x01\x02\x10\x01\x12#\n\
    \rcluster_names\x18\x02\x20\x03(\tR\x0cclusterNames\x12K\n\rgrpc_service\
    s\x18\x04\x20\x03(\x0b2&.envoy.config.core.v4alpha.GrpcServiceR\x0cgrpcS\
    ervices\x12>\n\rrefresh_delay\x18\x03\x20\x01(\x0b2\x19.google.protobuf.\
    DurationR\x0crefreshDelay\x12L\n\x0frequest_timeout\x18\x05\x20\x01(\x0b\
    2\x19.google.protobuf.DurationR\x0erequestTimeoutB\x08\xfaB\x05\xaa\x01\
    \x02*\0\x12\\\n\x13rate_limit_settings\x18\x06\x20\x01(\x0b2,.envoy.conf\
    ig.core.v4alpha.RateLimitSettingsR\x11rateLimitSettings\x12A\n\x1eset_no\
    de_on_first_message_only\x18\x07\x20\x01(\x08R\x19setNodeOnFirstMessageO\
    nly\"\x92\x01\n\x07ApiType\x123\n%DEPRECATED_AND_UNAVAILABLE_DO_NOT_USE\
    \x10\0\x1a\x08\x08\x01\xa8\xf7\xb4\x8b\x02\x01\x12\x08\n\x04REST\x10\x01\
    \x12\x08\n\x04GRPC\x10\x02\x12\x0e\n\nDELTA_GRPC\x10\x03\x12\x13\n\x0fAG\
    GREGATED_GRPC\x10\x05\x12\x19\n\x15AGGREGATED_DELTA_GRPC\x10\x06:+\x9a\
    \xc5\x88\x1e&\n$envoy.config.core.v3.ApiConfigSource\"L\n\x16AggregatedC\
    onfigSource:2\x9a\xc5\x88\x1e-\n+envoy.config.core.v3.AggregatedConfigSo\
    urce\"\xa5\x01\n\x10SelfConfigSource\x12c\n\x15transport_api_version\x18\
    \x01\x20\x01(\x0e2%.envoy.config.core.v4alpha.ApiVersionR\x13transportAp\
    iVersionB\x08\xfaB\x05\x82\x01\x02\x10\x01:,\x9a\xc5\x88\x1e'\n%envoy.co\
    nfig.core.v3.SelfConfigSource\"\xca\x01\n\x11RateLimitSettings\x12;\n\nm\
    ax_tokens\x18\x01\x20\x01(\x0b2\x1c.google.protobuf.UInt32ValueR\tmaxTok\
    ens\x12I\n\tfill_rate\x18\x02\x20\x01(\x0b2\x1c.google.protobuf.DoubleVa\
    lueR\x08fillRateB\x0e\xfaB\x0b\x12\t!\0\0\0\0\0\0\0\0:-\x9a\xc5\x88\x1e(\
    \n&envoy.config.core.v3.RateLimitSettings\"\xbe\x04\n\x0cConfigSource\
    \x128\n\x0bauthorities\x18\x07\x20\x03(\x0b2\x16.xds.core.v3.AuthorityR\
    \x0bauthorities\x12\x14\n\x04path\x18\x01\x20\x01(\tH\0R\x04path\x12X\n\
    \x11api_config_source\x18\x02\x20\x01(\x0b2*.envoy.config.core.v4alpha.A\
    piConfigSourceH\0R\x0fapiConfigSource\x12E\n\x03ads\x18\x03\x20\x01(\x0b\
    21.envoy.config.core.v4alpha.AggregatedConfigSourceH\0R\x03ads\x12A\n\
    \x04self\x18\x05\x20\x01(\x0b2+.envoy.config.core.v4alpha.SelfConfigSour\
    ceH\0R\x04self\x12M\n\x15initial_fetch_timeout\x18\x04\x20\x01(\x0b2\x19\
    .google.protobuf.DurationR\x13initialFetchTimeout\x12a\n\x14resource_api\
    _version\x18\x06\x20\x01(\x0e2%.envoy.config.core.v4alpha.ApiVersionR\
    \x12resourceApiVersionB\x08\xfaB\x05\x82\x01\x02\x10\x01B\x1e\n\x17confi\
    g_source_specifier\x12\x03\xf8B\x01:(\x9a\xc5\x88\x1e#\n!envoy.config.co\
    re.v3.ConfigSource*M\n\nApiVersion\x12-\n%DEPRECATED_AND_UNAVAILABLE_DO_\
    NOT_USE\x10\0\x1a\x02\x08\x01\x12\x06\n\x02V3\x10\x02*\x02V2\"\x04\x08\
    \x01\x10\x01BF\n'io.envoyproxy.envoy.config.core.v4alphaB\x11ConfigSourc\
    eProtoP\x01\xba\x80\xc8\xd1\x06\x02\x10\x03b\x06proto3\
";
