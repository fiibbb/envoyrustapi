...
//! Generated file from `envoy/config/core/v4alpha/address.proto`
...
impl SocketAddress {
    ...
    // .envoy.config.core.v4alpha.SocketAddress.Protocol protocol = 1;
...
impl BindConfig {
    ...
    // .envoy.config.core.v4alpha.SocketAddress source_address = 1;
    ...
    // repeated .envoy.config.core.v4alpha.SocketOption socket_options = 3;
...
impl Address {
    ...
    // .envoy.config.core.v4alpha.SocketAddress socket_address = 1;
    ...
    // .envoy.config.core.v4alpha.Pipe pipe = 2;
    ...
    // .envoy.config.core.v4alpha.EnvoyInternalAddress envoy_internal_address = 3;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n'envoy/config/core/v4alpha/address.proto\x12\x19envoy.config.core.v4al\
    pha\x1a-envoy/config/core/v4alpha/socket_option.proto\x1a\x1egoogle/prot\
    obuf/wrappers.proto\x1a\x1dudpa/annotations/status.proto\x1a!udpa/annota\
    tions/versioning.proto\x1a\x17validate/validate.proto\"c\n\x04Pipe\x12\
    \x1b\n\x04path\x18\x01\x20\x01(\tR\x04pathB\x07\xfaB\x04r\x02\x10\x01\
    \x12\x1c\n\x04mode\x18\x02\x20\x01(\rR\x04modeB\x08\xfaB\x05*\x03\x18\
    \xff\x03:\x20\x9a\xc5\x88\x1e\x1b\n\x19envoy.config.core.v3.Pipe\"\x9b\
    \x01\n\x14EnvoyInternalAddress\x122\n\x14server_listener_name\x18\x01\
    \x20\x01(\tH\0R\x12serverListenerNameB\x1d\n\x16address_name_specifier\
    \x12\x03\xf8B\x01:0\x9a\xc5\x88\x1e+\n)envoy.config.core.v3.EnvoyInterna\
    lAddress\"\xfe\x02\n\rSocketAddress\x12W\n\x08protocol\x18\x01\x20\x01(\
    \x0e21.envoy.config.core.v4alpha.SocketAddress.ProtocolR\x08protocolB\
    \x08\xfaB\x05\x82\x01\x02\x10\x01\x12!\n\x07address\x18\x02\x20\x01(\tR\
    \x07addressB\x07\xfaB\x04r\x02\x10\x01\x12*\n\nport_value\x18\x03\x20\
    \x01(\rH\0R\tportValueB\t\xfaB\x06*\x04\x18\xff\xff\x03\x12\x1f\n\nnamed\
    _port\x18\x04\x20\x01(\tH\0R\tnamedPort\x12#\n\rresolver_name\x18\x05\
    \x20\x01(\tR\x0cresolverName\x12\x1f\n\x0bipv4_compat\x18\x06\x20\x01(\
    \x08R\nipv4Compat\"\x1c\n\x08Protocol\x12\x07\n\x03TCP\x10\0\x12\x07\n\
    \x03UDP\x10\x01B\x15\n\x0eport_specifier\x12\x03\xf8B\x01:)\x9a\xc5\x88\
    \x1e$\n\"envoy.config.core.v3.SocketAddress\"\x93\x02\n\x0cTcpKeepalive\
    \x12G\n\x10keepalive_probes\x18\x01\x20\x01(\x0b2\x1c.google.protobuf.UI\
    nt32ValueR\x0fkeepaliveProbes\x12C\n\x0ekeepalive_time\x18\x02\x20\x01(\
    \x0b2\x1c.google.protobuf.UInt32ValueR\rkeepaliveTime\x12K\n\x12keepaliv\
    e_interval\x18\x03\x20\x01(\x0b2\x1c.google.protobuf.UInt32ValueR\x11kee\
    paliveInterval:(\x9a\xc5\x88\x1e#\n!envoy.config.core.v3.TcpKeepalive\"\
    \x97\x02\n\nBindConfig\x12Y\n\x0esource_address\x18\x01\x20\x01(\x0b2(.e\
    nvoy.config.core.v4alpha.SocketAddressR\rsourceAddressB\x08\xfaB\x05\x8a\
    \x01\x02\x10\x01\x126\n\x08freebind\x18\x02\x20\x01(\x0b2\x1a.google.pro\
    tobuf.BoolValueR\x08freebind\x12N\n\x0esocket_options\x18\x03\x20\x03(\
    \x0b2'.envoy.config.core.v4alpha.SocketOptionR\rsocketOptions:&\x9a\xc5\
    \x88\x1e!\n\x1fenvoy.config.core.v3.BindConfig\"\xb1\x02\n\x07Address\
    \x12Q\n\x0esocket_address\x18\x01\x20\x01(\x0b2(.envoy.config.core.v4alp\
    ha.SocketAddressH\0R\rsocketAddress\x125\n\x04pipe\x18\x02\x20\x01(\x0b2\
    \x1f.envoy.config.core.v4alpha.PipeH\0R\x04pipe\x12g\n\x16envoy_internal\
    _address\x18\x03\x20\x01(\x0b2/.envoy.config.core.v4alpha.EnvoyInternalA\
    ddressH\0R\x14envoyInternalAddressB\x0e\n\x07address\x12\x03\xf8B\x01:#\
    \x9a\xc5\x88\x1e\x1e\n\x1cenvoy.config.core.v3.Address\"\xa9\x01\n\tCidr\
    Range\x12.\n\x0eaddress_prefix\x18\x01\x20\x01(\tR\raddressPrefixB\x07\
    \xfaB\x04r\x02\x10\x01\x12E\n\nprefix_len\x18\x02\x20\x01(\x0b2\x1c.goog\
    le.protobuf.UInt32ValueR\tprefixLenB\x08\xfaB\x05*\x03\x18\x80\x01:%\x9a\
    \xc5\x88\x1e\x20\n\x1eenvoy.config.core.v3.CidrRangeBA\n'io.envoyproxy.e\
    nvoy.config.core.v4alphaB\x0cAddressProtoP\x01\xba\x80\xc8\xd1\x06\x02\
    \x10\x03b\x06proto3\
";
