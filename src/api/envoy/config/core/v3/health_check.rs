...
//! Generated file from `envoy/config/core/v3/health_check.proto`
...
pub struct HealthCheck {
    ...
    pub no_traffic_healthy_interval: ::protobuf::SingularPtrField<::protobuf::well_known_types::Duration>,
    ...
    pub transport_socket_match_criteria: ::protobuf::SingularPtrField<::protobuf::well_known_types::Struct>,
...
impl HealthCheck {
    ...
    pub fn get_no_traffic_healthy_interval(&self) -> &::protobuf::well_known_types::Duration {
        self.no_traffic_healthy_interval.as_ref().unwrap_or_else(|| <::protobuf::well_known_types::Duration as ::protobuf::Message>::default_instance())
    }
    pub fn clear_no_traffic_healthy_interval(&mut self) {
        self.no_traffic_healthy_interval.clear();
    }

    pub fn has_no_traffic_healthy_interval(&self) -> bool {
        self.no_traffic_healthy_interval.is_some()
    }

    // Param is passed by value, moved
    pub fn set_no_traffic_healthy_interval(&mut self, v: ::protobuf::well_known_types::Duration) {
        self.no_traffic_healthy_interval = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_no_traffic_healthy_interval(&mut self) -> &mut ::protobuf::well_known_types::Duration {
        if self.no_traffic_healthy_interval.is_none() {
            self.no_traffic_healthy_interval.set_default();
        }
        self.no_traffic_healthy_interval.as_mut().unwrap()
    }

    // Take field
    pub fn take_no_traffic_healthy_interval(&mut self) -> ::protobuf::well_known_types::Duration {
        self.no_traffic_healthy_interval.take().unwrap_or_else(|| ::protobuf::well_known_types::Duration::new())
    }
    ...
    pub fn get_transport_socket_match_criteria(&self) -> &::protobuf::well_known_types::Struct {
        self.transport_socket_match_criteria.as_ref().unwrap_or_else(|| <::protobuf::well_known_types::Struct as ::protobuf::Message>::default_instance())
    }
    pub fn clear_transport_socket_match_criteria(&mut self) {
        self.transport_socket_match_criteria.clear();
    }

    pub fn has_transport_socket_match_criteria(&self) -> bool {
        self.transport_socket_match_criteria.is_some()
    }

    // Param is passed by value, moved
    pub fn set_transport_socket_match_criteria(&mut self, v: ::protobuf::well_known_types::Struct) {
        self.transport_socket_match_criteria = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_transport_socket_match_criteria(&mut self) -> &mut ::protobuf::well_known_types::Struct {
        if self.transport_socket_match_criteria.is_none() {
            self.transport_socket_match_criteria.set_default();
        }
        self.transport_socket_match_criteria.as_mut().unwrap()
    }

    // Take field
    pub fn take_transport_socket_match_criteria(&mut self) -> ::protobuf::well_known_types::Struct {
        self.transport_socket_match_criteria.take().unwrap_or_else(|| ::protobuf::well_known_types::Struct::new())
    }
}
...
impl ::protobuf::Message for HealthCheck {
    fn is_initialized(&self) -> bool {
        ...
        for v in &self.no_traffic_healthy_interval {
            if !v.is_initialized() {
                return false;
            }
        };
        ...
        for v in &self.transport_socket_match_criteria {
            if !v.is_initialized() {
                return false;
            }
        };
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                24 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.no_traffic_healthy_interval)?;
                },
                14 => {
                ...
                23 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.transport_socket_match_criteria)?;
                },
                _ => {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let Some(ref v) = self.no_traffic_healthy_interval.as_ref() {
            let len = v.compute_size();
            my_size += 2 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        }
        ...
        if let Some(ref v) = self.transport_socket_match_criteria.as_ref() {
            let len = v.compute_size();
            my_size += 2 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<::protobuf::well_known_types::Duration>>(
                ...
                |m: &HealthCheck| { &m.no_traffic_healthy_interval },
                |m: &mut HealthCheck| { &mut m.no_traffic_healthy_interval },
            ));
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<::protobuf::well_known_types::Duration>>(
                "unhealthy_interval",
            ...
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<::protobuf::well_known_types::Struct>>(
                ...
                |m: &HealthCheck| { &m.transport_socket_match_criteria },
                |m: &mut HealthCheck| { &mut m.transport_socket_match_criteria },
            ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n'envoy/config/core/v3/health_check.proto\x12\x14envoy.config.core.v3\
    \x1a\x1fenvoy/config/core/v3/base.proto\x1a/envoy/config/core/v3/event_s\
    ervice_config.proto\x1a\"envoy/type/matcher/v3/string.proto\x1a\x18envoy\
    /type/v3/http.proto\x1a\x19envoy/type/v3/range.proto\x1a\x19google/proto\
    buf/any.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1cgoogle/protob\
    uf/struct.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a#envoy/annotati\
    ons/deprecation.proto\x1a\x1dudpa/annotations/status.proto\x1a!udpa/anno\
    tations/versioning.proto\x1a\x17validate/validate.proto\"\xc6\x1b\n\x0bH\
    ealthCheck\x12?\n\x07timeout\x18\x01\x20\x01(\x0b2\x19.google.protobuf.D\
    urationR\x07timeoutB\n\xfaB\x07\xaa\x01\x04\x08\x01*\0\x12A\n\x08interva\
    l\x18\x02\x20\x01(\x0b2\x19.google.protobuf.DurationR\x08intervalB\n\xfa\
    B\x07\xaa\x01\x04\x08\x01*\0\x12@\n\x0einitial_jitter\x18\x14\x20\x01(\
    \x0b2\x19.google.protobuf.DurationR\rinitialJitter\x12B\n\x0finterval_ji\
    tter\x18\x03\x20\x01(\x0b2\x19.google.protobuf.DurationR\x0eintervalJitt\
    er\x126\n\x17interval_jitter_percent\x18\x12\x20\x01(\rR\x15intervalJitt\
    erPercent\x12W\n\x13unhealthy_threshold\x18\x04\x20\x01(\x0b2\x1c.google\
    .protobuf.UInt32ValueR\x12unhealthyThresholdB\x08\xfaB\x05\x8a\x01\x02\
    \x10\x01\x12S\n\x11healthy_threshold\x18\x05\x20\x01(\x0b2\x1c.google.pr\
    otobuf.UInt32ValueR\x10healthyThresholdB\x08\xfaB\x05\x8a\x01\x02\x10\
    \x01\x127\n\x08alt_port\x18\x06\x20\x01(\x0b2\x1c.google.protobuf.UInt32\
    ValueR\x07altPort\x12E\n\x10reuse_connection\x18\x07\x20\x01(\x0b2\x1a.g\
    oogle.protobuf.BoolValueR\x0freuseConnection\x12_\n\x11http_health_check\
    \x18\x08\x20\x01(\x0b21.envoy.config.core.v3.HealthCheck.HttpHealthCheck\
    H\0R\x0fhttpHealthCheck\x12\\\n\x10tcp_health_check\x18\t\x20\x01(\x0b20\
    .envoy.config.core.v3.HealthCheck.TcpHealthCheckH\0R\x0etcpHealthCheck\
    \x12_\n\x11grpc_health_check\x18\x0b\x20\x01(\x0b21.envoy.config.core.v3\
    .HealthCheck.GrpcHealthCheckH\0R\x0fgrpcHealthCheck\x12e\n\x13custom_hea\
    lth_check\x18\r\x20\x01(\x0b23.envoy.config.core.v3.HealthCheck.CustomHe\
    althCheckH\0R\x11customHealthCheck\x12S\n\x13no_traffic_interval\x18\x0c\
    \x20\x01(\x0b2\x19.google.protobuf.DurationR\x11noTrafficIntervalB\x08\
    \xfaB\x05\xaa\x01\x02*\0\x12b\n\x1bno_traffic_healthy_interval\x18\x18\
    \x20\x01(\x0b2\x19.google.protobuf.DurationR\x18noTrafficHealthyInterval\
    B\x08\xfaB\x05\xaa\x01\x02*\0\x12R\n\x12unhealthy_interval\x18\x0e\x20\
    \x01(\x0b2\x19.google.protobuf.DurationR\x11unhealthyIntervalB\x08\xfaB\
    \x05\xaa\x01\x02*\0\x12[\n\x17unhealthy_edge_interval\x18\x0f\x20\x01(\
    \x0b2\x19.google.protobuf.DurationR\x15unhealthyEdgeIntervalB\x08\xfaB\
    \x05\xaa\x01\x02*\0\x12W\n\x15healthy_edge_interval\x18\x10\x20\x01(\x0b\
    2\x19.google.protobuf.DurationR\x13healthyEdgeIntervalB\x08\xfaB\x05\xaa\
    \x01\x02*\0\x12$\n\x0eevent_log_path\x18\x11\x20\x01(\tR\x0ceventLogPath\
    \x12M\n\revent_service\x18\x16\x20\x01(\x0b2(.envoy.config.core.v3.Event\
    ServiceConfigR\x0ceventService\x12F\n\x20always_log_health_check_failure\
    s\x18\x13\x20\x01(\x08R\x1calwaysLogHealthCheckFailures\x12M\n\x0btls_op\
    tions\x18\x15\x20\x01(\x0b2,.envoy.config.core.v3.HealthCheck.TlsOptions\
    R\ntlsOptions\x12^\n\x1ftransport_socket_match_criteria\x18\x17\x20\x01(\
    \x0b2\x17.google.protobuf.StructR\x1ctransportSocketMatchCriteria\x1a\
    \x80\x01\n\x07Payload\x12\x1d\n\x04text\x18\x01\x20\x01(\tH\0R\x04textB\
    \x07\xfaB\x04r\x02\x10\x01\x12\x18\n\x06binary\x18\x02\x20\x01(\x0cH\0R\
    \x06binaryB\x0e\n\x07payload\x12\x03\xf8B\x01:,\x9a\xc5\x88\x1e'\n%envoy\
    .api.v2.core.HealthCheck.Payload\x1a\xe0\x05\n\x0fHttpHealthCheck\x12\
    \x1f\n\x04host\x18\x01\x20\x01(\tR\x04hostB\x0b\xfaB\x08r\x06\xc0\x01\
    \x02\xc8\x01\0\x12!\n\x04path\x18\x02\x20\x01(\tR\x04pathB\r\xfaB\nr\x08\
    \x10\x01\xc0\x01\x02\xc8\x01\0\x12=\n\x04send\x18\x03\x20\x01(\x0b2).env\
    oy.config.core.v3.HealthCheck.PayloadR\x04send\x12C\n\x07receive\x18\x04\
    \x20\x01(\x0b2).envoy.config.core.v3.HealthCheck.PayloadR\x07receive\x12\
    g\n\x16request_headers_to_add\x18\x06\x20\x03(\x0b2'.envoy.config.core.v\
    3.HeaderValueOptionR\x13requestHeadersToAddB\t\xfaB\x06\x92\x01\x03\x10\
    \xe8\x07\x12K\n\x19request_headers_to_remove\x18\x08\x20\x03(\tR\x16requ\
    estHeadersToRemoveB\x10\xfaB\r\x92\x01\n\"\x08r\x06\xc0\x01\x01\xc8\x01\
    \0\x12F\n\x11expected_statuses\x18\t\x20\x03(\x0b2\x19.envoy.type.v3.Int\
    64RangeR\x10expectedStatuses\x12T\n\x11codec_client_type\x18\n\x20\x01(\
    \x0e2\x1e.envoy.type.v3.CodecClientTypeR\x0fcodecClientTypeB\x08\xfaB\
    \x05\x82\x01\x02\x10\x01\x12V\n\x14service_name_matcher\x18\x0b\x20\x01(\
    \x0b2$.envoy.type.matcher.v3.StringMatcherR\x12serviceNameMatcher:4\x9a\
    \xc5\x88\x1e/\n-envoy.api.v2.core.HealthCheck.HttpHealthCheckJ\x04\x08\
    \x05\x10\x06J\x04\x08\x07\x10\x08R\x0cservice_nameR\tuse_http2\x1a\xc9\
    \x01\n\x0eTcpHealthCheck\x12=\n\x04send\x18\x01\x20\x01(\x0b2).envoy.con\
    fig.core.v3.HealthCheck.PayloadR\x04send\x12C\n\x07receive\x18\x02\x20\
    \x03(\x0b2).envoy.config.core.v3.HealthCheck.PayloadR\x07receive:3\x9a\
    \xc5\x88\x1e.\n,envoy.api.v2.core.HealthCheck.TcpHealthCheck\x1a[\n\x10R\
    edisHealthCheck\x12\x10\n\x03key\x18\x01\x20\x01(\tR\x03key:5\x9a\xc5\
    \x88\x1e0\n.envoy.api.v2.core.HealthCheck.RedisHealthCheck\x1a\x95\x01\n\
    \x0fGrpcHealthCheck\x12!\n\x0cservice_name\x18\x01\x20\x01(\tR\x0bservic\
    eName\x12)\n\tauthority\x18\x02\x20\x01(\tR\tauthorityB\x0b\xfaB\x08r\
    \x06\xc0\x01\x02\xc8\x01\0:4\x9a\xc5\x88\x1e/\n-envoy.api.v2.core.Health\
    Check.GrpcHealthCheck\x1a\xc0\x01\n\x11CustomHealthCheck\x12\x1b\n\x04na\
    me\x18\x01\x20\x01(\tR\x04nameB\x07\xfaB\x04r\x02\x10\x01\x129\n\x0ctype\
    d_config\x18\x03\x20\x01(\x0b2\x14.google.protobuf.AnyH\0R\x0btypedConfi\
    gB\r\n\x0bconfig_type:6\x9a\xc5\x88\x1e1\n/envoy.api.v2.core.HealthCheck\
    .CustomHealthCheckJ\x04\x08\x02\x10\x03R\x06config\x1ad\n\nTlsOptions\
    \x12%\n\x0ealpn_protocols\x18\x01\x20\x03(\tR\ralpnProtocols:/\x9a\xc5\
    \x88\x1e*\n(envoy.api.v2.core.HealthCheck.TlsOptionsB\x15\n\x0ehealth_ch\
    ecker\x12\x03\xf8B\x01:$\x9a\xc5\x88\x1e\x1f\n\x1denvoy.api.v2.core.Heal\
    thCheckJ\x04\x08\n\x10\x0b*`\n\x0cHealthStatus\x12\x0b\n\x07UNKNOWN\x10\
    \0\x12\x0b\n\x07HEALTHY\x10\x01\x12\r\n\tUNHEALTHY\x10\x02\x12\x0c\n\x08\
    DRAINING\x10\x03\x12\x0b\n\x07TIMEOUT\x10\x04\x12\x0c\n\x08DEGRADED\x10\
    \x05B@\n\"io.envoyproxy.envoy.config.core.v3B\x10HealthCheckProtoP\x01\
