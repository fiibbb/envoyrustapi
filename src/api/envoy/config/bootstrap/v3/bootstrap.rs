...
//! Generated file from `envoy/config/bootstrap/v3/bootstrap.proto`
...
impl Bootstrap {
    ...
    // .envoy.config.bootstrap.v3.Watchdog watchdog = 8;
    ...
    // .envoy.config.trace.v3.Tracing tracing = 9;
    ...
    // repeated .envoy.config.bootstrap.v3.Bootstrap.CertificateProviderInstancesEntry certificate_provider_instances = 25;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n)envoy/config/bootstrap/v3/bootstrap.proto\x12\x19envoy.config.bootstr\
    ap.v3\x1a%envoy/config/cluster/v3/cluster.proto\x1a\"envoy/config/core/v\
    3/address.proto\x1a\x1fenvoy/config/core/v3/base.proto\x1a(envoy/config/\
    core/v3/config_source.proto\x1a/envoy/config/core/v3/event_service_confi\
    g.proto\x1a$envoy/config/core/v3/extension.proto\x1a(envoy/config/core/v\
    3/socket_option.proto\x1a'envoy/config/listener/v3/listener.proto\x1a#en\
    voy/config/metrics/v3/stats.proto\x1a'envoy/config/overload/v3/overload.\
    proto\x1a'envoy/config/trace/v3/http_tracer.proto\x1a6envoy/extensions/t\
    ransport_sockets/tls/v3/secret.proto\x1a\x1benvoy/type/v3/percent.proto\
    ...
    on.proto\x1a\x1eudpa/annotations/migrate.proto\x1a\x1fudpa/annotations/s\
    ecurity.proto\x1a\x1dudpa/annotations/status.proto\x1a!udpa/annotations/\
    versioning.proto\x1a\x17validate/validate.proto\"\x83\x16\n\tBootstrap\
    \x12.\n\x04node\x18\x01\x20\x01(\x0b2\x1a.envoy.config.core.v3.NodeR\x04\
    node\x12.\n\x13node_context_params\x18\x1a\x20\x03(\tR\x11nodeContextPar\
    ams\x12_\n\x10static_resources\x18\x02\x20\x01(\x0b24.envoy.config.boots\
    trap.v3.Bootstrap.StaticResourcesR\x0fstaticResources\x12b\n\x11dynamic_\
    resources\x18\x03\x20\x01(\x0b25.envoy.config.bootstrap.v3.Bootstrap.Dyn\
    amicResourcesR\x10dynamicResources\x12R\n\x0fcluster_manager\x18\x04\x20\
    \x01(\x0b2).envoy.config.bootstrap.v3.ClusterManagerR\x0eclusterManager\
    \x12D\n\nhds_config\x18\x0e\x20\x01(\x0b2%.envoy.config.core.v3.ApiConfi\
    gSourceR\thdsConfig\x12\x1d\n\nflags_path\x18\x05\x20\x01(\tR\tflagsPath\
    \x12C\n\x0bstats_sinks\x18\x06\x20\x03(\x0b2\".envoy.config.metrics.v3.S\
    tatsSinkR\nstatsSinks\x12G\n\x0cstats_config\x18\r\x20\x01(\x0b2$.envoy.\
    config.metrics.v3.StatsConfigR\x0bstatsConfig\x12^\n\x14stats_flush_inte\
    rval\x18\x07\x20\x01(\x0b2\x19.google.protobuf.DurationR\x12statsFlushIn\
    tervalB\x11\xfaB\x0e\xaa\x01\x0b\x1a\x03\x08\xac\x022\x04\x10\xc0\x84=\
    \x12C\n\x08watchdog\x18\x08\x20\x01(\x0b2#.envoy.config.bootstrap.v3.Wat\
    chdogR\x08watchdogB\x02\x18\x01\x12B\n\twatchdogs\x18\x1b\x20\x01(\x0b2$\
    .envoy.config.bootstrap.v3.WatchdogsR\twatchdogs\x12<\n\x07tracing\x18\t\
    \x20\x01(\x0b2\x1e.envoy.config.trace.v3.TracingR\x07tracingB\x02\x18\
    \x01\x12R\n\x0flayered_runtime\x18\x11\x20\x01(\x0b2).envoy.config.boots\
    trap.v3.LayeredRuntimeR\x0elayeredRuntime\x126\n\x05admin\x18\x0c\x20\
    \x01(\x0b2\x20.envoy.config.bootstrap.v3.AdminR\x05admin\x12d\n\x10overl\
    oad_manager\x18\x0f\x20\x01(\x0b2).envoy.config.overload.v3.OverloadMana\
    gerR\x0foverloadManagerB\x0e\x8a\x93\xb7*\x02\x08\x01\x8a\x93\xb7*\x02\
    \x10\x01\x126\n\x17enable_dispatcher_stats\x18\x10\x20\x01(\x08R\x15enab\
    leDispatcherStats\x12#\n\rheader_prefix\x18\x12\x20\x01(\tR\x0cheaderPre\
    fix\x12_\n\x1dstats_server_version_override\x18\x13\x20\x01(\x0b2\x1c.go\
    ogle.protobuf.UInt64ValueR\x1astatsServerVersionOverride\x124\n\x17use_t\
    cp_for_dns_lookups\x18\x14\x20\x01(\x08R\x13useTcpForDnsLookups\x12]\n\
    \x14bootstrap_extensions\x18\x15\x20\x03(\x0b2*.envoy.config.core.v3.Typ\
    edExtensionConfigR\x13bootstrapExtensions\x12K\n\rfatal_actions\x18\x1c\
    \x20\x03(\x0b2&.envoy.config.bootstrap.v3.FatalActionR\x0cfatalActions\
    \x12I\n\x0econfig_sources\x18\x16\x20\x03(\x0b2\".envoy.config.core.v3.C\
    onfigSourceR\rconfigSources\x12V\n\x15default_config_source\x18\x17\x20\
    \x01(\x0b2\".envoy.config.core.v3.ConfigSourceR\x13defaultConfigSource\
    \x128\n\x18default_socket_interface\x18\x18\x20\x01(\tR\x16defaultSocket\
    Interface\x12\x8c\x01\n\x1ecertificate_provider_instances\x18\x19\x20\
    \x03(\x0b2F.envoy.config.bootstrap.v3.Bootstrap.CertificateProviderInsta\
    ncesEntryR\x1ccertificateProviderInstances\x1a\x9a\x02\n\x0fStaticResour\
    ces\x12@\n\tlisteners\x18\x01\x20\x03(\x0b2\".envoy.config.listener.v3.L\
    istenerR\tlisteners\x12<\n\x08clusters\x18\x02\x20\x03(\x0b2\x20.envoy.c\
    onfig.cluster.v3.ClusterR\x08clusters\x12K\n\x07secrets\x18\x03\x20\x03(\
    \x0b21.envoy.extensions.transport_sockets.tls.v3.SecretR\x07secrets::\
    \x9a\xc5\x88\x1e5\n3envoy.config.bootstrap.v2.Bootstrap.StaticResources\
    \x1a\x89\x03\n\x10DynamicResources\x12A\n\nlds_config\x18\x01\x20\x01(\
    \x0b2\".envoy.config.core.v3.ConfigSourceR\tldsConfig\x122\n\x15lds_reso\
    urces_locator\x18\x05\x20\x01(\tR\x13ldsResourcesLocator\x12A\n\ncds_con\
    fig\x18\x02\x20\x01(\x0b2\".envoy.config.core.v3.ConfigSourceR\tcdsConfi\
    g\x122\n\x15cds_resources_locator\x18\x06\x20\x01(\tR\x13cdsResourcesLoc\
    ator\x12D\n\nads_config\x18\x03\x20\x01(\x0b2%.envoy.config.core.v3.ApiC\
    onfigSourceR\tadsConfig:;\x9a\xc5\x88\x1e6\n4envoy.config.bootstrap.v2.B\
    ootstrap.DynamicResourcesJ\x04\x08\x04\x10\x05\x1a{\n!CertificateProvide\
    rInstancesEntry\x12\x10\n\x03key\x18\x01\x20\x01(\tR\x03key\x12@\n\x05va\
    lue\x18\x02\x20\x01(\x0b2*.envoy.config.core.v3.TypedExtensionConfigR\
    \x05value:\x028\x01:*\x9a\xc5\x88\x1e%\n#envoy.config.bootstrap.v2.Boots\
    trapJ\x04\x08\n\x10\x0bJ\x04\x08\x0b\x10\x0cR\x07runtime\"\xfe\x01\n\x05\
    Admin\x12&\n\x0faccess_log_path\x18\x01\x20\x01(\tR\raccessLogPath\x12!\
    \n\x0cprofile_path\x18\x02\x20\x01(\tR\x0bprofilePath\x127\n\x07address\
    \x18\x03\x20\x01(\x0b2\x1d.envoy.config.core.v3.AddressR\x07address\x12I\
    \n\x0esocket_options\x18\x04\x20\x03(\x0b2\".envoy.config.core.v3.Socket\
    OptionR\rsocketOptions:&\x9a\xc5\x88\x1e!\n\x1fenvoy.config.bootstrap.v2\
    .Admin\"\xcb\x04\n\x0eClusterManager\x12,\n\x12local_cluster_name\x18\
    \x01\x20\x01(\tR\x10localClusterName\x12g\n\x11outlier_detection\x18\x02\
    \x20\x01(\x0b2:.envoy.config.bootstrap.v3.ClusterManager.OutlierDetectio\
    nR\x10outlierDetection\x12R\n\x14upstream_bind_config\x18\x03\x20\x01(\
    \x0b2\x20.envoy.config.core.v3.BindConfigR\x12upstreamBindConfig\x12Q\n\
    \x11load_stats_config\x18\x04\x20\x01(\x0b2%.envoy.config.core.v3.ApiCon\
    figSourceR\x0floadStatsConfig\x1a\xc9\x01\n\x10OutlierDetection\x12$\n\
    \x0eevent_log_path\x18\x01\x20\x01(\tR\x0ceventLogPath\x12M\n\revent_ser\
    vice\x18\x02\x20\x01(\x0b2(.envoy.config.core.v3.EventServiceConfigR\x0c\
    eventService:@\x9a\xc5\x88\x1e;\n9envoy.config.bootstrap.v2.ClusterManag\
    er.OutlierDetection:/\x9a\xc5\x88\x1e*\n(envoy.config.bootstrap.v2.Clust\
    erManager\"\xb0\x01\n\tWatchdogs\x12U\n\x14main_thread_watchdog\x18\x01\
    \x20\x01(\x0b2#.envoy.config.bootstrap.v3.WatchdogR\x12mainThreadWatchdo\
    g\x12L\n\x0fworker_watchdog\x18\x02\x20\x01(\x0b2#.envoy.config.bootstra\
    p.v3.WatchdogR\x0eworkerWatchdog\"\xba\x06\n\x08Watchdog\x12L\n\x07actio\
    ns\x18\x07\x20\x03(\x0b22.envoy.config.bootstrap.v3.Watchdog.WatchdogAct\
    ionR\x07actions\x12<\n\x0cmiss_timeout\x18\x01\x20\x01(\x0b2\x19.google.\
    protobuf.DurationR\x0bmissTimeout\x12D\n\x10megamiss_timeout\x18\x02\x20\
    ...
    meout\x12Z\n\x17max_kill_timeout_jitter\x18\x06\x20\x01(\x0b2\x19.google\
    .protobuf.DurationR\x14maxKillTimeoutJitterB\x08\xfaB\x05\xaa\x01\x022\0\
    \x12F\n\x11multikill_timeout\x18\x04\x20\x01(\x0b2\x19.google.protobuf.D\
    urationR\x10multikillTimeout\x12G\n\x13multikill_threshold\x18\x05\x20\
    \x01(\x0b2\x16.envoy.type.v3.PercentR\x12multikillThreshold\x1a\x85\x02\
    \n\x0eWatchdogAction\x12B\n\x06config\x18\x01\x20\x01(\x0b2*.envoy.confi\
    g.core.v3.TypedExtensionConfigR\x06config\x12`\n\x05event\x18\x02\x20\
    \x01(\x0e2@.envoy.config.bootstrap.v3.Watchdog.WatchdogAction.WatchdogEv\
    entR\x05eventB\x08\xfaB\x05\x82\x01\x02\x10\x01\"M\n\rWatchdogEvent\x12\
    \x0b\n\x07UNKNOWN\x10\0\x12\x08\n\x04KILL\x10\x01\x12\r\n\tMULTIKILL\x10\
    \x02\x12\x0c\n\x08MEGAMISS\x10\x03\x12\x08\n\x04MISS\x10\x04:)\x9a\xc5\
    \x88\x1e$\n\"envoy.config.bootstrap.v2.Watchdog\"Q\n\x0bFatalAction\x12B\
    \n\x06config\x18\x01\x20\x01(\x0b2*.envoy.config.core.v3.TypedExtensionC\
    onfigR\x06config\"\xdc\x01\n\x07Runtime\x12!\n\x0csymlink_root\x18\x01\
    \x20\x01(\tR\x0bsymlinkRoot\x12\"\n\x0csubdirectory\x18\x02\x20\x01(\tR\
    \x0csubdirectory\x123\n\x15override_subdirectory\x18\x03\x20\x01(\tR\x14\
    overrideSubdirectory\x12+\n\x04base\x18\x04\x20\x01(\x0b2\x17.google.pro\
    tobuf.StructR\x04base:(\x9a\xc5\x88\x1e#\n!envoy.config.bootstrap.v2.Run\
    time\"\xdb\x06\n\x0cRuntimeLayer\x12\x1b\n\x04name\x18\x01\x20\x01(\tR\
    \x04nameB\x07\xfaB\x04r\x02\x10\x01\x12<\n\x0cstatic_layer\x18\x02\x20\
    \x01(\x0b2\x17.google.protobuf.StructH\0R\x0bstaticLayer\x12R\n\ndisk_la\
    yer\x18\x03\x20\x01(\x0b21.envoy.config.bootstrap.v3.RuntimeLayer.DiskLa\
    yerH\0R\tdiskLayer\x12U\n\x0badmin_layer\x18\x04\x20\x01(\x0b22.envoy.co\
    nfig.bootstrap.v3.RuntimeLayer.AdminLayerH\0R\nadminLayer\x12R\n\nrtds_l\
    ayer\x18\x05\x20\x01(\x0b21.envoy.config.bootstrap.v3.RuntimeLayer.RtdsL\
    ayerH\0R\trtdsLayer\x1a\xc1\x01\n\tDiskLayer\x12!\n\x0csymlink_root\x18\
    \x01\x20\x01(\tR\x0bsymlinkRoot\x12\"\n\x0csubdirectory\x18\x03\x20\x01(\
    \tR\x0csubdirectory\x124\n\x16append_service_cluster\x18\x02\x20\x01(\
    \x08R\x14appendServiceCluster:7\x9a\xc5\x88\x1e2\n0envoy.config.bootstra\
    p.v2.RuntimeLayer.DiskLayer\x1aF\n\nAdminLayer:8\x9a\xc5\x88\x1e3\n1envo\
    y.config.bootstrap.v2.RuntimeLayer.AdminLayer\x1a\x9d\x01\n\tRtdsLayer\
    \x12\x12\n\x04name\x18\x01\x20\x01(\tR\x04name\x12C\n\x0brtds_config\x18\
    \x02\x20\x01(\x0b2\".envoy.config.core.v3.ConfigSourceR\nrtdsConfig:7\
    \x9a\xc5\x88\x1e2\n0envoy.config.bootstrap.v2.RuntimeLayer.RtdsLayerB\
    \x16\n\x0flayer_specifier\x12\x03\xf8B\x01:-\x9a\xc5\x88\x1e(\n&envoy.co\
    nfig.bootstrap.v2.RuntimeLayer\"\x82\x01\n\x0eLayeredRuntime\x12?\n\x06l\
    ayers\x18\x01\x20\x03(\x0b2'.envoy.config.bootstrap.v3.RuntimeLayerR\x06\
    layers:/\x9a\xc5\x88\x1e*\n(envoy.config.bootstrap.v2.LayeredRuntimeBC\n\
    'io.envoyproxy.envoy.config.bootstrap.v3B\x0eBootstrapProtoP\x01\xba\x80\
