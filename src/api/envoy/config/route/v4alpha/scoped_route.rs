...
//! Generated file from `envoy/config/route/v4alpha/scoped_route.proto`
...
impl ScopedRouteConfiguration {
    ...
    // .envoy.config.route.v4alpha.ScopedRouteConfiguration.Key key = 3;
...
impl ScopedRouteConfiguration_Key {
    ...
    // repeated .envoy.config.route.v4alpha.ScopedRouteConfiguration.Key.Fragment fragments = 1;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n-envoy/config/route/v4alpha/scoped_route.proto\x12\x1aenvoy.config.rou\
    te.v4alpha\x1a\x1dudpa/annotations/status.proto\x1a!udpa/annotations/ver\
    sioning.proto\x1a\x17validate/validate.proto\"\xd0\x04\n\x18ScopedRouteC\
    onfiguration\x12\x1b\n\ton_demand\x18\x04\x20\x01(\x08R\x08onDemand\x12\
    \x1b\n\x04name\x18\x01\x20\x01(\tR\x04nameB\x07\xfaB\x04r\x02\x10\x01\
    \x12A\n\x18route_configuration_name\x18\x02\x20\x01(\tR\x16routeConfigur\
    ationNameB\x07\xfaB\x04r\x02\x10\x01\x12T\n\x03key\x18\x03\x20\x01(\x0b2\
    8.envoy.config.route.v4alpha.ScopedRouteConfiguration.KeyR\x03keyB\x08\
    \xfaB\x05\x8a\x01\x02\x10\x01\x1a\xa9\x02\n\x03Key\x12i\n\tfragments\x18\
    \x01\x20\x03(\x0b2A.envoy.config.route.v4alpha.ScopedRouteConfiguration.\
    Key.FragmentR\tfragmentsB\x08\xfaB\x05\x92\x01\x02\x08\x01\x1a|\n\x08Fra\
    gment\x12\x1f\n\nstring_key\x18\x01\x20\x01(\tH\0R\tstringKeyB\x0b\n\x04\
    type\x12\x03\xf8B\x01:B\x9a\xc5\x88\x1e=\n;envoy.config.route.v3.ScopedR\
    outeConfiguration.Key.Fragment:9\x9a\xc5\x88\x1e4\n2envoy.config.route.v\
    3.ScopedRouteConfiguration.Key:5\x9a\xc5\x88\x1e0\n.envoy.config.route.v\
    3.ScopedRouteConfigurationBF\n(io.envoyproxy.envoy.config.route.v4alphaB\
    \x10ScopedRouteProtoP\x01\xba\x80\xc8\xd1\x06\x02\x10\x03b\x06proto3\
";
