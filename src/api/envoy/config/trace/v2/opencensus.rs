...
//! Generated file from `envoy/config/trace/v2/opencensus.proto`
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n&envoy/config/trace/v2/opencensus.proto\x12\x15envoy.config.trace.v2\
    \x1a$envoy/api/v2/core/grpc_service.proto\x1a,opencensus/proto/trace/v1/\
    trace_config.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/\
    validate.proto\"\xe4\x07\n\x10OpenCensusConfig\x12I\n\x0ctrace_config\
    \x18\x01\x20\x01(\x0b2&.opencensus.proto.trace.v1.TraceConfigR\x0btraceC\
    onfig\x126\n\x17stdout_exporter_enabled\x18\x02\x20\x01(\x08R\x15stdoutE\
    xporterEnabled\x12@\n\x1cstackdriver_exporter_enabled\x18\x03\x20\x01(\
    \x08R\x1astackdriverExporterEnabled\x124\n\x16stackdriver_project_id\x18\
    \x04\x20\x01(\tR\x14stackdriverProjectId\x12/\n\x13stackdriver_address\
    \x18\n\x20\x01(\tR\x12stackdriverAddress\x12X\n\x18stackdriver_grpc_serv\
    ice\x18\r\x20\x01(\x0b2\x1e.envoy.api.v2.core.GrpcServiceR\x16stackdrive\
    rGrpcService\x126\n\x17zipkin_exporter_enabled\x18\x05\x20\x01(\x08R\x15\
    zipkinExporterEnabled\x12\x1d\n\nzipkin_url\x18\x06\x20\x01(\tR\tzipkinU\
    rl\x128\n\x18ocagent_exporter_enabled\x18\x0b\x20\x01(\x08R\x16ocagentEx\
    porterEnabled\x12'\n\x0focagent_address\x18\x0c\x20\x01(\tR\x0eocagentAd\
    dress\x12P\n\x14ocagent_grpc_service\x18\x0e\x20\x01(\x0b2\x1e.envoy.api\
    .v2.core.GrpcServiceR\x12ocagentGrpcService\x12j\n\x16incoming_trace_con\
    text\x18\x08\x20\x03(\x0e24.envoy.config.trace.v2.OpenCensusConfig.Trace\
    ContextR\x14incomingTraceContext\x12j\n\x16outgoing_trace_context\x18\t\
    \x20\x03(\x0e24.envoy.config.trace.v2.OpenCensusConfig.TraceContextR\x14\
    outgoingTraceContext\"`\n\x0cTraceContext\x12\x08\n\x04NONE\x10\0\x12\
    \x11\n\rTRACE_CONTEXT\x10\x01\x12\x12\n\x0eGRPC_TRACE_BIN\x10\x02\x12\
    \x17\n\x13CLOUD_TRACE_CONTEXT\x10\x03\x12\x06\n\x02B3\x10\x04J\x04\x08\
    \x07\x10\x08B@\n#io.envoyproxy.envoy.config.trace.v2B\x0fOpencensusProto\
