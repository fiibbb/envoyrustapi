...
//! Generated file from `envoy/config/filter/http/fault/v2/fault.proto`
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n-envoy/config/filter/http/fault/v2/fault.proto\x12!envoy.config.filter\
    .http.fault.v2\x1a)envoy/api/v2/route/route_components.proto\x1a(envoy/c\
    onfig/filter/fault/v2/fault.proto\x1a\x18envoy/type/percent.proto\x1a\
    ...
    \x83\x02\n\nFaultAbort\x12.\n\x0bhttp_status\x18\x02\x20\x01(\rH\0R\nhtt\
    pStatusB\x0b\xfaB\x08*\x06\x10\xd8\x04(\xc8\x01\x12^\n\x0cheader_abort\
    \x18\x04\x20\x01(\x0b29.envoy.config.filter.http.fault.v2.FaultAbort.Hea\
    derAbortH\0R\x0bheaderAbort\x12=\n\npercentage\x18\x03\x20\x01(\x0b2\x1d\
    .envoy.type.FractionalPercentR\npercentage\x1a\r\n\x0bHeaderAbortB\x11\n\
    \nerror_type\x12\x03\xf8B\x01J\x04\x08\x01\x10\x02\"\xad\x06\n\tHTTPFaul\
    t\x12>\n\x05delay\x18\x01\x20\x01(\x0b2(.envoy.config.filter.fault.v2.Fa\
    ultDelayR\x05delay\x12C\n\x05abort\x18\x02\x20\x01(\x0b2-.envoy.config.f\
    ilter.http.fault.v2.FaultAbortR\x05abort\x12)\n\x10upstream_cluster\x18\
    \x03\x20\x01(\tR\x0fupstreamCluster\x12;\n\x07headers\x18\x04\x20\x03(\
    \x0b2!.envoy.api.v2.route.HeaderMatcherR\x07headers\x12)\n\x10downstream\
    _nodes\x18\x05\x20\x03(\tR\x0fdownstreamNodes\x12H\n\x11max_active_fault\
    s\x18\x06\x20\x01(\x0b2\x1c.google.protobuf.UInt32ValueR\x0fmaxActiveFau\
    lts\x12\\\n\x13response_rate_limit\x18\x07\x20\x01(\x0b2,.envoy.config.f\
    ilter.fault.v2.FaultRateLimitR\x11responseRateLimit\x122\n\x15delay_perc\
    ent_runtime\x18\x08\x20\x01(\tR\x13delayPercentRuntime\x122\n\x15abort_p\
    ercent_runtime\x18\t\x20\x01(\tR\x13abortPercentRuntime\x124\n\x16delay_\
    duration_runtime\x18\n\x20\x01(\tR\x14delayDurationRuntime\x129\n\x19abo\
    rt_http_status_runtime\x18\x0b\x20\x01(\tR\x16abortHttpStatusRuntime\x12\
    9\n\x19max_active_faults_runtime\x18\x0c\x20\x01(\tR\x16maxActiveFaultsR\
    untime\x12L\n#response_rate_limit_percent_runtime\x18\r\x20\x01(\tR\x1fr\
    esponseRateLimitPercentRuntimeBu\n/io.envoyproxy.envoy.config.filter.htt\
    p.fault.v2B\nFaultProtoP\x01\xf2\x98\xfe\x8f\x05(\x12&envoy.extensions.f\
    ilters.http.fault.v3\xba\x80\xc8\xd1\x06\x02\x10\x01b\x06proto3\
";
