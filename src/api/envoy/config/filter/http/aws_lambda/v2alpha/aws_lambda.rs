...
//! Generated file from `envoy/config/filter/http/aws_lambda/v2alpha/aws_lambda.proto`
...
impl Config {
    ...
    // .envoy.config.filter.http.aws_lambda.v2alpha.Config.InvocationMode invocation_mode = 3;
...
impl PerRouteConfig {
    ...
    // .envoy.config.filter.http.aws_lambda.v2alpha.Config invoke_config = 1;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n<envoy/config/filter/http/aws_lambda/v2alpha/aws_lambda.proto\x12+envo\
    y.config.filter.http.aws_lambda.v2alpha\x1a\x1eudpa/annotations/migrate.\
    ...
    \x0e2B.envoy.config.filter.http.aws_lambda.v2alpha.Config.InvocationMode\
    R\x0einvocationModeB\x08\xfaB\x05\x82\x01\x02\x10\x01\"3\n\x0eInvocation\
    Mode\x12\x0f\n\x0bSYNCHRONOUS\x10\0\x12\x10\n\x0cASYNCHRONOUS\x10\x01\"j\
