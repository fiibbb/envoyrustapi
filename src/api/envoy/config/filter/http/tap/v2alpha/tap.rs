...
//! Generated file from `envoy/config/filter/http/tap/v2alpha/tap.proto`
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n.envoy/config/filter/http/tap/v2alpha/tap.proto\x12$envoy.config.filte\
    r.http.tap.v2alpha\x1a,envoy/config/common/tap/v2alpha/common.proto\x1a\
