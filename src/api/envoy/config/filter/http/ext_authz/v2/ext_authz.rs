...
//! Generated file from `envoy/config/filter/http/ext_authz/v2/ext_authz.proto`
...
impl ExtAuthz {
    ...
    pub fn clear_use_alpha(&mut self) {
        self.use_alpha = false;
    }

    // Param is passed by value, moved
    pub fn set_use_alpha(&mut self, v: bool) {
        self.use_alpha = v;
    }
...
impl ::protobuf::Message for ExtAuthz {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.use_alpha != false {
            os.write_bool(4, self.use_alpha)?;
        }
        if let Some(ref v) = self.with_request_body.as_ref() {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBool>(
                "use_alpha",
                |m: &ExtAuthz| { &m.use_alpha },
                |m: &mut ExtAuthz| { &mut m.use_alpha },
            ));
...
impl CheckSettings {
    ...
    // repeated .envoy.config.filter.http.ext_authz.v2.CheckSettings.ContextExtensionsEntry context_extensions = 1;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n5envoy/config/filter/http/ext_authz/v2/ext_authz.proto\x12%envoy.confi\
    g.filter.http.ext_authz.v2\x1a\x1cenvoy/api/v2/core/base.proto\x1a$envoy\
    /api/v2/core/grpc_service.proto\x1a\x20envoy/api/v2/core/http_uri.proto\
    \x1a\x1cenvoy/type/http_status.proto\x1a\x1fenvoy/type/matcher/string.pr\
    ...
    \x0b2\x1e.envoy.api.v2.core.GrpcServiceH\0R\x0bgrpcService\x12W\n\x0chtt\
    p_service\x18\x03\x20\x01(\x0b22.envoy.config.filter.http.ext_authz.v2.H\
    ttpServiceH\0R\x0bhttpService\x12,\n\x12failure_mode_allow\x18\x02\x20\
    \x01(\x08R\x10failureModeAllow\x12%\n\tuse_alpha\x18\x04\x20\x01(\x08R\
    \x08useAlphaB\x08\x18\x01\xb8\xee\xf2\xd2\x05\x01\x12a\n\x11with_request\
    _body\x18\x05\x20\x01(\x0b25.envoy.config.filter.http.ext_authz.v2.Buffe\
    rSettingsR\x0fwithRequestBody\x12*\n\x11clear_route_cache\x18\x06\x20\
    \x01(\x08R\x0fclearRouteCache\x12>\n\x0fstatus_on_error\x18\x07\x20\x01(\
    \x0b2\x16.envoy.type.HttpStatusR\rstatusOnError\x12>\n\x1bmetadata_conte\
    xt_namespaces\x18\x08\x20\x03(\tR\x19metadataContextNamespaces\x12R\n\
    \x0efilter_enabled\x18\t\x20\x01(\x0b2+.envoy.api.v2.core.RuntimeFractio\
    nalPercentR\rfilterEnabled\x12M\n\x0fdeny_at_disable\x18\x0b\x20\x01(\
    \x0b2%.envoy.api.v2.core.RuntimeFeatureFlagR\rdenyAtDisable\x128\n\x18in\
    clude_peer_certificate\x18\n\x20\x01(\x08R\x16includePeerCertificateB\n\
    \n\x08services\"y\n\x0eBufferSettings\x123\n\x11max_request_bytes\x18\
    \x01\x20\x01(\rR\x0fmaxRequestBytesB\x07\xfaB\x04*\x02\x20\0\x122\n\x15a\
    llow_partial_message\x18\x02\x20\x01(\x08R\x13allowPartialMessage\"\xe8\
    \x02\n\x0bHttpService\x129\n\nserver_uri\x18\x01\x20\x01(\x0b2\x1a.envoy\
    .api.v2.core.HttpUriR\tserverUri\x12\x1f\n\x0bpath_prefix\x18\x02\x20\
    \x01(\tR\npathPrefix\x12p\n\x15authorization_request\x18\x07\x20\x01(\
    \x0b2;.envoy.config.filter.http.ext_authz.v2.AuthorizationRequestR\x14au\
    thorizationRequest\x12s\n\x16authorization_response\x18\x08\x20\x01(\x0b\
    2<.envoy.config.filter.http.ext_authz.v2.AuthorizationResponseR\x15autho\
    rizationResponseJ\x04\x08\x03\x10\x04J\x04\x08\x04\x10\x05J\x04\x08\x05\
    \x10\x06J\x04\x08\x06\x10\x07\"\xac\x01\n\x14AuthorizationRequest\x12N\n\
    \x0fallowed_headers\x18\x01\x20\x01(\x0b2%.envoy.type.matcher.ListString\
    MatcherR\x0eallowedHeaders\x12D\n\x0eheaders_to_add\x18\x02\x20\x03(\x0b\
    2\x1e.envoy.api.v2.core.HeaderValueR\x0cheadersToAdd\"\xd5\x01\n\x15Auth\
    orizationResponse\x12_\n\x18allowed_upstream_headers\x18\x01\x20\x01(\
    \x0b2%.envoy.type.matcher.ListStringMatcherR\x16allowedUpstreamHeaders\
    \x12[\n\x16allowed_client_headers\x18\x02\x20\x01(\x0b2%.envoy.type.matc\
    her.ListStringMatcherR\x14allowedClientHeaders\"\xb3\x01\n\x10ExtAuthzPe\
    rRoute\x12%\n\x08disabled\x18\x01\x20\x01(\x08H\0R\x08disabledB\x07\xfaB\
    \x04j\x02\x08\x01\x12g\n\x0echeck_settings\x18\x02\x20\x01(\x0b24.envoy.\
    config.filter.http.ext_authz.v2.CheckSettingsH\0R\rcheckSettingsB\x08\
    \xfaB\x05\x8a\x01\x02\x10\x01B\x0f\n\x08override\x12\x03\xf8B\x01\"\xd1\
    \x01\n\rCheckSettings\x12z\n\x12context_extensions\x18\x01\x20\x03(\x0b2\
    K.envoy.config.filter.http.ext_authz.v2.CheckSettings.ContextExtensionsE\
