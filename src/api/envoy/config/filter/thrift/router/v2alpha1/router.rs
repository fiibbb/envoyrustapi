...
//! Generated file from `envoy/config/filter/thrift/router/v2alpha1/router.proto`
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n7envoy/config/filter/thrift/router/v2alpha1/router.proto\x12*envoy.con\
    fig.filter.thrift.router.v2alpha1\x1a\x1dudpa/annotations/status.proto\"\
    \x08\n\x06RouterBQ\n8io.envoyproxy.envoy.config.filter.thrift.router.v2a\
    lpha1B\x0bRouterProtoP\x01\xba\x80\xc8\xd1\x06\x02\x10\x02b\x06proto3\
";
