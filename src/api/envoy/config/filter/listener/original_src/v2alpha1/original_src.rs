...
//! Generated file from `envoy/config/filter/listener/original_src/v2alpha1/original_src.proto`
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \nEenvoy/config/filter/listener/original_src/v2alpha1/original_src.proto\
    \x122envoy.config.filter.listener.original_src.v2alpha1\x1a\x1eudpa/anno\
