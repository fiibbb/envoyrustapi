...
//! Generated file from `envoy/config/filter/fault/v2/fault.proto`
...
pub struct FaultDelay {
    // message fields
    pub field_type: FaultDelay_FaultDelayType,
...
impl FaultDelay {
    ...
    // .envoy.config.filter.fault.v2.FaultDelay.FaultDelayType type = 1;


    pub fn get_field_type(&self) -> FaultDelay_FaultDelayType {
        self.field_type
    }
    pub fn clear_field_type(&mut self) {
        self.field_type = FaultDelay_FaultDelayType::FIXED;
    }

    // Param is passed by value, moved
    pub fn set_field_type(&mut self, v: FaultDelay_FaultDelayType) {
        self.field_type = v;
    }
...
impl ::protobuf::Message for FaultDelay {
    ...
    fn compute_size(&self) -> u32 {
        let mut my_size = 0;
        if self.field_type != FaultDelay_FaultDelayType::FIXED {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeEnum<FaultDelay_FaultDelayType>>(
                "type",
                |m: &FaultDelay| { &m.field_type },
                |m: &mut FaultDelay| { &mut m.field_type },
            ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n(envoy/config/filter/fault/v2/fault.proto\x12\x1cenvoy.config.filter.f\
    ault.v2\x1a\x18envoy/type/percent.proto\x1a\x1egoogle/protobuf/duration.\
    proto\x1a#envoy/annotations/deprecation.proto\x1a\x1eudpa/annotations/mi\
    grate.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validat\
    e.proto\"\x94\x03\n\nFaultDelay\x12U\n\x04type\x18\x01\x20\x01(\x0e27.en\
    voy.config.filter.fault.v2.FaultDelay.FaultDelayTypeR\x04typeB\x08\x18\
    \x01\xb8\xee\xf2\xd2\x05\x01\x12F\n\x0bfixed_delay\x18\x03\x20\x01(\x0b2\
    \x19.google.protobuf.DurationH\0R\nfixedDelayB\x08\xfaB\x05\xaa\x01\x02*\
    \0\x12Y\n\x0cheader_delay\x18\x05\x20\x01(\x0b24.envoy.config.filter.fau\
    lt.v2.FaultDelay.HeaderDelayH\0R\x0bheaderDelay\x12=\n\npercentage\x18\
    \x04\x20\x01(\x0b2\x1d.envoy.type.FractionalPercentR\npercentage\x1a\r\n\
    \x0bHeaderDelay\"\x1b\n\x0eFaultDelayType\x12\t\n\x05FIXED\x10\0B\x1b\n\
    \x14fault_delay_secifier\x12\x03\xf8B\x01J\x04\x08\x02\x10\x03\"\xe2\x02\
    \n\x0eFaultRateLimit\x12Z\n\x0bfixed_limit\x18\x01\x20\x01(\x0b27.envoy.\
    config.filter.fault.v2.FaultRateLimit.FixedLimitH\0R\nfixedLimit\x12]\n\
    \x0cheader_limit\x18\x03\x20\x01(\x0b28.envoy.config.filter.fault.v2.Fau\
    ltRateLimit.HeaderLimitH\0R\x0bheaderLimit\x12=\n\npercentage\x18\x02\
    \x20\x01(\x0b2\x1d.envoy.type.FractionalPercentR\npercentage\x1a4\n\nFix\
    edLimit\x12&\n\nlimit_kbps\x18\x01\x20\x01(\x04R\tlimitKbpsB\x07\xfaB\
    \x042\x02(\x01\x1a\r\n\x0bHeaderLimitB\x11\n\nlimit_type\x12\x03\xf8B\
    \x01Br\n*io.envoyproxy.envoy.config.filter.fault.v2B\nFaultProtoP\x01\
    \xf2\x98\xfe\x8f\x05*\x12(envoy.extensions.filters.common.fault.v3\xba\
