...
//! Generated file from `envoy/type/matcher/string.proto`
...
impl StringMatcher {
    ...
    pub fn get_regex(&self) -> &str {
        match self.match_pattern {
            ::std::option::Option::Some(StringMatcher_oneof_match_pattern::regex(ref v)) => v,
            _ => "",
        }
    }
    ...
    pub fn has_regex(&self) -> bool {
        match self.match_pattern {
            ::std::option::Option::Some(StringMatcher_oneof_match_pattern::regex(..)) => true,
            _ => false,
        }
    }
    ...
    pub fn set_regex(&mut self, v: ::std::string::String) {
        self.match_pattern = ::std::option::Option::Some(StringMatcher_oneof_match_pattern::regex(v))
    }

    // Mutable pointer to the field.
    pub fn mut_regex(&mut self) -> &mut ::std::string::String {
        if let ::std::option::Option::Some(StringMatcher_oneof_match_pattern::regex(_)) = self.match_pattern {
        } else {
            self.match_pattern = ::std::option::Option::Some(StringMatcher_oneof_match_pattern::regex(::std::string::String::new()));
        }
        match self.match_pattern {
            ::std::option::Option::Some(StringMatcher_oneof_match_pattern::regex(ref mut v)) => v,
            _ => panic!(),
        }
    }
    ...
    pub fn take_regex(&mut self) -> ::std::string::String {
        if self.has_regex() {
            match self.match_pattern.take() {
                ::std::option::Option::Some(StringMatcher_oneof_match_pattern::regex(v)) => v,
                _ => panic!(),
            }
        } else {
            ::std::string::String::new()
    ...
    // .envoy.type.matcher.RegexMatcher safe_regex = 5;
...
impl ::protobuf::Message for StringMatcher {
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                4 => {
                    ...
                    self.match_pattern = ::std::option::Option::Some(StringMatcher_oneof_match_pattern::regex(is.read_string()?));
                },
                5 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let ::std::option::Option::Some(ref v) = self.match_pattern {
            match v {
                ...
                &StringMatcher_oneof_match_pattern::regex(ref v) => {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_singular_string_accessor::<_>(
                "regex",
                StringMatcher::has_regex,
                StringMatcher::get_regex,
            ));
...
impl ListStringMatcher {
    ...
    // repeated .envoy.type.matcher.StringMatcher patterns = 1;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1fenvoy/type/matcher/string.proto\x12\x12envoy.type.matcher\x1a\x1ee\
    nvoy/type/matcher/regex.proto\x1a#envoy/annotations/deprecation.proto\
    ...
    \x04r\x02\x10\x01\x12(\n\x05regex\x18\x04\x20\x01(\tH\0R\x05regexB\x10\
    \x18\x01\xfaB\x05r\x03(\x80\x08\xb8\xee\xf2\xd2\x05\x01\x12K\n\nsafe_reg\
    ex\x18\x05\x20\x01(\x0b2\x20.envoy.type.matcher.RegexMatcherH\0R\tsafeRe\
    gexB\x08\xfaB\x05\x8a\x01\x02\x10\x01\x12\x1f\n\x0bignore_case\x18\x06\
    \x20\x01(\x08R\nignoreCaseB\x14\n\rmatch_pattern\x12\x03\xf8B\x01\"\\\n\
    \x11ListStringMatcher\x12G\n\x08patterns\x18\x01\x20\x03(\x0b2!.envoy.ty\
    pe.matcher.StringMatcherR\x08patternsB\x08\xfaB\x05\x92\x01\x02\x08\x01B\
    9\n\x20io.envoyproxy.envoy.type.matcherB\x0bStringProtoP\x01\xba\x80\xc8\
