...
//! Generated file from `envoy/admin/v4alpha/server_info.proto`
...
impl ServerInfo {
    ...
    // .envoy.admin.v4alpha.ServerInfo.State state = 2;
    ...
    // .envoy.admin.v4alpha.CommandLineOptions command_line_options = 6;
    ...
    // .envoy.config.core.v4alpha.Node node = 7;
...
impl CommandLineOptions {
    ...
    // .envoy.admin.v4alpha.CommandLineOptions.IpVersion local_address_ip_version = 7;
    ...
    // .envoy.admin.v4alpha.CommandLineOptions.DrainStrategy drain_strategy = 33;
    ...
    // .envoy.admin.v4alpha.CommandLineOptions.Mode mode = 19;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n%envoy/admin/v4alpha/server_info.proto\x12\x13envoy.admin.v4alpha\x1a$\
    envoy/config/core/v4alpha/base.proto\x1a\x1egoogle/protobuf/duration.pro\
    to\x1a#envoy/annotations/deprecation.proto\x1a\x1dudpa/annotations/statu\
    s.proto\x1a!udpa/annotations/versioning.proto\"\xa2\x04\n\nServerInfo\
    \x12\x18\n\x07version\x18\x01\x20\x01(\tR\x07version\x12;\n\x05state\x18\
    \x02\x20\x01(\x0e2%.envoy.admin.v4alpha.ServerInfo.StateR\x05state\x12K\
    \n\x14uptime_current_epoch\x18\x03\x20\x01(\x0b2\x19.google.protobuf.Dur\
    ationR\x12uptimeCurrentEpoch\x12E\n\x11uptime_all_epochs\x18\x04\x20\x01\
    (\x0b2\x19.google.protobuf.DurationR\x0fuptimeAllEpochs\x12.\n\x13hot_re\
    start_version\x18\x05\x20\x01(\tR\x11hotRestartVersion\x12Y\n\x14command\
    _line_options\x18\x06\x20\x01(\x0b2'.envoy.admin.v4alpha.CommandLineOpti\
    onsR\x12commandLineOptions\x123\n\x04node\x18\x07\x20\x01(\x0b2\x1f.envo\
    y.config.core.v4alpha.NodeR\x04node\"G\n\x05State\x12\x08\n\x04LIVE\x10\
    \0\x12\x0c\n\x08DRAINING\x10\x01\x12\x14\n\x10PRE_INITIALIZING\x10\x02\
    \x12\x10\n\x0cINITIALIZING\x10\x03:\x20\x9a\xc5\x88\x1e\x1b\n\x19envoy.a\
    dmin.v3.ServerInfo\"\xb2\x0e\n\x12CommandLineOptions\x12\x17\n\x07base_i\
    d\x18\x01\x20\x01(\x04R\x06baseId\x12-\n\x13use_dynamic_base_id\x18\x1f\
    \x20\x01(\x08R\x10useDynamicBaseId\x12\x20\n\x0cbase_id_path\x18\x20\x20\
    \x01(\tR\nbaseIdPath\x12\x20\n\x0bconcurrency\x18\x02\x20\x01(\rR\x0bcon\
    currency\x12\x1f\n\x0bconfig_path\x18\x03\x20\x01(\tR\nconfigPath\x12\
    \x1f\n\x0bconfig_yaml\x18\x04\x20\x01(\tR\nconfigYaml\x12=\n\x1ballow_un\
    known_static_fields\x18\x05\x20\x01(\x08R\x18allowUnknownStaticFields\
    \x12A\n\x1dreject_unknown_dynamic_fields\x18\x1a\x20\x01(\x08R\x1areject\
    UnknownDynamicFields\x12A\n\x1dignore_unknown_dynamic_fields\x18\x1e\x20\
    \x01(\x08R\x1aignoreUnknownDynamicFields\x12,\n\x12admin_address_path\
    \x18\x06\x20\x01(\tR\x10adminAddressPath\x12j\n\x18local_address_ip_vers\
    ion\x18\x07\x20\x01(\x0e21.envoy.admin.v4alpha.CommandLineOptions.IpVers\
    ionR\x15localAddressIpVersion\x12\x1b\n\tlog_level\x18\x08\x20\x01(\tR\
    \x08logLevel\x12.\n\x13component_log_level\x18\t\x20\x01(\tR\x11componen\
    tLogLevel\x12\x1d\n\nlog_format\x18\n\x20\x01(\tR\tlogFormat\x12,\n\x12l\
    og_format_escaped\x18\x1b\x20\x01(\x08R\x10logFormatEscaped\x12\x19\n\
    \x08log_path\x18\x0b\x20\x01(\tR\x07logPath\x12'\n\x0fservice_cluster\
    \x18\r\x20\x01(\tR\x0eserviceCluster\x12!\n\x0cservice_node\x18\x0e\x20\
    \x01(\tR\x0bserviceNode\x12!\n\x0cservice_zone\x18\x0f\x20\x01(\tR\x0bse\
    rviceZone\x12I\n\x13file_flush_interval\x18\x10\x20\x01(\x0b2\x19.google\
    .protobuf.DurationR\x11fileFlushInterval\x128\n\ndrain_time\x18\x11\x20\
    \x01(\x0b2\x19.google.protobuf.DurationR\tdrainTime\x12\\\n\x0edrain_str\
    ategy\x18!\x20\x01(\x0e25.envoy.admin.v4alpha.CommandLineOptions.DrainSt\
    rategyR\rdrainStrategy\x12K\n\x14parent_shutdown_time\x18\x12\x20\x01(\
    \x0b2\x19.google.protobuf.DurationR\x12parentShutdownTime\x12@\n\x04mode\
    \x18\x13\x20\x01(\x0e2,.envoy.admin.v4alpha.CommandLineOptions.ModeR\x04\
    mode\x12.\n\x13disable_hot_restart\x18\x16\x20\x01(\x08R\x11disableHotRe\
    start\x120\n\x14enable_mutex_tracing\x18\x17\x20\x01(\x08R\x12enableMute\
    xTracing\x12#\n\rrestart_epoch\x18\x18\x20\x01(\rR\x0crestartEpoch\x12%\
    \n\x0ecpuset_threads\x18\x19\x20\x01(\x08R\rcpusetThreads\x12/\n\x13disa\
    bled_extensions\x18\x1c\x20\x03(\tR\x12disabledExtensions\x12+\n\x11boot\
    strap_version\x18\x1d\x20\x01(\rR\x10bootstrapVersion\x129\n\x19enable_f\
    ine_grain_logging\x18\"\x20\x01(\x08R\x16enableFineGrainLogging\x12\x1f\
    \n\x0bsocket_path\x18#\x20\x01(\tR\nsocketPath\x12\x1f\n\x0bsocket_mode\
    \x18$\x20\x01(\rR\nsocketMode\"\x1b\n\tIpVersion\x12\x06\n\x02v4\x10\0\
    \x12\x06\n\x02v6\x10\x01\"-\n\x04Mode\x12\t\n\x05Serve\x10\0\x12\x0c\n\
    \x08Validate\x10\x01\x12\x0c\n\x08InitOnly\x10\x02\"+\n\rDrainStrategy\
    \x12\x0b\n\x07Gradual\x10\0\x12\r\n\tImmediate\x10\x01:(\x9a\xc5\x88\x1e\
    #\n!envoy.admin.v3.CommandLineOptionsJ\x04\x08\x0c\x10\rJ\x04\x08\x14\
    \x10\x15J\x04\x08\x15\x10\x16R\tmax_statsR\x10max_obj_name_lenB>\n!io.en\
    voyproxy.envoy.admin.v4alphaB\x0fServerInfoProtoP\x01\xba\x80\xc8\xd1\
