...
//! Generated file from `envoy/admin/v3/clusters.proto`
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1denvoy/admin/v3/clusters.proto\x12\x0eenvoy.admin.v3\x1a\x1cenvoy/a\
    dmin/v3/metrics.proto\x1a-envoy/config/cluster/v3/circuit_breaker.proto\
    \x1a\"envoy/config/core/v3/address.proto\x1a\x1fenvoy/config/core/v3/bas\
    e.proto\x1a'envoy/config/core/v3/health_check.proto\x1a\x1benvoy/type/v3\
    /percent.proto\x1a\x1dudpa/annotations/status.proto\x1a!udpa/annotations\
    /versioning.proto\"y\n\x08Clusters\x12H\n\x10cluster_statuses\x18\x01\
    \x20\x03(\x0b2\x1d.envoy.admin.v3.ClusterStatusR\x0fclusterStatuses:#\
    \x9a\xc5\x88\x1e\x1e\n\x1cenvoy.admin.v2alpha.Clusters\"\xdd\x03\n\rClus\
    terStatus\x12\x12\n\x04name\x18\x01\x20\x01(\tR\x04name\x12\"\n\radded_v\
    ia_api\x18\x02\x20\x01(\x08R\x0baddedViaApi\x12]\n\x1fsuccess_rate_eject\
    ion_threshold\x18\x03\x20\x01(\x0b2\x16.envoy.type.v3.PercentR\x1csucces\
    sRateEjectionThreshold\x12?\n\rhost_statuses\x18\x04\x20\x03(\x0b2\x1a.e\
    nvoy.admin.v3.HostStatusR\x0chostStatuses\x12u\n,local_origin_success_ra\
    te_ejection_threshold\x18\x05\x20\x01(\x0b2\x16.envoy.type.v3.PercentR'l\
    ocalOriginSuccessRateEjectionThreshold\x12S\n\x10circuit_breakers\x18\
    \x06\x20\x01(\x0b2(.envoy.config.cluster.v3.CircuitBreakersR\x0fcircuitB\
    reakers:(\x9a\xc5\x88\x1e#\n!envoy.admin.v2alpha.ClusterStatus\"\x81\x04\
    \n\nHostStatus\x127\n\x07address\x18\x01\x20\x01(\x0b2\x1d.envoy.config.\
    core.v3.AddressR\x07address\x122\n\x05stats\x18\x02\x20\x03(\x0b2\x1c.en\
    voy.admin.v3.SimpleMetricR\x05stats\x12E\n\rhealth_status\x18\x03\x20\
    \x01(\x0b2\x20.envoy.admin.v3.HostHealthStatusR\x0chealthStatus\x129\n\
    \x0csuccess_rate\x18\x04\x20\x01(\x0b2\x16.envoy.type.v3.PercentR\x0bsuc\
    cessRate\x12\x16\n\x06weight\x18\x05\x20\x01(\rR\x06weight\x12\x1a\n\x08\
    hostname\x18\x06\x20\x01(\tR\x08hostname\x12\x1a\n\x08priority\x18\x07\
    \x20\x01(\rR\x08priority\x12Q\n\x19local_origin_success_rate\x18\x08\x20\
    \x01(\x0b2\x16.envoy.type.v3.PercentR\x16localOriginSuccessRate\x12:\n\
    \x08locality\x18\t\x20\x01(\x0b2\x1e.envoy.config.core.v3.LocalityR\x08l\
    ocality:%\x9a\xc5\x88\x1e\x20\n\x1eenvoy.admin.v2alpha.HostStatus\"\xa3\
    \x03\n\x10HostHealthStatus\x12;\n\x1afailed_active_health_check\x18\x01\
    \x20\x01(\x08R\x17failedActiveHealthCheck\x120\n\x14failed_outlier_check\
    \x18\x02\x20\x01(\x08R\x12failedOutlierCheck\x12?\n\x1cfailed_active_deg\
    raded_check\x18\x04\x20\x01(\x08R\x19failedActiveDegradedCheck\x126\n\
    \x17pending_dynamic_removal\x18\x05\x20\x01(\x08R\x15pendingDynamicRemov\
    al\x12*\n\x11pending_active_hc\x18\x06\x20\x01(\x08R\x0fpendingActiveHc\
    \x12N\n\x11eds_health_status\x18\x03\x20\x01(\x0e2\".envoy.config.core.v\
    3.HealthStatusR\x0fedsHealthStatus:+\x9a\xc5\x88\x1e&\n$envoy.admin.v2al\
    pha.HostHealthStatusB7\n\x1cio.envoyproxy.envoy.admin.v3B\rClustersProto\
    P\x01\xba\x80\xc8\xd1\x06\x02\x10\x02b\x06proto3\
";
