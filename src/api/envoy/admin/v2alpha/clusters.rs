...
//! Generated file from `envoy/admin/v2alpha/clusters.proto`
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\"envoy/admin/v2alpha/clusters.proto\x12\x13envoy.admin.v2alpha\x1a!en\
    voy/admin/v2alpha/metrics.proto\x1a\x1fenvoy/api/v2/core/address.proto\
    \x1a\x1cenvoy/api/v2/core/base.proto\x1a$envoy/api/v2/core/health_check.\
    proto\x1a\x18envoy/type/percent.proto\x1a\x1dudpa/annotations/status.pro\
    to\"Y\n\x08Clusters\x12M\n\x10cluster_statuses\x18\x01\x20\x03(\x0b2\".e\
    nvoy.admin.v2alpha.ClusterStatusR\x0fclusterStatuses\"\xdd\x02\n\rCluste\
    rStatus\x12\x12\n\x04name\x18\x01\x20\x01(\tR\x04name\x12\"\n\radded_via\
    _api\x18\x02\x20\x01(\x08R\x0baddedViaApi\x12Z\n\x1fsuccess_rate_ejectio\
    n_threshold\x18\x03\x20\x01(\x0b2\x13.envoy.type.PercentR\x1csuccessRate\
    EjectionThreshold\x12D\n\rhost_statuses\x18\x04\x20\x03(\x0b2\x1f.envoy.\
    admin.v2alpha.HostStatusR\x0chostStatuses\x12r\n,local_origin_success_ra\
    te_ejection_threshold\x18\x05\x20\x01(\x0b2\x13.envoy.type.PercentR'loca\
    lOriginSuccessRateEjectionThreshold\"\xd8\x03\n\nHostStatus\x124\n\x07ad\
    dress\x18\x01\x20\x01(\x0b2\x1a.envoy.api.v2.core.AddressR\x07address\
    \x127\n\x05stats\x18\x02\x20\x03(\x0b2!.envoy.admin.v2alpha.SimpleMetric\
    R\x05stats\x12J\n\rhealth_status\x18\x03\x20\x01(\x0b2%.envoy.admin.v2al\
    pha.HostHealthStatusR\x0chealthStatus\x126\n\x0csuccess_rate\x18\x04\x20\
    \x01(\x0b2\x13.envoy.type.PercentR\x0bsuccessRate\x12\x16\n\x06weight\
    \x18\x05\x20\x01(\rR\x06weight\x12\x1a\n\x08hostname\x18\x06\x20\x01(\tR\
    \x08hostname\x12\x1a\n\x08priority\x18\x07\x20\x01(\rR\x08priority\x12N\
    \n\x19local_origin_success_rate\x18\x08\x20\x01(\x0b2\x13.envoy.type.Per\
    centR\x16localOriginSuccessRate\x127\n\x08locality\x18\t\x20\x01(\x0b2\
    \x1b.envoy.api.v2.core.LocalityR\x08locality\"\xf3\x02\n\x10HostHealthSt\
    atus\x12;\n\x1afailed_active_health_check\x18\x01\x20\x01(\x08R\x17faile\
    dActiveHealthCheck\x120\n\x14failed_outlier_check\x18\x02\x20\x01(\x08R\
    \x12failedOutlierCheck\x12?\n\x1cfailed_active_degraded_check\x18\x04\
    \x20\x01(\x08R\x19failedActiveDegradedCheck\x126\n\x17pending_dynamic_re\
    moval\x18\x05\x20\x01(\x08R\x15pendingDynamicRemoval\x12*\n\x11pending_a\
    ctive_hc\x18\x06\x20\x01(\x08R\x0fpendingActiveHc\x12K\n\x11eds_health_s\
    tatus\x18\x03\x20\x01(\x0e2\x1f.envoy.api.v2.core.HealthStatusR\x0fedsHe\
    althStatusB<\n!io.envoyproxy.envoy.admin.v2alphaB\rClustersProtoP\x01\
