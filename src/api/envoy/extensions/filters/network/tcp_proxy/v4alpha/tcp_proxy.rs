...
//! Generated file from `envoy/extensions/filters/network/tcp_proxy/v4alpha/tcp_proxy.proto`
...
pub struct TcpProxy {
    ...
    pub max_downstream_connection_duration: ::protobuf::SingularPtrField<::protobuf::well_known_types::Duration>,
...
impl TcpProxy {
    ...
    // .envoy.extensions.filters.network.tcp_proxy.v4alpha.TcpProxy.WeightedCluster weighted_clusters = 10;
    ...
    // .envoy.config.core.v4alpha.Metadata metadata_match = 9;
    ...
    // repeated .envoy.config.accesslog.v4alpha.AccessLog access_log = 5;
    ...
    // .envoy.extensions.filters.network.tcp_proxy.v4alpha.TcpProxy.TunnelingConfig tunneling_config = 12;
    ...
    pub fn get_max_downstream_connection_duration(&self) -> &::protobuf::well_known_types::Duration {
        self.max_downstream_connection_duration.as_ref().unwrap_or_else(|| <::protobuf::well_known_types::Duration as ::protobuf::Message>::default_instance())
    }
    pub fn clear_max_downstream_connection_duration(&mut self) {
        self.max_downstream_connection_duration.clear();
    }

    pub fn has_max_downstream_connection_duration(&self) -> bool {
        self.max_downstream_connection_duration.is_some()
    }

    // Param is passed by value, moved
    pub fn set_max_downstream_connection_duration(&mut self, v: ::protobuf::well_known_types::Duration) {
        self.max_downstream_connection_duration = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_max_downstream_connection_duration(&mut self) -> &mut ::protobuf::well_known_types::Duration {
        if self.max_downstream_connection_duration.is_none() {
            self.max_downstream_connection_duration.set_default();
        }
        self.max_downstream_connection_duration.as_mut().unwrap()
    }

    // Take field
    pub fn take_max_downstream_connection_duration(&mut self) -> ::protobuf::well_known_types::Duration {
        self.max_downstream_connection_duration.take().unwrap_or_else(|| ::protobuf::well_known_types::Duration::new())
    }
}
...
impl ::protobuf::Message for TcpProxy {
    fn is_initialized(&self) -> bool {
        ...
        for v in &self.max_downstream_connection_duration {
            if !v.is_initialized() {
                return false;
            }
        };
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                13 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.max_downstream_connection_duration)?;
                },
                _ => {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let Some(ref v) = self.max_downstream_connection_duration.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<::protobuf::well_known_types::Duration>>(
                ...
                |m: &TcpProxy| { &m.max_downstream_connection_duration },
                |m: &mut TcpProxy| { &mut m.max_downstream_connection_duration },
            ));
...
impl TcpProxy_WeightedCluster {
    ...
    // repeated .envoy.extensions.filters.network.tcp_proxy.v4alpha.TcpProxy.WeightedCluster.ClusterWeight clusters = 1;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \nBenvoy/extensions/filters/network/tcp_proxy/v4alpha/tcp_proxy.proto\
    \x122envoy.extensions.filters.network.tcp_proxy.v4alpha\x1a.envoy/config\
    /accesslog/v4alpha/accesslog.proto\x1a$envoy/config/core/v4alpha/base.pr\
    oto\x1a\x1fenvoy/type/v3/hash_policy.proto\x1a\x1egoogle/protobuf/durati\
    on.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1dudpa/annotations/s\
    tatus.proto\x1a!udpa/annotations/versioning.proto\x1a\x17validate/valida\
    te.proto\"\xa6\r\n\x08TcpProxy\x12(\n\x0bstat_prefix\x18\x01\x20\x01(\tR\
    \nstatPrefixB\x07\xfaB\x04r\x02\x10\x01\x12\x1a\n\x07cluster\x18\x02\x20\
    \x01(\tH\0R\x07cluster\x12{\n\x11weighted_clusters\x18\n\x20\x01(\x0b2L.\
    envoy.extensions.filters.network.tcp_proxy.v4alpha.TcpProxy.WeightedClus\
    terH\0R\x10weightedClusters\x12J\n\x0emetadata_match\x18\t\x20\x01(\x0b2\
    #.envoy.config.core.v4alpha.MetadataR\rmetadataMatch\x12<\n\x0cidle_time\
    ...
    out\x12H\n\naccess_log\x18\x05\x20\x03(\x0b2).envoy.config.accesslog.v4a\
    lpha.AccessLogR\taccessLog\x12W\n\x14max_connect_attempts\x18\x07\x20\
    \x01(\x0b2\x1c.google.protobuf.UInt32ValueR\x12maxConnectAttemptsB\x07\
    \xfaB\x04*\x02(\x01\x12D\n\x0bhash_policy\x18\x0b\x20\x03(\x0b2\x19.envo\
    y.type.v3.HashPolicyR\nhashPolicyB\x08\xfaB\x05\x92\x01\x02\x10\x01\x12w\
    \n\x10tunneling_config\x18\x0c\x20\x01(\x0b2L.envoy.extensions.filters.n\
    etwork.tcp_proxy.v4alpha.TcpProxy.TunnelingConfigR\x0ftunnelingConfig\
    \x12t\n\"max_downstream_connection_duration\x18\r\x20\x01(\x0b2\x19.goog\
    le.protobuf.DurationR\x1fmaxDownstreamConnectionDurationB\x0c\xfaB\t\xaa\
    \x01\x062\x04\x10\xc0\x84=\x1a\xdc\x03\n\x0fWeightedCluster\x12\x80\x01\
    \n\x08clusters\x18\x01\x20\x03(\x0b2Z.envoy.extensions.filters.network.t\
    cp_proxy.v4alpha.TcpProxy.WeightedCluster.ClusterWeightR\x08clustersB\
    \x08\xfaB\x05\x92\x01\x02\x08\x01\x1a\xf6\x01\n\rClusterWeight\x12\x1b\n\
    \x04name\x18\x01\x20\x01(\tR\x04nameB\x07\xfaB\x04r\x02\x10\x01\x12\x1f\
    \n\x06weight\x18\x02\x20\x01(\rR\x06weightB\x07\xfaB\x04*\x02(\x01\x12J\
    \n\x0emetadata_match\x18\x03\x20\x01(\x0b2#.envoy.config.core.v4alpha.Me\
    tadataR\rmetadataMatch:[\x9a\xc5\x88\x1eV\nTenvoy.extensions.filters.net\
    work.tcp_proxy.v3.TcpProxy.WeightedCluster.ClusterWeight:M\x9a\xc5\x88\
    \x1eH\nFenvoy.extensions.filters.network.tcp_proxy.v3.TcpProxy.WeightedC\
    luster\x1a\x85\x01\n\x0fTunnelingConfig\x12#\n\x08hostname\x18\x01\x20\
    \x01(\tR\x08hostnameB\x07\xfaB\x04r\x02\x10\x01:M\x9a\xc5\x88\x1eH\nFenv\
    oy.extensions.filters.network.tcp_proxy.v3.TcpProxy.TunnelingConfigB\x18\
    \n\x11cluster_specifier\x12\x03\xf8B\x01:=\x9a\xc5\x88\x1e8\n6envoy.exte\
    nsions.filters.network.tcp_proxy.v3.TcpProxyJ\x04\x08\x06\x10\x07R\rdepr\
    ecated_v1B[\n@io.envoyproxy.envoy.extensions.filters.network.tcp_proxy.v\
    4alphaB\rTcpProxyProtoP\x01\xba\x80\xc8\xd1\x06\x02\x10\x03b\x06proto3\
";
