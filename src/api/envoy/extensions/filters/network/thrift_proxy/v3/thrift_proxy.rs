...
//! Generated file from `envoy/extensions/filters/network/thrift_proxy/v3/thrift_proxy.proto`
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x120envoy.extensions.filters.network.thrift_proxy.v3\x1a<envoy/extensio\
    ns/filters/network/thrift_proxy/v3/route.proto\x1a\x19google/protobuf/an\
    y.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1dudpa/annotations/stat\
    us.proto\x1a!udpa/annotations/versioning.proto\x1a\x17validate/validate.\
    proto\"\xcd\x04\n\x0bThriftProxy\x12g\n\ttransport\x18\x02\x20\x01(\x0e2\
    ?.envoy.extensions.filters.network.thrift_proxy.v3.TransportTypeR\ttrans\
    portB\x08\xfaB\x05\x82\x01\x02\x10\x01\x12d\n\x08protocol\x18\x03\x20\
    \x01(\x0e2>.envoy.extensions.filters.network.thrift_proxy.v3.ProtocolTyp\
    eR\x08protocolB\x08\xfaB\x05\x82\x01\x02\x10\x01\x12(\n\x0bstat_prefix\
    \x18\x01\x20\x01(\tR\nstatPrefixB\x07\xfaB\x04r\x02\x10\x01\x12g\n\x0cro\
    ute_config\x18\x04\x20\x01(\x0b2D.envoy.extensions.filters.network.thrif\
    t_proxy.v3.RouteConfigurationR\x0brouteConfig\x12e\n\x0ethrift_filters\
    \x18\x05\x20\x03(\x0b2>.envoy.extensions.filters.network.thrift_proxy.v3\
    .ThriftFilterR\rthriftFilters\x12/\n\x13payload_passthrough\x18\x06\x20\
    \x01(\x08R\x12payloadPassthrough:D\x9a\xc5\x88\x1e?\n=envoy.config.filte\
    r.network.thrift_proxy.v2alpha1.ThriftProxy\"\xca\x01\n\x0cThriftFilter\
    \x12\x1b\n\x04name\x18\x01\x20\x01(\tR\x04nameB\x07\xfaB\x04r\x02\x10\
    \x01\x129\n\x0ctyped_config\x18\x03\x20\x01(\x0b2\x14.google.protobuf.An\
    yH\0R\x0btypedConfigB\r\n\x0bconfig_type:E\x9a\xc5\x88\x1e@\n>envoy.conf\
    ig.filter.network.thrift_proxy.v2alpha1.ThriftFilterJ\x04\x08\x02\x10\
    \x03R\x06config\"\xb6\x02\n\x15ThriftProtocolOptions\x12g\n\ttransport\
    \x18\x01\x20\x01(\x0e2?.envoy.extensions.filters.network.thrift_proxy.v3\
    .TransportTypeR\ttransportB\x08\xfaB\x05\x82\x01\x02\x10\x01\x12d\n\x08p\
    rotocol\x18\x02\x20\x01(\x0e2>.envoy.extensions.filters.network.thrift_p\
    roxy.v3.ProtocolTypeR\x08protocolB\x08\xfaB\x05\x82\x01\x02\x10\x01:N\
    \x9a\xc5\x88\x1eI\nGenvoy.config.filter.network.thrift_proxy.v2alpha1.Th\
    riftProtocolOptions*I\n\rTransportType\x12\x12\n\x0eAUTO_TRANSPORT\x10\0\
    ...
    s.filters.network.thrift_proxy.v3B\x10ThriftProxyProtoP\x01\xba\x80\xc8\
