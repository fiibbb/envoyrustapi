...
//! Generated file from `envoy/extensions/filters/network/thrift_proxy/v3/route.proto`
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n<envoy/extensions/filters/network/thrift_proxy/v3/route.proto\x120envo\
    y.extensions.filters.network.thrift_proxy.v3\x1a\x1fenvoy/config/core/v3\
    /base.proto\x1a,envoy/config/route/v3/route_components.proto\x1a\x1egoog\
    le/protobuf/wrappers.proto\x1a\x1dudpa/annotations/status.proto\x1a!udpa\
    /annotations/versioning.proto\x1a\x17validate/validate.proto\"\xc6\x01\n\
    \x12RouteConfiguration\x12\x12\n\x04name\x18\x01\x20\x01(\tR\x04name\x12\
    O\n\x06routes\x18\x02\x20\x03(\x0b27.envoy.extensions.filters.network.th\
    rift_proxy.v3.RouteR\x06routes:K\x9a\xc5\x88\x1eF\nDenvoy.config.filter.\
    network.thrift_proxy.v2alpha1.RouteConfiguration\"\x84\x02\n\x05Route\
    \x12\\\n\x05match\x18\x01\x20\x01(\x0b2<.envoy.extensions.filters.networ\
    k.thrift_proxy.v3.RouteMatchR\x05matchB\x08\xfaB\x05\x8a\x01\x02\x10\x01\
    \x12]\n\x05route\x18\x02\x20\x01(\x0b2=.envoy.extensions.filters.network\
    .thrift_proxy.v3.RouteActionR\x05routeB\x08\xfaB\x05\x8a\x01\x02\x10\x01\
    :>\x9a\xc5\x88\x1e9\n7envoy.config.filter.network.thrift_proxy.v2alpha1.\
    Route\"\x89\x02\n\nRouteMatch\x12!\n\x0bmethod_name\x18\x01\x20\x01(\tH\
    \0R\nmethodName\x12#\n\x0cservice_name\x18\x02\x20\x01(\tH\0R\x0bservice\
    Name\x12\x16\n\x06invert\x18\x03\x20\x01(\x08R\x06invert\x12>\n\x07heade\
    rs\x18\x04\x20\x03(\x0b2$.envoy.config.route.v3.HeaderMatcherR\x07header\
    sB\x16\n\x0fmatch_specifier\x12\x03\xf8B\x01:C\x9a\xc5\x88\x1e>\n<envoy.\
    config.filter.network.thrift_proxy.v2alpha1.RouteMatch\"\xf4\x03\n\x0bRo\
    uteAction\x12#\n\x07cluster\x18\x01\x20\x01(\tH\0R\x07clusterB\x07\xfaB\
    \x04r\x02\x10\x01\x12p\n\x11weighted_clusters\x18\x02\x20\x01(\x0b2A.env\
    oy.extensions.filters.network.thrift_proxy.v3.WeightedClusterH\0R\x10wei\
    ghtedClusters\x126\n\x0ecluster_header\x18\x06\x20\x01(\tH\0R\rclusterHe\
    aderB\r\xfaB\nr\x08\x10\x01\xc0\x01\x02\xc8\x01\0\x12E\n\x0emetadata_mat\
    ch\x18\x03\x20\x01(\x0b2\x1e.envoy.config.core.v3.MetadataR\rmetadataMat\
    ch\x12A\n\x0brate_limits\x18\x04\x20\x03(\x0b2\x20.envoy.config.route.v3\
    .RateLimitR\nrateLimits\x12,\n\x12strip_service_name\x18\x05\x20\x01(\
    \x08R\x10stripServiceNameB\x18\n\x11cluster_specifier\x12\x03\xf8B\x01:D\
    \x9a\xc5\x88\x1e?\n=envoy.config.filter.network.thrift_proxy.v2alpha1.Ro\
    uteAction\"\xdf\x03\n\x0fWeightedCluster\x12u\n\x08clusters\x18\x01\x20\
    \x03(\x0b2O.envoy.extensions.filters.network.thrift_proxy.v3.WeightedClu\
    ster.ClusterWeightR\x08clustersB\x08\xfaB\x05\x92\x01\x02\x08\x01\x1a\
    ...
    ogle.protobuf.UInt32ValueR\x06weightB\x07\xfaB\x04*\x02(\x01\x12E\n\x0em\
    etadata_match\x18\x03\x20\x01(\x0b2\x1e.envoy.config.core.v3.MetadataR\r\
    metadataMatch:V\x9a\xc5\x88\x1eQ\nOenvoy.config.filter.network.thrift_pr\
    oxy.v2alpha1.WeightedCluster.ClusterWeight:H\x9a\xc5\x88\x1eC\nAenvoy.co\
    nfig.filter.network.thrift_proxy.v2alpha1.WeightedClusterBV\n>io.envoypr\
    oxy.envoy.extensions.filters.network.thrift_proxy.v3B\nRouteProtoP\x01\
