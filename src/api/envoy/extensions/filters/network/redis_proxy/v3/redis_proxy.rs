...
//! Generated file from `envoy/extensions/filters/network/redis_proxy/v3/redis_proxy.proto`
...
pub struct RedisProxy {
    ...
    pub faults: ::protobuf::RepeatedField<RedisProxy_RedisFault>,
    pub downstream_auth_username: ::protobuf::SingularPtrField<super::base::DataSource>,
    // special fields
...
impl RedisProxy {
    ...
    // .envoy.config.core.v3.DataSource downstream_auth_password = 6;
    ...
    pub fn get_faults(&self) -> &[RedisProxy_RedisFault] {
        &self.faults
    }
    ...
    // Param is passed by value, moved
    pub fn set_faults(&mut self, v: ::protobuf::RepeatedField<RedisProxy_RedisFault>) {
        self.faults = v;
    }

    // Mutable pointer to the field.
    pub fn mut_faults(&mut self) -> &mut ::protobuf::RepeatedField<RedisProxy_RedisFault> {
        &mut self.faults
    }

    // Take field
    pub fn take_faults(&mut self) -> ::protobuf::RepeatedField<RedisProxy_RedisFault> {
        ::std::mem::replace(&mut self.faults, ::protobuf::RepeatedField::new())
    }

    // .envoy.config.core.v3.DataSource downstream_auth_username = 7;


    pub fn get_downstream_auth_username(&self) -> &super::base::DataSource {
        self.downstream_auth_username.as_ref().unwrap_or_else(|| <super::base::DataSource as ::protobuf::Message>::default_instance())
    }
    pub fn clear_downstream_auth_username(&mut self) {
        self.downstream_auth_username.clear();
    }

    pub fn has_downstream_auth_username(&self) -> bool {
        self.downstream_auth_username.is_some()
    }

    // Param is passed by value, moved
    pub fn set_downstream_auth_username(&mut self, v: super::base::DataSource) {
        self.downstream_auth_username = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_downstream_auth_username(&mut self) -> &mut super::base::DataSource {
        if self.downstream_auth_username.is_none() {
            self.downstream_auth_username.set_default();
        }
        self.downstream_auth_username.as_mut().unwrap()
    }

    // Take field
    pub fn take_downstream_auth_username(&mut self) -> super::base::DataSource {
        self.downstream_auth_username.take().unwrap_or_else(|| super::base::DataSource::new())
    }
}
...
impl ::protobuf::Message for RedisProxy {
    fn is_initialized(&self) -> bool {
        ...
        for v in &self.downstream_auth_username {
            if !v.is_initialized() {
                return false;
            }
        };
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                8 => {
                    ::protobuf::rt::read_repeated_message_into(wire_type, is, &mut self.faults)?;
                },
                7 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.downstream_auth_username)?;
                },
                _ => {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let Some(ref v) = self.downstream_auth_username.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_repeated_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<RedisProxy_RedisFault>>(
                "faults",
                |m: &RedisProxy| { &m.faults },
                |m: &mut RedisProxy| { &mut m.faults },
            ));
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<super::base::DataSource>>(
                "downstream_auth_username",
                |m: &RedisProxy| { &m.downstream_auth_username },
                |m: &mut RedisProxy| { &mut m.downstream_auth_username },
            ));
...
#[derive(PartialEq,Clone,Default)]
pub struct RedisProxy_RedisFault {
    // message fields
    pub fault_type: RedisProxy_RedisFault_RedisFaultType,
    pub fault_enabled: ::protobuf::SingularPtrField<super::base::RuntimeFractionalPercent>,
...
impl<'a> ::std::default::Default for &'a RedisProxy_RedisFault {
    fn default() -> &'a RedisProxy_RedisFault {
        <RedisProxy_RedisFault as ::protobuf::Message>::default_instance()
    }
}

impl RedisProxy_RedisFault {
    pub fn new() -> RedisProxy_RedisFault {
        ::std::default::Default::default()
    }
    ...
    pub fn get_fault_type(&self) -> RedisProxy_RedisFault_RedisFaultType {
        self.fault_type
    }
    pub fn clear_fault_type(&mut self) {
        self.fault_type = RedisProxy_RedisFault_RedisFaultType::DELAY;
    }

    // Param is passed by value, moved
    pub fn set_fault_type(&mut self, v: RedisProxy_RedisFault_RedisFaultType) {
        self.fault_type = v;
    }
    ...
    pub fn get_fault_enabled(&self) -> &super::base::RuntimeFractionalPercent {
        self.fault_enabled.as_ref().unwrap_or_else(|| <super::base::RuntimeFractionalPercent as ::protobuf::Message>::default_instance())
    }
    pub fn clear_fault_enabled(&mut self) {
        self.fault_enabled.clear();
    }

    pub fn has_fault_enabled(&self) -> bool {
        self.fault_enabled.is_some()
    }

    // Param is passed by value, moved
    pub fn set_fault_enabled(&mut self, v: super::base::RuntimeFractionalPercent) {
        self.fault_enabled = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_fault_enabled(&mut self) -> &mut super::base::RuntimeFractionalPercent {
        if self.fault_enabled.is_none() {
            self.fault_enabled.set_default();
        }
        self.fault_enabled.as_mut().unwrap()
    }

    // Take field
    pub fn take_fault_enabled(&mut self) -> super::base::RuntimeFractionalPercent {
        self.fault_enabled.take().unwrap_or_else(|| super::base::RuntimeFractionalPercent::new())
    }
    ...
    pub fn get_delay(&self) -> &::protobuf::well_known_types::Duration {
        self.delay.as_ref().unwrap_or_else(|| <::protobuf::well_known_types::Duration as ::protobuf::Message>::default_instance())
    }
...
impl ::protobuf::Message for RedisProxy_RedisFault {
    fn is_initialized(&self) -> bool {
        for v in &self.fault_enabled {
            if !v.is_initialized() {
                return false;
            }
        };
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ::protobuf::rt::read_proto3_enum_with_unknown_fields_into(wire_type, is, &mut self.fault_type, 1, &mut self.unknown_fields)?
                },
                2 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.fault_enabled)?;
                },
                3 => {
    ...
    fn compute_size(&self) -> u32 {
        let mut my_size = 0;
        if self.fault_type != RedisProxy_RedisFault_RedisFaultType::DELAY {
            my_size += ::protobuf::rt::enum_size(1, self.fault_type);
        }
        if let Some(ref v) = self.fault_enabled.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        if self.fault_type != RedisProxy_RedisFault_RedisFaultType::DELAY {
            os.write_enum(1, ::protobuf::ProtobufEnum::value(&self.fault_type))?;
        }
        if let Some(ref v) = self.fault_enabled.as_ref() {
            os.write_tag(2, ::protobuf::wire_format::WireTypeLengthDelimited)?;
            os.write_raw_varint32(v.get_cached_size())?;
    ...
    fn new() -> RedisProxy_RedisFault {
        RedisProxy_RedisFault::new()
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            let mut fields = ::std::vec::Vec::new();
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeEnum<RedisProxy_RedisFault_RedisFaultType>>(
                "fault_type",
                |m: &RedisProxy_RedisFault| { &m.fault_type },
                |m: &mut RedisProxy_RedisFault| { &mut m.fault_type },
            ));
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<super::base::RuntimeFractionalPercent>>(
                "fault_enabled",
                |m: &RedisProxy_RedisFault| { &m.fault_enabled },
                |m: &mut RedisProxy_RedisFault| { &mut m.fault_enabled },
            ));
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<::protobuf::well_known_types::Duration>>(
                "delay",
                |m: &RedisProxy_RedisFault| { &m.delay },
                |m: &mut RedisProxy_RedisFault| { &mut m.delay },
            ));
            fields.push(::protobuf::reflect::accessor::make_repeated_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "commands",
                |m: &RedisProxy_RedisFault| { &m.commands },
                |m: &mut RedisProxy_RedisFault| { &mut m.commands },
            ));
            ::protobuf::reflect::MessageDescriptor::new_pb_name::<RedisProxy_RedisFault>(
    ...
    fn default_instance() -> &'static RedisProxy_RedisFault {
        static instance: ::protobuf::rt::LazyV2<RedisProxy_RedisFault> = ::protobuf::rt::LazyV2::INIT;
        instance.get(RedisProxy_RedisFault::new)
    }
}

impl ::protobuf::Clear for RedisProxy_RedisFault {
    fn clear(&mut self) {
        self.fault_type = RedisProxy_RedisFault_RedisFaultType::DELAY;
        self.fault_enabled.clear();
        self.delay.clear();
...
impl ::std::fmt::Debug for RedisProxy_RedisFault {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for RedisProxy_RedisFault {
    fn as_ref(&self) -> ::protobuf::reflect::ReflectValueRef {
        ::protobuf::reflect::ReflectValueRef::Message(self)
    }
}
...
#[derive(Clone,PartialEq,Eq,Debug,Hash)]
pub enum RedisProxy_RedisFault_RedisFaultType {
    DELAY = 0,
    ERROR = 1,
}

impl ::protobuf::ProtobufEnum for RedisProxy_RedisFault_RedisFaultType {
    fn value(&self) -> i32 {
        *self as i32
    }

    fn from_i32(value: i32) -> ::std::option::Option<RedisProxy_RedisFault_RedisFaultType> {
        match value {
            0 => ::std::option::Option::Some(RedisProxy_RedisFault_RedisFaultType::DELAY),
            1 => ::std::option::Option::Some(RedisProxy_RedisFault_RedisFaultType::ERROR),
            _ => ::std::option::Option::None
        }
    }

    fn values() -> &'static [Self] {
        static values: &'static [RedisProxy_RedisFault_RedisFaultType] = &[
            RedisProxy_RedisFault_RedisFaultType::DELAY,
            RedisProxy_RedisFault_RedisFaultType::ERROR,
        ];
        values
    }
    ...
    fn enum_descriptor_static() -> &'static ::protobuf::reflect::EnumDescriptor {
        static descriptor: ::protobuf::rt::LazyV2<::protobuf::reflect::EnumDescriptor> = ::protobuf::rt::LazyV2::INIT;
        descriptor.get(|| {
            ::protobuf::reflect::EnumDescriptor::new_pb_name::<RedisProxy_RedisFault_RedisFaultType>("RedisProxy.RedisFault.RedisFaultType", file_descriptor_proto())
        })
    }
}

impl ::std::marker::Copy for RedisProxy_RedisFault_RedisFaultType {
}

impl ::std::default::Default for RedisProxy_RedisFault_RedisFaultType {
    fn default() -> Self {
        RedisProxy_RedisFault_RedisFaultType::DELAY
    }
}

impl ::protobuf::reflect::ProtobufValue for RedisProxy_RedisFault_RedisFaultType {
    fn as_ref(&self) -> ::protobuf::reflect::ReflectValueRef {
        ::protobuf::reflect::ReflectValueRef::Enum(::protobuf::ProtobufEnum::descriptor(self))
    }
}
...
pub struct RedisProtocolOptions {
    ...
    pub auth_username: ::protobuf::SingularPtrField<super::base::DataSource>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl RedisProtocolOptions {
    ...
    pub fn get_auth_username(&self) -> &super::base::DataSource {
        self.auth_username.as_ref().unwrap_or_else(|| <super::base::DataSource as ::protobuf::Message>::default_instance())
    }
    pub fn clear_auth_username(&mut self) {
        self.auth_username.clear();
    }

    pub fn has_auth_username(&self) -> bool {
        self.auth_username.is_some()
    }

    // Param is passed by value, moved
    pub fn set_auth_username(&mut self, v: super::base::DataSource) {
        self.auth_username = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_auth_username(&mut self) -> &mut super::base::DataSource {
        if self.auth_username.is_none() {
            self.auth_username.set_default();
        }
        self.auth_username.as_mut().unwrap()
    }

    // Take field
    pub fn take_auth_username(&mut self) -> super::base::DataSource {
        self.auth_username.take().unwrap_or_else(|| super::base::DataSource::new())
    }
}
...
impl ::protobuf::Message for RedisProtocolOptions {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                2 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.auth_username)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let Some(ref v) = self.auth_username.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<super::base::DataSource>>(
                "auth_username",
                |m: &RedisProtocolOptions| { &m.auth_username },
                |m: &mut RedisProtocolOptions| { &mut m.auth_username },
            ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \nAenvoy/extensions/filters/network/redis_proxy/v3/redis_proxy.proto\x12\
    /envoy.extensions.filters.network.redis_proxy.v3\x1a\x1fenvoy/config/cor\
    e/v3/base.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1egoogle/prot\
    obuf/wrappers.proto\x1a#envoy/annotations/deprecation.proto\x1a\x1eudpa/\
    annotations/migrate.proto\x1a\x20udpa/annotations/sensitive.proto\x1a\
    \x1dudpa/annotations/status.proto\x1a!udpa/annotations/versioning.proto\
    \x1a\x17validate/validate.proto\"\xdb\x16\n\nRedisProxy\x12(\n\x0bstat_p\
    refix\x18\x01\x20\x01(\tR\nstatPrefixB\x07\xfaB\x04r\x02\x10\x01\x12r\n\
    \x08settings\x18\x03\x20\x01(\x0b2L.envoy.extensions.filters.network.red\
    is_proxy.v3.RedisProxy.ConnPoolSettingsR\x08settingsB\x08\xfaB\x05\x8a\
    \x01\x02\x10\x01\x12*\n\x11latency_in_micros\x18\x04\x20\x01(\x08R\x0fla\
    tencyInMicros\x12m\n\rprefix_routes\x18\x05\x20\x01(\x0b2H.envoy.extensi\
    ons.filters.network.redis_proxy.v3.RedisProxy.PrefixRoutesR\x0cprefixRou\
    tes\x12b\n\x18downstream_auth_password\x18\x06\x20\x01(\x0b2\x20.envoy.c\
    onfig.core.v3.DataSourceR\x16downstreamAuthPasswordB\x06\xb8\xb7\x8b\xa4\
    \x02\x01\x12^\n\x06faults\x18\x08\x20\x03(\x0b2F.envoy.extensions.filter\
    s.network.redis_proxy.v3.RedisProxy.RedisFaultR\x06faults\x12b\n\x18down\
    stream_auth_username\x18\x07\x20\x01(\x0b2\x20.envoy.config.core.v3.Data\
    SourceR\x16downstreamAuthUsernameB\x06\xb8\xb7\x8b\xa4\x02\x01\x1a\xae\
    \x06\n\x10ConnPoolSettings\x12B\n\nop_timeout\x18\x01\x20\x01(\x0b2\x19.\
    google.protobuf.DurationR\topTimeoutB\x08\xfaB\x05\xaa\x01\x02\x08\x01\
    \x12-\n\x12enable_hashtagging\x18\x02\x20\x01(\x08R\x11enableHashtagging\
    \x12-\n\x12enable_redirection\x18\x03\x20\x01(\x08R\x11enableRedirection\
    \x12>\n\x1cmax_buffer_size_before_flush\x18\x04\x20\x01(\rR\x18maxBuffer\
    SizeBeforeFlush\x12K\n\x14buffer_flush_timeout\x18\x05\x20\x01(\x0b2\x19\
    .google.protobuf.DurationR\x12bufferFlushTimeout\x12e\n\x20max_upstream_\
    unknown_connections\x18\x06\x20\x01(\x0b2\x1c.google.protobuf.UInt32Valu\
    eR\x1dmaxUpstreamUnknownConnections\x120\n\x14enable_command_stats\x18\
    \x08\x20\x01(\x08R\x12enableCommandStats\x12\x82\x01\n\x0bread_policy\
    \x18\x07\x20\x01(\x0e2W.envoy.extensions.filters.network.redis_proxy.v3.\
    RedisProxy.ConnPoolSettings.ReadPolicyR\nreadPolicyB\x08\xfaB\x05\x82\
    \x01\x02\x10\x01\"~\n\nReadPolicy\x12\x1b\n\x06MASTER\x10\0\x1a\x0f\xf2\
    \x98\xfe\x8f\x05\t\n\x07PRIMARY\x12)\n\rPREFER_MASTER\x10\x01\x1a\x16\
    \xf2\x98\xfe\x8f\x05\x10\n\x0ePREFER_PRIMARY\x12\x0b\n\x07REPLICA\x10\
    \x02\x12\x12\n\x0ePREFER_REPLICA\x10\x03\x12\x07\n\x03ANY\x10\x04:M\x9a\
    \xc5\x88\x1eH\nFenvoy.config.filter.network.redis_proxy.v2.RedisProxy.Co\
    nnPoolSettings\x1a\x8a\x08\n\x0cPrefixRoutes\x12f\n\x06routes\x18\x01\
    \x20\x03(\x0b2N.envoy.extensions.filters.network.redis_proxy.v3.RedisPro\
    xy.PrefixRoutes.RouteR\x06routes\x12)\n\x10case_insensitive\x18\x02\x20\
    \x01(\x08R\x0fcaseInsensitive\x12v\n\x0fcatch_all_route\x18\x04\x20\x01(\
    \x0b2N.envoy.extensions.filters.network.redis_proxy.v3.RedisProxy.Prefix\
    Routes.RouteR\rcatchAllRoute\x1a\x8a\x05\n\x05Route\x12\x20\n\x06prefix\
    \x18\x01\x20\x01(\tR\x06prefixB\x08\xfaB\x05r\x03(\xe8\x07\x12#\n\rremov\
    e_prefix\x18\x02\x20\x01(\x08R\x0cremovePrefix\x12!\n\x07cluster\x18\x03\
    \x20\x01(\tR\x07clusterB\x07\xfaB\x04r\x02\x10\x01\x12\x96\x01\n\x15requ\
    est_mirror_policy\x18\x04\x20\x03(\x0b2b.envoy.extensions.filters.networ\
    k.redis_proxy.v3.RedisProxy.PrefixRoutes.Route.RequestMirrorPolicyR\x13r\
    equestMirrorPolicy\x1a\xac\x02\n\x13RequestMirrorPolicy\x12!\n\x07cluste\
    r\x18\x01\x20\x01(\tR\x07clusterB\x07\xfaB\x04r\x02\x10\x01\x12Y\n\x10ru\
    ntime_fraction\x18\x02\x20\x01(\x0b2..envoy.config.core.v3.RuntimeFracti\
    onalPercentR\x0fruntimeFraction\x122\n\x15exclude_read_commands\x18\x03\
    \x20\x01(\x08R\x13excludeReadCommands:c\x9a\xc5\x88\x1e^\n\\envoy.config\
    .filter.network.redis_proxy.v2.RedisProxy.PrefixRoutes.Route.RequestMirr\
    orPolicy:O\x9a\xc5\x88\x1eJ\nHenvoy.config.filter.network.redis_proxy.v2\
    .RedisProxy.PrefixRoutes.Route:I\x9a\xc5\x88\x1eD\nBenvoy.config.filter.\
    network.redis_proxy.v2.RedisProxy.PrefixRoutesJ\x04\x08\x03\x10\x04R\x11\
    catch_all_cluster\x1a\xe0\x02\n\nRedisFault\x12~\n\nfault_type\x18\x01\
    \x20\x01(\x0e2U.envoy.extensions.filters.network.redis_proxy.v3.RedisPro\
    xy.RedisFault.RedisFaultTypeR\tfaultTypeB\x08\xfaB\x05\x82\x01\x02\x10\
    \x01\x12]\n\rfault_enabled\x18\x02\x20\x01(\x0b2..envoy.config.core.v3.R\
    untimeFractionalPercentR\x0cfaultEnabledB\x08\xfaB\x05\x8a\x01\x02\x10\
    \x01\x12/\n\x05delay\x18\x03\x20\x01(\x0b2\x19.google.protobuf.DurationR\
    \x05delay\x12\x1a\n\x08commands\x18\x04\x20\x03(\tR\x08commands\"&\n\x0e\
    RedisFaultType\x12\t\n\x05DELAY\x10\0\x12\t\n\x05ERROR\x10\x01:<\x9a\xc5\
    \x88\x1e7\n5envoy.config.filter.network.redis_proxy.v2.RedisProxyJ\x04\
    \x08\x02\x10\x03R\x07cluster\"\xfc\x01\n\x14RedisProtocolOptions\x12M\n\
    \rauth_password\x18\x01\x20\x01(\x0b2\x20.envoy.config.core.v3.DataSourc\
    eR\x0cauthPasswordB\x06\xb8\xb7\x8b\xa4\x02\x01\x12M\n\rauth_username\
    \x18\x02\x20\x01(\x0b2\x20.envoy.config.core.v3.DataSourceR\x0cauthUsern\
    ameB\x06\xb8\xb7\x8b\xa4\x02\x01:F\x9a\xc5\x88\x1eA\n?envoy.config.filte\
    r.network.redis_proxy.v2.RedisProtocolOptionsBZ\n=io.envoyproxy.envoy.ex\
    tensions.filters.network.redis_proxy.v3B\x0fRedisProxyProtoP\x01\xba\x80\
