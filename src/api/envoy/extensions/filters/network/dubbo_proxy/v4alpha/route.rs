...
//! Generated file from `envoy/extensions/filters/network/dubbo_proxy/v4alpha/route.proto`
...
impl RouteConfiguration {
    ...
    // repeated .envoy.extensions.filters.network.dubbo_proxy.v4alpha.Route routes = 5;
...
impl Route {
    ...
    // .envoy.extensions.filters.network.dubbo_proxy.v4alpha.RouteMatch match = 1;
    ...
    // .envoy.extensions.filters.network.dubbo_proxy.v4alpha.RouteAction route = 2;
...
impl RouteMatch {
    ...
    // .envoy.extensions.filters.network.dubbo_proxy.v4alpha.MethodMatch method = 1;
...
impl RouteAction {
    ...
    // .envoy.config.route.v4alpha.WeightedCluster weighted_clusters = 2;
...
impl MethodMatch {
    ...
    // .envoy.type.matcher.v4alpha.StringMatcher name = 1;
    ...
    // repeated .envoy.extensions.filters.network.dubbo_proxy.v4alpha.MethodMatch.ParamsMatchEntry params_match = 2;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n@envoy/extensions/filters/network/dubbo_proxy/v4alpha/route.proto\x124\
    envoy.extensions.filters.network.dubbo_proxy.v4alpha\x1a1envoy/config/ro\
    ute/v4alpha/route_components.proto\x1a'envoy/type/matcher/v4alpha/string\
    .proto\x1a\x19envoy/type/v3/range.proto\x1a\x1dudpa/annotations/status.p\
    roto\x1a!udpa/annotations/versioning.proto\x1a\x17validate/validate.prot\
    o\"\x96\x02\n\x12RouteConfiguration\x12\x12\n\x04name\x18\x01\x20\x01(\t\
    R\x04name\x12\x1c\n\tinterface\x18\x02\x20\x01(\tR\tinterface\x12\x14\n\
    \x05group\x18\x03\x20\x01(\tR\x05group\x12\x18\n\x07version\x18\x04\x20\
    \x01(\tR\x07version\x12S\n\x06routes\x18\x05\x20\x03(\x0b2;.envoy.extens\
    ions.filters.network.dubbo_proxy.v4alpha.RouteR\x06routes:I\x9a\xc5\x88\
    \x1eD\nBenvoy.extensions.filters.network.dubbo_proxy.v3.RouteConfigurati\
    on\"\x8a\x02\n\x05Route\x12`\n\x05match\x18\x01\x20\x01(\x0b2@.envoy.ext\
    ensions.filters.network.dubbo_proxy.v4alpha.RouteMatchR\x05matchB\x08\
    \xfaB\x05\x8a\x01\x02\x10\x01\x12a\n\x05route\x18\x02\x20\x01(\x0b2A.env\
    oy.extensions.filters.network.dubbo_proxy.v4alpha.RouteActionR\x05routeB\
    \x08\xfaB\x05\x8a\x01\x02\x10\x01:<\x9a\xc5\x88\x1e7\n5envoy.extensions.\
    filters.network.dubbo_proxy.v3.Route\"\xef\x01\n\nRouteMatch\x12Y\n\x06m\
    ethod\x18\x01\x20\x01(\x0b2A.envoy.extensions.filters.network.dubbo_prox\
    y.v4alpha.MethodMatchR\x06method\x12C\n\x07headers\x18\x02\x20\x03(\x0b2\
    ).envoy.config.route.v4alpha.HeaderMatcherR\x07headers:A\x9a\xc5\x88\x1e\
    <\n:envoy.extensions.filters.network.dubbo_proxy.v3.RouteMatch\"\xe3\x01\
    \n\x0bRouteAction\x12\x1a\n\x07cluster\x18\x01\x20\x01(\tH\0R\x07cluster\
    \x12Z\n\x11weighted_clusters\x18\x02\x20\x01(\x0b2+.envoy.config.route.v\
    4alpha.WeightedClusterH\0R\x10weightedClustersB\x18\n\x11cluster_specifi\
    er\x12\x03\xf8B\x01:B\x9a\xc5\x88\x1e=\n;envoy.extensions.filters.networ\
    k.dubbo_proxy.v3.RouteAction\"\x99\x05\n\x0bMethodMatch\x12=\n\x04name\
    \x18\x01\x20\x01(\x0b2).envoy.type.matcher.v4alpha.StringMatcherR\x04nam\
    e\x12u\n\x0cparams_match\x18\x02\x20\x03(\x0b2R.envoy.extensions.filters\
    .network.dubbo_proxy.v4alpha.MethodMatch.ParamsMatchEntryR\x0bparamsMatc\
    h\x1a\xf3\x01\n\x17ParameterMatchSpecifier\x12!\n\x0bexact_match\x18\x03\
    \x20\x01(\tH\0R\nexactMatch\x12<\n\x0brange_match\x18\x04\x20\x01(\x0b2\
    \x19.envoy.type.v3.Int64RangeH\0R\nrangeMatchB\x1b\n\x19parameter_match_\
    specifier:Z\x9a\xc5\x88\x1eU\nSenvoy.extensions.filters.network.dubbo_pr\
    oxy.v3.MethodMatch.ParameterMatchSpecifier\x1a\x99\x01\n\x10ParamsMatchE\
    ntry\x12\x10\n\x03key\x18\x01\x20\x01(\rR\x03key\x12o\n\x05value\x18\x02\
    \x20\x01(\x0b2Y.envoy.extensions.filters.network.dubbo_proxy.v4alpha.Met\
    hodMatch.ParameterMatchSpecifierR\x05value:\x028\x01:B\x9a\xc5\x88\x1e=\
    \n;envoy.extensions.filters.network.dubbo_proxy.v3.MethodMatchBZ\nBio.en\
    voyproxy.envoy.extensions.filters.network.dubbo_proxy.v4alphaB\nRoutePro\
    toP\x01\xba\x80\xc8\xd1\x06\x02\x10\x03b\x06proto3\
";
