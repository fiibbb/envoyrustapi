...
//! Generated file from `envoy/extensions/filters/network/dubbo_proxy/v3/route.proto`
...
impl MethodMatch {
    ...
    // repeated .envoy.extensions.filters.network.dubbo_proxy.v3.MethodMatch.ParamsMatchEntry params_match = 2;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n;envoy/extensions/filters/network/dubbo_proxy/v3/route.proto\x12/envoy\
    .extensions.filters.network.dubbo_proxy.v3\x1a,envoy/config/route/v3/rou\
    te_components.proto\x1a\"envoy/type/matcher/v3/string.proto\x1a\x19envoy\
    /type/v3/range.proto\x1a\x1dudpa/annotations/status.proto\x1a!udpa/annot\
    ations/versioning.proto\x1a\x17validate/validate.proto\"\x92\x02\n\x12Ro\
    uteConfiguration\x12\x12\n\x04name\x18\x01\x20\x01(\tR\x04name\x12\x1c\n\
    \tinterface\x18\x02\x20\x01(\tR\tinterface\x12\x14\n\x05group\x18\x03\
    \x20\x01(\tR\x05group\x12\x18\n\x07version\x18\x04\x20\x01(\tR\x07versio\
    n\x12N\n\x06routes\x18\x05\x20\x03(\x0b26.envoy.extensions.filters.netwo\
    rk.dubbo_proxy.v3.RouteR\x06routes:J\x9a\xc5\x88\x1eE\nCenvoy.config.fil\
    ter.network.dubbo_proxy.v2alpha1.RouteConfiguration\"\x81\x02\n\x05Route\
    \x12[\n\x05match\x18\x01\x20\x01(\x0b2;.envoy.extensions.filters.network\
    .dubbo_proxy.v3.RouteMatchR\x05matchB\x08\xfaB\x05\x8a\x01\x02\x10\x01\
    \x12\\\n\x05route\x18\x02\x20\x01(\x0b2<.envoy.extensions.filters.networ\
    k.dubbo_proxy.v3.RouteActionR\x05routeB\x08\xfaB\x05\x8a\x01\x02\x10\x01\
    :=\x9a\xc5\x88\x1e8\n6envoy.config.filter.network.dubbo_proxy.v2alpha1.R\
    oute\"\xe6\x01\n\nRouteMatch\x12T\n\x06method\x18\x01\x20\x01(\x0b2<.env\
    oy.extensions.filters.network.dubbo_proxy.v3.MethodMatchR\x06method\x12>\
    \n\x07headers\x18\x02\x20\x03(\x0b2$.envoy.config.route.v3.HeaderMatcher\
    R\x07headers:B\x9a\xc5\x88\x1e=\n;envoy.config.filter.network.dubbo_prox\
    y.v2alpha1.RouteMatch\"\xdf\x01\n\x0bRouteAction\x12\x1a\n\x07cluster\
    \x18\x01\x20\x01(\tH\0R\x07cluster\x12U\n\x11weighted_clusters\x18\x02\
    \x20\x01(\x0b2&.envoy.config.route.v3.WeightedClusterH\0R\x10weightedClu\
    stersB\x18\n\x11cluster_specifier\x12\x03\xf8B\x01:C\x9a\xc5\x88\x1e>\n<\
    envoy.config.filter.network.dubbo_proxy.v2alpha1.RouteAction\"\x8c\x05\n\
    \x0bMethodMatch\x128\n\x04name\x18\x01\x20\x01(\x0b2$.envoy.type.matcher\
    .v3.StringMatcherR\x04name\x12p\n\x0cparams_match\x18\x02\x20\x03(\x0b2M\
    .envoy.extensions.filters.network.dubbo_proxy.v3.MethodMatch.ParamsMatch\
    EntryR\x0bparamsMatch\x1a\xf4\x01\n\x17ParameterMatchSpecifier\x12!\n\
    \x0bexact_match\x18\x03\x20\x01(\tH\0R\nexactMatch\x12<\n\x0brange_match\
    \x18\x04\x20\x01(\x0b2\x19.envoy.type.v3.Int64RangeH\0R\nrangeMatchB\x1b\
    \n\x19parameter_match_specifier:[\x9a\xc5\x88\x1eV\nTenvoy.config.filter\
    .network.dubbo_proxy.v2alpha1.MethodMatch.ParameterMatchSpecifier\x1a\
    \x94\x01\n\x10ParamsMatchEntry\x12\x10\n\x03key\x18\x01\x20\x01(\rR\x03k\
    ey\x12j\n\x05value\x18\x02\x20\x01(\x0b2T.envoy.extensions.filters.netwo\
    rk.dubbo_proxy.v3.MethodMatch.ParameterMatchSpecifierR\x05value:\x028\
    \x01:C\x9a\xc5\x88\x1e>\n<envoy.config.filter.network.dubbo_proxy.v2alph\
    a1.MethodMatchBU\n=io.envoyproxy.envoy.extensions.filters.network.dubbo_\
    proxy.v3B\nRouteProtoP\x01\xba\x80\xc8\xd1\x06\x02\x10\x02b\x06proto3\
";
