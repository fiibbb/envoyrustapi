...
//! Generated file from `envoy/extensions/filters/http/router/v3/router.proto`
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n4envoy/extensions/filters/http/router/v3/router.proto\x12'envoy.extens\
    ions.filters.http.router.v3\x1a)envoy/config/accesslog/v3/accesslog.prot\
    o\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1dudpa/annotations/status.p\
    roto\x1a!udpa/annotations/versioning.proto\x1a\x17validate/validate.prot\
    o\"\xad\x04\n\x06Router\x12?\n\rdynamic_stats\x18\x01\x20\x01(\x0b2\x1a.\
    google.protobuf.BoolValueR\x0cdynamicStats\x12(\n\x10start_child_span\
    \x18\x02\x20\x01(\x08R\x0estartChildSpan\x12G\n\x0cupstream_log\x18\x03\
    \x20\x03(\x0b2$.envoy.config.accesslog.v3.AccessLogR\x0bupstreamLog\x124\
    \n\x16suppress_envoy_headers\x18\x04\x20\x01(\x08R\x14suppressEnvoyHeade\
    rs\x12\xc7\x01\n\x14strict_check_headers\x18\x05\x20\x03(\tR\x12strictCh\
    eckHeadersB\x94\x01\xfaB\x90\x01\x92\x01\x8c\x01\"\x89\x01r\x86\x01R\x1e\
    x-envoy-upstream-rq-timeout-msR&x-envoy-upstream-rq-per-try-timeout-msR\
    \x13x-envoy-max-retriesR\x15x-envoy-retry-grpc-onR\x10x-envoy-retry-on\
    \x12=\n\x1brespect_expected_rq_timeout\x18\x06\x20\x01(\x08R\x18respectE\
    xpectedRqTimeout:0\x9a\xc5\x88\x1e+\n)envoy.config.filter.http.router.v2\
    .RouterBN\n5io.envoyproxy.envoy.extensions.filters.http.router.v3B\x0bRo\
    uterProtoP\x01\xba\x80\xc8\xd1\x06\x02\x10\x02b\x06proto3\
";
