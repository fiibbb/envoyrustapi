...
//! Generated file from `envoy/extensions/filters/http/cache/v3alpha/cache.proto`
...
impl CacheConfig {
    ...
    // .envoy.extensions.filters.http.cache.v3alpha.CacheConfig.KeyCreatorParams key_creator_params = 3;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n7envoy/extensions/filters/http/cache/v3alpha/cache.proto\x12+envoy.ext\
    ensions.filters.http.cache.v3alpha\x1a,envoy/config/route/v3/route_compo\
    nents.proto\x1a\"envoy/type/matcher/v3/string.proto\x1a\x19google/protob\
    uf/any.proto\x1a\x1dudpa/annotations/status.proto\x1a!udpa/annotations/v\
    ersioning.proto\x1a\x17validate/validate.proto\"\x81\x06\n\x0bCacheConfi\
    g\x12A\n\x0ctyped_config\x18\x01\x20\x01(\x0b2\x14.google.protobuf.AnyR\
    \x0btypedConfigB\x08\xfaB\x05\xa2\x01\x02\x08\x01\x12V\n\x14allowed_vary\
    _headers\x18\x02\x20\x03(\x0b2$.envoy.type.matcher.v3.StringMatcherR\x12\
    allowedVaryHeaders\x12w\n\x12key_creator_params\x18\x03\x20\x01(\x0b2I.e\
    nvoy.extensions.filters.http.cache.v3alpha.CacheConfig.KeyCreatorParamsR\
    \x10keyCreatorParams\x12$\n\x0emax_body_bytes\x18\x04\x20\x01(\rR\x0cmax\
    BodyBytes\x1a\xfc\x02\n\x10KeyCreatorParams\x12%\n\x0eexclude_scheme\x18\
    \x01\x20\x01(\x08R\rexcludeScheme\x12!\n\x0cexclude_host\x18\x02\x20\x01\
    (\x08R\x0bexcludeHost\x12h\n\x19query_parameters_included\x18\x03\x20\
    \x03(\x0b2,.envoy.config.route.v3.QueryParameterMatcherR\x17queryParamet\
    ersIncluded\x12h\n\x19query_parameters_excluded\x18\x04\x20\x03(\x0b2,.e\
    nvoy.config.route.v3.QueryParameterMatcherR\x17queryParametersExcluded:J\
    \x9a\xc5\x88\x1eE\nCenvoy.config.filter.http.cache.v2alpha.CacheConfig.K\
    eyCreatorParams:9\x9a\xc5\x88\x1e4\n2envoy.config.filter.http.cache.v2al\
    pha.CacheConfigBY\n9io.envoyproxy.envoy.extensions.filters.http.cache.v3\
    alphaB\nCacheProtoP\x01\xba\x80\xc8\xd1\x06\x02\x08\x01\xba\x80\xc8\xd1\
