...
//! Generated file from `envoy/extensions/filters/http/jwt_authn/v4alpha/config.proto`
...
impl JwtProvider {
    ...
    // repeated .envoy.extensions.filters.http.jwt_authn.v4alpha.JwtHeader from_headers = 6;
    ...
    pub fn get_clock_skew_seconds(&self) -> u32 {
        self.clock_skew_seconds
    }
    pub fn clear_clock_skew_seconds(&mut self) {
        self.clock_skew_seconds = 0;
    }

    // Param is passed by value, moved
    pub fn set_clock_skew_seconds(&mut self, v: u32) {
        self.clock_skew_seconds = v;
    }
}
...
impl ::protobuf::Message for JwtProvider {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.clock_skew_seconds != 0 {
            my_size += ::protobuf::rt::value_size(10, self.clock_skew_seconds, ::protobuf::wire_format::WireTypeVarint);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.clock_skew_seconds != 0 {
            os.write_uint32(10, self.clock_skew_seconds)?;
        }
        if let ::std::option::Option::Some(ref v) = self.jwks_source_specifier {
            match v {
                &JwtProvider_oneof_jwks_source_specifier::remote_jwks(ref v) => {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeUint32>(
                "clock_skew_seconds",
                |m: &JwtProvider| { &m.clock_skew_seconds },
                |m: &mut JwtProvider| { &mut m.clock_skew_seconds },
            ));
...
impl RemoteJwks {
    ...
    // .envoy.config.core.v4alpha.HttpUri http_uri = 1;
...
impl JwtRequirement {
    ...
    // .envoy.extensions.filters.http.jwt_authn.v4alpha.ProviderWithAudiences provider_and_audiences = 2;
    ...
    // .envoy.extensions.filters.http.jwt_authn.v4alpha.JwtRequirementOrList requires_any = 3;
    ...
    // .envoy.extensions.filters.http.jwt_authn.v4alpha.JwtRequirementAndList requires_all = 4;
...
impl JwtRequirementOrList {
    ...
    // repeated .envoy.extensions.filters.http.jwt_authn.v4alpha.JwtRequirement requirements = 1;
...
pub struct RequirementRule {
    ...
    // message oneof groups
    pub requirement_type: ::std::option::Option<RequirementRule_oneof_requirement_type>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
#[derive(Clone,PartialEq,Debug)]
pub enum RequirementRule_oneof_requirement_type {
    requires(JwtRequirement),
    requirement_name(::std::string::String),
}
...
impl RequirementRule {
    ...
    // .envoy.extensions.filters.http.jwt_authn.v4alpha.JwtRequirement requires = 2;


    pub fn get_requires(&self) -> &JwtRequirement {
        match self.requirement_type {
            ::std::option::Option::Some(RequirementRule_oneof_requirement_type::requires(ref v)) => v,
            _ => <JwtRequirement as ::protobuf::Message>::default_instance(),
        }
    }
    pub fn clear_requires(&mut self) {
        self.requirement_type = ::std::option::Option::None;
    }

    pub fn has_requires(&self) -> bool {
        match self.requirement_type {
            ::std::option::Option::Some(RequirementRule_oneof_requirement_type::requires(..)) => true,
            _ => false,
        }
    }
    ...
    pub fn set_requires(&mut self, v: JwtRequirement) {
        self.requirement_type = ::std::option::Option::Some(RequirementRule_oneof_requirement_type::requires(v))
    }

    // Mutable pointer to the field.
    pub fn mut_requires(&mut self) -> &mut JwtRequirement {
        if let ::std::option::Option::Some(RequirementRule_oneof_requirement_type::requires(_)) = self.requirement_type {
        } else {
            self.requirement_type = ::std::option::Option::Some(RequirementRule_oneof_requirement_type::requires(JwtRequirement::new()));
        }
        match self.requirement_type {
            ::std::option::Option::Some(RequirementRule_oneof_requirement_type::requires(ref mut v)) => v,
            _ => panic!(),
        }
    }
    ...
    pub fn take_requires(&mut self) -> JwtRequirement {
        if self.has_requires() {
            match self.requirement_type.take() {
                ::std::option::Option::Some(RequirementRule_oneof_requirement_type::requires(v)) => v,
                _ => panic!(),
            }
        } else {
            JwtRequirement::new()
    ...
    pub fn get_requirement_name(&self) -> &str {
        match self.requirement_type {
            ::std::option::Option::Some(RequirementRule_oneof_requirement_type::requirement_name(ref v)) => v,
            _ => "",
        }
    }
    pub fn clear_requirement_name(&mut self) {
        self.requirement_type = ::std::option::Option::None;
    }

    pub fn has_requirement_name(&self) -> bool {
        match self.requirement_type {
            ::std::option::Option::Some(RequirementRule_oneof_requirement_type::requirement_name(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_requirement_name(&mut self, v: ::std::string::String) {
        self.requirement_type = ::std::option::Option::Some(RequirementRule_oneof_requirement_type::requirement_name(v))
    }

    // Mutable pointer to the field.
    pub fn mut_requirement_name(&mut self) -> &mut ::std::string::String {
        if let ::std::option::Option::Some(RequirementRule_oneof_requirement_type::requirement_name(_)) = self.requirement_type {
        } else {
            self.requirement_type = ::std::option::Option::Some(RequirementRule_oneof_requirement_type::requirement_name(::std::string::String::new()));
        }
        match self.requirement_type {
            ::std::option::Option::Some(RequirementRule_oneof_requirement_type::requirement_name(ref mut v)) => v,
            _ => panic!(),
        }
    }

    // Take field
    pub fn take_requirement_name(&mut self) -> ::std::string::String {
        if self.has_requirement_name() {
            match self.requirement_type.take() {
                ::std::option::Option::Some(RequirementRule_oneof_requirement_type::requirement_name(v)) => v,
                _ => panic!(),
            }
        } else {
            ::std::string::String::new()
...
impl ::protobuf::Message for RequirementRule {
    fn is_initialized(&self) -> bool {
        ...
        if let Some(RequirementRule_oneof_requirement_type::requires(ref v)) = self.requirement_type {
            if !v.is_initialized() {
                return false;
            }
        }
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                2 => {
                    ...
                    self.requirement_type = ::std::option::Option::Some(RequirementRule_oneof_requirement_type::requires(is.read_message()?));
                },
                3 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    }
                    self.requirement_type = ::std::option::Option::Some(RequirementRule_oneof_requirement_type::requirement_name(is.read_string()?));
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let ::std::option::Option::Some(ref v) = self.requirement_type {
            match v {
                &RequirementRule_oneof_requirement_type::requires(ref v) => {
                    let len = v.compute_size();
                    my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
                },
                &RequirementRule_oneof_requirement_type::requirement_name(ref v) => {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_singular_message_accessor::<_, JwtRequirement>(
                "requires",
                RequirementRule::has_requires,
                RequirementRule::get_requires,
            ));
            fields.push(::protobuf::reflect::accessor::make_singular_string_accessor::<_>(
                "requirement_name",
                RequirementRule::has_requirement_name,
                RequirementRule::get_requirement_name,
            ));
...
impl FilterStateRule {
    ...
    // repeated .envoy.extensions.filters.http.jwt_authn.v4alpha.FilterStateRule.RequiresEntry requires = 3;
...
pub struct JwtAuthentication {
    ...
    pub requirement_map: ::std::collections::HashMap<::std::string::String, JwtRequirement>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl JwtAuthentication {
    ...
    // repeated .envoy.extensions.filters.http.jwt_authn.v4alpha.JwtAuthentication.ProvidersEntry providers = 1;
    ...
    // repeated .envoy.extensions.filters.http.jwt_authn.v4alpha.RequirementRule rules = 2;
    ...
    // .envoy.extensions.filters.http.jwt_authn.v4alpha.FilterStateRule filter_state_rules = 3;
    ...
    // repeated .envoy.extensions.filters.http.jwt_authn.v4alpha.JwtAuthentication.RequirementMapEntry requirement_map = 5;


    pub fn get_requirement_map(&self) -> &::std::collections::HashMap<::std::string::String, JwtRequirement> {
        &self.requirement_map
    }
    pub fn clear_requirement_map(&mut self) {
        self.requirement_map.clear();
    }

    // Param is passed by value, moved
    pub fn set_requirement_map(&mut self, v: ::std::collections::HashMap<::std::string::String, JwtRequirement>) {
        self.requirement_map = v;
    }

    // Mutable pointer to the field.
    pub fn mut_requirement_map(&mut self) -> &mut ::std::collections::HashMap<::std::string::String, JwtRequirement> {
        &mut self.requirement_map
    }

    // Take field
    pub fn take_requirement_map(&mut self) -> ::std::collections::HashMap<::std::string::String, JwtRequirement> {
        ::std::mem::replace(&mut self.requirement_map, ::std::collections::HashMap::new())
    }
}
...
impl ::protobuf::Message for JwtAuthentication {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                5 => {
                    ::protobuf::rt::read_map_into::<::protobuf::types::ProtobufTypeString, ::protobuf::types::ProtobufTypeMessage<JwtRequirement>>(wire_type, is, &mut self.requirement_map)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        my_size += ::protobuf::rt::compute_map_size::<::protobuf::types::ProtobufTypeString, ::protobuf::types::ProtobufTypeMessage<JwtRequirement>>(5, &self.requirement_map);
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        ::protobuf::rt::write_map_with_cached_sizes::<::protobuf::types::ProtobufTypeString, ::protobuf::types::ProtobufTypeMessage<JwtRequirement>>(5, &self.requirement_map, os)?;
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_map_accessor::<_, ::protobuf::types::ProtobufTypeString, ::protobuf::types::ProtobufTypeMessage<JwtRequirement>>(
                "requirement_map",
                |m: &JwtAuthentication| { &m.requirement_map },
                |m: &mut JwtAuthentication| { &mut m.requirement_map },
            ));
...
pub struct PerRouteConfig {
    // message oneof groups
    pub requirement_specifier: ::std::option::Option<PerRouteConfig_oneof_requirement_specifier>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
#[derive(Clone,PartialEq,Debug)]
pub enum PerRouteConfig_oneof_requirement_specifier {
    disabled(bool),
    requirement_name(::std::string::String),
}
...
impl PerRouteConfig {
    ...
    pub fn get_disabled(&self) -> bool {
        match self.requirement_specifier {
            ::std::option::Option::Some(PerRouteConfig_oneof_requirement_specifier::disabled(v)) => v,
            _ => false,
        }
    }
    pub fn clear_disabled(&mut self) {
        self.requirement_specifier = ::std::option::Option::None;
    }

    pub fn has_disabled(&self) -> bool {
        match self.requirement_specifier {
            ::std::option::Option::Some(PerRouteConfig_oneof_requirement_specifier::disabled(..)) => true,
            _ => false,
        }
    }
    ...
    pub fn set_disabled(&mut self, v: bool) {
        self.requirement_specifier = ::std::option::Option::Some(PerRouteConfig_oneof_requirement_specifier::disabled(v))
    }
    ...
    pub fn get_requirement_name(&self) -> &str {
        match self.requirement_specifier {
            ::std::option::Option::Some(PerRouteConfig_oneof_requirement_specifier::requirement_name(ref v)) => v,
            _ => "",
        }
    }
    pub fn clear_requirement_name(&mut self) {
    ...
    pub fn has_requirement_name(&self) -> bool {
        match self.requirement_specifier {
            ::std::option::Option::Some(PerRouteConfig_oneof_requirement_specifier::requirement_name(..)) => true,
            _ => false,
        }
    }
    ...
    // Param is passed by value, moved
    pub fn set_requirement_name(&mut self, v: ::std::string::String) {
        self.requirement_specifier = ::std::option::Option::Some(PerRouteConfig_oneof_requirement_specifier::requirement_name(v))
    }

    // Mutable pointer to the field.
    pub fn mut_requirement_name(&mut self) -> &mut ::std::string::String {
        if let ::std::option::Option::Some(PerRouteConfig_oneof_requirement_specifier::requirement_name(_)) = self.requirement_specifier {
        } else {
            self.requirement_specifier = ::std::option::Option::Some(PerRouteConfig_oneof_requirement_specifier::requirement_name(::std::string::String::new()));
        }
        match self.requirement_specifier {
            ::std::option::Option::Some(PerRouteConfig_oneof_requirement_specifier::requirement_name(ref mut v)) => v,
            _ => panic!(),
        }
    }
    ...
    pub fn take_requirement_name(&mut self) -> ::std::string::String {
        if self.has_requirement_name() {
            match self.requirement_specifier.take() {
                ::std::option::Option::Some(PerRouteConfig_oneof_requirement_specifier::requirement_name(v)) => v,
                _ => panic!(),
            }
        } else {
            ::std::string::String::new()
...
impl ::protobuf::Message for PerRouteConfig {
        ...
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ...
                    self.requirement_specifier = ::std::option::Option::Some(PerRouteConfig_oneof_requirement_specifier::disabled(is.read_bool()?));
                },
                2 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    }
                    self.requirement_specifier = ::std::option::Option::Some(PerRouteConfig_oneof_requirement_specifier::requirement_name(is.read_string()?));
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        let mut my_size = 0;
        if let ::std::option::Option::Some(ref v) = self.requirement_specifier {
            match v {
                &PerRouteConfig_oneof_requirement_specifier::disabled(v) => {
                    my_size += 2;
                },
                &PerRouteConfig_oneof_requirement_specifier::requirement_name(ref v) => {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_singular_bool_accessor::<_>(
                "disabled",
                PerRouteConfig::has_disabled,
                PerRouteConfig::get_disabled,
            ));
            fields.push(::protobuf::reflect::accessor::make_singular_string_accessor::<_>(
                "requirement_name",
                PerRouteConfig::has_requirement_name,
                PerRouteConfig::get_requirement_name,
            ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n<envoy/extensions/filters/http/jwt_authn/v4alpha/config.proto\x12/envo\
    y.extensions.filters.http.jwt_authn.v4alpha\x1a$envoy/config/core/v4alph\
    a/base.proto\x1a(envoy/config/core/v4alpha/http_uri.proto\x1a1envoy/conf\
    ig/route/v4alpha/route_components.proto\x1a\x1egoogle/protobuf/duration.\
    proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1dudpa/annotations/status.\
    proto\x1a!udpa/annotations/versioning.proto\x1a\x17validate/validate.pro\
    to\"\x8c\x05\n\x0bJwtProvider\x12\x1f\n\x06issuer\x18\x01\x20\x01(\tR\
    \x06issuerB\x07\xfaB\x04r\x02\x10\x01\x12\x1c\n\taudiences\x18\x02\x20\
    \x03(\tR\taudiences\x12^\n\x0bremote_jwks\x18\x03\x20\x01(\x0b2;.envoy.e\
    xtensions.filters.http.jwt_authn.v4alpha.RemoteJwksH\0R\nremoteJwks\x12F\
    \n\nlocal_jwks\x18\x04\x20\x01(\x0b2%.envoy.config.core.v4alpha.DataSour\
    ceH\0R\tlocalJwks\x12\x18\n\x07forward\x18\x05\x20\x01(\x08R\x07forward\
    \x12]\n\x0cfrom_headers\x18\x06\x20\x03(\x0b2:.envoy.extensions.filters.\
    http.jwt_authn.v4alpha.JwtHeaderR\x0bfromHeaders\x12\x1f\n\x0bfrom_param\
    s\x18\x07\x20\x03(\tR\nfromParams\x12A\n\x16forward_payload_header\x18\
    \x08\x20\x01(\tR\x14forwardPayloadHeaderB\x0b\xfaB\x08r\x06\xc0\x01\x01\
    \xc8\x01\0\x12.\n\x13payload_in_metadata\x18\t\x20\x01(\tR\x11payloadInM\
    etadata\x12,\n\x12clock_skew_seconds\x18\n\x20\x01(\rR\x10clockSkewSecon\
    dsB\x1c\n\x15jwks_source_specifier\x12\x03\xf8B\x01:=\x9a\xc5\x88\x1e8\n\
    6envoy.extensions.filters.http.jwt_authn.v3.JwtProvider\"\xcb\x01\n\nRem\
    oteJwks\x12=\n\x08http_uri\x18\x01\x20\x01(\x0b2\".envoy.config.core.v4a\
    lpha.HttpUriR\x07httpUri\x12@\n\x0ecache_duration\x18\x02\x20\x01(\x0b2\
    \x19.google.protobuf.DurationR\rcacheDuration:<\x9a\xc5\x88\x1e7\n5envoy\
    .extensions.filters.http.jwt_authn.v3.RemoteJwks\"\x9b\x01\n\tJwtHeader\
    \x12!\n\x04name\x18\x01\x20\x01(\tR\x04nameB\r\xfaB\nr\x08\x10\x01\xc0\
    \x01\x01\xc8\x01\0\x12.\n\x0cvalue_prefix\x18\x02\x20\x01(\tR\x0bvaluePr\
    efixB\x0b\xfaB\x08r\x06\xc0\x01\x02\xc8\x01\0:;\x9a\xc5\x88\x1e6\n4envoy\
    .extensions.filters.http.jwt_authn.v3.JwtHeader\"\xa3\x01\n\x15ProviderW\
    ithAudiences\x12#\n\rprovider_name\x18\x01\x20\x01(\tR\x0cproviderName\
    \x12\x1c\n\taudiences\x18\x02\x20\x03(\tR\taudiences:G\x9a\xc5\x88\x1eB\
    \n@envoy.extensions.filters.http.jwt_authn.v3.ProviderWithAudiences\"\
    \xf3\x04\n\x0eJwtRequirement\x12%\n\rprovider_name\x18\x01\x20\x01(\tH\0\
    R\x0cproviderName\x12~\n\x16provider_and_audiences\x18\x02\x20\x01(\x0b2\
    F.envoy.extensions.filters.http.jwt_authn.v4alpha.ProviderWithAudiencesH\
    \0R\x14providerAndAudiences\x12j\n\x0crequires_any\x18\x03\x20\x01(\x0b2\
    E.envoy.extensions.filters.http.jwt_authn.v4alpha.JwtRequirementOrListH\
    \0R\x0brequiresAny\x12k\n\x0crequires_all\x18\x04\x20\x01(\x0b2F.envoy.e\
    xtensions.filters.http.jwt_authn.v4alpha.JwtRequirementAndListH\0R\x0bre\
    quiresAll\x12O\n\x17allow_missing_or_failed\x18\x05\x20\x01(\x0b2\x16.go\
    ogle.protobuf.EmptyH\0R\x14allowMissingOrFailed\x12=\n\rallow_missing\
    \x18\x06\x20\x01(\x0b2\x16.google.protobuf.EmptyH\0R\x0callowMissingB\
    \x0f\n\rrequires_type:@\x9a\xc5\x88\x1e;\n9envoy.extensions.filters.http\
    .jwt_authn.v3.JwtRequirement\"\xcd\x01\n\x14JwtRequirementOrList\x12m\n\
    \x0crequirements\x18\x01\x20\x03(\x0b2?.envoy.extensions.filters.http.jw\
    t_authn.v4alpha.JwtRequirementR\x0crequirementsB\x08\xfaB\x05\x92\x01\
    \x02\x08\x02:F\x9a\xc5\x88\x1eA\n?envoy.extensions.filters.http.jwt_auth\
    n.v3.JwtRequirementOrList\"\xcf\x01\n\x15JwtRequirementAndList\x12m\n\
    \x0crequirements\x18\x01\x20\x03(\x0b2?.envoy.extensions.filters.http.jw\
    t_authn.v4alpha.JwtRequirementR\x0crequirementsB\x08\xfaB\x05\x92\x01\
    \x02\x08\x02:G\x9a\xc5\x88\x1eB\n@envoy.extensions.filters.http.jwt_auth\
    n.v3.JwtRequirementAndList\"\xc5\x02\n\x0fRequirementRule\x12F\n\x05matc\
    h\x18\x01\x20\x01(\x0b2&.envoy.config.route.v4alpha.RouteMatchR\x05match\
    B\x08\xfaB\x05\x8a\x01\x02\x10\x01\x12]\n\x08requires\x18\x02\x20\x01(\
    \x0b2?.envoy.extensions.filters.http.jwt_authn.v4alpha.JwtRequirementH\0\
    R\x08requires\x124\n\x10requirement_name\x18\x03\x20\x01(\tH\0R\x0frequi\
    rementNameB\x07\xfaB\x04r\x02\x10\x01B\x12\n\x10requirement_type:A\x9a\
    \xc5\x88\x1e<\n:envoy.extensions.filters.http.jwt_authn.v3.RequirementRu\
    le\"\xdb\x02\n\x0fFilterStateRule\x12\x1b\n\x04name\x18\x01\x20\x01(\tR\
    \x04nameB\x07\xfaB\x04r\x02\x10\x01\x12j\n\x08requires\x18\x03\x20\x03(\
    \x0b2N.envoy.extensions.filters.http.jwt_authn.v4alpha.FilterStateRule.R\
    equiresEntryR\x08requires\x1a|\n\rRequiresEntry\x12\x10\n\x03key\x18\x01\
    \x20\x01(\tR\x03key\x12U\n\x05value\x18\x02\x20\x01(\x0b2?.envoy.extensi\
    ons.filters.http.jwt_authn.v4alpha.JwtRequirementR\x05value:\x028\x01:A\
    \x9a\xc5\x88\x1e<\n:envoy.extensions.filters.http.jwt_authn.v3.FilterSta\
    teRule\"\xc7\x06\n\x11JwtAuthentication\x12o\n\tproviders\x18\x01\x20\
    \x03(\x0b2Q.envoy.extensions.filters.http.jwt_authn.v4alpha.JwtAuthentic\
    ation.ProvidersEntryR\tproviders\x12V\n\x05rules\x18\x02\x20\x03(\x0b2@.\
    envoy.extensions.filters.http.jwt_authn.v4alpha.RequirementRuleR\x05rule\
    s\x12n\n\x12filter_state_rules\x18\x03\x20\x01(\x0b2@.envoy.extensions.f\
    ilters.http.jwt_authn.v4alpha.FilterStateRuleR\x10filterStateRules\x122\
    \n\x15bypass_cors_preflight\x18\x04\x20\x01(\x08R\x13bypassCorsPreflight\
    \x12\x7f\n\x0frequirement_map\x18\x05\x20\x03(\x0b2V.envoy.extensions.fi\
    lters.http.jwt_authn.v4alpha.JwtAuthentication.RequirementMapEntryR\x0er\
    equirementMap\x1az\n\x0eProvidersEntry\x12\x10\n\x03key\x18\x01\x20\x01(\
    \tR\x03key\x12R\n\x05value\x18\x02\x20\x01(\x0b2<.envoy.extensions.filte\
    rs.http.jwt_authn.v4alpha.JwtProviderR\x05value:\x028\x01\x1a\x82\x01\n\
    \x13RequirementMapEntry\x12\x10\n\x03key\x18\x01\x20\x01(\tR\x03key\x12U\
    \n\x05value\x18\x02\x20\x01(\x0b2?.envoy.extensions.filters.http.jwt_aut\
    hn.v4alpha.JwtRequirementR\x05value:\x028\x01:C\x9a\xc5\x88\x1e>\n<envoy\
    .extensions.filters.http.jwt_authn.v3.JwtAuthentication\"\xcd\x01\n\x0eP\
    erRouteConfig\x12%\n\x08disabled\x18\x01\x20\x01(\x08H\0R\x08disabledB\
    \x07\xfaB\x04j\x02\x08\x01\x124\n\x10requirement_name\x18\x02\x20\x01(\t\
    H\0R\x0frequirementNameB\x07\xfaB\x04r\x02\x10\x01B\x1c\n\x15requirement\
    _specifier\x12\x03\xf8B\x01:@\x9a\xc5\x88\x1e;\n9envoy.extensions.filter\
    s.http.jwt_authn.v3.PerRouteConfigBV\n=io.envoyproxy.envoy.extensions.fi\
    lters.http.jwt_authn.v4alphaB\x0bConfigProtoP\x01\xba\x80\xc8\xd1\x06\
