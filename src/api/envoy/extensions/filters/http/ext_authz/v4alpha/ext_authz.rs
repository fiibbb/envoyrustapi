...
//! Generated file from `envoy/extensions/filters/http/ext_authz/v4alpha/ext_authz.proto`
...
impl ExtAuthz {
    ...
    // .envoy.extensions.filters.http.ext_authz.v4alpha.HttpService http_service = 3;
    ...
    // .envoy.config.core.v4alpha.ApiVersion transport_api_version = 12;
    ...
    // .envoy.extensions.filters.http.ext_authz.v4alpha.BufferSettings with_request_body = 5;
    ...
    // .envoy.type.matcher.v4alpha.MetadataMatcher filter_enabled_metadata = 14;
    ...
    // .envoy.config.core.v4alpha.RuntimeFeatureFlag deny_at_disable = 11;
...
impl HttpService {
    ...
    // .envoy.config.core.v4alpha.HttpUri server_uri = 1;
    ...
    // .envoy.extensions.filters.http.ext_authz.v4alpha.AuthorizationRequest authorization_request = 7;
    ...
    // .envoy.extensions.filters.http.ext_authz.v4alpha.AuthorizationResponse authorization_response = 8;
...
impl AuthorizationRequest {
    ...
    // .envoy.type.matcher.v4alpha.ListStringMatcher allowed_headers = 1;
    ...
    // repeated .envoy.config.core.v4alpha.HeaderValue headers_to_add = 2;
...
impl AuthorizationResponse {
    ...
    // .envoy.type.matcher.v4alpha.ListStringMatcher allowed_upstream_headers = 1;
    ...
    // .envoy.type.matcher.v4alpha.ListStringMatcher allowed_upstream_headers_to_append = 3;
    ...
    // .envoy.type.matcher.v4alpha.ListStringMatcher allowed_client_headers = 2;
...
impl ExtAuthzPerRoute {
    ...
    // .envoy.extensions.filters.http.ext_authz.v4alpha.CheckSettings check_settings = 2;
...
impl CheckSettings {
    ...
    // repeated .envoy.extensions.filters.http.ext_authz.v4alpha.CheckSettings.ContextExtensionsEntry context_extensions = 1;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n?envoy/extensions/filters/http/ext_authz/v4alpha/ext_authz.proto\x12/e\
    nvoy.extensions.filters.http.ext_authz.v4alpha\x1a$envoy/config/core/v4a\
    lpha/base.proto\x1a-envoy/config/core/v4alpha/config_source.proto\x1a,en\
    voy/config/core/v4alpha/grpc_service.proto\x1a(envoy/config/core/v4alpha\
    /http_uri.proto\x1a)envoy/type/matcher/v4alpha/metadata.proto\x1a'envoy/\
    type/matcher/v4alpha/string.proto\x1a\x1fenvoy/type/v3/http_status.proto\
    \x1a#envoy/annotations/deprecation.proto\x1a\x1dudpa/annotations/status.\
    proto\x1a!udpa/annotations/versioning.proto\x1a\x17validate/validate.pro\
    to\"\xb5\x08\n\x08ExtAuthz\x12K\n\x0cgrpc_service\x18\x01\x20\x01(\x0b2&\
    .envoy.config.core.v4alpha.GrpcServiceH\0R\x0bgrpcService\x12a\n\x0chttp\
    _service\x18\x03\x20\x01(\x0b2<.envoy.extensions.filters.http.ext_authz.\
    v4alpha.HttpServiceH\0R\x0bhttpService\x12c\n\x15transport_api_version\
    \x18\x0c\x20\x01(\x0e2%.envoy.config.core.v4alpha.ApiVersionR\x13transpo\
    rtApiVersionB\x08\xfaB\x05\x82\x01\x02\x10\x01\x12,\n\x12failure_mode_al\
    low\x18\x02\x20\x01(\x08R\x10failureModeAllow\x12k\n\x11with_request_bod\
    y\x18\x05\x20\x01(\x0b2?.envoy.extensions.filters.http.ext_authz.v4alpha\
    .BufferSettingsR\x0fwithRequestBody\x12*\n\x11clear_route_cache\x18\x06\
    \x20\x01(\x08R\x0fclearRouteCache\x12A\n\x0fstatus_on_error\x18\x07\x20\
    \x01(\x0b2\x19.envoy.type.v3.HttpStatusR\rstatusOnError\x12>\n\x1bmetada\
    ta_context_namespaces\x18\x08\x20\x03(\tR\x19metadataContextNamespaces\
    \x12Z\n\x0efilter_enabled\x18\t\x20\x01(\x0b23.envoy.config.core.v4alpha\
    .RuntimeFractionalPercentR\rfilterEnabled\x12c\n\x17filter_enabled_metad\
    ata\x18\x0e\x20\x01(\x0b2+.envoy.type.matcher.v4alpha.MetadataMatcherR\
    \x15filterEnabledMetadata\x12U\n\x0fdeny_at_disable\x18\x0b\x20\x01(\x0b\
    2-.envoy.config.core.v4alpha.RuntimeFeatureFlagR\rdenyAtDisable\x128\n\
    \x18include_peer_certificate\x18\n\x20\x01(\x08R\x16includePeerCertifica\
    te\x12\x1f\n\x0bstat_prefix\x18\r\x20\x01(\tR\nstatPrefixB\n\n\x08servic\
    es::\x9a\xc5\x88\x1e5\n3envoy.extensions.filters.http.ext_authz.v3.ExtAu\
    thzJ\x04\x08\x04\x10\x05R\tuse_alpha\"\xdf\x01\n\x0eBufferSettings\x123\
    ...
    packAsBytes:@\x9a\xc5\x88\x1e;\n9envoy.extensions.filters.http.ext_authz\
    .v3.BufferSettings\"\xc3\x03\n\x0bHttpService\x12A\n\nserver_uri\x18\x01\
    \x20\x01(\x0b2\".envoy.config.core.v4alpha.HttpUriR\tserverUri\x12\x1f\n\
    \x0bpath_prefix\x18\x02\x20\x01(\tR\npathPrefix\x12z\n\x15authorization_\
    request\x18\x07\x20\x01(\x0b2E.envoy.extensions.filters.http.ext_authz.v\
    4alpha.AuthorizationRequestR\x14authorizationRequest\x12}\n\x16authoriza\
    tion_response\x18\x08\x20\x01(\x0b2F.envoy.extensions.filters.http.ext_a\
    uthz.v4alpha.AuthorizationResponseR\x15authorizationResponse:=\x9a\xc5\
    \x88\x1e8\n6envoy.extensions.filters.http.ext_authz.v3.HttpServiceJ\x04\
    \x08\x03\x10\x04J\x04\x08\x04\x10\x05J\x04\x08\x05\x10\x06J\x04\x08\x06\
    \x10\x07\"\x84\x02\n\x14AuthorizationRequest\x12V\n\x0fallowed_headers\
    \x18\x01\x20\x01(\x0b2-.envoy.type.matcher.v4alpha.ListStringMatcherR\
    \x0eallowedHeaders\x12L\n\x0eheaders_to_add\x18\x02\x20\x03(\x0b2&.envoy\
    .config.core.v4alpha.HeaderValueR\x0cheadersToAdd:F\x9a\xc5\x88\x1eA\n?e\
    nvoy.extensions.filters.http.ext_authz.v3.AuthorizationRequest\"\xa9\x03\
    \n\x15AuthorizationResponse\x12g\n\x18allowed_upstream_headers\x18\x01\
    \x20\x01(\x0b2-.envoy.type.matcher.v4alpha.ListStringMatcherR\x16allowed\
    UpstreamHeaders\x12y\n\"allowed_upstream_headers_to_append\x18\x03\x20\
    \x01(\x0b2-.envoy.type.matcher.v4alpha.ListStringMatcherR\x1eallowedUpst\
    reamHeadersToAppend\x12c\n\x16allowed_client_headers\x18\x02\x20\x01(\
    \x0b2-.envoy.type.matcher.v4alpha.ListStringMatcherR\x14allowedClientHea\
    ders:G\x9a\xc5\x88\x1eB\n@envoy.extensions.filters.http.ext_authz.v3.Aut\
    horizationResponse\"\x81\x02\n\x10ExtAuthzPerRoute\x12%\n\x08disabled\
    \x18\x01\x20\x01(\x08H\0R\x08disabledB\x07\xfaB\x04j\x02\x08\x01\x12q\n\
    \x0echeck_settings\x18\x02\x20\x01(\x0b2>.envoy.extensions.filters.http.\
    ext_authz.v4alpha.CheckSettingsH\0R\rcheckSettingsB\x08\xfaB\x05\x8a\x01\
    \x02\x10\x01B\x0f\n\x08override\x12\x03\xf8B\x01:B\x9a\xc5\x88\x1e=\n;en\
    voy.extensions.filters.http.ext_authz.v3.ExtAuthzPerRoute\"\xe2\x02\n\rC\
    heckSettings\x12\x84\x01\n\x12context_extensions\x18\x01\x20\x03(\x0b2U.\
    envoy.extensions.filters.http.ext_authz.v4alpha.CheckSettings.ContextExt\
    ensionsEntryR\x11contextExtensions\x12C\n\x1edisable_request_body_buffer\
    ing\x18\x02\x20\x01(\x08R\x1bdisableRequestBodyBuffering\x1aD\n\x16Conte\
    xtExtensionsEntry\x12\x10\n\x03key\x18\x01\x20\x01(\tR\x03key\x12\x14\n\
    \x05value\x18\x02\x20\x01(\tR\x05value:\x028\x01:?\x9a\xc5\x88\x1e:\n8en\
    voy.extensions.filters.http.ext_authz.v3.CheckSettingsBX\n=io.envoyproxy\
    .envoy.extensions.filters.http.ext_authz.v4alphaB\rExtAuthzProtoP\x01\
