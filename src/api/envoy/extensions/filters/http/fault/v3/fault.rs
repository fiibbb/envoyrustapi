...
//! Generated file from `envoy/extensions/filters/http/fault/v3/fault.proto`
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n2envoy/extensions/filters/http/fault/v3/fault.proto\x12&envoy.extensio\
    ns.filters.http.fault.v3\x1a,envoy/config/route/v3/route_components.prot\
    o\x1a4envoy/extensions/filters/common/fault/v3/fault.proto\x1a\x1benvoy/\
    ...
    lidate/validate.proto\"\xa4\x03\n\nFaultAbort\x12.\n\x0bhttp_status\x18\
    \x02\x20\x01(\rH\0R\nhttpStatusB\x0b\xfaB\x08*\x06\x10\xd8\x04(\xc8\x01\
    \x12!\n\x0bgrpc_status\x18\x05\x20\x01(\rH\0R\ngrpcStatus\x12c\n\x0chead\
    er_abort\x18\x04\x20\x01(\x0b2>.envoy.extensions.filters.http.fault.v3.F\
    aultAbort.HeaderAbortH\0R\x0bheaderAbort\x12@\n\npercentage\x18\x03\x20\
    \x01(\x0b2\x20.envoy.type.v3.FractionalPercentR\npercentage\x1aN\n\x0bHe\
    aderAbort:?\x9a\xc5\x88\x1e:\n8envoy.config.filter.http.fault.v2.FaultAb\
    ort.HeaderAbortB\x11\n\nerror_type\x12\x03\xf8B\x01:3\x9a\xc5\x88\x1e.\n\
    ,envoy.config.filter.http.fault.v2.FaultAbortJ\x04\x08\x01\x10\x02\"\xbc\
    \x07\n\tHTTPFault\x12J\n\x05delay\x18\x01\x20\x01(\x0b24.envoy.extension\
    s.filters.common.fault.v3.FaultDelayR\x05delay\x12H\n\x05abort\x18\x02\
    \x20\x01(\x0b22.envoy.extensions.filters.http.fault.v3.FaultAbortR\x05ab\
    ort\x12)\n\x10upstream_cluster\x18\x03\x20\x01(\tR\x0fupstreamCluster\
    \x12>\n\x07headers\x18\x04\x20\x03(\x0b2$.envoy.config.route.v3.HeaderMa\
    tcherR\x07headers\x12)\n\x10downstream_nodes\x18\x05\x20\x03(\tR\x0fdown\
    streamNodes\x12H\n\x11max_active_faults\x18\x06\x20\x01(\x0b2\x1c.google\
    .protobuf.UInt32ValueR\x0fmaxActiveFaults\x12h\n\x13response_rate_limit\
    \x18\x07\x20\x01(\x0b28.envoy.extensions.filters.common.fault.v3.FaultRa\
    teLimitR\x11responseRateLimit\x122\n\x15delay_percent_runtime\x18\x08\
    \x20\x01(\tR\x13delayPercentRuntime\x122\n\x15abort_percent_runtime\x18\
    \t\x20\x01(\tR\x13abortPercentRuntime\x124\n\x16delay_duration_runtime\
    \x18\n\x20\x01(\tR\x14delayDurationRuntime\x129\n\x19abort_http_status_r\
    untime\x18\x0b\x20\x01(\tR\x16abortHttpStatusRuntime\x129\n\x19max_activ\
    e_faults_runtime\x18\x0c\x20\x01(\tR\x16maxActiveFaultsRuntime\x12L\n#re\
    sponse_rate_limit_percent_runtime\x18\r\x20\x01(\tR\x1fresponseRateLimit\
    PercentRuntime\x129\n\x19abort_grpc_status_runtime\x18\x0e\x20\x01(\tR\
    \x16abortGrpcStatusRuntime:2\x9a\xc5\x88\x1e-\n+envoy.config.filter.http\
    .fault.v2.HTTPFaultBL\n4io.envoyproxy.envoy.extensions.filters.http.faul\
