...
//! Generated file from `envoy/extensions/filters/http/grpc_http1_bridge/v3/config.proto`
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n?envoy/extensions/filters/http/grpc_http1_bridge/v3/config.proto\x122e\
    nvoy.extensions.filters.http.grpc_http1_bridge.v3\x1a\x1dudpa/annotation\
    s/status.proto\x1a!udpa/annotations/versioning.proto\"E\n\x06Config:;\
    \x9a\xc5\x88\x1e6\n4envoy.config.filter.http.grpc_http1_bridge.v2.Config\
    BY\n@io.envoyproxy.envoy.extensions.filters.http.grpc_http1_bridge.v3B\
