...
//! Generated file from `envoy/extensions/transport_sockets/tls/v4alpha/common.proto`
...
impl TlsParameters {
    ...
    // .envoy.extensions.transport_sockets.tls.v4alpha.TlsParameters.TlsProtocol tls_minimum_protocol_version = 1;
    ...
    // .envoy.extensions.transport_sockets.tls.v4alpha.TlsParameters.TlsProtocol tls_maximum_protocol_version = 2;
...
pub struct TlsCertificate {
    ...
    pub watched_directory: ::protobuf::SingularPtrField<super::base::WatchedDirectory>,
...
impl TlsCertificate {
    ...
    pub fn get_watched_directory(&self) -> &super::base::WatchedDirectory {
        self.watched_directory.as_ref().unwrap_or_else(|| <super::base::WatchedDirectory as ::protobuf::Message>::default_instance())
    }
    pub fn clear_watched_directory(&mut self) {
        self.watched_directory.clear();
    }

    pub fn has_watched_directory(&self) -> bool {
        self.watched_directory.is_some()
    }

    // Param is passed by value, moved
    pub fn set_watched_directory(&mut self, v: super::base::WatchedDirectory) {
        self.watched_directory = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_watched_directory(&mut self) -> &mut super::base::WatchedDirectory {
        if self.watched_directory.is_none() {
            self.watched_directory.set_default();
        }
        self.watched_directory.as_mut().unwrap()
    }

    // Take field
    pub fn take_watched_directory(&mut self) -> super::base::WatchedDirectory {
        self.watched_directory.take().unwrap_or_else(|| super::base::WatchedDirectory::new())
    }
    ...
    // .envoy.config.core.v4alpha.DataSource password = 3;
    ...
    // .envoy.config.core.v4alpha.DataSource ocsp_staple = 4;
...
impl ::protobuf::Message for TlsCertificate {
    fn is_initialized(&self) -> bool {
        ...
        for v in &self.watched_directory {
            if !v.is_initialized() {
                return false;
            }
        };
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                7 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.watched_directory)?;
                },
                6 => {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let Some(ref v) = self.watched_directory.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<super::base::WatchedDirectory>>(
                "watched_directory",
                |m: &TlsCertificate| { &m.watched_directory },
                |m: &mut TlsCertificate| { &mut m.watched_directory },
            ));
...
impl TlsSessionTicketKeys {
    ...
    // repeated .envoy.config.core.v4alpha.DataSource keys = 1;
...
impl CertificateValidationContext {
    ...
    // .envoy.extensions.transport_sockets.tls.v4alpha.CertificateValidationContext.TrustChainVerification trust_chain_verification = 10;
...
impl ::protobuf::Message for CertificateValidationContext {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<super::base::WatchedDirectory>>(
                "watched_directory",
                |m: &CertificateValidationContext| { &m.watched_directory },
                |m: &mut CertificateValidationContext| { &mut m.watched_directory },
            ));
            fields.push(::protobuf::reflect::accessor::make_repeated_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n;envoy/extensions/transport_sockets/tls/v4alpha/common.proto\x12.envoy\
    .extensions.transport_sockets.tls.v4alpha\x1a$envoy/config/core/v4alpha/\
    base.proto\x1a'envoy/type/matcher/v4alpha/string.proto\x1a\x19google/pro\
    tobuf/any.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1egoogle/protob\
    uf/wrappers.proto\x1a\x20udpa/annotations/sensitive.proto\x1a\x1dudpa/an\
    notations/status.proto\x1a!udpa/annotations/versioning.proto\x1a\x17vali\
    date/validate.proto\"\x94\x04\n\rTlsParameters\x12\x94\x01\n\x1ctls_mini\
    mum_protocol_version\x18\x01\x20\x01(\x0e2I.envoy.extensions.transport_s\
    ockets.tls.v4alpha.TlsParameters.TlsProtocolR\x19tlsMinimumProtocolVersi\
    onB\x08\xfaB\x05\x82\x01\x02\x10\x01\x12\x94\x01\n\x1ctls_maximum_protoc\
    ol_version\x18\x02\x20\x01(\x0e2I.envoy.extensions.transport_sockets.tls\
    .v4alpha.TlsParameters.TlsProtocolR\x19tlsMaximumProtocolVersionB\x08\
    \xfaB\x05\x82\x01\x02\x10\x01\x12#\n\rcipher_suites\x18\x03\x20\x03(\tR\
    \x0ccipherSuites\x12\x1f\n\x0becdh_curves\x18\x04\x20\x03(\tR\necdhCurve\
    s\"O\n\x0bTlsProtocol\x12\x0c\n\x08TLS_AUTO\x10\0\x12\x0b\n\x07TLSv1_0\
    \x10\x01\x12\x0b\n\x07TLSv1_1\x10\x02\x12\x0b\n\x07TLSv1_2\x10\x03\x12\
    \x0b\n\x07TLSv1_3\x10\x04:>\x9a\xc5\x88\x1e9\n7envoy.extensions.transpor\
    t_sockets.tls.v3.TlsParameters\"\xe7\x01\n\x12PrivateKeyProvider\x12,\n\
    \rprovider_name\x18\x01\x20\x01(\tR\x0cproviderNameB\x07\xfaB\x04r\x02\
    \x10\x01\x12A\n\x0ctyped_config\x18\x03\x20\x01(\x0b2\x14.google.protobu\
    f.AnyH\0R\x0btypedConfigB\x06\xb8\xb7\x8b\xa4\x02\x01B\r\n\x0bconfig_typ\
    e:C\x9a\xc5\x88\x1e>\n<envoy.extensions.transport_sockets.tls.v3.Private\
    KeyProviderJ\x04\x08\x02\x10\x03R\x06config\"\xc1\x05\n\x0eTlsCertificat\
    e\x12R\n\x11certificate_chain\x18\x01\x20\x01(\x0b2%.envoy.config.core.v\
    4alpha.DataSourceR\x10certificateChain\x12N\n\x0bprivate_key\x18\x02\x20\
    \x01(\x0b2%.envoy.config.core.v4alpha.DataSourceR\nprivateKeyB\x06\xb8\
    \xb7\x8b\xa4\x02\x01\x12X\n\x11watched_directory\x18\x07\x20\x01(\x0b2+.\
    envoy.config.core.v4alpha.WatchedDirectoryR\x10watchedDirectory\x12t\n\
    \x14private_key_provider\x18\x06\x20\x01(\x0b2B.envoy.extensions.transpo\
    rt_sockets.tls.v4alpha.PrivateKeyProviderR\x12privateKeyProvider\x12I\n\
    \x08password\x18\x03\x20\x01(\x0b2%.envoy.config.core.v4alpha.DataSource\
    R\x08passwordB\x06\xb8\xb7\x8b\xa4\x02\x01\x12F\n\x0bocsp_staple\x18\x04\
    \x20\x01(\x0b2%.envoy.config.core.v4alpha.DataSourceR\nocspStaple\x12g\n\
    \x1csigned_certificate_timestamp\x18\x05\x20\x03(\x0b2%.envoy.config.cor\
    ...
    \x0b2+.envoy.config.core.v4alpha.WatchedDirectoryR\x10watchedDirectory\
    \x12F\n\x17verify_certificate_spki\x18\x03\x20\x03(\tR\x15verifyCertific\
    ateSpkiB\x0e\xfaB\x0b\x92\x01\x08\"\x06r\x04\x10,(,\x12F\n\x17verify_cer\
    tificate_hash\x18\x02\x20\x03(\tR\x15verifyCertificateHashB\x0e\xfaB\x0b\
    \x92\x01\x08\"\x06r\x04\x10@(_\x12`\n\x17match_subject_alt_names\x18\t\
    \x20\x03(\x0b2).envoy.type.matcher.v4alpha.StringMatcherR\x14matchSubjec\
    ...
    \x127\n\x03crl\x18\x07\x20\x01(\x0b2%.envoy.config.core.v4alpha.DataSour\
    ceR\x03crl\x12:\n\x19allow_expired_certificate\x18\x08\x20\x01(\x08R\x17\
    allowExpiredCertificate\x12\xa7\x01\n\x18trust_chain_verification\x18\n\
    \x20\x01(\x0e2c.envoy.extensions.transport_sockets.tls.v4alpha.Certifica\
    teValidationContext.TrustChainVerificationR\x16trustChainVerificationB\
    \x08\xfaB\x05\x82\x01\x02\x10\x01\"F\n\x16TrustChainVerification\x12\x16\
    \n\x12VERIFY_TRUST_CHAIN\x10\0\x12\x14\n\x10ACCEPT_UNTRUSTED\x10\x01:M\
    \x9a\xc5\x88\x1eH\nFenvoy.extensions.transport_sockets.tls.v3.Certificat\
    eValidationContextJ\x04\x08\x04\x10\x05J\x04\x08\x05\x10\x06R\x17verify_\
    subject_alt_nameBU\n<io.envoyproxy.envoy.extensions.transport_sockets.tl\
    s.v4alphaB\x0bCommonProtoP\x01\xba\x80\xc8\xd1\x06\x02\x10\x03b\x06proto\
    3\
";
