...
//! Generated file from `envoy/extensions/transport_sockets/tls/v3/tls.proto`
...
impl CommonTlsContext {
    ...
    // .envoy.extensions.transport_sockets.tls.v3.CommonTlsContext.CertificateProvider tls_certificate_certificate_provider = 9;
    ...
    // .envoy.extensions.transport_sockets.tls.v3.CommonTlsContext.CertificateProviderInstance tls_certificate_certificate_provider_instance = 11;
    ...
    // .envoy.extensions.transport_sockets.tls.v3.CommonTlsContext.CertificateProvider validation_context_certificate_provider = 10;
    ...
    // .envoy.extensions.transport_sockets.tls.v3.CommonTlsContext.CertificateProviderInstance validation_context_certificate_provider_instance = 12;
...
pub struct CommonTlsContext_CombinedCertificateValidationContext {
    ...
    pub validation_context_certificate_provider: ::protobuf::SingularPtrField<CommonTlsContext_CertificateProvider>,
    pub validation_context_certificate_provider_instance: ::protobuf::SingularPtrField<CommonTlsContext_CertificateProviderInstance>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl CommonTlsContext_CombinedCertificateValidationContext {
    ...
    // .envoy.extensions.transport_sockets.tls.v3.CommonTlsContext.CertificateProvider validation_context_certificate_provider = 3;


    pub fn get_validation_context_certificate_provider(&self) -> &CommonTlsContext_CertificateProvider {
        self.validation_context_certificate_provider.as_ref().unwrap_or_else(|| <CommonTlsContext_CertificateProvider as ::protobuf::Message>::default_instance())
    }
    pub fn clear_validation_context_certificate_provider(&mut self) {
        self.validation_context_certificate_provider.clear();
    }

    pub fn has_validation_context_certificate_provider(&self) -> bool {
        self.validation_context_certificate_provider.is_some()
    }

    // Param is passed by value, moved
    pub fn set_validation_context_certificate_provider(&mut self, v: CommonTlsContext_CertificateProvider) {
        self.validation_context_certificate_provider = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_validation_context_certificate_provider(&mut self) -> &mut CommonTlsContext_CertificateProvider {
        if self.validation_context_certificate_provider.is_none() {
            self.validation_context_certificate_provider.set_default();
        }
        self.validation_context_certificate_provider.as_mut().unwrap()
    }

    // Take field
    pub fn take_validation_context_certificate_provider(&mut self) -> CommonTlsContext_CertificateProvider {
        self.validation_context_certificate_provider.take().unwrap_or_else(|| CommonTlsContext_CertificateProvider::new())
    }

    // .envoy.extensions.transport_sockets.tls.v3.CommonTlsContext.CertificateProviderInstance validation_context_certificate_provider_instance = 4;


    pub fn get_validation_context_certificate_provider_instance(&self) -> &CommonTlsContext_CertificateProviderInstance {
        self.validation_context_certificate_provider_instance.as_ref().unwrap_or_else(|| <CommonTlsContext_CertificateProviderInstance as ::protobuf::Message>::default_instance())
    }
    pub fn clear_validation_context_certificate_provider_instance(&mut self) {
        self.validation_context_certificate_provider_instance.clear();
    }

    pub fn has_validation_context_certificate_provider_instance(&self) -> bool {
        self.validation_context_certificate_provider_instance.is_some()
    }

    // Param is passed by value, moved
    pub fn set_validation_context_certificate_provider_instance(&mut self, v: CommonTlsContext_CertificateProviderInstance) {
        self.validation_context_certificate_provider_instance = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_validation_context_certificate_provider_instance(&mut self) -> &mut CommonTlsContext_CertificateProviderInstance {
        if self.validation_context_certificate_provider_instance.is_none() {
            self.validation_context_certificate_provider_instance.set_default();
        }
        self.validation_context_certificate_provider_instance.as_mut().unwrap()
    }

    // Take field
    pub fn take_validation_context_certificate_provider_instance(&mut self) -> CommonTlsContext_CertificateProviderInstance {
        self.validation_context_certificate_provider_instance.take().unwrap_or_else(|| CommonTlsContext_CertificateProviderInstance::new())
    }
}
...
impl ::protobuf::Message for CommonTlsContext_CombinedCertificateValidationContext {
    fn is_initialized(&self) -> bool {
        ...
        for v in &self.validation_context_certificate_provider {
            if !v.is_initialized() {
                return false;
            }
        };
        for v in &self.validation_context_certificate_provider_instance {
            if !v.is_initialized() {
                return false;
            }
        };
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                3 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.validation_context_certificate_provider)?;
                },
                4 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.validation_context_certificate_provider_instance)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let Some(ref v) = self.validation_context_certificate_provider.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        }
        if let Some(ref v) = self.validation_context_certificate_provider_instance.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<CommonTlsContext_CertificateProvider>>(
                "validation_context_certificate_provider",
                |m: &CommonTlsContext_CombinedCertificateValidationContext| { &m.validation_context_certificate_provider },
                |m: &mut CommonTlsContext_CombinedCertificateValidationContext| { &mut m.validation_context_certificate_provider },
            ));
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<CommonTlsContext_CertificateProviderInstance>>(
                "validation_context_certificate_provider_instance",
                |m: &CommonTlsContext_CombinedCertificateValidationContext| { &m.validation_context_certificate_provider_instance },
                |m: &mut CommonTlsContext_CombinedCertificateValidationContext| { &mut m.validation_context_certificate_provider_instance },
            ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n3envoy/extensions/transport_sockets/tls/v3/tls.proto\x12)envoy.extensi\
    ons.transport_sockets.tls.v3\x1a$envoy/config/core/v3/extension.proto\
    \x1a6envoy/extensions/transport_sockets/tls/v3/common.proto\x1a6envoy/ex\
    tensions/transport_sockets/tls/v3/secret.proto\x1a\x19google/protobuf/an\
    y.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1egoogle/protobuf/wra\
    ...
    xt\x18\x01\x20\x01(\x0b2;.envoy.extensions.transport_sockets.tls.v3.Comm\
    onTlsContextR\x10commonTlsContext\x12\x1a\n\x03sni\x18\x02\x20\x01(\tR\
    \x03sniB\x08\xfaB\x05r\x03(\xff\x01\x12/\n\x13allow_renegotiation\x18\
    \x03\x20\x01(\x08R\x12allowRenegotiation\x12F\n\x10max_session_keys\x18\
    \x04\x20\x01(\x0b2\x1c.google.protobuf.UInt32ValueR\x0emaxSessionKeys:+\
    \x9a\xc5\x88\x1e&\n$envoy.api.v2.auth.UpstreamTlsContext\"\xea\x07\n\x14\
    DownstreamTlsContext\x12i\n\x12common_tls_context\x18\x01\x20\x01(\x0b2;\
    .envoy.extensions.transport_sockets.tls.v3.CommonTlsContextR\x10commonTl\
    sContext\x12X\n\x1arequire_client_certificate\x18\x02\x20\x01(\x0b2\x1a.\
    google.protobuf.BoolValueR\x18requireClientCertificate\x12;\n\x0brequire\
    _sni\x18\x03\x20\x01(\x0b2\x1a.google.protobuf.BoolValueR\nrequireSni\
    \x12q\n\x13session_ticket_keys\x18\x04\x20\x01(\x0b2?.envoy.extensions.t\
    ransport_sockets.tls.v3.TlsSessionTicketKeysH\0R\x11sessionTicketKeys\
    \x12\x8d\x01\n%session_ticket_keys_sds_secret_config\x18\x05\x20\x01(\
    \x0b2:.envoy.extensions.transport_sockets.tls.v3.SdsSecretConfigH\0R\x20\
    sessionTicketKeysSdsSecretConfig\x12Q\n$disable_stateless_session_resump\
    tion\x18\x07\x20\x01(\x08H\0R!disableStatelessSessionResumption\x12T\n\
    \x0fsession_timeout\x18\x06\x20\x01(\x0b2\x19.google.protobuf.DurationR\
    \x0esessionTimeoutB\x10\xfaB\r\xaa\x01\n\x1a\x06\x08\x80\x80\x80\x80\x10\
    2\0\x12\x88\x01\n\x12ocsp_staple_policy\x18\x08\x20\x01(\x0e2P.envoy.ext\
    ensions.transport_sockets.tls.v3.DownstreamTlsContext.OcspStaplePolicyR\
    \x10ocspStaplePolicyB\x08\xfaB\x05\x82\x01\x02\x10\x01\"N\n\x10OcspStapl\
    ePolicy\x12\x14\n\x10LENIENT_STAPLING\x10\0\x12\x13\n\x0fSTRICT_STAPLING\
    \x10\x01\x12\x0f\n\x0bMUST_STAPLE\x10\x02B\x1a\n\x18session_ticket_keys_\
    type:-\x9a\xc5\x88\x1e(\n&envoy.api.v2.auth.DownstreamTlsContext\"\xa7\
    \x16\n\x10CommonTlsContext\x12W\n\ntls_params\x18\x01\x20\x01(\x0b28.env\
    oy.extensions.transport_sockets.tls.v3.TlsParametersR\ttlsParams\x12d\n\
    \x10tls_certificates\x18\x02\x20\x03(\x0b29.envoy.extensions.transport_s\
    ockets.tls.v3.TlsCertificateR\x0ftlsCertificates\x12\x90\x01\n\"tls_cert\
    ificate_sds_secret_configs\x18\x06\x20\x03(\x0b2:.envoy.extensions.trans\
    port_sockets.tls.v3.SdsSecretConfigR\x1etlsCertificateSdsSecretConfigsB\
    \x08\xfaB\x05\x92\x01\x02\x10\x01\x12\xa0\x01\n$tls_certificate_certific\
    ate_provider\x18\t\x20\x01(\x0b2O.envoy.extensions.transport_sockets.tls\
    .v3.CommonTlsContext.CertificateProviderR!tlsCertificateCertificateProvi\
    der\x12\xb9\x01\n-tls_certificate_certificate_provider_instance\x18\x0b\
    \x20\x01(\x0b2W.envoy.extensions.transport_sockets.tls.v3.CommonTlsConte\
    xt.CertificateProviderInstanceR)tlsCertificateCertificateProviderInstanc\
    e\x12x\n\x12validation_context\x18\x03\x20\x01(\x0b2G.envoy.extensions.t\
    ransport_sockets.tls.v3.CertificateValidationContextH\0R\x11validationCo\
    ntext\x12\x8c\x01\n$validation_context_sds_secret_config\x18\x07\x20\x01\
    (\x0b2:.envoy.extensions.transport_sockets.tls.v3.SdsSecretConfigH\0R\
    \x20validationContextSdsSecretConfig\x12\xa2\x01\n\x1bcombined_validatio\
    n_context\x18\x08\x20\x01(\x0b2`.envoy.extensions.transport_sockets.tls.\
    v3.CommonTlsContext.CombinedCertificateValidationContextH\0R\x19combined\
    ValidationContext\x12\xa8\x01\n'validation_context_certificate_provider\
    \x18\n\x20\x01(\x0b2O.envoy.extensions.transport_sockets.tls.v3.CommonTl\
    sContext.CertificateProviderH\0R$validationContextCertificateProvider\
    \x12\xc1\x01\n0validation_context_certificate_provider_instance\x18\x0c\
    \x20\x01(\x0b2W.envoy.extensions.transport_sockets.tls.v3.CommonTlsConte\
    xt.CertificateProviderInstanceH\0R,validationContextCertificateProviderI\
    nstance\x12%\n\x0ealpn_protocols\x18\x04\x20\x03(\tR\ralpnProtocols\x12W\
    \n\x11custom_handshaker\x18\r\x20\x01(\x0b2*.envoy.config.core.v3.TypedE\
    xtensionConfigR\x10customHandshaker\x1a\x92\x01\n\x13CertificateProvider\
    \x12\x1b\n\x04name\x18\x01\x20\x01(\tR\x04nameB\x07\xfaB\x04r\x02\x10\
    \x01\x12O\n\x0ctyped_config\x18\x02\x20\x01(\x0b2*.envoy.config.core.v3.\
    TypedExtensionConfigH\0R\x0btypedConfigB\r\n\x06config\x12\x03\xf8B\x01\
    \x1am\n\x1bCertificateProviderInstance\x12#\n\rinstance_name\x18\x01\x20\
    \x01(\tR\x0cinstanceName\x12)\n\x10certificate_name\x18\x02\x20\x01(\tR\
    \x0fcertificateName\x1a\xf4\x06\n$CombinedCertificateValidationContext\
    \x12\x8f\x01\n\x1adefault_validation_context\x18\x01\x20\x01(\x0b2G.envo\
    y.extensions.transport_sockets.tls.v3.CertificateValidationContextR\x18d\
