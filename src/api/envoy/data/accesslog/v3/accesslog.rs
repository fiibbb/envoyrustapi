...
//! Generated file from `envoy/data/accesslog/v3/accesslog.proto`
...
impl AccessLogCommon {
    ...
    // repeated .envoy.data.accesslog.v3.AccessLogCommon.FilterStateObjectsEntry filter_state_objects = 21;
...
impl ResponseFlags {
    ...
    pub fn get_upstream_max_stream_duration_reached(&self) -> bool {
        self.upstream_max_stream_duration_reached
    }
    pub fn clear_upstream_max_stream_duration_reached(&mut self) {
        self.upstream_max_stream_duration_reached = false;
    }

    // Param is passed by value, moved
    pub fn set_upstream_max_stream_duration_reached(&mut self, v: bool) {
        self.upstream_max_stream_duration_reached = v;
    }

    // bool response_from_cache_filter = 21;


    pub fn get_response_from_cache_filter(&self) -> bool {
        self.response_from_cache_filter
    }
    pub fn clear_response_from_cache_filter(&mut self) {
        self.response_from_cache_filter = false;
    }

    // Param is passed by value, moved
    pub fn set_response_from_cache_filter(&mut self, v: bool) {
        self.response_from_cache_filter = v;
    }

    // bool no_filter_config_found = 22;


    pub fn get_no_filter_config_found(&self) -> bool {
        self.no_filter_config_found
    }
    pub fn clear_no_filter_config_found(&mut self) {
        self.no_filter_config_found = false;
    }

    // Param is passed by value, moved
    pub fn set_no_filter_config_found(&mut self, v: bool) {
        self.no_filter_config_found = v;
    }

    // bool duration_timeout = 23;


    pub fn get_duration_timeout(&self) -> bool {
        self.duration_timeout
    }
    pub fn clear_duration_timeout(&mut self) {
        self.duration_timeout = false;
    }

    // Param is passed by value, moved
    pub fn set_duration_timeout(&mut self, v: bool) {
        self.duration_timeout = v;
    }
}
...
impl ::protobuf::Message for ResponseFlags {
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                20 => {
                    ...
                    let tmp = is.read_bool()?;
                    self.upstream_max_stream_duration_reached = tmp;
                },
                21 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    ...
                    let tmp = is.read_bool()?;
                    self.response_from_cache_filter = tmp;
                },
                22 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    ...
                    let tmp = is.read_bool()?;
                    self.no_filter_config_found = tmp;
                },
                23 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.upstream_max_stream_duration_reached != false {
            my_size += 3;
        }
        if self.response_from_cache_filter != false {
            my_size += 3;
        }
        if self.no_filter_config_found != false {
            my_size += 3;
        }
        if self.duration_timeout != false {
            my_size += 3;
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.upstream_max_stream_duration_reached != false {
            os.write_bool(20, self.upstream_max_stream_duration_reached)?;
        }
        if self.response_from_cache_filter != false {
            os.write_bool(21, self.response_from_cache_filter)?;
        }
        if self.no_filter_config_found != false {
            os.write_bool(22, self.no_filter_config_found)?;
        }
        if self.duration_timeout != false {
            os.write_bool(23, self.duration_timeout)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBool>(
                ...
                |m: &ResponseFlags| { &m.upstream_max_stream_duration_reached },
                |m: &mut ResponseFlags| { &mut m.upstream_max_stream_duration_reached },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBool>(
                "response_from_cache_filter",
                |m: &ResponseFlags| { &m.response_from_cache_filter },
                |m: &mut ResponseFlags| { &mut m.response_from_cache_filter },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBool>(
                "no_filter_config_found",
                |m: &ResponseFlags| { &m.no_filter_config_found },
                |m: &mut ResponseFlags| { &mut m.no_filter_config_found },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBool>(
                "duration_timeout",
                |m: &ResponseFlags| { &m.duration_timeout },
                |m: &mut ResponseFlags| { &mut m.duration_timeout },
            ));
...
impl HTTPRequestProperties {
    ...
    // repeated .envoy.data.accesslog.v3.HTTPRequestProperties.RequestHeadersEntry request_headers = 13;
...
impl HTTPResponseProperties {
    ...
    // repeated .envoy.data.accesslog.v3.HTTPResponseProperties.ResponseHeadersEntry response_headers = 4;
    ...
    // repeated .envoy.data.accesslog.v3.HTTPResponseProperties.ResponseTrailersEntry response_trailers = 5;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n'envoy/data/accesslog/v3/accesslog.proto\x12\x17envoy.data.accesslog.v\
    3\x1a\"envoy/config/core/v3/address.proto\x1a\x1fenvoy/config/core/v3/ba\
    se.proto\x1a\x19google/protobuf/any.proto\x1a\x1egoogle/protobuf/duratio\
    n.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wr\
    appers.proto\x1a\x1dudpa/annotations/status.proto\x1a!udpa/annotations/v\
    ersioning.proto\x1a\x17validate/validate.proto\"\x80\x02\n\x11TCPAccessL\
    ogEntry\x12U\n\x11common_properties\x18\x01\x20\x01(\x0b2(.envoy.data.ac\
    cesslog.v3.AccessLogCommonR\x10commonProperties\x12b\n\x15connection_pro\
    perties\x18\x02\x20\x01(\x0b2-.envoy.data.accesslog.v3.ConnectionPropert\
    iesR\x14connectionProperties:0\x9a\xc5\x88\x1e+\n)envoy.data.accesslog.v\
    2.TCPAccessLogEntry\"\xf0\x03\n\x12HTTPAccessLogEntry\x12U\n\x11common_p\
    roperties\x18\x01\x20\x01(\x0b2(.envoy.data.accesslog.v3.AccessLogCommon\
    R\x10commonProperties\x12b\n\x10protocol_version\x18\x02\x20\x01(\x0e27.\
    envoy.data.accesslog.v3.HTTPAccessLogEntry.HTTPVersionR\x0fprotocolVersi\
    on\x12H\n\x07request\x18\x03\x20\x01(\x0b2..envoy.data.accesslog.v3.HTTP\
    RequestPropertiesR\x07request\x12K\n\x08response\x18\x04\x20\x01(\x0b2/.\
    envoy.data.accesslog.v3.HTTPResponsePropertiesR\x08response\"U\n\x0bHTTP\
    Version\x12\x18\n\x14PROTOCOL_UNSPECIFIED\x10\0\x12\n\n\x06HTTP10\x10\
    \x01\x12\n\n\x06HTTP11\x10\x02\x12\t\n\x05HTTP2\x10\x03\x12\t\n\x05HTTP3\
    \x10\x04:1\x9a\xc5\x88\x1e,\n*envoy.data.accesslog.v2.HTTPAccessLogEntry\
    \"\x91\x01\n\x14ConnectionProperties\x12%\n\x0ereceived_bytes\x18\x01\
    \x20\x01(\x04R\rreceivedBytes\x12\x1d\n\nsent_bytes\x18\x02\x20\x01(\x04\
    R\tsentBytes:3\x9a\xc5\x88\x1e.\n,envoy.data.accesslog.v2.ConnectionProp\
    erties\"\xbf\x0e\n\x0fAccessLogCommon\x128\n\x0bsample_rate\x18\x01\x20\
    \x01(\x01R\nsampleRateB\x17\xfaB\x14\x12\x12\x19\0\0\0\0\0\0\xf0?!\0\0\0\
    \0\0\0\0\0\x12Y\n\x19downstream_remote_address\x18\x02\x20\x01(\x0b2\x1d\
    .envoy.config.core.v3.AddressR\x17downstreamRemoteAddress\x12W\n\x18down\
    stream_local_address\x18\x03\x20\x01(\x0b2\x1d.envoy.config.core.v3.Addr\
    essR\x16downstreamLocalAddress\x12M\n\x0etls_properties\x18\x04\x20\x01(\
    \x0b2&.envoy.data.accesslog.v3.TLSPropertiesR\rtlsProperties\x129\n\nsta\
    rt_time\x18\x05\x20\x01(\x0b2\x1a.google.protobuf.TimestampR\tstartTime\
    \x12I\n\x14time_to_last_rx_byte\x18\x06\x20\x01(\x0b2\x19.google.protobu\
    f.DurationR\x10timeToLastRxByte\x12\\\n\x1etime_to_first_upstream_tx_byt\
    e\x18\x07\x20\x01(\x0b2\x19.google.protobuf.DurationR\x19timeToFirstUpst\
    reamTxByte\x12Z\n\x1dtime_to_last_upstream_tx_byte\x18\x08\x20\x01(\x0b2\
    \x19.google.protobuf.DurationR\x18timeToLastUpstreamTxByte\x12\\\n\x1eti\
    me_to_first_upstream_rx_byte\x18\t\x20\x01(\x0b2\x19.google.protobuf.Dur\
    ationR\x19timeToFirstUpstreamRxByte\x12Z\n\x1dtime_to_last_upstream_rx_b\
    yte\x18\n\x20\x01(\x0b2\x19.google.protobuf.DurationR\x18timeToLastUpstr\
    eamRxByte\x12`\n\x20time_to_first_downstream_tx_byte\x18\x0b\x20\x01(\
    \x0b2\x19.google.protobuf.DurationR\x1btimeToFirstDownstreamTxByte\x12^\
    \n\x1ftime_to_last_downstream_tx_byte\x18\x0c\x20\x01(\x0b2\x19.google.p\
    rotobuf.DurationR\x1atimeToLastDownstreamTxByte\x12U\n\x17upstream_remot\
    e_address\x18\r\x20\x01(\x0b2\x1d.envoy.config.core.v3.AddressR\x15upstr\
    eamRemoteAddress\x12S\n\x16upstream_local_address\x18\x0e\x20\x01(\x0b2\
    \x1d.envoy.config.core.v3.AddressR\x14upstreamLocalAddress\x12)\n\x10ups\
    tream_cluster\x18\x0f\x20\x01(\tR\x0fupstreamCluster\x12M\n\x0eresponse_\
    flags\x18\x10\x20\x01(\x0b2&.envoy.data.accesslog.v3.ResponseFlagsR\rres\
    ponseFlags\x12:\n\x08metadata\x18\x11\x20\x01(\x0b2\x1e.envoy.config.cor\
    e.v3.MetadataR\x08metadata\x12I\n!upstream_transport_failure_reason\x18\
    \x12\x20\x01(\tR\x1eupstreamTransportFailureReason\x12\x1d\n\nroute_name\
    \x18\x13\x20\x01(\tR\trouteName\x12f\n\x20downstream_direct_remote_addre\
    ss\x18\x14\x20\x01(\x0b2\x1d.envoy.config.core.v3.AddressR\x1ddownstream\
    DirectRemoteAddress\x12r\n\x14filter_state_objects\x18\x15\x20\x03(\x0b2\
    @.envoy.data.accesslog.v3.AccessLogCommon.FilterStateObjectsEntryR\x12fi\
    lterStateObjects\x1a[\n\x17FilterStateObjectsEntry\x12\x10\n\x03key\x18\
    \x01\x20\x01(\tR\x03key\x12*\n\x05value\x18\x02\x20\x01(\x0b2\x14.google\
    .protobuf.AnyR\x05value:\x028\x01:.\x9a\xc5\x88\x1e)\n'envoy.data.access\
    log.v2.AccessLogCommon\"\xa6\x0c\n\rResponseFlags\x128\n\x18failed_local\
    _healthcheck\x18\x01\x20\x01(\x08R\x16failedLocalHealthcheck\x12.\n\x13n\
    o_healthy_upstream\x18\x02\x20\x01(\x08R\x11noHealthyUpstream\x128\n\x18\
    upstream_request_timeout\x18\x03\x20\x01(\x08R\x16upstreamRequestTimeout\
    \x12\x1f\n\x0blocal_reset\x18\x04\x20\x01(\x08R\nlocalReset\x122\n\x15up\
    stream_remote_reset\x18\x05\x20\x01(\x08R\x13upstreamRemoteReset\x12>\n\
    \x1bupstream_connection_failure\x18\x06\x20\x01(\x08R\x19upstreamConnect\
    ionFailure\x12F\n\x1fupstream_connection_termination\x18\x07\x20\x01(\
    \x08R\x1dupstreamConnectionTermination\x12+\n\x11upstream_overflow\x18\
    \x08\x20\x01(\x08R\x10upstreamOverflow\x12$\n\x0eno_route_found\x18\t\
    \x20\x01(\x08R\x0cnoRouteFound\x12%\n\x0edelay_injected\x18\n\x20\x01(\
    \x08R\rdelayInjected\x12%\n\x0efault_injected\x18\x0b\x20\x01(\x08R\rfau\
    ltInjected\x12!\n\x0crate_limited\x18\x0c\x20\x01(\x08R\x0brateLimited\
    \x12f\n\x14unauthorized_details\x18\r\x20\x01(\x0b23.envoy.data.accesslo\
    g.v3.ResponseFlags.UnauthorizedR\x13unauthorizedDetails\x127\n\x18rate_l\
    imit_service_error\x18\x0e\x20\x01(\x08R\x15rateLimitServiceError\x12J\n\
    !downstream_connection_termination\x18\x0f\x20\x01(\x08R\x1fdownstreamCo\
    nnectionTermination\x12A\n\x1dupstream_retry_limit_exceeded\x18\x10\x20\
    \x01(\x08R\x1aupstreamRetryLimitExceeded\x12.\n\x13stream_idle_timeout\
    \x18\x11\x20\x01(\x08R\x11streamIdleTimeout\x12A\n\x1dinvalid_envoy_requ\
    est_headers\x18\x12\x20\x01(\x08R\x1ainvalidEnvoyRequestHeaders\x12:\n\
    \x19downstream_protocol_error\x18\x13\x20\x01(\x08R\x17downstreamProtoco\
    lError\x12N\n$upstream_max_stream_duration_reached\x18\x14\x20\x01(\x08R\
    \x20upstreamMaxStreamDurationReached\x12;\n\x1aresponse_from_cache_filte\
    r\x18\x15\x20\x01(\x08R\x17responseFromCacheFilter\x123\n\x16no_filter_c\
    onfig_found\x18\x16\x20\x01(\x08R\x13noFilterConfigFound\x12)\n\x10durat\
    ion_timeout\x18\x17\x20\x01(\x08R\x0fdurationTimeout\x1a\xd5\x01\n\x0cUn\
    authorized\x12R\n\x06reason\x18\x01\x20\x01(\x0e2:.envoy.data.accesslog.\
    v3.ResponseFlags.Unauthorized.ReasonR\x06reason\"6\n\x06Reason\x12\x16\n\
    \x12REASON_UNSPECIFIED\x10\0\x12\x14\n\x10EXTERNAL_SERVICE\x10\x01:9\x9a\
    \xc5\x88\x1e4\n2envoy.data.accesslog.v2.ResponseFlags.Unauthorized:,\x9a\
    \xc5\x88\x1e'\n%envoy.data.accesslog.v2.ResponseFlags\"\x84\x08\n\rTLSPr\
    operties\x12R\n\x0btls_version\x18\x01\x20\x01(\x0e21.envoy.data.accessl\
    og.v3.TLSProperties.TLSVersionR\ntlsVersion\x12F\n\x10tls_cipher_suite\
    \x18\x02\x20\x01(\x0b2\x1c.google.protobuf.UInt32ValueR\x0etlsCipherSuit\
    e\x12(\n\x10tls_sni_hostname\x18\x03\x20\x01(\tR\x0etlsSniHostname\x12~\
    \n\x1clocal_certificate_properties\x18\x04\x20\x01(\x0b2<.envoy.data.acc\
    esslog.v3.TLSProperties.CertificatePropertiesR\x1alocalCertificateProper\
    ties\x12|\n\x1bpeer_certificate_properties\x18\x05\x20\x01(\x0b2<.envoy.\
    data.accesslog.v3.TLSProperties.CertificatePropertiesR\x19peerCertificat\
    eProperties\x12$\n\x0etls_session_id\x18\x06\x20\x01(\tR\x0ctlsSessionId\
    \x1a\x81\x03\n\x15CertificateProperties\x12u\n\x10subject_alt_name\x18\
    \x01\x20\x03(\x0b2K.envoy.data.accesslog.v3.TLSProperties.CertificatePro\
    perties.SubjectAltNameR\x0esubjectAltName\x12\x18\n\x07subject\x18\x02\
    \x20\x01(\tR\x07subject\x1a\x92\x01\n\x0eSubjectAltName\x12\x12\n\x03uri\
    \x18\x01\x20\x01(\tH\0R\x03uri\x12\x12\n\x03dns\x18\x02\x20\x01(\tH\0R\
    \x03dnsB\x05\n\x03san:Q\x9a\xc5\x88\x1eL\nJenvoy.data.accesslog.v2.TLSPr\
    operties.CertificateProperties.SubjectAltName:B\x9a\xc5\x88\x1e=\n;envoy\
    .data.accesslog.v2.TLSProperties.CertificateProperties\"W\n\nTLSVersion\
    \x12\x17\n\x13VERSION_UNSPECIFIED\x10\0\x12\t\n\x05TLSv1\x10\x01\x12\x0b\
    \n\x07TLSv1_1\x10\x02\x12\x0b\n\x07TLSv1_2\x10\x03\x12\x0b\n\x07TLSv1_3\
    \x10\x04:,\x9a\xc5\x88\x1e'\n%envoy.data.accesslog.v2.TLSProperties\"\
    \xd3\x05\n\x15HTTPRequestProperties\x12T\n\x0erequest_method\x18\x01\x20\
    \x01(\x0e2#.envoy.config.core.v3.RequestMethodR\rrequestMethodB\x08\xfaB\
    \x05\x82\x01\x02\x10\x01\x12\x16\n\x06scheme\x18\x02\x20\x01(\tR\x06sche\
    me\x12\x1c\n\tauthority\x18\x03\x20\x01(\tR\tauthority\x120\n\x04port\
    \x18\x04\x20\x01(\x0b2\x1c.google.protobuf.UInt32ValueR\x04port\x12\x12\
    \n\x04path\x18\x05\x20\x01(\tR\x04path\x12\x1d\n\nuser_agent\x18\x06\x20\
    \x01(\tR\tuserAgent\x12\x18\n\x07referer\x18\x07\x20\x01(\tR\x07referer\
    \x12#\n\rforwarded_for\x18\x08\x20\x01(\tR\x0cforwardedFor\x12\x1d\n\nre\
    quest_id\x18\t\x20\x01(\tR\trequestId\x12#\n\roriginal_path\x18\n\x20\
    \x01(\tR\x0coriginalPath\x122\n\x15request_headers_bytes\x18\x0b\x20\x01\
    (\x04R\x13requestHeadersBytes\x12,\n\x12request_body_bytes\x18\x0c\x20\
    \x01(\x04R\x10requestBodyBytes\x12k\n\x0frequest_headers\x18\r\x20\x03(\
    \x0b2B.envoy.data.accesslog.v3.HTTPRequestProperties.RequestHeadersEntry\
    R\x0erequestHeaders\x1aA\n\x13RequestHeadersEntry\x12\x10\n\x03key\x18\
    \x01\x20\x01(\tR\x03key\x12\x14\n\x05value\x18\x02\x20\x01(\tR\x05value:\
    \x028\x01:4\x9a\xc5\x88\x1e/\n-envoy.data.accesslog.v2.HTTPRequestProper\
    ties\"\x9a\x05\n\x16HTTPResponseProperties\x12A\n\rresponse_code\x18\x01\
    \x20\x01(\x0b2\x1c.google.protobuf.UInt32ValueR\x0cresponseCode\x124\n\
    \x16response_headers_bytes\x18\x02\x20\x01(\x04R\x14responseHeadersBytes\
    \x12.\n\x13response_body_bytes\x18\x03\x20\x01(\x04R\x11responseBodyByte\
    s\x12o\n\x10response_headers\x18\x04\x20\x03(\x0b2D.envoy.data.accesslog\
    .v3.HTTPResponseProperties.ResponseHeadersEntryR\x0fresponseHeaders\x12r\
    \n\x11response_trailers\x18\x05\x20\x03(\x0b2E.envoy.data.accesslog.v3.H\
    TTPResponseProperties.ResponseTrailersEntryR\x10responseTrailers\x122\n\
    \x15response_code_details\x18\x06\x20\x01(\tR\x13responseCodeDetails\x1a\
    B\n\x14ResponseHeadersEntry\x12\x10\n\x03key\x18\x01\x20\x01(\tR\x03key\
    \x12\x14\n\x05value\x18\x02\x20\x01(\tR\x05value:\x028\x01\x1aC\n\x15Res\
    ponseTrailersEntry\x12\x10\n\x03key\x18\x01\x20\x01(\tR\x03key\x12\x14\n\
    \x05value\x18\x02\x20\x01(\tR\x05value:\x028\x01:5\x9a\xc5\x88\x1e0\n.en\
    voy.data.accesslog.v2.HTTPResponsePropertiesBA\n%io.envoyproxy.envoy.dat\
    a.accesslog.v3B\x0eAccesslogProtoP\x01\xba\x80\xc8\xd1\x06\x02\x10\x02b\
    \x06proto3\
";
