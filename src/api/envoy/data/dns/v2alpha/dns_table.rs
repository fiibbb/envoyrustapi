...
//! Generated file from `envoy/data/dns/v2alpha/dns_table.proto`
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n&envoy/data/dns/v2alpha/dns_table.proto\x12\x16envoy.data.dns.v2alpha\
    \x1a\x1fenvoy/type/matcher/string.proto\x1a\x1egoogle/protobuf/duration.\
    proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.prot\
    o\"\xe2\x04\n\x08DnsTable\x120\n\x14external_retry_count\x18\x01\x20\x01\
    (\rR\x12externalRetryCount\x12d\n\x0fvirtual_domains\x18\x02\x20\x03(\
    \x0b21.envoy.data.dns.v2alpha.DnsTable.DnsVirtualDomainR\x0evirtualDomai\
    nsB\x08\xfaB\x05\x92\x01\x02\x08\x01\x12H\n\x0eknown_suffixes\x18\x03\
    \x20\x03(\x0b2!.envoy.type.matcher.StringMatcherR\rknownSuffixes\x1a7\n\
    \x0bAddressList\x12(\n\x07address\x18\x01\x20\x03(\tR\x07addressB\x0e\
    \xfaB\x0b\x92\x01\x08\x08\x01\"\x04r\x02\x10\x03\x1ax\n\x0bDnsEndpoint\
    \x12Q\n\x0caddress_list\x18\x01\x20\x01(\x0b2,.envoy.data.dns.v2alpha.Dn\
    sTable.AddressListH\0R\x0baddressListB\x16\n\x0fendpoint_config\x12\x03\
    \xf8B\x01\x1a\xc0\x01\n\x10DnsVirtualDomain\x12\x1e\n\x04name\x18\x01\
    \x20\x01(\tR\x04nameB\n\xfaB\x07r\x05\x10\x02\xc0\x01\x01\x12H\n\x08endp\
    oint\x18\x02\x20\x01(\x0b2,.envoy.data.dns.v2alpha.DnsTable.DnsEndpointR\
    \x08endpoint\x12B\n\nanswer_ttl\x18\x03\x20\x01(\x0b2\x19.google.protobu\
    f.DurationR\tanswerTtlB\x08\xfaB\x05\xaa\x01\x02*\0BG\n$io.envoyproxy.en\
    voy.data.dns.v2alphaB\rDnsTableProtoP\x01\xba\x80\xc8\xd1\x06\x02\x08\
