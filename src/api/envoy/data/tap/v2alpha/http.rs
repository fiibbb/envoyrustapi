...
//! Generated file from `envoy/data/tap/v2alpha/http.proto`
...
impl HttpBufferedTrace {
    ...
    // .envoy.data.tap.v2alpha.HttpBufferedTrace.Message request = 1;
    ...
    // .envoy.data.tap.v2alpha.HttpBufferedTrace.Message response = 2;
...
impl HttpBufferedTrace_Message {
    ...
    // .envoy.data.tap.v2alpha.Body body = 2;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n!envoy/data/tap/v2alpha/http.proto\x12\x16envoy.data.tap.v2alpha\x1a\
    \x1cenvoy/api/v2/core/base.proto\x1a#envoy/data/tap/v2alpha/common.proto\
    \x1a\x1dudpa/annotations/status.proto\"\xe3\x02\n\x11HttpBufferedTrace\
    \x12K\n\x07request\x18\x01\x20\x01(\x0b21.envoy.data.tap.v2alpha.HttpBuf\
    feredTrace.MessageR\x07request\x12M\n\x08response\x18\x02\x20\x01(\x0b21\
    .envoy.data.tap.v2alpha.HttpBufferedTrace.MessageR\x08response\x1a\xb1\
    \x01\n\x07Message\x128\n\x07headers\x18\x01\x20\x03(\x0b2\x1e.envoy.api.\
    v2.core.HeaderValueR\x07headers\x120\n\x04body\x18\x02\x20\x01(\x0b2\x1c\
    .envoy.data.tap.v2alpha.BodyR\x04body\x12:\n\x08trailers\x18\x03\x20\x03\
    (\x0b2\x1e.envoy.api.v2.core.HeaderValueR\x08trailers\"\x90\x04\n\x18Htt\
    pStreamedTraceSegment\x12\x19\n\x08trace_id\x18\x01\x20\x01(\x04R\x07tra\
    ceId\x12G\n\x0frequest_headers\x18\x02\x20\x01(\x0b2\x1c.envoy.api.v2.co\
    re.HeaderMapH\0R\x0erequestHeaders\x12L\n\x12request_body_chunk\x18\x03\
    \x20\x01(\x0b2\x1c.envoy.data.tap.v2alpha.BodyH\0R\x10requestBodyChunk\
    \x12I\n\x10request_trailers\x18\x04\x20\x01(\x0b2\x1c.envoy.api.v2.core.\
    HeaderMapH\0R\x0frequestTrailers\x12I\n\x10response_headers\x18\x05\x20\
    \x01(\x0b2\x1c.envoy.api.v2.core.HeaderMapH\0R\x0fresponseHeaders\x12N\n\
    \x13response_body_chunk\x18\x06\x20\x01(\x0b2\x1c.envoy.data.tap.v2alpha\
    .BodyH\0R\x11responseBodyChunk\x12K\n\x11response_trailers\x18\x07\x20\
    \x01(\x0b2\x1c.envoy.api.v2.core.HeaderMapH\0R\x10responseTrailersB\x0f\
    \n\rmessage_pieceB;\n$io.envoyproxy.envoy.data.tap.v2alphaB\tHttpProtoP\
    \x01\xba\x80\xc8\xd1\x06\x02\x10\x01b\x06proto3\
";
