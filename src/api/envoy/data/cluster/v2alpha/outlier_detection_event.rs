...
//! Generated file from `envoy/data/cluster/v2alpha/outlier_detection_event.proto`
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n8envoy/data/cluster/v2alpha/outlier_detection_event.proto\x12\x1aenvoy\
    .data.cluster.v2alpha\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoog\
    le/protobuf/wrappers.proto\x1a\x1eudpa/annotations/migrate.proto\x1a\x1d\
    udpa/annotations/status.proto\x1a\x17validate/validate.proto\"\xc2\x06\n\
    \x15OutlierDetectionEvent\x12M\n\x04type\x18\x01\x20\x01(\x0e2/.envoy.da\
    ta.cluster.v2alpha.OutlierEjectionTypeR\x04typeB\x08\xfaB\x05\x82\x01\
    \x02\x10\x01\x128\n\ttimestamp\x18\x02\x20\x01(\x0b2\x1a.google.protobuf\
    .TimestampR\ttimestamp\x12Q\n\x16secs_since_last_action\x18\x03\x20\x01(\
    \x0b2\x1c.google.protobuf.UInt64ValueR\x13secsSinceLastAction\x12*\n\x0c\
    cluster_name\x18\x04\x20\x01(\tR\x0bclusterNameB\x07\xfaB\x04r\x02\x20\
    \x01\x12*\n\x0cupstream_url\x18\x05\x20\x01(\tR\x0bupstreamUrlB\x07\xfaB\
    \x04r\x02\x20\x01\x12D\n\x06action\x18\x06\x20\x01(\x0e2\".envoy.data.cl\
    uster.v2alpha.ActionR\x06actionB\x08\xfaB\x05\x82\x01\x02\x10\x01\x12#\n\
    \rnum_ejections\x18\x07\x20\x01(\rR\x0cnumEjections\x12\x1a\n\x08enforce\
    d\x18\x08\x20\x01(\x08R\x08enforced\x12n\n\x18eject_success_rate_event\
    \x18\t\x20\x01(\x0b23.envoy.data.cluster.v2alpha.OutlierEjectSuccessRate\
    H\0R\x15ejectSuccessRateEvent\x12m\n\x17eject_consecutive_event\x18\n\
    \x20\x01(\x0b23.envoy.data.cluster.v2alpha.OutlierEjectConsecutiveH\0R\
    \x15ejectConsecutiveEvent\x12\x80\x01\n\x1eeject_failure_percentage_even\
    t\x18\x0b\x20\x01(\x0b29.envoy.data.cluster.v2alpha.OutlierEjectFailureP\
    ercentageH\0R\x1bejectFailurePercentageEventB\x0c\n\x05event\x12\x03\xf8\
    B\x01\"\xf7\x01\n\x17OutlierEjectSuccessRate\x123\n\x11host_success_rate\
    \x18\x01\x20\x01(\rR\x0fhostSuccessRateB\x07\xfaB\x04*\x02\x18d\x12H\n\
    \x1ccluster_average_success_rate\x18\x02\x20\x01(\rR\x19clusterAverageSu\
    ccessRateB\x07\xfaB\x04*\x02\x18d\x12]\n'cluster_success_rate_ejection_t\
    hreshold\x18\x03\x20\x01(\rR#clusterSuccessRateEjectionThresholdB\x07\
    \xfaB\x04*\x02\x18d\"\x19\n\x17OutlierEjectConsecutive\"T\n\x1dOutlierEj\
    ectFailurePercentage\x123\n\x11host_success_rate\x18\x01\x20\x01(\rR\x0f\
    hostSuccessRateB\x07\xfaB\x04*\x02\x18d*\xdf\x01\n\x13OutlierEjectionTyp\
    e\x12\x13\n\x0fCONSECUTIVE_5XX\x10\0\x12\x1f\n\x1bCONSECUTIVE_GATEWAY_FA\
    ILURE\x10\x01\x12\x10\n\x0cSUCCESS_RATE\x10\x02\x12$\n\x20CONSECUTIVE_LO\
    CAL_ORIGIN_FAILURE\x10\x03\x12\x1d\n\x19SUCCESS_RATE_LOCAL_ORIGIN\x10\
