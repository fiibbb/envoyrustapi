...
//! Generated file from `envoy/extensions/filters/network/http_connection_manager/v4alpha/http_connection_manager.proto`
...
impl HttpConnectionManager {
    ...
    // .envoy.extensions.filters.network.http_connection_manager.v4alpha.HttpConnectionManager.CodecType codec_type = 1;
    ...
    // .envoy.extensions.filters.network.http_connection_manager.v4alpha.Rds rds = 3;
    ...
    // .envoy.config.route.v4alpha.RouteConfiguration route_config = 4;
    ...
    // .envoy.extensions.filters.network.http_connection_manager.v4alpha.ScopedRoutes scoped_routes = 31;
    ...
    // repeated .envoy.extensions.filters.network.http_connection_manager.v4alpha.HttpFilter http_filters = 5;
    ...
    // .envoy.extensions.filters.network.http_connection_manager.v4alpha.HttpConnectionManager.Tracing tracing = 7;
    ...
    // .envoy.config.core.v4alpha.HttpProtocolOptions common_http_protocol_options = 35;
    ...
    // .envoy.config.core.v4alpha.Http1ProtocolOptions http_protocol_options = 8;
    ...
    // .envoy.config.core.v4alpha.Http2ProtocolOptions http2_protocol_options = 9;
    ...
    // .envoy.extensions.filters.network.http_connection_manager.v4alpha.HttpConnectionManager.ServerHeaderTransformation server_header_transformation = 34;
    ...
    // repeated .envoy.config.accesslog.v4alpha.AccessLog access_log = 13;
    ...
    // .envoy.extensions.filters.network.http_connection_manager.v4alpha.HttpConnectionManager.InternalAddressConfig internal_address_config = 25;
    ...
    // .envoy.extensions.filters.network.http_connection_manager.v4alpha.HttpConnectionManager.ForwardClientCertDetails forward_client_cert_details = 16;
    ...
    // .envoy.extensions.filters.network.http_connection_manager.v4alpha.HttpConnectionManager.SetCurrentClientCertDetails set_current_client_cert_details = 17;
    ...
    // .envoy.extensions.filters.network.http_connection_manager.v4alpha.RequestIDExtension request_id_extension = 36;
    ...
    // .envoy.extensions.filters.network.http_connection_manager.v4alpha.LocalReplyConfig local_reply_config = 38;
...
impl HttpConnectionManager_Tracing {
    ...
    // .envoy.config.trace.v4alpha.Tracing.Http provider = 9;
...
impl HttpConnectionManager_UpgradeConfig {
    ...
    // repeated .envoy.extensions.filters.network.http_connection_manager.v4alpha.HttpFilter filters = 2;
...
impl LocalReplyConfig {
    ...
    // repeated .envoy.extensions.filters.network.http_connection_manager.v4alpha.ResponseMapper mappers = 1;
    ...
    // .envoy.config.core.v4alpha.SubstitutionFormatString body_format = 2;
...
impl ResponseMapper {
    ...
    // .envoy.config.accesslog.v4alpha.AccessLogFilter filter = 1;
    ...
    // .envoy.config.core.v4alpha.DataSource body = 3;
    ...
    // .envoy.config.core.v4alpha.SubstitutionFormatString body_format_override = 4;
    ...
    // repeated .envoy.config.core.v4alpha.HeaderValueOption headers_to_add = 5;
...
impl ScopedRouteConfigurationsList {
    ...
    // repeated .envoy.config.route.v4alpha.ScopedRouteConfiguration scoped_route_configurations = 1;
...
impl ScopedRoutes {
    ...
    // .envoy.extensions.filters.network.http_connection_manager.v4alpha.ScopedRoutes.ScopeKeyBuilder scope_key_builder = 2;
    ...
    // .envoy.config.core.v4alpha.ConfigSource rds_config_source = 3;
    ...
    // .envoy.extensions.filters.network.http_connection_manager.v4alpha.ScopedRouteConfigurationsList scoped_route_configurations_list = 4;
    ...
    // .envoy.extensions.filters.network.http_connection_manager.v4alpha.ScopedRds scoped_rds = 5;
...
impl ScopedRoutes_ScopeKeyBuilder {
    ...
    // repeated .envoy.extensions.filters.network.http_connection_manager.v4alpha.ScopedRoutes.ScopeKeyBuilder.FragmentBuilder fragments = 1;
...
impl ScopedRoutes_ScopeKeyBuilder_FragmentBuilder {
    ...
    // .envoy.extensions.filters.network.http_connection_manager.v4alpha.ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor header_value_extractor = 1;
...
impl ScopedRoutes_ScopeKeyBuilder_FragmentBuilder_HeaderValueExtractor {
    ...
    // .envoy.extensions.filters.network.http_connection_manager.v4alpha.ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor.KvElement element = 4;
...
impl ScopedRds {
    ...
    // .envoy.config.core.v4alpha.ConfigSource scoped_rds_config_source = 1;
...
impl HttpFilter {
    ...
    // .envoy.config.core.v4alpha.ExtensionConfigSource config_discovery = 5;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n^envoy/extensions/filters/network/http_connection_manager/v4alpha/http\
    _connection_manager.proto\x12@envoy.extensions.filters.network.http_conn\
    ection_manager.v4alpha\x1a.envoy/config/accesslog/v4alpha/accesslog.prot\
    o\x1a$envoy/config/core/v4alpha/base.proto\x1a-envoy/config/core/v4alpha\
    /config_source.proto\x1a)envoy/config/core/v4alpha/extension.proto\x1a(e\
    nvoy/config/core/v4alpha/protocol.proto\x1a:envoy/config/core/v4alpha/su\
    bstitution_format_string.proto\x1a&envoy/config/route/v4alpha/route.prot\
    o\x1a-envoy/config/route/v4alpha/scoped_route.proto\x1a,envoy/config/tra\
    ce/v4alpha/http_tracer.proto\x1a&envoy/type/tracing/v3/custom_tag.proto\
    \x1a\x1benvoy/type/v3/percent.proto\x1a\x19google/protobuf/any.proto\x1a\
    ...
    .proto\x1a\x1fudpa/annotations/security.proto\x1a\x1dudpa/annotations/st\
    atus.proto\x1a!udpa/annotations/versioning.proto\x1a\x17validate/validat\
    e.proto\"\xae+\n\x15HttpConnectionManager\x12\x8a\x01\n\ncodec_type\x18\
    \x01\x20\x01(\x0e2a.envoy.extensions.filters.network.http_connection_man\
    ager.v4alpha.HttpConnectionManager.CodecTypeR\tcodecTypeB\x08\xfaB\x05\
    \x82\x01\x02\x10\x01\x12(\n\x0bstat_prefix\x18\x02\x20\x01(\tR\nstatPref\
    ixB\x07\xfaB\x04r\x02\x10\x01\x12Y\n\x03rds\x18\x03\x20\x01(\x0b2E.envoy\
    .extensions.filters.network.http_connection_manager.v4alpha.RdsH\0R\x03r\
    ds\x12S\n\x0croute_config\x18\x04\x20\x01(\x0b2..envoy.config.route.v4al\
    pha.RouteConfigurationH\0R\x0brouteConfig\x12u\n\rscoped_routes\x18\x1f\
    \x20\x01(\x0b2N.envoy.extensions.filters.network.http_connection_manager\
    .v4alpha.ScopedRoutesH\0R\x0cscopedRoutes\x12o\n\x0chttp_filters\x18\x05\
    \x20\x03(\x0b2L.envoy.extensions.filters.network.http_connection_manager\
    .v4alpha.HttpFilterR\x0bhttpFilters\x12@\n\x0eadd_user_agent\x18\x06\x20\
    \x01(\x0b2\x1a.google.protobuf.BoolValueR\x0caddUserAgent\x12y\n\x07trac\
    ing\x18\x07\x20\x01(\x0b2_.envoy.extensions.filters.network.http_connect\
    ion_manager.v4alpha.HttpConnectionManager.TracingR\x07tracing\x12x\n\x1c\
    common_http_protocol_options\x18#\x20\x01(\x0b2..envoy.config.core.v4alp\
    ha.HttpProtocolOptionsR\x19commonHttpProtocolOptionsB\x07\x8a\x93\xb7*\
    \x02\x08\x01\x12c\n\x15http_protocol_options\x18\x08\x20\x01(\x0b2/.envo\
    y.config.core.v4alpha.Http1ProtocolOptionsR\x13httpProtocolOptions\x12n\
    \n\x16http2_protocol_options\x18\t\x20\x01(\x0b2/.envoy.config.core.v4al\
    pha.Http2ProtocolOptionsR\x14http2ProtocolOptionsB\x07\x8a\x93\xb7*\x02\
    \x08\x01\x12,\n\x0bserver_name\x18\n\x20\x01(\tR\nserverNameB\x0b\xfaB\
    \x08r\x06\xc0\x01\x02\xc8\x01\0\x12\xbe\x01\n\x1cserver_header_transform\
    ation\x18\"\x20\x01(\x0e2r.envoy.extensions.filters.network.http_connect\
    ion_manager.v4alpha.HttpConnectionManager.ServerHeaderTransformationR\
    \x1aserverHeaderTransformationB\x08\xfaB\x05\x82\x01\x02\x10\x01\x12\\\n\
    \x16max_request_headers_kb\x18\x1d\x20\x01(\x0b2\x1c.google.protobuf.UIn\
    t32ValueR\x13maxRequestHeadersKbB\t\xfaB\x06*\x04\x18`\x20\0\x12R\n\x13s\
    tream_idle_timeout\x18\x18\x20\x01(\x0b2\x19.google.protobuf.DurationR\
    \x11streamIdleTimeoutB\x07\x8a\x93\xb7*\x02\x08\x01\x12K\n\x0frequest_ti\
    meout\x18\x1c\x20\x01(\x0b2\x19.google.protobuf.DurationR\x0erequestTime\
    outB\x07\x8a\x93\xb7*\x02\x08\x01\x12b\n\x17request_headers_timeout\x18)\
    \x20\x01(\x0b2\x19.google.protobuf.DurationR\x15requestHeadersTimeoutB\
    \x0f\x8a\x93\xb7*\x02\x08\x01\xfaB\x05\xaa\x01\x022\0\x12>\n\rdrain_time\
    out\x18\x0c\x20\x01(\x0b2\x19.google.protobuf.DurationR\x0cdrainTimeout\
    \x12M\n\x15delayed_close_timeout\x18\x1a\x20\x01(\x0b2\x19.google.protob\
    uf.DurationR\x13delayedCloseTimeout\x12H\n\naccess_log\x18\r\x20\x03(\
    \x0b2).envoy.config.accesslog.v4alpha.AccessLogR\taccessLog\x12Q\n\x12us\
    e_remote_address\x18\x0e\x20\x01(\x0b2\x1a.google.protobuf.BoolValueR\
    \x10useRemoteAddressB\x07\x8a\x93\xb7*\x02\x08\x01\x12/\n\x14xff_num_tru\
    sted_hops\x18\x13\x20\x01(\rR\x11xffNumTrustedHops\x12\xa5\x01\n\x17inte\
    rnal_address_config\x18\x19\x20\x01(\x0b2m.envoy.extensions.filters.netw\
    ork.http_connection_manager.v4alpha.HttpConnectionManager.InternalAddres\
    sConfigR\x15internalAddressConfig\x12&\n\x0fskip_xff_append\x18\x15\x20\
    ...
    \x18\x20\x20\x01(\x08R\x19preserveExternalRequestId\x12G\n!always_set_re\
    quest_id_in_response\x18%\x20\x01(\x08R\x1calwaysSetRequestIdInResponse\
    \x12\xb9\x01\n\x1bforward_client_cert_details\x18\x10\x20\x01(\x0e2p.env\
    oy.extensions.filters.network.http_connection_manager.v4alpha.HttpConnec\
    tionManager.ForwardClientCertDetailsR\x18forwardClientCertDetailsB\x08\
    \xfaB\x05\x82\x01\x02\x10\x01\x12\xb9\x01\n\x1fset_current_client_cert_d\
    etails\x18\x11\x20\x01(\x0b2s.envoy.extensions.filters.network.http_conn\
    ection_manager.v4alpha.HttpConnectionManager.SetCurrentClientCertDetails\
    R\x1bsetCurrentClientCertDetails\x12,\n\x12proxy_100_continue\x18\x12\
    \x20\x01(\x08R\x10proxy100Continue\x12e\n1represent_ipv4_remote_address_\
    as_ipv4_mapped_ipv6\x18\x14\x20\x01(\x08R*representIpv4RemoteAddressAsIp\
    v4MappedIpv6\x12\x8e\x01\n\x0fupgrade_configs\x18\x17\x20\x03(\x0b2e.env\
    oy.extensions.filters.network.http_connection_manager.v4alpha.HttpConnec\
    tionManager.UpgradeConfigR\x0eupgradeConfigs\x12A\n\x0enormalize_path\
    \x18\x1e\x20\x01(\x0b2\x1a.google.protobuf.BoolValueR\rnormalizePath\x12\
    #\n\rmerge_slashes\x18!\x20\x01(\x08R\x0cmergeSlashes\x12\x86\x01\n\x14r\
    equest_id_extension\x18$\x20\x01(\x0b2T.envoy.extensions.filters.network\
    .http_connection_manager.v4alpha.RequestIDExtensionR\x12requestIdExtensi\
    on\x12\x80\x01\n\x12local_reply_config\x18&\x20\x01(\x0b2R.envoy.extensi\
    ons.filters.network.http_connection_manager.v4alpha.LocalReplyConfigR\
    \x10localReplyConfig\x127\n\x18strip_matching_host_port\x18'\x20\x01(\
    \x08R\x15stripMatchingHostPort\x12i\n$stream_error_on_invalid_http_messa\
    ge\x18(\x20\x01(\x0b2\x1a.google.protobuf.BoolValueR\x1fstreamErrorOnInv\
    alidHttpMessage\x1a\x80\x05\n\x07Tracing\x12?\n\x0fclient_sampling\x18\
    \x03\x20\x01(\x0b2\x16.envoy.type.v3.PercentR\x0eclientSampling\x12?\n\
    \x0frandom_sampling\x18\x04\x20\x01(\x0b2\x16.envoy.type.v3.PercentR\x0e\
    randomSampling\x12A\n\x10overall_sampling\x18\x05\x20\x01(\x0b2\x16.envo\
    y.type.v3.PercentR\x0foverallSampling\x12\x18\n\x07verbose\x18\x06\x20\
    \x01(\x08R\x07verbose\x12K\n\x13max_path_tag_length\x18\x07\x20\x01(\x0b\
    2\x1c.google.protobuf.UInt32ValueR\x10maxPathTagLength\x12A\n\x0bcustom_\
    tags\x18\x08\x20\x03(\x0b2\x20.envoy.type.tracing.v3.CustomTagR\ncustomT\
    ags\x12D\n\x08provider\x18\t\x20\x01(\x0b2(.envoy.config.trace.v4alpha.T\
    racing.HttpR\x08provider\"(\n\rOperationName\x12\x0b\n\x07INGRESS\x10\0\
    \x12\n\n\x06EGRESS\x10\x01:`\x9a\xc5\x88\x1e[\nYenvoy.extensions.filters\
    .network.http_connection_manager.v3.HttpConnectionManager.TracingJ\x04\
    \x08\x01\x10\x02J\x04\x08\x02\x10\x03R\x0eoperation_nameR\x18request_hea\
    ders_for_tags\x1a\xaa\x01\n\x15InternalAddressConfig\x12!\n\x0cunix_sock\
    ets\x18\x01\x20\x01(\x08R\x0bunixSockets:n\x9a\xc5\x88\x1ei\ngenvoy.exte\
    nsions.filters.network.http_connection_manager.v3.HttpConnectionManager.\
    InternalAddressConfig\x1a\x9d\x02\n\x1bSetCurrentClientCertDetails\x124\
    \n\x07subject\x18\x01\x20\x01(\x0b2\x1a.google.protobuf.BoolValueR\x07su\
    bject\x12\x12\n\x04cert\x18\x03\x20\x01(\x08R\x04cert\x12\x14\n\x05chain\
    \x18\x06\x20\x01(\x08R\x05chain\x12\x10\n\x03dns\x18\x04\x20\x01(\x08R\
    \x03dns\x12\x10\n\x03uri\x18\x05\x20\x01(\x08R\x03uri:t\x9a\xc5\x88\x1eo\
    \nmenvoy.extensions.filters.network.http_connection_manager.v3.HttpConne\
    ctionManager.SetCurrentClientCertDetailsJ\x04\x08\x02\x10\x03\x1a\xb8\
    \x02\n\rUpgradeConfig\x12!\n\x0cupgrade_type\x18\x01\x20\x01(\tR\x0bupgr\
    adeType\x12f\n\x07filters\x18\x02\x20\x03(\x0b2L.envoy.extensions.filter\
    s.network.http_connection_manager.v4alpha.HttpFilterR\x07filters\x124\n\
    \x07enabled\x18\x03\x20\x01(\x0b2\x1a.google.protobuf.BoolValueR\x07enab\
    led:f\x9a\xc5\x88\x1ea\n_envoy.extensions.filters.network.http_connectio\
    n_manager.v3.HttpConnectionManager.UpgradeConfig\"6\n\tCodecType\x12\x08\
    ...
    \x04B\x16\n\x0froute_specifier\x12\x03\xf8B\x01:X\x9a\xc5\x88\x1eS\nQenv\
    oy.extensions.filters.network.http_connection_manager.v3.HttpConnectionM\
    anagerJ\x04\x08\x1b\x10\x1cJ\x04\x08\x0b\x10\x0cR\x0cidle_timeout\"\xa9\
    \x02\n\x10LocalReplyConfig\x12j\n\x07mappers\x18\x01\x20\x03(\x0b2P.envo\
    y.extensions.filters.network.http_connection_manager.v4alpha.ResponseMap\
    perR\x07mappers\x12T\n\x0bbody_format\x18\x02\x20\x01(\x0b23.envoy.confi\
    g.core.v4alpha.SubstitutionFormatStringR\nbodyFormat:S\x9a\xc5\x88\x1eN\
    \nLenvoy.extensions.filters.network.http_connection_manager.v3.LocalRepl\
    yConfig\"\x83\x04\n\x0eResponseMapper\x12Q\n\x06filter\x18\x01\x20\x01(\
    \x0b2/.envoy.config.accesslog.v4alpha.AccessLogFilterR\x06filterB\x08\
    \xfaB\x05\x8a\x01\x02\x10\x01\x12J\n\x0bstatus_code\x18\x02\x20\x01(\x0b\
    2\x1c.google.protobuf.UInt32ValueR\nstatusCodeB\x0b\xfaB\x08*\x06\x10\
    \xd8\x04(\xc8\x01\x129\n\x04body\x18\x03\x20\x01(\x0b2%.envoy.config.cor\
    e.v4alpha.DataSourceR\x04body\x12e\n\x14body_format_override\x18\x04\x20\
    \x01(\x0b23.envoy.config.core.v4alpha.SubstitutionFormatStringR\x12bodyF\
    ormatOverride\x12]\n\x0eheaders_to_add\x18\x05\x20\x03(\x0b2,.envoy.conf\
    ig.core.v4alpha.HeaderValueOptionR\x0cheadersToAddB\t\xfaB\x06\x92\x01\
    \x03\x10\xe8\x07:Q\x9a\xc5\x88\x1eL\nJenvoy.extensions.filters.network.h\
    ttp_connection_manager.v3.ResponseMapper\"\xd1\x01\n\x03Rds\x12V\n\rconf\
    ig_source\x18\x01\x20\x01(\x0b2'.envoy.config.core.v4alpha.ConfigSourceR\
    \x0cconfigSourceB\x08\xfaB\x05\x8a\x01\x02\x10\x01\x12*\n\x11route_confi\
    g_name\x18\x02\x20\x01(\tR\x0frouteConfigName:F\x9a\xc5\x88\x1eA\n?envoy\
    .extensions.filters.network.http_connection_manager.v3.Rds\"\x81\x02\n\
    \x1dScopedRouteConfigurationsList\x12~\n\x1bscoped_route_configurations\
    \x18\x01\x20\x03(\x0b24.envoy.config.route.v4alpha.ScopedRouteConfigurat\
    ionR\x19scopedRouteConfigurationsB\x08\xfaB\x05\x92\x01\x02\x08\x01:`\
    \x9a\xc5\x88\x1e[\nYenvoy.extensions.filters.network.http_connection_man\
    ager.v3.ScopedRouteConfigurationsList\"\xa7\x0f\n\x0cScopedRoutes\x12\
    \x1b\n\x04name\x18\x01\x20\x01(\tR\x04nameB\x07\xfaB\x04r\x02\x10\x01\
    \x12\x94\x01\n\x11scope_key_builder\x18\x02\x20\x01(\x0b2^.envoy.extensi\
    ons.filters.network.http_connection_manager.v4alpha.ScopedRoutes.ScopeKe\
    yBuilderR\x0fscopeKeyBuilderB\x08\xfaB\x05\x8a\x01\x02\x10\x01\x12]\n\
    \x11rds_config_source\x18\x03\x20\x01(\x0b2'.envoy.config.core.v4alpha.C\
    onfigSourceR\x0frdsConfigSourceB\x08\xfaB\x05\x8a\x01\x02\x10\x01\x12\
    \xaa\x01\n\x20scoped_route_configurations_list\x18\x04\x20\x01(\x0b2_.en\
    voy.extensions.filters.network.http_connection_manager.v4alpha.ScopedRou\
    teConfigurationsListH\0R\x1dscopedRouteConfigurationsList\x12l\n\nscoped\
    _rds\x18\x05\x20\x01(\x0b2K.envoy.extensions.filters.network.http_connec\
    tion_manager.v4alpha.ScopedRdsH\0R\tscopedRds\x1a\xfe\t\n\x0fScopeKeyBui\
    lder\x12\x96\x01\n\tfragments\x18\x01\x20\x03(\x0b2n.envoy.extensions.fi\
    lters.network.http_connection_manager.v4alpha.ScopedRoutes.ScopeKeyBuild\
    er.FragmentBuilderR\tfragmentsB\x08\xfaB\x05\x92\x01\x02\x08\x01\x1a\xf0\
    \x07\n\x0fFragmentBuilder\x12\xbc\x01\n\x16header_value_extractor\x18\
    \x01\x20\x01(\x0b2\x83\x01.envoy.extensions.filters.network.http_connect\
    ion_manager.v4alpha.ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderV\
    alueExtractorH\0R\x14headerValueExtractor\x1a\x9f\x05\n\x14HeaderValueEx\
    tractor\x12\x1b\n\x04name\x18\x01\x20\x01(\tR\x04nameB\x07\xfaB\x04r\x02\
    \x10\x01\x12+\n\x11element_separator\x18\x02\x20\x01(\tR\x10elementSepar\
    ator\x12\x16\n\x05index\x18\x03\x20\x01(\rH\0R\x05index\x12\xaa\x01\n\
    \x07element\x18\x04\x20\x01(\x0b2\x8d\x01.envoy.extensions.filters.netwo\
    rk.http_connection_manager.v4alpha.ScopedRoutes.ScopeKeyBuilder.Fragment\
    Builder.HeaderValueExtractor.KvElementH\0R\x07element\x1a\xe0\x01\n\tKvE\
    lement\x12%\n\tseparator\x18\x01\x20\x01(\tR\tseparatorB\x07\xfaB\x04r\
    \x02\x10\x01\x12\x19\n\x03key\x18\x02\x20\x01(\tR\x03keyB\x07\xfaB\x04r\
    \x02\x10\x01:\x90\x01\x9a\xc5\x88\x1e\x8a\x01\n\x87\x01envoy.extensions.\
    filters.network.http_connection_manager.v3.ScopedRoutes.ScopeKeyBuilder.\
    FragmentBuilder.HeaderValueExtractor.KvElementB\x0e\n\x0cextract_type:\
    \x84\x01\x9a\xc5\x88\x1e\x7f\n}envoy.extensions.filters.network.http_con\
    nection_manager.v3.ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderVa\
    lueExtractorB\x0b\n\x04type\x12\x03\xf8B\x01:o\x9a\xc5\x88\x1ej\nhenvoy.\
    extensions.filters.network.http_connection_manager.v3.ScopedRoutes.Scope\
    KeyBuilder.FragmentBuilder:_\x9a\xc5\x88\x1eZ\nXenvoy.extensions.filters\
    .network.http_connection_manager.v3.ScopedRoutes.ScopeKeyBuilderB\x17\n\
    \x10config_specifier\x12\x03\xf8B\x01:O\x9a\xc5\x88\x1eJ\nHenvoy.extensi\
    ons.filters.network.http_connection_manager.v3.ScopedRoutes\"\xc5\x01\n\
    \tScopedRds\x12j\n\x18scoped_rds_config_source\x18\x01\x20\x01(\x0b2'.en\
    voy.config.core.v4alpha.ConfigSourceR\x15scopedRdsConfigSourceB\x08\xfaB\
    \x05\x8a\x01\x02\x10\x01:L\x9a\xc5\x88\x1eG\nEenvoy.extensions.filters.n\
    etwork.http_connection_manager.v3.ScopedRds\"\xb5\x02\n\nHttpFilter\x12\
    \x1b\n\x04name\x18\x01\x20\x01(\tR\x04nameB\x07\xfaB\x04r\x02\x10\x01\
    \x129\n\x0ctyped_config\x18\x04\x20\x01(\x0b2\x14.google.protobuf.AnyH\0\
    R\x0btypedConfig\x12]\n\x10config_discovery\x18\x05\x20\x01(\x0b20.envoy\
    .config.core.v4alpha.ExtensionConfigSourceH\0R\x0fconfigDiscoveryB\r\n\
    \x0bconfig_type:M\x9a\xc5\x88\x1eH\nFenvoy.extensions.filters.network.ht\
    tp_connection_manager.v3.HttpFilterJ\x04\x08\x03\x10\x04J\x04\x08\x02\
    \x10\x03R\x06config\"\xa4\x01\n\x12RequestIDExtension\x127\n\x0ctyped_co\
    nfig\x18\x01\x20\x01(\x0b2\x14.google.protobuf.AnyR\x0btypedConfig:U\x9a\
    \xc5\x88\x1eP\nNenvoy.extensions.filters.network.http_connection_manager\
    .v3.RequestIDExtensionBv\nNio.envoyproxy.envoy.extensions.filters.networ\
    k.http_connection_manager.v4alphaB\x1aHttpConnectionManagerProtoP\x01\
