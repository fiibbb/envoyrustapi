...
//! Generated file from `envoy/extensions/filters/http/cache/v4alpha/cache.proto`
...
impl CacheConfig {
    ...
    // repeated .envoy.type.matcher.v4alpha.StringMatcher allowed_vary_headers = 2;
    ...
    // .envoy.extensions.filters.http.cache.v4alpha.CacheConfig.KeyCreatorParams key_creator_params = 3;
...
impl CacheConfig_KeyCreatorParams {
    ...
    // repeated .envoy.config.route.v4alpha.QueryParameterMatcher query_parameters_included = 3;
    ...
    // repeated .envoy.config.route.v4alpha.QueryParameterMatcher query_parameters_excluded = 4;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n7envoy/extensions/filters/http/cache/v4alpha/cache.proto\x12+envoy.ext\
    ensions.filters.http.cache.v4alpha\x1a1envoy/config/route/v4alpha/route_\
    components.proto\x1a'envoy/type/matcher/v4alpha/string.proto\x1a\x19goog\
    le/protobuf/any.proto\x1a\x1dudpa/annotations/status.proto\x1a!udpa/anno\
    tations/versioning.proto\x1a\x17validate/validate.proto\"\x9a\x06\n\x0bC\
    acheConfig\x12A\n\x0ctyped_config\x18\x01\x20\x01(\x0b2\x14.google.proto\
    buf.AnyR\x0btypedConfigB\x08\xfaB\x05\xa2\x01\x02\x08\x01\x12[\n\x14allo\
    wed_vary_headers\x18\x02\x20\x03(\x0b2).envoy.type.matcher.v4alpha.Strin\
    gMatcherR\x12allowedVaryHeaders\x12w\n\x12key_creator_params\x18\x03\x20\
    \x01(\x0b2I.envoy.extensions.filters.http.cache.v4alpha.CacheConfig.KeyC\
    reatorParamsR\x10keyCreatorParams\x12$\n\x0emax_body_bytes\x18\x04\x20\
    \x01(\rR\x0cmaxBodyBytes\x1a\x8b\x03\n\x10KeyCreatorParams\x12%\n\x0eexc\
    lude_scheme\x18\x01\x20\x01(\x08R\rexcludeScheme\x12!\n\x0cexclude_host\
    \x18\x02\x20\x01(\x08R\x0bexcludeHost\x12m\n\x19query_parameters_include\
    d\x18\x03\x20\x03(\x0b21.envoy.config.route.v4alpha.QueryParameterMatche\
    rR\x17queryParametersIncluded\x12m\n\x19query_parameters_excluded\x18\
    \x04\x20\x03(\x0b21.envoy.config.route.v4alpha.QueryParameterMatcherR\
    \x17queryParametersExcluded:O\x9a\xc5\x88\x1eJ\nHenvoy.extensions.filter\
    s.http.cache.v3alpha.CacheConfig.KeyCreatorParams:>\x9a\xc5\x88\x1e9\n7e\
    nvoy.extensions.filters.http.cache.v3alpha.CacheConfigBY\n9io.envoyproxy\
    .envoy.extensions.filters.http.cache.v4alphaB\nCacheProtoP\x01\xba\x80\
