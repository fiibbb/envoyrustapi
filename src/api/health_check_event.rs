...
//! Generated file from `envoy/data/core/v3/health_check_event.proto`
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n+envoy/data/core/v3/health_check_event.proto\x12\x12envoy.data.core.v3\
    \x1a\"envoy/config/core/v3/address.proto\x1a\x1fgoogle/protobuf/timestam\
    p.proto\x1a\x1dudpa/annotations/status.proto\x1a!udpa/annotations/versio\
    ning.proto\x1a\x17validate/validate.proto\"\xb2\x06\n\x10HealthCheckEven\
    t\x12_\n\x13health_checker_type\x18\x01\x20\x01(\x0e2%.envoy.data.core.v\
    3.HealthCheckerTypeR\x11healthCheckerTypeB\x08\xfaB\x05\x82\x01\x02\x10\
    \x01\x121\n\x04host\x18\x02\x20\x01(\x0b2\x1d.envoy.config.core.v3.Addre\
    ssR\x04host\x12*\n\x0ccluster_name\x18\x03\x20\x01(\tR\x0bclusterNameB\
    \x07\xfaB\x04r\x02\x10\x01\x12c\n\x15eject_unhealthy_event\x18\x04\x20\
    \x01(\x0b2-.envoy.data.core.v3.HealthCheckEjectUnhealthyH\0R\x13ejectUnh\
    ealthyEvent\x12W\n\x11add_healthy_event\x18\x05\x20\x01(\x0b2).envoy.dat\
    a.core.v3.HealthCheckAddHealthyH\0R\x0faddHealthyEvent\x12e\n\x1ahealth_\
    check_failure_event\x18\x07\x20\x01(\x0b2&.envoy.data.core.v3.HealthChec\
    kFailureH\0R\x17healthCheckFailureEvent\x12]\n\x15degraded_healthy_host\
    \x18\x08\x20\x01(\x0b2'.envoy.data.core.v3.DegradedHealthyHostH\0R\x13de\
    gradedHealthyHost\x12a\n\x17no_longer_degraded_host\x18\t\x20\x01(\x0b2(\
    .envoy.data.core.v3.NoLongerDegradedHostH\0R\x14noLongerDegradedHost\x12\
    8\n\ttimestamp\x18\x06\x20\x01(\x0b2\x1a.google.protobuf.TimestampR\ttim\
    estampB\x0c\n\x05event\x12\x03\xf8B\x01:/\x9a\xc5\x88\x1e*\n(envoy.data.\
    core.v2alpha.HealthCheckEvent\"\xae\x01\n\x19HealthCheckEjectUnhealthy\
    \x12W\n\x0cfailure_type\x18\x01\x20\x01(\x0e2*.envoy.data.core.v3.Health\
    CheckFailureTypeR\x0bfailureTypeB\x08\xfaB\x05\x82\x01\x02\x10\x01:8\x9a\
    \xc5\x88\x1e3\n1envoy.data.core.v2alpha.HealthCheckEjectUnhealthy\"n\n\
    \x15HealthCheckAddHealthy\x12\x1f\n\x0bfirst_check\x18\x01\x20\x01(\x08R\
    \nfirstCheck:4\x9a\xc5\x88\x1e/\n-envoy.data.core.v2alpha.HealthCheckAdd\
    Healthy\"\xc1\x01\n\x12HealthCheckFailure\x12W\n\x0cfailure_type\x18\x01\
    \x20\x01(\x0e2*.envoy.data.core.v3.HealthCheckFailureTypeR\x0bfailureTyp\
    eB\x08\xfaB\x05\x82\x01\x02\x10\x01\x12\x1f\n\x0bfirst_check\x18\x02\x20\
    \x01(\x08R\nfirstCheck:1\x9a\xc5\x88\x1e,\n*envoy.data.core.v2alpha.Heal\
    thCheckFailure\"I\n\x13DegradedHealthyHost:2\x9a\xc5\x88\x1e-\n+envoy.da\
    ta.core.v2alpha.DegradedHealthyHost\"K\n\x14NoLongerDegradedHost:3\x9a\
    \xc5\x88\x1e.\n,envoy.data.core.v2alpha.NoLongerDegradedHost*>\n\x16Heal\
    thCheckFailureType\x12\n\n\x06ACTIVE\x10\0\x12\x0b\n\x07PASSIVE\x10\x01\
    \x12\x0b\n\x07NETWORK\x10\x02*;\n\x11HealthCheckerType\x12\x08\n\x04HTTP\
    \x10\0\x12\x07\n\x03TCP\x10\x01\x12\x08\n\x04GRPC\x10\x02\x12\t\n\x05RED\
    IS\x10\x03BC\n\x20io.envoyproxy.envoy.data.core.v3B\x15HealthCheckEventP\
    rotoP\x01\xba\x80\xc8\xd1\x06\x02\x10\x02b\x06proto3\
";
