...
//! Generated file from `envoy/extensions/upstreams/http/v4alpha/http_protocol_options.proto`
...
impl HttpProtocolOptions {
    ...
    // .envoy.config.core.v4alpha.UpstreamHttpProtocolOptions upstream_http_protocol_options = 2;
    ...
    // .envoy.extensions.upstreams.http.v4alpha.HttpProtocolOptions.ExplicitHttpConfig explicit_http_config = 3;
    ...
    // .envoy.extensions.upstreams.http.v4alpha.HttpProtocolOptions.UseDownstreamHttpConfig use_downstream_protocol_config = 4;
...
impl HttpProtocolOptions_ExplicitHttpConfig {
    ...
    // .envoy.config.core.v4alpha.Http1ProtocolOptions http_protocol_options = 1;
    ...
    // .envoy.config.core.v4alpha.Http2ProtocolOptions http2_protocol_options = 2;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \nCenvoy/extensions/upstreams/http/v4alpha/http_protocol_options.proto\
    \x12'envoy.extensions.upstreams.http.v4alpha\x1a(envoy/config/core/v4alp\
    ha/protocol.proto\x1a\x1dudpa/annotations/status.proto\x1a!udpa/annotati\
    ons/versioning.proto\"\x8e\n\n\x13HttpProtocolOptions\x12o\n\x1ccommon_h\
    ttp_protocol_options\x18\x01\x20\x01(\x0b2..envoy.config.core.v4alpha.Ht\
    tpProtocolOptionsR\x19commonHttpProtocolOptions\x12{\n\x1eupstream_http_\
    protocol_options\x18\x02\x20\x01(\x0b26.envoy.config.core.v4alpha.Upstre\
    amHttpProtocolOptionsR\x1bupstreamHttpProtocolOptions\x12\x83\x01\n\x14e\
    xplicit_http_config\x18\x03\x20\x01(\x0b2O.envoy.extensions.upstreams.ht\
    tp.v4alpha.HttpProtocolOptions.ExplicitHttpConfigH\0R\x12explicitHttpCon\
    fig\x12\x9b\x01\n\x1euse_downstream_protocol_config\x18\x04\x20\x01(\x0b\
    2T.envoy.extensions.upstreams.http.v4alpha.HttpProtocolOptions.UseDownst\
    reamHttpConfigH\0R\x1buseDownstreamProtocolConfig\x1a\xc9\x02\n\x12Expli\
    citHttpConfig\x12e\n\x15http_protocol_options\x18\x01\x20\x01(\x0b2/.env\
    oy.config.core.v4alpha.Http1ProtocolOptionsH\0R\x13httpProtocolOptions\
    \x12g\n\x16http2_protocol_options\x18\x02\x20\x01(\x0b2/.envoy.config.co\
    re.v4alpha.Http2ProtocolOptionsH\0R\x14http2ProtocolOptionsB\x11\n\x0fpr\
    otocol_config:P\x9a\xc5\x88\x1eK\nIenvoy.extensions.upstreams.http.v3.Ht\
    tpProtocolOptions.ExplicitHttpConfig\x1a\xbc\x02\n\x17UseDownstreamHttpC\
    onfig\x12c\n\x15http_protocol_options\x18\x01\x20\x01(\x0b2/.envoy.confi\
    g.core.v4alpha.Http1ProtocolOptionsR\x13httpProtocolOptions\x12e\n\x16ht\
    tp2_protocol_options\x18\x02\x20\x01(\x0b2/.envoy.config.core.v4alpha.Ht\
    tp2ProtocolOptionsR\x14http2ProtocolOptions:U\x9a\xc5\x88\x1eP\nNenvoy.e\
    xtensions.upstreams.http.v3.HttpProtocolOptions.UseDownstreamHttpConfigB\
    \x1b\n\x19upstream_protocol_options:=\x9a\xc5\x88\x1e8\n6envoy.extension\
    s.upstreams.http.v3.HttpProtocolOptionsB[\n5io.envoyproxy.envoy.extensio\
    ns.upstreams.http.v4alphaB\x18HttpProtocolOptionsProtoP\x01\xba\x80\xc8\
