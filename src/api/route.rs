...
//! Generated file from `envoy/extensions/filters/network/thrift_proxy/v4alpha/route.proto`
...
impl RouteConfiguration {
    ...
    // repeated .envoy.extensions.filters.network.thrift_proxy.v4alpha.Route routes = 2;
...
impl Route {
    ...
    // .envoy.extensions.filters.network.thrift_proxy.v4alpha.RouteMatch match = 1;
    ...
    // .envoy.extensions.filters.network.thrift_proxy.v4alpha.RouteAction route = 2;
...
impl RouteAction {
    ...
    // .envoy.extensions.filters.network.thrift_proxy.v4alpha.WeightedCluster weighted_clusters = 2;
    ...
    // repeated .envoy.config.route.v4alpha.RateLimit rate_limits = 4;
...
impl WeightedCluster {
    ...
    // repeated .envoy.extensions.filters.network.thrift_proxy.v4alpha.WeightedCluster.ClusterWeight clusters = 1;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \nAenvoy/extensions/filters/network/thrift_proxy/v4alpha/route.proto\x12\
    5envoy.extensions.filters.network.thrift_proxy.v4alpha\x1a$envoy/config/\
    core/v4alpha/base.proto\x1a1envoy/config/route/v4alpha/route_components.\
    ...
    \x01(\tR\x04name\x12T\n\x06routes\x18\x02\x20\x03(\x0b2<.envoy.extension\
    s.filters.network.thrift_proxy.v4alpha.RouteR\x06routes:J\x9a\xc5\x88\
    \x1eE\nCenvoy.extensions.filters.network.thrift_proxy.v3.RouteConfigurat\
    ion\"\x8d\x02\n\x05Route\x12a\n\x05match\x18\x01\x20\x01(\x0b2A.envoy.ex\
    tensions.filters.network.thrift_proxy.v4alpha.RouteMatchR\x05matchB\x08\
    \xfaB\x05\x8a\x01\x02\x10\x01\x12b\n\x05route\x18\x02\x20\x01(\x0b2B.env\
    oy.extensions.filters.network.thrift_proxy.v4alpha.RouteActionR\x05route\
    B\x08\xfaB\x05\x8a\x01\x02\x10\x01:=\x9a\xc5\x88\x1e8\n6envoy.extensions\
    .filters.network.thrift_proxy.v3.Route\"\x8d\x02\n\nRouteMatch\x12!\n\
    \x0bmethod_name\x18\x01\x20\x01(\tH\0R\nmethodName\x12#\n\x0cservice_nam\
    e\x18\x02\x20\x01(\tH\0R\x0bserviceName\x12\x16\n\x06invert\x18\x03\x20\
    \x01(\x08R\x06invert\x12C\n\x07headers\x18\x04\x20\x03(\x0b2).envoy.conf\
    ig.route.v4alpha.HeaderMatcherR\x07headersB\x16\n\x0fmatch_specifier\x12\
    \x03\xf8B\x01:B\x9a\xc5\x88\x1e=\n;envoy.extensions.filters.network.thri\
    ft_proxy.v3.RouteMatch\"\x82\x04\n\x0bRouteAction\x12#\n\x07cluster\x18\
    \x01\x20\x01(\tH\0R\x07clusterB\x07\xfaB\x04r\x02\x10\x01\x12u\n\x11weig\
    hted_clusters\x18\x02\x20\x01(\x0b2F.envoy.extensions.filters.network.th\
    rift_proxy.v4alpha.WeightedClusterH\0R\x10weightedClusters\x126\n\x0eclu\
    ster_header\x18\x06\x20\x01(\tH\0R\rclusterHeaderB\r\xfaB\nr\x08\x10\x01\
    \xc0\x01\x02\xc8\x01\0\x12J\n\x0emetadata_match\x18\x03\x20\x01(\x0b2#.e\
    nvoy.config.core.v4alpha.MetadataR\rmetadataMatch\x12F\n\x0brate_limits\
    \x18\x04\x20\x03(\x0b2%.envoy.config.route.v4alpha.RateLimitR\nrateLimit\
    s\x12,\n\x12strip_service_name\x18\x05\x20\x01(\x08R\x10stripServiceName\
    B\x18\n\x11cluster_specifier\x12\x03\xf8B\x01:C\x9a\xc5\x88\x1e>\n<envoy\
    .extensions.filters.network.thrift_proxy.v3.RouteAction\"\xe7\x03\n\x0fW\
    eightedCluster\x12z\n\x08clusters\x18\x01\x20\x03(\x0b2T.envoy.extension\
    s.filters.network.thrift_proxy.v4alpha.WeightedCluster.ClusterWeightR\
    \x08clustersB\x08\xfaB\x05\x92\x01\x02\x08\x01\x1a\x8e\x02\n\rClusterWei\
    ght\x12\x1b\n\x04name\x18\x01\x20\x01(\tR\x04nameB\x07\xfaB\x04r\x02\x10\
    \x01\x12=\n\x06weight\x18\x02\x20\x01(\x0b2\x1c.google.protobuf.UInt32Va\
    lueR\x06weightB\x07\xfaB\x04*\x02(\x01\x12J\n\x0emetadata_match\x18\x03\
    \x20\x01(\x0b2#.envoy.config.core.v4alpha.MetadataR\rmetadataMatch:U\x9a\
    \xc5\x88\x1eP\nNenvoy.extensions.filters.network.thrift_proxy.v3.Weighte\
    dCluster.ClusterWeight:G\x9a\xc5\x88\x1eB\n@envoy.extensions.filters.net\
    work.thrift_proxy.v3.WeightedClusterB[\nCio.envoyproxy.envoy.extensions.\
    filters.network.thrift_proxy.v4alphaB\nRouteProtoP\x01\xba\x80\xc8\xd1\
