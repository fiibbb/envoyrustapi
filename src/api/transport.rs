...
//! Generated file from `envoy/data/tap/v3/transport.proto`
...
impl Connection {
    ...
    // .envoy.config.core.v3.Address remote_address = 3;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n!envoy/data/tap/v3/transport.proto\x12\x11envoy.data.tap.v3\x1a\"envoy\
    /config/core/v3/address.proto\x1a\x1eenvoy/data/tap/v3/common.proto\x1a\
    \x1fgoogle/protobuf/timestamp.proto\x1a\x1dudpa/annotations/status.proto\
    \x1a!udpa/annotations/versioning.proto\"\xc0\x01\n\nConnection\x12B\n\rl\
    ocal_address\x18\x02\x20\x01(\x0b2\x1d.envoy.config.core.v3.AddressR\x0c\
    localAddress\x12D\n\x0eremote_address\x18\x03\x20\x01(\x0b2\x1d.envoy.co\
    nfig.core.v3.AddressR\rremoteAddress:(\x9a\xc5\x88\x1e#\n!envoy.data.tap\
    .v2alpha.Connection\"\xe6\x04\n\x0bSocketEvent\x128\n\ttimestamp\x18\x01\
    \x20\x01(\x0b2\x1a.google.protobuf.TimestampR\ttimestamp\x129\n\x04read\
    \x18\x02\x20\x01(\x0b2#.envoy.data.tap.v3.SocketEvent.ReadH\0R\x04read\
    \x12<\n\x05write\x18\x03\x20\x01(\x0b2$.envoy.data.tap.v3.SocketEvent.Wr\
    iteH\0R\x05write\x12?\n\x06closed\x18\x04\x20\x01(\x0b2%.envoy.data.tap.\
    v3.SocketEvent.ClosedH\0R\x06closed\x1ac\n\x04Read\x12+\n\x04data\x18\
    \x01\x20\x01(\x0b2\x17.envoy.data.tap.v3.BodyR\x04data:.\x9a\xc5\x88\x1e\
    )\n'envoy.data.tap.v2alpha.SocketEvent.Read\x1a\x84\x01\n\x05Write\x12+\
    \n\x04data\x18\x01\x20\x01(\x0b2\x17.envoy.data.tap.v3.BodyR\x04data\x12\
    \x1d\n\nend_stream\x18\x02\x20\x01(\x08R\tendStream:/\x9a\xc5\x88\x1e*\n\
    (envoy.data.tap.v2alpha.SocketEvent.Write\x1a:\n\x06Closed:0\x9a\xc5\x88\
    \x1e+\n)envoy.data.tap.v2alpha.SocketEvent.ClosedB\x10\n\x0eevent_select\
    or:)\x9a\xc5\x88\x1e$\n\"envoy.data.tap.v2alpha.SocketEvent\"\xaa\x02\n\
    \x13SocketBufferedTrace\x12\x19\n\x08trace_id\x18\x01\x20\x01(\x04R\x07t\
    raceId\x12=\n\nconnection\x18\x02\x20\x01(\x0b2\x1d.envoy.data.tap.v3.Co\
    nnectionR\nconnection\x126\n\x06events\x18\x03\x20\x03(\x0b2\x1e.envoy.d\
    ata.tap.v3.SocketEventR\x06events\x12%\n\x0eread_truncated\x18\x04\x20\
    \x01(\x08R\rreadTruncated\x12'\n\x0fwrite_truncated\x18\x05\x20\x01(\x08\
    R\x0ewriteTruncated:1\x9a\xc5\x88\x1e,\n*envoy.data.tap.v2alpha.SocketBu\
    fferedTrace\"\xfb\x01\n\x1aSocketStreamedTraceSegment\x12\x19\n\x08trace\
    _id\x18\x01\x20\x01(\x04R\x07traceId\x12?\n\nconnection\x18\x02\x20\x01(\
    \x0b2\x1d.envoy.data.tap.v3.ConnectionH\0R\nconnection\x126\n\x05event\
    \x18\x03\x20\x01(\x0b2\x1e.envoy.data.tap.v3.SocketEventH\0R\x05eventB\
    \x0f\n\rmessage_piece:8\x9a\xc5\x88\x1e3\n1envoy.data.tap.v2alpha.Socket\
    StreamedTraceSegmentB;\n\x1fio.envoyproxy.envoy.data.tap.v3B\x0eTranspor\
    tProtoP\x01\xba\x80\xc8\xd1\x06\x02\x10\x02b\x06proto3\
";
