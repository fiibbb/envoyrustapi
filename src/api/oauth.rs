...
//! Generated file from `envoy/extensions/filters/http/oauth2/v4alpha/oauth.proto`
...
impl OAuth2Credentials {
    ...
    // .envoy.extensions.transport_sockets.tls.v4alpha.SdsSecretConfig token_secret = 2;
    ...
    // .envoy.extensions.transport_sockets.tls.v4alpha.SdsSecretConfig hmac_secret = 3;
...
impl OAuth2Config {
    ...
    // .envoy.config.core.v4alpha.HttpUri token_endpoint = 1;
    ...
    // .envoy.extensions.filters.http.oauth2.v4alpha.OAuth2Credentials credentials = 3;
    ...
    // .envoy.type.matcher.v4alpha.PathMatcher redirect_path_matcher = 5;
    ...
    // .envoy.type.matcher.v4alpha.PathMatcher signout_path = 6;
    ...
    // repeated .envoy.config.route.v4alpha.HeaderMatcher pass_through_matcher = 8;
...
impl OAuth2 {
    ...
    // .envoy.extensions.filters.http.oauth2.v4alpha.OAuth2Config config = 1;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n8envoy/extensions/filters/http/oauth2/v4alpha/oauth.proto\x12,envoy.ex\
    tensions.filters.http.oauth2.v4alpha\x1a(envoy/config/core/v4alpha/http_\
    uri.proto\x1a1envoy/config/route/v4alpha/route_components.proto\x1a;envo\
    y/extensions/transport_sockets/tls/v4alpha/secret.proto\x1a%envoy/type/m\
    atcher/v4alpha/path.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1du\
    dpa/annotations/status.proto\x1a!udpa/annotations/versioning.proto\x1a\
    \x17validate/validate.proto\"\xf4\x02\n\x11OAuth2Credentials\x12$\n\tcli\
    ent_id\x18\x01\x20\x01(\tR\x08clientIdB\x07\xfaB\x04r\x02\x10\x01\x12l\n\
    \x0ctoken_secret\x18\x02\x20\x01(\x0b2?.envoy.extensions.transport_socke\
    ts.tls.v4alpha.SdsSecretConfigR\x0btokenSecretB\x08\xfaB\x05\x8a\x01\x02\
    \x10\x01\x12l\n\x0bhmac_secret\x18\x03\x20\x01(\x0b2?.envoy.extensions.t\
    ransport_sockets.tls.v4alpha.SdsSecretConfigH\0R\nhmacSecretB\x08\xfaB\
    \x05\x8a\x01\x02\x10\x01B\x16\n\x0ftoken_formation\x12\x03\xf8B\x01:E\
    \x9a\xc5\x88\x1e@\n>envoy.extensions.filters.http.oauth2.v3alpha.OAuth2C\
    redentials\"\xc0\x05\n\x0cOAuth2Config\x12I\n\x0etoken_endpoint\x18\x01\
    \x20\x01(\x0b2\".envoy.config.core.v4alpha.HttpUriR\rtokenEndpoint\x12>\
    \n\x16authorization_endpoint\x18\x02\x20\x01(\tR\x15authorizationEndpoin\
    tB\x07\xfaB\x04r\x02\x10\x01\x12k\n\x0bcredentials\x18\x03\x20\x01(\x0b2\
    ?.envoy.extensions.filters.http.oauth2.v4alpha.OAuth2CredentialsR\x0bcre\
    dentialsB\x08\xfaB\x05\x8a\x01\x02\x10\x01\x12*\n\x0credirect_uri\x18\
    \x04\x20\x01(\tR\x0bredirectUriB\x07\xfaB\x04r\x02\x10\x01\x12e\n\x15red\
    irect_path_matcher\x18\x05\x20\x01(\x0b2'.envoy.type.matcher.v4alpha.Pat\
    hMatcherR\x13redirectPathMatcherB\x08\xfaB\x05\x8a\x01\x02\x10\x01\x12T\
    \n\x0csignout_path\x18\x06\x20\x01(\x0b2'.envoy.type.matcher.v4alpha.Pat\
    hMatcherR\x0bsignoutPathB\x08\xfaB\x05\x8a\x01\x02\x10\x01\x120\n\x14for\
    ward_bearer_token\x18\x07\x20\x01(\x08R\x12forwardBearerToken\x12[\n\x14\
    pass_through_matcher\x18\x08\x20\x03(\x0b2).envoy.config.route.v4alpha.H\
    eaderMatcherR\x12passThroughMatcher:@\x9a\xc5\x88\x1e;\n9envoy.extension\
    s.filters.http.oauth2.v3alpha.OAuth2Config\"\x98\x01\n\x06OAuth2\x12R\n\
    \x06config\x18\x01\x20\x01(\x0b2:.envoy.extensions.filters.http.oauth2.v\
    4alpha.OAuth2ConfigR\x06config::\x9a\xc5\x88\x1e5\n3envoy.extensions.fil\
    ters.http.oauth2.v3alpha.OAuth2BZ\n:io.envoyproxy.envoy.extensions.filte\
    rs.http.oauth2.v4alphaB\nOauthProtoP\x01\xba\x80\xc8\xd1\x06\x02\x08\x01\
